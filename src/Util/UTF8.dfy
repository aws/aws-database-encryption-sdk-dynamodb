...
module {:extern "UTF8"} UTF8 {
  ...
  // The implementation is exactly the same as the above, I just can't know if the input is valid or not though.
  function method {:extern "AttemptDecode"} AttemptDecode(b: seq<uint8>): (res: Result<string, string>)
