...
if [[ "$1" == "implementation" ]]; then
  ...
  for directory in runtimes/java/temp/AwsCryptographyStructuredEncryption-java/*; do
  ...
  for allFiles in runtimes/java/temp-tests/AwsCryptographyStructuredEncryptionTests-java/*; do
