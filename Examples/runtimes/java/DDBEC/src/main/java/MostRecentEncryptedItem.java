...
public class MostRecentEncryptedItem {
  ...
  public static void encryptRecord(
    ...
    ddbClient.putItem(PutItemRequest.builder().tableName(tableName).item(encrypted_record).build());
    ...
    final GetItemResponse getResponse =
        ddbClient.getItem(GetItemRequest.builder().tableName(tableName).key(keyToGet).build());
