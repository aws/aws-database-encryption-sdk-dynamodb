...
import ddbec.MigrationExampleStep0;
...
public class TestMigrationExampleStep3 {
    ...
    public void TestMigrationStep3() {
        ...
        MigrationExampleStep1.MigrationStep1(ddbec.TestUtils.TEST_KMS_KEY_ID, ddbec.TestUtils.TEST_DDB_TABLE_NAME, 1);
        ...
        MigrationExampleStep2.MigrationStep2(ddbec.TestUtils.TEST_KMS_KEY_ID, ddbec.TestUtils.TEST_DDB_TABLE_NAME, 2);
