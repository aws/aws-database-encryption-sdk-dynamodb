...
import software.software.cryptography.dbencryptionsdk.dynamodb.enhancedclient.CreateDynamoDbEncryptionInterceptorInput;
import software.software.cryptography.dbencryptionsdk.dynamodb.enhancedclient.DynamoDbEnhancedClientEncryption;
import software.software.cryptography.dbencryptionsdk.dynamodb.enhancedclient.DynamoDbEnhancedTableEncryptionConfig;
...
public class MigrationExampleStep1 {
    ...
    public static void MigrationStep1(String kmsKeyId, String ddbTableName, int sortReadValue) {
        ...
        // 4. Configure the attributeActions that are configured on our modelled class in Step 0
        //    in an explicit map.
        ...
        legacyActions.put("encrypt_and_sign", CryptoAction.ENCRYPT_AND_SIGN);
        legacyActions.put("sign_only", CryptoAction.SIGN_ONLY);
        legacyActions.put("do_nothing", CryptoAction.DO_NOTHING);
        ...
        //    created above. For Legacy Policy, use `REQUIRE_ENCRYPT_ALLOW_DECRYPT`.
