...
public class TestMigrationExampleStep3 {
    ...
    public void TestMigrationStep3() {
        ...
        MigrationExampleStep1.MigrationStep1(
            software.amazon.cryptography.examples.migration.ddbec.TestUtils.TEST_KMS_KEY_ID, software.amazon.cryptography.examples.migration.ddbec.TestUtils.TEST_DDB_TABLE_NAME, 1);
        ...
        MigrationExampleStep2.MigrationStep2(
            software.amazon.cryptography.examples.migration.ddbec.TestUtils.TEST_KMS_KEY_ID, software.amazon.cryptography.examples.migration.ddbec.TestUtils.TEST_DDB_TABLE_NAME, 2);
