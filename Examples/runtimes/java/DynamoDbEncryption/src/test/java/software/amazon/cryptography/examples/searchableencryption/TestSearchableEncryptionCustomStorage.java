...
public class TestSearchableEncryptionCustomStorage {

  @Test
  public void TestCustomStorage() throws InterruptedException {
    ...
    SearchableEncryptionCustomStorage.PutItemQueryItemWithBeaconCustomStorage(
