...
public class TestSearchableEncryptionDefaultStorage {

  @Test
  public void TestDefaultStorage() throws InterruptedException {
    ...
    SearchableEncryptionDefaultStorage.PutItemQueryItemWithBeaconDefaultStorage(
