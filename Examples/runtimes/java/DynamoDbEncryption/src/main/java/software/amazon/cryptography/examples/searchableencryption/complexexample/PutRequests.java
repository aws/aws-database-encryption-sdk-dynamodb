...
public class PutRequests {
  ...
  public static void putAllMeetingItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    meeting2AttendeeList.add(AttributeValue.builder().s("barney@gmail.com").build());
    meeting2AttendeeList.add(AttributeValue.builder().s("zorro@gmail.com").build());
    ...
    meeting2.put("partition_key", AttributeValue.builder().s("meeting2").build());
    meeting2.put("EmployeeID", AttributeValue.builder().s("emp_002").build());
    meeting2.put("EmployeeEmail", AttributeValue.builder().s("barney@gmail.com").build());
    meeting2.put("MeetingStart", AttributeValue.builder().s("2022-07-04T13:00").build());
    meeting2.put("Location", AttributeValue.builder().m(meeting2Location).build());
    meeting2.put("Duration", AttributeValue.builder().s("30").build());
    meeting2.put("Attendees", AttributeValue.builder().l(meeting2AttendeeList).build());
    ...
    meeting3AttendeeList.add(AttributeValue.builder().s("charlie@gmail.com").build());
    meeting3AttendeeList.add(AttributeValue.builder().s("zorro@gmail.com").build());
    ...
    meeting3.put("partition_key", AttributeValue.builder().s("meeting3").build());
    meeting3.put("EmployeeID", AttributeValue.builder().s("emp_003").build());
    meeting3.put("EmployeeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    meeting3.put("MeetingStart", AttributeValue.builder().s("2022-07-04T13:00").build());
    meeting3.put("Location", AttributeValue.builder().m(meeting3Location).build());
    meeting3.put("Duration", AttributeValue.builder().s("30").build());
    meeting3.put("Attendees", AttributeValue.builder().l(meeting3AttendeeList).build());
    ...
    meeting4AttendeeList.add(AttributeValue.builder().s("david@gmail.com").build());
    meeting4AttendeeList.add(AttributeValue.builder().s("zorro@gmail.com").build());
    ...
    meeting4.put("partition_key", AttributeValue.builder().s("meeting4").build());
    meeting4.put("EmployeeID", AttributeValue.builder().s("emp_004").build());
    meeting4.put("EmployeeEmail", AttributeValue.builder().s("david@gmail.com").build());
    meeting4.put("MeetingStart", AttributeValue.builder().s("2022-07-04T13:00").build());
    meeting4.put("Location", AttributeValue.builder().m(meeting4Location).build());
    meeting4.put("Duration", AttributeValue.builder().s("30").build());
    meeting4.put("Attendees", AttributeValue.builder().l(meeting4AttendeeList).build());
    ...
    meeting5AttendeeList.add(AttributeValue.builder().s("barney@gmail.com").build());
    meeting5AttendeeList.add(AttributeValue.builder().s("zorro@gmail.com").build());
    ...
    meeting5.put("partition_key", AttributeValue.builder().s("meeting5").build());
    meeting5.put("EmployeeID", AttributeValue.builder().s("emp_002").build());
    meeting5.put("EmployeeEmail", AttributeValue.builder().s("barney@gmail.com").build());
    meeting5.put("MeetingStart", AttributeValue.builder().s("2022-07-04T14:00").build());
    meeting5.put("Location", AttributeValue.builder().m(meeting5Location).build());
    meeting5.put("Duration", AttributeValue.builder().s("30").build());
    meeting5.put("Attendees", AttributeValue.builder().l(meeting5AttendeeList).build());
    ...
    meeting6AttendeeList.add(AttributeValue.builder().s("charlie@gmail.com").build());
    meeting6AttendeeList.add(AttributeValue.builder().s("zorro@gmail.com").build());
    ...
    meeting6.put("partition_key", AttributeValue.builder().s("meeting6").build());
    meeting6.put("EmployeeID", AttributeValue.builder().s("emp_003").build());
    meeting6.put("EmployeeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    meeting6.put("MeetingStart", AttributeValue.builder().s("2022-07-04T14:00").build());
    meeting6.put("Location", AttributeValue.builder().m(meeting6Location).build());
    meeting6.put("Duration", AttributeValue.builder().s("30").build());
    meeting6.put("Attendees", AttributeValue.builder().l(meeting6AttendeeList).build());
  ...
  public static void putAllEmployeeItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    employee2Location.put("City", AttributeValue.builder().s("Seattle").build());

    final HashMap<String, AttributeValue> employee2 = new HashMap<>();
    employee2.put("partition_key", AttributeValue.builder().s("employee2").build());
    employee2.put("EmployeeID", AttributeValue.builder().s("emp_002").build());
    employee2.put("EmployeeEmail", AttributeValue.builder().s("barney@gmail.com").build());
    employee2.put("ManagerEmail", AttributeValue.builder().s("zorro@gmail.com").build());
    employee2.put("EmployeeName", AttributeValue.builder().s("Barney Jones").build());
    employee2.put("EmployeeTitle", AttributeValue.builder().s("SDE8").build());
    employee2.put("Location", AttributeValue.builder().m(employee2Location).build());
    ...
    employee3Location.put("City", AttributeValue.builder().s("Seattle").build());

    final HashMap<String, AttributeValue> employee3 = new HashMap<>();
    employee3.put("partition_key", AttributeValue.builder().s("employee3").build());
    employee3.put("EmployeeID", AttributeValue.builder().s("emp_003").build());
    employee3.put("EmployeeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    employee3.put("ManagerEmail", AttributeValue.builder().s("zorro@gmail.com").build());
    employee3.put("EmployeeName", AttributeValue.builder().s("Charlie Jones").build());
    employee3.put("EmployeeTitle", AttributeValue.builder().s("SDE7").build());
    employee3.put("Location", AttributeValue.builder().m(employee3Location).build());
    ...
    employee4.put("partition_key", AttributeValue.builder().s("employee4").build());
    employee4.put("EmployeeID", AttributeValue.builder().s("emp_004").build());
    employee4.put("EmployeeEmail", AttributeValue.builder().s("david@gmail.com").build());
    employee4.put("ManagerEmail", AttributeValue.builder().s("zorro@gmail.com").build());
    employee4.put("EmployeeName", AttributeValue.builder().s("David Jones").build());
    employee4.put("EmployeeTitle", AttributeValue.builder().s("SDE6").build());
    employee4.put("Location", AttributeValue.builder().m(employee4Location).build());
  ...
  public static void putAllProjectItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    project2.put("partition_key", AttributeValue.builder().s("project2").build());
    project2.put("ProjectName", AttributeValue.builder().s("project_002").build());
    project2.put("ProjectStatus", AttributeValue.builder().s("Active").build());
    project2.put("ProjectStart", AttributeValue.builder().s("2022-07-04").build());
    project2.put("Description", AttributeValue.builder().s("Scan Beacons").build());
    project2.put("ProjectTarget", AttributeValue.builder().s("2024-01-01").build());
    ...
    project3.put("partition_key", AttributeValue.builder().s("project3").build());
    project3.put("ProjectName", AttributeValue.builder().s("project_003").build());
    project3.put("ProjectStatus", AttributeValue.builder().s("Active").build());
    project3.put("ProjectStart", AttributeValue.builder().s("2022-08-05").build());
    project3.put("Description", AttributeValue.builder().s("DB ESDK").build());
    project3.put("ProjectTarget", AttributeValue.builder().s("2023-02-27").build());
    ...
    project4.put("partition_key", AttributeValue.builder().s("project4").build());
    project4.put("ProjectName", AttributeValue.builder().s("project_004").build());
    project4.put("ProjectStatus", AttributeValue.builder().s("Done").build());
    project4.put("ProjectStart", AttributeValue.builder().s("2020-03-03").build());
    project4.put("Description", AttributeValue.builder().s("S3EC").build());
    project4.put("ProjectTarget", AttributeValue.builder().s("2021-09-05").build());
  ...
  public static void putAllReservationItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    reservation1AttendeeList.add(AttributeValue.builder().s("barney@gmail.com").build());
    ...
    reservation2AttendeeList.add(AttributeValue.builder().s("able@gmail.com").build());
    reservation2AttendeeList.add(AttributeValue.builder().s("barney@gmail.com").build());

    final HashMap<String, AttributeValue> reservation2Location = new HashMap<>();
    reservation2Location.put("Building", AttributeValue.builder().s("SEA33").build());
    ...
    reservation2.put("partition_key", AttributeValue.builder().s("reservation2").build());
    reservation2.put("Location", AttributeValue.builder().m(reservation2Location).build());
    reservation2.put("MeetingStart", AttributeValue.builder().s("2022-07-04T14:00").build());
    reservation2.put("OrganizerEmail", AttributeValue.builder().s("barney@gmail.com").build());
    reservation2.put("Duration", AttributeValue.builder().s("30").build());
    reservation2.put("Attendees", AttributeValue.builder().l(reservation2AttendeeList).build());
  ...
  public static void putAllTicketItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    ticket2.put("TicketNumber", AttributeValue.builder().s("ticket_001").build());
    ticket2.put("TicketModTime", AttributeValue.builder().s("2022-10-07T14:32:25").build());
    ticket2.put("CreatorEmail", AttributeValue.builder().s("able@gmail.com").build());
    ticket2.put("AssigneeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    ticket2.put("Severity", AttributeValue.builder().s("3").build());
    ticket2.put("Subject", AttributeValue.builder().s("Bad bug").build());
    ticket2.put("Message", AttributeValue.builder().s("Charlie should handle this").build());
    ...
    ticket3.put("TicketNumber", AttributeValue.builder().s("ticket_002").build());
    ticket3.put("TicketModTime", AttributeValue.builder().s("2022-10-06T14:32:25").build());
    ticket3.put("CreatorEmail", AttributeValue.builder().s("zorro@gmail.com").build());
    ticket3.put("AssigneeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    ticket3.put("Severity", AttributeValue.builder().s("3").build());
    ticket3.put("Subject", AttributeValue.builder().s("Easy Bug").build());
    ticket3.put("Message", AttributeValue.builder().s("This seems simple enough").build());
    ...
    ticket4.put("TicketNumber", AttributeValue.builder().s("ticket_002").build());
    ticket4.put("TicketModTime", AttributeValue.builder().s("2022-10-08T14:32:25").build());
    ticket4.put("CreatorEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    ticket4.put("AssigneeEmail", AttributeValue.builder().s("able@gmail.com").build());
    ticket4.put("Severity", AttributeValue.builder().s("3").build());
    ticket4.put("Subject", AttributeValue.builder().s("Easy Bug").build());
    ticket4.put("Message", AttributeValue.builder().s("that's in able's code").build());
  ...
  public static void putAllTimecardItemsToTable(String ddbTableName, DynamoDbClient ddb) {
    ...
    timecard2.put("partition_key", AttributeValue.builder().s("timecard2").build());
    timecard2.put("ProjectName", AttributeValue.builder().s("project_002").build());
    timecard2.put("TimeCardStart", AttributeValue.builder().s("2022-09-12").build());
    timecard2.put("EmployeeEmail", AttributeValue.builder().s("barney@gmail.com").build());
    ...
    timecard3.put("partition_key", AttributeValue.builder().s("timecard3").build());
    timecard3.put("ProjectName", AttributeValue.builder().s("project_003").build());
    timecard3.put("TimeCardStart", AttributeValue.builder().s("2022-09-12").build());
    timecard3.put("EmployeeEmail", AttributeValue.builder().s("charlie@gmail.com").build());
    ...
    timecard4.put("partition_key", AttributeValue.builder().s("timecard4").build());
    timecard4.put("ProjectName", AttributeValue.builder().s("project_003").build());
    timecard4.put("TimeCardStart", AttributeValue.builder().s("2022-09-12").build());
    timecard4.put("EmployeeEmail", AttributeValue.builder().s("barney@gmail.com").build());
