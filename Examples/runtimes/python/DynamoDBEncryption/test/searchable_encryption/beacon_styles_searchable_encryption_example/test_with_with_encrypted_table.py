...
from ....src.searchable_encryption.beacon_styles_searchable_encryption_example.with_encrypted_table import (
    beacon_styles_table_example,
)
...
def test_beacon_styles_table_example():
    """Test beacon styles searchable encryption example."""
