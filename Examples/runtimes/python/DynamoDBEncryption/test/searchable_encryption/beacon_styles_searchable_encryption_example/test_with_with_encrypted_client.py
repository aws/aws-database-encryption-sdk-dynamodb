...
from ....src.searchable_encryption.beacon_styles_searchable_encryption_example.with_encrypted_client import (
    beacon_styles_client_example,
)
...
def test_beacon_styles_client_example():
    """Test beacon styles searchable encryption example."""
