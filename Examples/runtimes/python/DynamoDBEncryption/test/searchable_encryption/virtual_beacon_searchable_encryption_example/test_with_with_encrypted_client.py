...
from ....src.searchable_encryption.virtual_beacon_searchable_encryption_example.with_encrypted_client import (
    virtual_beacon_client_example,
)
...
def test_virtual_beacon_client_example():
    """Test virtual beacon searchable encryption example."""
