...
"""Test the complex searchable encryption example with the EncryptedClient."""
import time

import pytest

from .....src import create_keystore_key_example
from .....src.searchable_encryption.complex_example.client import example
...
def test_complex_example_client():
