...
from ...src.encrypted_resource.batch_read_write_example import encrypted_resource_batch_read_write_example
...
def test_encrypted_resource_batch_read_write_example():
    ...
    encrypted_resource_batch_read_write_example(test_kms_key_id, test_dynamodb_table_name)
