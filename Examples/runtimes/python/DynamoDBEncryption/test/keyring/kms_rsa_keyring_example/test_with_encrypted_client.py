...
"""Test KMS RSA keyring with encrypted client example."""
import pytest

from ....src.keyring.kms_rsa_keyring_example.utility import (
    should_get_new_public_key,
    write_public_key_pem_for_rsa_key,
)
from ....src.keyring.kms_rsa_keyring_example.with_encrypted_client import kms_rsa_keyring_client_example
...
def test_kms_rsa_keyring_client_example():
    """Test the KMS RSA keyring client example."""
    ...
    kms_rsa_keyring_client_example(TEST_DDB_TABLE_NAME, TEST_KMS_RSA_KEY_ID)
