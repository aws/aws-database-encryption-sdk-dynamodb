...
"""Test KMS RSA keyring with encrypted table example."""
import pytest
...
from ....src.keyring.kms_rsa_keyring_example.with_encrypted_table import kms_rsa_keyring_table_example
...
def test_kms_rsa_keyring_table_example():
    """Test the KMS RSA keyring table example."""
    ...
    kms_rsa_keyring_table_example(TEST_DDB_TABLE_NAME, TEST_KMS_RSA_KEY_ID)
