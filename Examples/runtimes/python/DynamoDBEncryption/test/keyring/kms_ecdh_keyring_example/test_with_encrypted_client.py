...
"""Test KMS ECDH keyring with encrypted client example."""
import pytest
...
from ....src.keyring.kms_ecdh_keyring_example.with_encrypted_client import (
    kms_ecdh_discovery_client_example,
    kms_ecdh_keyring_client_example,
)
...
def test_kms_ecdh_keyring_client_example_static():
    """Test kms_ecdh_keyring_client_example with static configuration."""
    ...
    kms_ecdh_keyring_client_example(TEST_DDB_TABLE_NAME, TEST_KMS_ECDH_KEY_ID_P256_SENDER)


def test_kms_ecdh_keyring_client_example_discovery():
    """Test kms_ecdh_keyring_client_example with discovery configuration."""
    ...
    kms_ecdh_discovery_client_example(TEST_DDB_TABLE_NAME, TEST_KMS_ECDH_KEY_ID_P256_RECIPIENT)
