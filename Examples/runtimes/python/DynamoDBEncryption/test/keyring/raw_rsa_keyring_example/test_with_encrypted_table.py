...
"""Test raw RSA keyring with encrypted table example."""
import pytest
...
from ....src.keyring.raw_rsa_keyring_example.with_encrypted_table import raw_rsa_keyring_table_example
from ...test_utils import TEST_DDB_TABLE_NAME

pytestmark = [pytest.mark.examples]


def test_raw_rsa_keyring_table_example():
    """Test raw_rsa_keyring_table_example."""
