...
"""Test raw ECDH keyring with encrypted table example."""
import pytest
...
def test_raw_ecdh_keyring_get_item_put_item_with_table():
    """Test raw_ecdh_keyring_get_item_put_item with static configuration using EncryptedTable."""
...
def test_ephemeral_raw_ecdh_keyring_put_item_with_table():
    """Test ephemeral_raw_ecdh_keyring_put_item with ephemeral configuration using EncryptedTable."""
...
def test_discovery_raw_ecdh_keyring_get_item_with_table():
    """Test discovery_raw_ecdh_keyring_get_item with discovery configuration using EncryptedTable."""
    # You may provide your own ECC Public Key in the files located at
    # - EXAMPLE_ECC_PUBLIC_KEY_FILENAME_RECIPIENT
