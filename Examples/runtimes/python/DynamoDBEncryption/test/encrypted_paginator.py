...
from ..src.encrypted_paginator import encrypted_paginator_scan_example

pytestmark = [pytest.mark.examples]


def test_encrypted_paginator_put_get_example():
    ...
    encrypted_paginator_scan_example(test_kms_key_id, test_dynamodb_table_name)
