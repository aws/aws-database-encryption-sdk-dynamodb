...
"""
Example for using an EncryptedTable to put and get an encrypted item.
...
def encrypted_table_put_get_example(
    kms_key_id: str,
    dynamodb_table_name: str,
):
    """Use an EncryptedTable to put and get an encrypted item."""
    ...
    put_item_response = encrypted_table.put_item(**put_item_request)
