...
# function accepts (ddb_client, table_name) as arguments; convert the expressions to DynamoDB string expressions; query on client; responses assertions use DDB JSON format
...
def run_query_6(ddb_client, table_name):
    ...
    response = ddb_client.query(
        ...
        ExpressionAttributeValues={
            ":email": {"S": "CE-zorro@gmail.com"},
            ":date": {"S": "MS-2023-03-20"}
        }
    )
