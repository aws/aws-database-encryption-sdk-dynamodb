...
"""
Example demonstrating DynamoDB encryption using beacons with EncryptedClient.
...
from DynamoDBEncryption.src.searchable_encryption.basic_searchable_encryption_example.beacon_config import (
    GSI_NAME,
    setup_beacon_config,
)


def basic_searchable_encryption_client_example(
    ddb_table_name: str, branch_key_id: str, branch_key_wrapping_kms_key_arn: str, branch_key_ddb_table_name: str
):
    """
    Demonstrate using beacons with DynamoDB encryption with EncryptedClient.
