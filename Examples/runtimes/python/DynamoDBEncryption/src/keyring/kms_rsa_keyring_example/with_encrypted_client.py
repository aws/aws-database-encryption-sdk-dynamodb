...
"""
Example demonstrating DynamoDb Encryption using a KMS RSA Keyring with EncryptedClient.
...
def kms_rsa_keyring_client_example(
    ddb_table_name: str, rsa_key_arn: str, rsa_public_key_filename: str = DEFAULT_EXAMPLE_RSA_PUBLIC_KEY_FILENAME
):
    """
    Create a KMS RSA keyring and use it to encrypt/decrypt DynamoDB items with EncryptedClient.
    ...
    # 5. Get the item back from our table using the client.
