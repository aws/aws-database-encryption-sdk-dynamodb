...
"""
These examples set up DynamoDb Encryption for the AWS SDK client using the raw ECDH Keyring with EncrypedClient.
...
def discovery_raw_ecdh_keyring_get_item_with_encrypted_client(ddb_table_name: str, curve_spec: str):
    ...
    get_example_with_keyring_with_encrypted_client(raw_ecdh_keyring, ddb_table_name)


def put_get_example_with_keyring_with_encrypted_client(raw_ecdh_keyring: IKeyring, ddb_table_name: str):
    """
...
def put_example_with_keyring_with_encrypted_client(raw_ecdh_keyring: IKeyring, ddb_table_name: str):
    """
...
def get_example_with_keyring_with_encrypted_client(raw_ecdh_keyring: IKeyring, ddb_table_name: str):
    """
