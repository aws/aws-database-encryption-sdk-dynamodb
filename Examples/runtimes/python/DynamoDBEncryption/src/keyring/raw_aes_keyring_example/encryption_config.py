...
"""
Configuration module for raw AES keyring encryption setup.
...
def create_encryption_config(ddb_table_name: str, aes_key_bytes: bytes) -> DynamoDbTablesEncryptionConfig:
    """
