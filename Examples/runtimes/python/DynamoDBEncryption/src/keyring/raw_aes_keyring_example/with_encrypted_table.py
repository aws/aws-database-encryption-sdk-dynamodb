...
"""
Example demonstrating DynamoDb Encryption using a Raw AES Keyring with EncryptedTable.
...
def raw_aes_keyring_table_example(ddb_table_name: str, aes_key_bytes: bytes):
    """
    Demonstrate using a raw AES keyring with EncryptedTable.
    ...
    item = {
        "partition_key": "rawAesKeyringItem",
        "sort_key": 0,
    ...
    key_to_get = {"partition_key": "rawAesKeyringItem", "sort_key": 0}
