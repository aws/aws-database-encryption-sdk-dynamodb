...
"""
Example demonstrating DynamoDb Encryption using a Raw RSA Keyring with EncryptedTable.
...
def raw_rsa_keyring_table_example(ddb_table_name: str, private_key_path: str, public_key_path: str):
    """
    Demonstrate using a raw RSA keyring with EncryptedTable.
    ...
    item = {
        "partition_key": "rawRsaKeyringItem",
        "sort_key": 0,
    ...
    key_to_get = {"partition_key": "rawRsaKeyringItem", "sort_key": 0}
