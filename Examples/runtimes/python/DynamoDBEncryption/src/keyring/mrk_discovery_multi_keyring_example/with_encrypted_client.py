...
"""
Example demonstrating DynamoDb Encryption using a MRK discovery multi-keyring with EncryptedClient.
...
def multi_mrk_discovery_keyring_client_example(
    ddb_table_name: str, key_arn: str, account_ids: List[str], regions: List[str]
):
    """
    Demonstrate using a MRK discovery multi-keyring with EncryptedClient.
