...
"""
Examples demonstrating DynamoDb Encryption using a AWS KMS ECDH Keyring with EncryptedClient.
...
def kms_ecdh_keyring_client_example(
    ddb_table_name: str,
    ecc_key_arn: str,
...
def kms_ecdh_discovery_client_example(ddb_table_name: str, ecc_recipient_key_arn: str):
    """
