...
def kms_ecdh_keyring_table_example(
    ddb_table_name: str,
    ecc_key_arn: str,
...
def kms_ecdh_discovery_table_example(ddb_table_name: str, ecc_recipient_key_arn: str):
    """
...
def get_item_with_keyring(kms_ecdh_keyring: IKeyring, ddb_table_name: str):
    ...
    # Get the item back from our table using the above table.
    # The table will decrypt the item client-side using the ECDH keyring
    # and return the original item.
    key_to_get = {"partition_key": "awsKmsEcdhKeyringItem", "sort_key": 0}
...
def put_get_item_with_keyring(aws_kms_ecdh_keyring: IKeyring, ddb_table_name: str):
    ...
    # Put an item into our table using the above table.
    # Before the item gets sent to DynamoDb, it will be encrypted
    # client-side, according to our configuration.
    item = {
        "partition_key": "awsKmsEcdhKeyringItem",
        "sort_key": 0,
    ...
    # Get the item back from our table using the table
