...
def test_migration_step_3():
    ...
    with pytest.raises(Exception):
        migration_step_3.migration_step_3(
    ...
    migration_step_3.migration_step_3(kms_key_id=TEST_KMS_KEY_ID, ddb_table_name=TEST_DDB_TABLE_NAME, sort_read_value=2)
