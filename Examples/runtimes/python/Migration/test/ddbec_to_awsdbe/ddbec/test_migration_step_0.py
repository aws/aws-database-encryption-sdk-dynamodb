...
and ensures that step 0 (using legacy DynamoDB Encryption Client) behaves correctly
...
def test_migration_step_0():
    ...
    migration_step_0.migration_step_0(kms_key_id=TEST_KMS_KEY_ID, ddb_table_name=TEST_DDB_TABLE_NAME, sort_read_value=1)
    ...
    with pytest.raises(Exception):  # The exact exception may vary in Python implementation
        migration_step_0.migration_step_0(
