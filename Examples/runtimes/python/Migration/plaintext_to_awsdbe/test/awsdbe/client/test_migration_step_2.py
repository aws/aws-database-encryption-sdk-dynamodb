...
and ensures that step 2 (using AWS DBESDK with plaintext override for reads only)
behaves correctly with data from different migration stages.
"""
import pytest
...
def test_migration_step_2_with_client():
