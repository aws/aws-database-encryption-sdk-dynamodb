...
def setup_awsdbe_resource_without_plaintext_override(kms_key_id: str, ddb_table_name: str):
    ...
    # Create an EncryptedResource using the DynamoDB resource
...
def setup_awsdbe_resource_with_plaintext_override(kms_key_id: str, ddb_table_name: str, policy: str):
    """
    Set up an AWS Database Encryption SDK EncryptedResource with plaintext override.
