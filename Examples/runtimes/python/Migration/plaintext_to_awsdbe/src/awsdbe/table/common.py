...
def setup_awsdbe_table_without_plaintext_override(kms_key_id: str, ddb_table_name: str):
    ...
    # Create an EncryptedTable using the DynamoDB table resource
...
def setup_awsdbe_table_with_plaintext_override(kms_key_id: str, ddb_table_name: str, policy: str):
    """
    Set up an AWS Database Encryption SDK EncryptedTable with plaintext override.
