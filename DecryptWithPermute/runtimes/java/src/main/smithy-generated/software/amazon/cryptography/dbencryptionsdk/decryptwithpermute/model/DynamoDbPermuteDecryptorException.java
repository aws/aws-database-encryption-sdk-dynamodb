...
public class DynamoDbPermuteDecryptorException extends RuntimeException {
  protected DynamoDbPermuteDecryptorException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    DynamoDbPermuteDecryptorException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(DynamoDbPermuteDecryptorException model) {
    ...
    public DynamoDbPermuteDecryptorException build() {
      if (Objects.isNull(this.message()))  {
        throw new IllegalArgumentException("Missing value for required field `message`");
      }
      return new DynamoDbPermuteDecryptorException(this);
    }
  }
}
