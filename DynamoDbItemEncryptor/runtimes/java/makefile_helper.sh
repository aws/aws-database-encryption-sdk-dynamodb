...
if [[ "$1" == "implementation" ]]; then
  ...
  for directory in runtimes/java/temp/AwsCryptographyDynamoDbItemEncryptor-java/*; do
  ...
  for allFiles in runtimes/java/temp-tests/AwsCryptographyDynamoDbItemEncryptorTests-java/*; do
