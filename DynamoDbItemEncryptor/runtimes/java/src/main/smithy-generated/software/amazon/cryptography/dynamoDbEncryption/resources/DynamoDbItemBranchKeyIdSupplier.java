...
public final class DynamoDbItemBranchKeyIdSupplier implements IDynamoDbItemBranchKeyIdSupplier {
  private final Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.IDynamoDbItemBranchKeyIdSupplier _impl;

  private DynamoDbItemBranchKeyIdSupplier(
      Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.IDynamoDbItemBranchKeyIdSupplier iDynamoDbItemBranchKeyIdSupplier) {
  ...
  public static <I extends IDynamoDbItemBranchKeyIdSupplier> DynamoDbItemBranchKeyIdSupplier wrap(
    ...
    Objects.requireNonNull(iDynamoDbItemBranchKeyIdSupplier, "Missing value for required argument `iDynamoDbItemBranchKeyIdSupplier`");
    if (iDynamoDbItemBranchKeyIdSupplier instanceof software.amazon.cryptography.dynamoDbEncryption.resources.DynamoDbItemBranchKeyIdSupplier) {
  ...
  public Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.IDynamoDbItemBranchKeyIdSupplier impl(
      ) {
    return this._impl;
  }
  ...
  public GetBranchKeyIdFromItemOutput GetBranchKeyIdFromItem(
    ...
    Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemInput dafnyValue = ToDafny.GetBranchKeyIdFromItemInput(nativeValue);
    Result<Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemOutput, Error> result = this._impl.GetBranchKeyIdFromItem(dafnyValue);
  ...
  private static final class NativeWrapper implements Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.IDynamoDbItemBranchKeyIdSupplier {
    ...
    public Result<Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemOutput, Error> GetBranchKeyIdFromItem(
        Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemInput dafnyInput) {
      ...
      try {
        ...
        Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemOutput dafnyOutput = ToDafny.GetBranchKeyIdFromItemOutput(nativeOutput);
    ...
    public Result<Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemOutput, Error> GetBranchKeyIdFromItem_k(
        Dafny.Aws.Cryptography.DynamoDbEncryption.Resources.Types.GetBranchKeyIdFromItemInput dafnyInput) {
