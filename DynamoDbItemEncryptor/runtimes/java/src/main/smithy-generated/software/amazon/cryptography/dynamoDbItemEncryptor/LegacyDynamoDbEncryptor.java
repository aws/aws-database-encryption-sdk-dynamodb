...
public final class LegacyDynamoDbEncryptor implements ILegacyDynamoDbEncryptor {
  private final Dafny.Aws.Cryptography.DynamoDbItemEncryptor.Types.ILegacyDynamoDbEncryptor _impl;

  private LegacyDynamoDbEncryptor(
      Dafny.Aws.Cryptography.DynamoDbItemEncryptor.Types.ILegacyDynamoDbEncryptor iLegacyDynamoDbEncryptor) {
  ...
  public static <I extends ILegacyDynamoDbEncryptor> LegacyDynamoDbEncryptor wrap(
    ...
    Objects.requireNonNull(iLegacyDynamoDbEncryptor, "Missing value for required argument `iLegacyDynamoDbEncryptor`");
    if (iLegacyDynamoDbEncryptor instanceof software.amazon.cryptography.dynamoDbItemEncryptor.LegacyDynamoDbEncryptor) {
  ...
  public Dafny.Aws.Cryptography.DynamoDbItemEncryptor.Types.ILegacyDynamoDbEncryptor impl() {
    return this._impl;
  }

  protected static final class NativeWrapper implements Dafny.Aws.Cryptography.DynamoDbItemEncryptor.Types.ILegacyDynamoDbEncryptor {
