...
public class TestConfig {
    ...
    public static class DataSizes {
        ...
        public List<Integer> getSmall() { return small; }
        public void setSmall(List<Integer> small) { this.small = small; }
        
        public List<Integer> getMedium() { return medium; }
        public void setMedium(List<Integer> medium) { this.medium = medium; }
        
        public List<Integer> getLarge() { return large; }
        public void setLarge(List<Integer> large) { this.large = large; }
    }
    ...
    public static class QuickConfig {
        ...
        public DataSizes getDataSizes() { return dataSizes; }
        public void setDataSizes(DataSizes dataSizes) { this.dataSizes = dataSizes; }
        
        public Iterations getIterations() { return iterations; }
        public void setIterations(Iterations iterations) { this.iterations = iterations; }
        
        public List<Integer> getConcurrencyLevels() { return concurrencyLevels; }
        public void setConcurrencyLevels(List<Integer> concurrencyLevels) { this.concurrencyLevels = concurrencyLevels; }
    ...
    public QuickConfig getQuickConfig() { return quickConfig; }
    public void setQuickConfig(QuickConfig quickConfig) { this.quickConfig = quickConfig; }

    public String getTableName() { return tableName; }
    public void setTableName(String tableName) { this.tableName = tableName; }

    public String getKeyring() { return keyring; }
    public void setKeyring(String keyring) { this.keyring = keyring; }
    ...
    private static TestConfig parseYamlToConfig(Map<String, Object> yamlData) {
        ...
        if (yamlData.containsKey("data_sizes")) {
            Map<String, Object> dataSizesMap = (Map<String, Object>) yamlData.get("data_sizes");
        ...
        if (yamlData.containsKey("iterations")) {
            Map<String, Object> iterationsMap = (Map<String, Object>) yamlData.get("iterations");
        ...
        if (yamlData.containsKey("concurrency_levels")) {
            config.setConcurrencyLevels((List<Integer>) yamlData.get("concurrency_levels"));
        }

        // Parse quick_config
        if (yamlData.containsKey("quick_config")) {
            Map<String, Object> quickConfigMap = (Map<String, Object>) yamlData.get("quick_config");
            QuickConfig quickConfig = new QuickConfig();

            // Parse quick_config data_sizes
            if (quickConfigMap.containsKey("data_sizes")) {
                Map<String, Object> quickDataSizesMap = (Map<String, Object>) quickConfigMap.get("data_sizes");
            ...
            if (quickConfigMap.containsKey("iterations")) {
                Map<String, Object> quickIterationsMap = (Map<String, Object>) quickConfigMap.get("iterations");
                Iterations quickIterations = new Iterations();
                quickIterations.setWarmup((Integer) quickIterationsMap.get("warmup"));
                quickIterations.setMeasurement((Integer) quickIterationsMap.get("measurement"));
            ...
            if (quickConfigMap.containsKey("concurrency_levels")) {
                quickConfig.setConcurrencyLevels((List<Integer>) quickConfigMap.get("concurrency_levels"));
            }
            if (quickConfigMap.containsKey("test_types")) {
                quickConfig.setTestTypes((List<String>) quickConfigMap.get("test_types"));
            }
    ...
    public void adjustForQuickTest() {
        if (quickConfig == null) {
            throw new IllegalStateException("Quick mode requested but no quick_config found in config file");
        }
        
        // Apply quick config settings
        this.iterations.setMeasurement(quickConfig.getIterations().getMeasurement());
