...
public class BenchmarkResult {
    ...
    public BenchmarkResult(String testName, String language, int dataSize, int concurrency) {
    ...
    public double getPutLatencyMs() { return putLatencyMs; }
    public void setPutLatencyMs(double putLatencyMs) { this.putLatencyMs = putLatencyMs; }

    public double getGetLatencyMs() { return getLatencyMs; }
    public void setGetLatencyMs(double getLatencyMs) { this.getLatencyMs = getLatencyMs; }

    public double getEndToEndLatencyMs() { return endToEndLatencyMs; }
    public void setEndToEndLatencyMs(double endToEndLatencyMs) { this.endToEndLatencyMs = endToEndLatencyMs; }
    ...
    public double getMemoryEfficiencyRatio() { return memoryEfficiencyRatio; }
    public void setMemoryEfficiencyRatio(double memoryEfficiencyRatio) { this.memoryEfficiencyRatio = memoryEfficiencyRatio; }
    ...
    public String toString() {
        return String.format("BenchmarkResult{testName='%s', dataSize=%d, concurrency=%d, opsPerSecond=%.2f}", 
                           testName, dataSize, concurrency, opsPerSecond);
    }
}
