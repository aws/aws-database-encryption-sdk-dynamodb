...
func (_static *CompanionStruct_Default___) AddJson(prev m_DdbEncryptionTestVectors.TestVectorConfig, file _dafny.Sequence, keyVectors *m_KeyVectors.KeyVectorsClient) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_configBytes m_Wrappers.Result
	_ = _0_configBytes
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_FileIO.Companion_Default___.ReadBytesFromFile(file)
	_0_configBytes = _out0
	if (_0_configBytes).Is_Failure() {
	...
	var _1_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _1_valueOrError0
	_1_valueOrError0 = m_JSON_API.Companion_Default___.Deserialize((_0_configBytes).Dtor_value().(_dafny.Sequence))
	if !(!((_1_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(36,16): " + (_1_valueOrError0).String())
	}
	var _2_json m_JSON_Values.JSON
	_ = _2_json
	_2_json = (_1_valueOrError0).Extract().(m_JSON_Values.JSON)
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_DdbEncryptionTestVectors.Companion_Default___.ParseTestVector(_2_json, prev, keyVectors)
	output = _out1
...
func (_static *CompanionStruct_Default___) ASDF() {
	...
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_KeyVectors.Companion_Default___.KeyVectors(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyVectorsConfig_.Create_KeyVectorsConfig_(Companion_Default___.DEFAULT__KEYS()))
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(53,22): " + (_0_valueOrError0).String())
	}
	var _1_keyVectors *m_KeyVectors.KeyVectorsClient
	_ = _1_keyVectors
	_1_keyVectors = (_0_valueOrError0).Extract().(*m_KeyVectors.KeyVectorsClient)
	m_WriteSetPermutations.Companion_Default___.WriteSetPermutations()
	var _2_config m_DdbEncryptionTestVectors.TestVectorConfig
	_ = _2_config
	_2_config = m_DdbEncryptionTestVectors.Companion_Default___.MakeEmptyTestVector()
	var _3_valueOrError1 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _3_valueOrError1
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("records.json"), _1_keyVectors)
	_3_valueOrError1 = _out1
	if !(!((_3_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(61,14): " + (_3_valueOrError1).String())
	}
	_2_config = (_3_valueOrError1).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _4_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _4_valueOrError2
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("configs.json"), _1_keyVectors)
	_4_valueOrError2 = _out2
	if !(!((_4_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(62,14): " + (_4_valueOrError2).String())
	}
	_2_config = (_4_valueOrError2).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _5_valueOrError3 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _5_valueOrError3
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("data.json"), _1_keyVectors)
	_5_valueOrError3 = _out3
	if !(!((_5_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(63,14): " + (_5_valueOrError3).String())
	}
	_2_config = (_5_valueOrError3).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _6_valueOrError4 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _6_valueOrError4
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("iotest.json"), _1_keyVectors)
	_6_valueOrError4 = _out4
	if !(!((_6_valueOrError4).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(64,14): " + (_6_valueOrError4).String())
	}
	_2_config = (_6_valueOrError4).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _7_valueOrError5 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _7_valueOrError5
	var _out5 m_Wrappers.Result
	_ = _out5
	_out5 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("PermTest.json"), _1_keyVectors)
	_7_valueOrError5 = _out5
	if !(!((_7_valueOrError5).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(65,14): " + (_7_valueOrError5).String())
	}
	_2_config = (_7_valueOrError5).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	var _8_valueOrError6 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _8_valueOrError6
	var _out6 m_Wrappers.Result
	_ = _out6
	_out6 = Companion_Default___.AddJson(_2_config, _dafny.SeqOfString("large_records.json"), _1_keyVectors)
	_8_valueOrError6 = _out6
	if !(!((_8_valueOrError6).IsFailure())) {
		panic("dafny/DDBEncryption/src/Index.dfy(66,14): " + (_8_valueOrError6).String())
	}
	_2_config = (_8_valueOrError6).Extract().(m_DdbEncryptionTestVectors.TestVectorConfig)
	(_2_config).RunAllTests(_1_keyVectors)
}
