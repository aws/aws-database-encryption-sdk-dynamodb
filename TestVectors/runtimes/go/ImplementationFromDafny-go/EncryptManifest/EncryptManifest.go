...
func (_static *CompanionStruct_Default___) OnePositiveTest(name _dafny.Sequence, theType _dafny.Sequence, desc _dafny.Sequence, config m_JSON_Values.JSON, decryptConfig m_Wrappers.Option, record m_JSON_Values.JSON, keys *m_KeyVectors.KeyVectorsClient) m_Wrappers.Result {
	...
	if !(!((_4_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(54,21): " + (_4_valueOrError2).String())
	}
	...
	if !(!((_6_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(59,16): " + (_6_valueOrError3).String())
	}
...
func (_static *CompanionStruct_Default___) OneNegativeTest(name _dafny.Sequence, config m_JSON_Values.JSON, record m_JSON_Values.JSON, keys *m_KeyVectors.KeyVectorsClient) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) OneTest(name _dafny.Sequence, value m_JSON_Values.JSON, keys *m_KeyVectors.KeyVectorsClient) m_Wrappers.Result {
	...
	if _dafny.Companion_Sequence_.Equal((_1_types).Dtor_value().(_dafny.Sequence), _dafny.SeqOfString("positive-encrypt")) {
		...
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = Companion_Default___.OnePositiveTest(name, _dafny.SeqOfString("positive-decrypt"), (_2_description).Dtor_value().(_dafny.Sequence), (_3_config).Dtor_value().(m_JSON_Values.JSON), _4_decryptConfig, (_5_record).Dtor_value().(m_JSON_Values.JSON), keys)
		...
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.OnePositiveTest(name, _dafny.SeqOfString("negative-decrypt"), (_2_description).Dtor_value().(_dafny.Sequence), (_3_config).Dtor_value().(m_JSON_Values.JSON), _4_decryptConfig, (_5_record).Dtor_value().(m_JSON_Values.JSON), keys)
		...
		var _out2 m_Wrappers.Result
		_ = _out2
		_out2 = Companion_Default___.OneNegativeTest(name, (_3_config).Dtor_value().(m_JSON_Values.JSON), (_5_record).Dtor_value().(m_JSON_Values.JSON), keys)
		_21___v1 = _out2
...
func (_static *CompanionStruct_Default___) Encrypt(inFile _dafny.Sequence, outFile _dafny.Sequence, lang _dafny.Sequence, version _dafny.Sequence, keyVectors *m_KeyVectors.KeyVectorsClient) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
	_ = output
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(152,21): " + (_0_valueOrError0).String())
	}
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(154,23): " + (_2_valueOrError1).String())
	}
	...
	_4_valueOrError2 = _out2
	if !(!((_4_valueOrError2).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(155,17): " + (_4_valueOrError2).String())
	}
	...
	if !(!((_5_valueOrError3).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(157,16): " + (_5_valueOrError3).String())
	}
	...
	if !(!((_7_valueOrError4).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(158,17): " + (_7_valueOrError4).String())
	}
	...
	_ = _8_valueOrError5
	_8_valueOrError5 = m_Wrappers.Companion_Default___.Need((_6_json).Is_Object(), _dafny.SeqOfString("Encrypt file must contain a JSON object."))
	...
	var _10_manifest m_Wrappers.Option
	_ = _10_manifest
	_10_manifest = m_Wrappers.Companion_Option_.Create_None_()
	var _11_tests m_Wrappers.Option
	_ = _11_tests
	_11_tests = m_Wrappers.Companion_Option_.Create_None_()
	var _hi0 _dafny.Int = _dafny.IntOfUint32(((_6_json).Dtor_obj()).Cardinality())
	_ = _hi0
	for _12_i := _dafny.Zero; _12_i.Cmp(_hi0) < 0; _12_i = _12_i.Plus(_dafny.One) {
		var _13_obj _dafny.Tuple
		_ = _13_obj
		_13_obj = ((_6_json).Dtor_obj()).Select((_12_i).Uint32()).(_dafny.Tuple)
		var _source0 _dafny.Sequence = (*(_13_obj).IndexInt(0)).(_dafny.Sequence)
		_ = _source0
		{
			{
				if (_source0).Equals(_dafny.SeqOfString("keys")) {
					var _14_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _14_valueOrError6
					_14_valueOrError6 = m_Wrappers.Companion_Default___.Need(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'keys' must be a string."))
					if (_14_valueOrError6).IsFailure() {
						output = (_14_valueOrError6).PropagateFailure()
						return output
					}
					_9_keys = m_Wrappers.Companion_Option_.Create_Some_(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("manifest")) {
					...
					_ = _15_valueOrError7
					_15_valueOrError7 = m_Wrappers.Companion_Default___.Need(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'manifest' must be an object."))
					if (_15_valueOrError7).IsFailure() {
						output = (_15_valueOrError7).PropagateFailure()
						return output
					}
					_10_manifest = m_Wrappers.Companion_Option_.Create_Some_(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_obj())
					goto Lmatch0
				}
			}
			{
				if (_source0).Equals(_dafny.SeqOfString("tests")) {
					var _16_valueOrError8 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _16_valueOrError8
					_16_valueOrError8 = m_Wrappers.Companion_Default___.Need(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.SeqOfString("Value of 'tests' must be an object."))
					if (_16_valueOrError8).IsFailure() {
						output = (_16_valueOrError8).PropagateFailure()
						return output
					}
					_11_tests = m_Wrappers.Companion_Option_.Create_Some_(((*(_13_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_obj())
					goto Lmatch0
				}
			}
			{
				output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unknown top level encrypt tag : "), (*(_13_obj).IndexInt(0)).(_dafny.Sequence)))
				return output
			}
			goto Lmatch0
		}
	...
	_ = _17_valueOrError9
	_17_valueOrError9 = m_Wrappers.Companion_Default___.Need((_9_keys).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'keys' member."))
	if (_17_valueOrError9).IsFailure() {
		output = (_17_valueOrError9).PropagateFailure()
		return output
	}
	var _18_valueOrError10 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _18_valueOrError10
	_18_valueOrError10 = m_Wrappers.Companion_Default___.Need((_10_manifest).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'manifest' member."))
	if (_18_valueOrError10).IsFailure() {
		output = (_18_valueOrError10).PropagateFailure()
		return output
	}
	var _19_valueOrError11 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _19_valueOrError11
	_19_valueOrError11 = m_Wrappers.Companion_Default___.Need((_11_tests).Is_Some(), _dafny.SeqOfString("Encrypt manifest requires a 'tests' member."))
	if (_19_valueOrError11).IsFailure() {
		output = (_19_valueOrError11).PropagateFailure()
		return output
	}
	var _hi1 _dafny.Int = _dafny.IntOfUint32(((_10_manifest).Dtor_value().(_dafny.Sequence)).Cardinality())
	_ = _hi1
	for _20_i := _dafny.Zero; _20_i.Cmp(_hi1) < 0; _20_i = _20_i.Plus(_dafny.One) {
		var _21_obj _dafny.Tuple
		_ = _21_obj
		_21_obj = ((_10_manifest).Dtor_value().(_dafny.Sequence)).Select((_20_i).Uint32()).(_dafny.Tuple)
		var _source1 _dafny.Sequence = (*(_21_obj).IndexInt(0)).(_dafny.Sequence)
		_ = _source1
		{
			{
				if (_source1).Equals(_dafny.SeqOfString("type")) {
					...
					_22_valueOrError12 = m_Wrappers.Companion_Default___.Need(((*(_21_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'type' must be a string."))
			...
			}
			{
				if (_source1).Equals(_dafny.SeqOfString("version")) {
					var _24_valueOrError14 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _24_valueOrError14
					_24_valueOrError14 = m_Wrappers.Companion_Default___.Need(((*(_21_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_String(), _dafny.SeqOfString("Value of 'version' must be a string."))
					if (_24_valueOrError14).IsFailure() {
						output = (_24_valueOrError14).PropagateFailure()
						return output
					}
					var _25_valueOrError15 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
					_ = _25_valueOrError15
					_25_valueOrError15 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(((*(_21_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_str(), _dafny.SeqOfString("1")), _dafny.SeqOfString("Value of 'version' must be '1'"))
					if (_25_valueOrError15).IsFailure() {
						output = (_25_valueOrError15).PropagateFailure()
						return output
					}
					goto Lmatch1
				}
			...
			{
				output = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unknown manifest member : "), (*(_21_obj).IndexInt(0)).(_dafny.Sequence)))
				return output
			}
			goto Lmatch1
		}
	...
	var _26_result _dafny.Sequence
	_ = _26_result
	_26_result = _dafny.SeqOf(Companion_Default___.Manifest(), Companion_Default___.Client(lang, version), _dafny.TupleOf(_dafny.SeqOfString("keys"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("file://keys.json"))))
	var _27_test _dafny.Sequence
	_ = _27_test
	_27_test = _dafny.SeqOf()
	var _hi2 _dafny.Int = _dafny.IntOfUint32(((_11_tests).Dtor_value().(_dafny.Sequence)).Cardinality())
	_ = _hi2
	for _28_i := _dafny.Zero; _28_i.Cmp(_hi2) < 0; _28_i = _28_i.Plus(_dafny.One) {
		var _29_obj _dafny.Tuple
		_ = _29_obj
		_29_obj = ((_11_tests).Dtor_value().(_dafny.Sequence)).Select((_28_i).Uint32()).(_dafny.Tuple)
		var _30_valueOrError16 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
		_ = _30_valueOrError16
		_30_valueOrError16 = m_Wrappers.Companion_Default___.Need(((*(_29_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Object(), _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Value of test '"), (*(_29_obj).IndexInt(0)).(_dafny.Sequence)), _dafny.SeqOfString("' must be an Object.")))
		if (_30_valueOrError16).IsFailure() {
			output = (_30_valueOrError16).PropagateFailure()
			return output
		}
		var _31_valueOrError17 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_Wrappers.Companion_Option_.Default())
		_ = _31_valueOrError17
		var _out4 m_Wrappers.Result
		_ = _out4
		_out4 = Companion_Default___.OneTest((*(_29_obj).IndexInt(0)).(_dafny.Sequence), (*(_29_obj).IndexInt(1)).(m_JSON_Values.JSON), keyVectors)
		_31_valueOrError17 = _out4
		if (_31_valueOrError17).IsFailure() {
			output = (_31_valueOrError17).PropagateFailure()
			return output
		}
		var _32_newTest m_Wrappers.Option
		_ = _32_newTest
		_32_newTest = (_31_valueOrError17).Extract().(m_Wrappers.Option)
		if (_32_newTest).Is_Some() {
			_27_test = _dafny.Companion_Sequence_.Concatenate(_27_test, _dafny.SeqOf((_32_newTest).Dtor_value().(_dafny.Tuple)))
		}
	}
	var _33_final m_JSON_Values.JSON
	_ = _33_final
	_33_final = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.Companion_Sequence_.Concatenate(_26_result, _dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("tests"), m_JSON_Values.Companion_JSON_.Create_Object_(_27_test)))))
	var _34_valueOrError18 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _34_valueOrError18
	_34_valueOrError18 = m_JSON_API.Companion_Default___.Serialize(_33_final)
	if !(!((_34_valueOrError18).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(213,21): " + (_34_valueOrError18).String())
	}
	var _35_jsonBytes _dafny.Sequence
	_ = _35_jsonBytes
	_35_jsonBytes = (_34_valueOrError18).Extract().(_dafny.Sequence)
	var _36_valueOrError19 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _36_valueOrError19
	var _out5 m_Wrappers.Result
	_ = _out5
	_out5 = m_FileIO.Companion_Default___.WriteBytesToFile(outFile, _35_jsonBytes)
	_36_valueOrError19 = _out5
	if !(!((_36_valueOrError19).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(214,13): " + (_36_valueOrError19).String())
	}
	var _37_x _dafny.Tuple
	_ = _37_x
	_37_x = (_36_valueOrError19).Extract().(_dafny.Tuple)
	var _38_valueOrError20 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _38_valueOrError20
	var _out6 m_Wrappers.Result
	_ = _out6
	_out6 = m__Time.GetCurrentTimeStamp()
	_38_valueOrError20 = _out6
	if !(!((_38_valueOrError20).IsFailure())) {
		panic("dafny/DDBEncryption/src/EncryptManifest.dfy(216,17): " + (_38_valueOrError20).String())
	}
	_1_timeStamp = (_38_valueOrError20).Extract().(_dafny.Sequence)
