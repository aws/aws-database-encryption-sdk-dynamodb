...
func (_static *CompanionStruct_Default___) WriteSetPermutations() {
	...
	if !(!((_3_valueOrError0).IsFailure())) {
		panic("dafny/DDBEncryption/src/WriteSetPermutations.dfy(129,21): " + (_3_valueOrError0).String())
	}
	...
	_ = _out1
	_out1 = m_FileIO.Companion_Default___.WriteBytesToFile(_dafny.SeqOfString("PermTest.json"), _4_jsonBytes)
	_5_valueOrError1 = _out1
	if !(!((_5_valueOrError1).IsFailure())) {
		panic("dafny/DDBEncryption/src/WriteSetPermutations.dfy(131,13): " + (_5_valueOrError1).String())
	}
	var _6___v0 _dafny.Tuple
	_ = _6___v0
	_6___v0 = (_5_valueOrError1).Extract().(_dafny.Tuple)
}
