...
impl _CreateWrappedItemEncryptor_Compile::_default {
    pub fn CreateWrappedItemEncryptor(
        ...
        let item_encryptor = aws_db_esdk::item_encryptor::Client::from_conf(native_config);
        let wrapped_encryptor = crate::deps::com_amazonaws_dynamodb::item_encryptor::DynamoDbItemEncryptorShim { inner: item_encryptor };
