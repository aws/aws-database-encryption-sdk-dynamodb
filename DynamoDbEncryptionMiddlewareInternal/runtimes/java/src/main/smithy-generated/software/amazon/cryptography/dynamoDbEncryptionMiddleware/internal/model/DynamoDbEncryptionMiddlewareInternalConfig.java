...
public class DynamoDbEncryptionMiddlewareInternalConfig {
  private final Map<String, DynamoDbTableEncryptionConfig> tableEncryptionConfigs;

  protected DynamoDbEncryptionMiddlewareInternalConfig(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    DynamoDbEncryptionMiddlewareInternalConfig build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(DynamoDbEncryptionMiddlewareInternalConfig model) {
    ...
    public DynamoDbEncryptionMiddlewareInternalConfig build() {
      ...
      return new DynamoDbEncryptionMiddlewareInternalConfig(this);
    }
  }
}
