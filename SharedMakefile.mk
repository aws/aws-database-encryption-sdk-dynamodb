...
# Note that this is not guaranteed to generate identical files as `transpile_implementation_java`.
...
# Targets to transpile single local service for convenience.
# Specify the local service to build by passing a SERVICE env var.
# Note that this is not guaranteed to generate identical files as `transpile_test_java`.
