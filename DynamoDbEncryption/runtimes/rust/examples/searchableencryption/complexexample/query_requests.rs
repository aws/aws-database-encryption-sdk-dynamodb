...
async fn run_query9(
    ...
    let query9_values = HashMap::from([entry(":employee", "E-emp_001"), entry(":prefix", "E-"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query10(
    ...
    let query10_values =
        HashMap::from([entry(":email", "EE-able@gmail.com"), entry(":prefix", "E-"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query11(
    ...
    let query11_values = HashMap::from([entry(":ticket", "T-ticket_001"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query15(
    ...
    let query15_values = HashMap::from([entry(":manageremail", "ME-zorro@gmail.com"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query16(
    ...
    let query16_values = HashMap::from([entry(":assigneeemail", "AE-able@gmail.com"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query19(
    ...
    let query19_values = HashMap::from([entry(":projectname", "P-project_001"), entry(":rustsuffix", "-rust"),
    ]);
...
async fn run_query22(
    ...
    let query22_values = HashMap::from([entry(":building", "B-SEA33"), entry(":rustsuffix", "-rust"),
    ]);
