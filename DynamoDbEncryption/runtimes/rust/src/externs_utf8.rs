    ...
    impl crate::UTF8::_default {
        ...
        > {
            ...
            for c in v.iter() {
                ...
                match s {
                    ...
                    Err(e) => {
                        ...
                        return ::std::rc::Rc::new(_Wrappers_Compile::Result::<UTF8::ValidUTF8Bytes, ::dafny_runtime::Sequence<::dafny_runtime::DafnyCharUTF16>>::Failure {
          ...
          error: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(
            ...
            ::std::rc::Rc::new(_Wrappers_Compile::Result::<
                UTF8::ValidUTF8Bytes,
                ::dafny_runtime::Sequence<::dafny_runtime::DafnyCharUTF16>,
            >::Success {
        ...
        > {
            ...
            match b {
        Ok(s) => {
          ::std::rc::Rc::new(_Wrappers_Compile::Result::<::dafny_runtime::Sequence<::dafny_runtime::DafnyCharUTF16>,
