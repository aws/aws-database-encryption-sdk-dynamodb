...
class LegacyDynamoDbEncryptor(ILegacyDynamoDbEncryptor):
    ...
    _impl: (
        aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.ILegacyDynamoDbEncryptor
    )
...
class IDynamoDbKeyBranchKeyIdSupplier(metaclass=abc.ABCMeta):
    ...
    def get_branch_key_id_from_ddb_key(
        self,
        param: "aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyInput",
    ) -> "aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyOutput":
...
class DynamoDbKeyBranchKeyIdSupplier(IDynamoDbKeyBranchKeyIdSupplier):
    ...
    _impl: (
        aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.IDynamoDbKeyBranchKeyIdSupplier
    )
    ...
    def get_branch_key_id_from_ddb_key(
        ...
        dafny_output = self._impl.GetBranchKeyIdFromDdbKey(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyInput(
                param
            )
        )
        if dafny_output.IsFailure():
            from aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.deserialize import (
            ...
            return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyOutput(
                dafny_output.value
            )
