...
class LegacyDynamoDbEncryptor(ILegacyDynamoDbEncryptor):
    ...
    _impl: aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.ILegacyDynamoDbEncryptor

    def __init__(self, _impl: aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.ILegacyDynamoDbEncryptor):
        self._impl = _impl
...
class IDynamoDbKeyBranchKeyIdSupplier(metaclass=abc.ABCMeta):
    ...
    def __subclasshook__(cls, subclass):
        return (
            hasattr(subclass, "GetBranchKeyIdFromDdbKey") and callable(subclass.GetBranchKeyIdFromDdbKey)
        )

    @abc.abstractmethod
    def get_branch_key_id_from_ddb_key(self, param: 'aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyInput') -> 'aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyOutput':
    ...
    def GetBranchKeyIdFromDdbKey(self, dafny_input: 'DafnyGetBranchKeyIdFromDdbKeyInput') -> 'DafnyGetBranchKeyIdFromDdbKeyOutput':
        """
        Do not use.
        This method allows custom implementations of this interface to interact with generated code.
        """
        native_input = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyInput(
            dafny_input
        )
        try:
            native_output = self.get_branch_key_id_from_ddb_key(native_input)
            dafny_output = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyOutput(
                native_output
            )
...
class DynamoDbKeyBranchKeyIdSupplier(IDynamoDbKeyBranchKeyIdSupplier):
    ...
    _impl: aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.IDynamoDbKeyBranchKeyIdSupplier

    def __init__(self, _impl: aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.IDynamoDbKeyBranchKeyIdSupplier):
        self._impl = _impl
    ...
    def get_branch_key_id_from_ddb_key(self, param: 'aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyInput') -> 'aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyOutput':
        ...
        and unwrapping data keys.
        """
        dafny_output = self._impl.GetBranchKeyIdFromDdbKey(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyInput(param))
        if dafny_output.IsFailure():
            from aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.deserialize import _deserialize_error as aws_cryptography_dbencryptionsdk_dynamodb_deserialize_error
            raise aws_cryptography_dbencryptionsdk_dynamodb_deserialize_error(dafny_output.error)

        else:
            return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyOutput(dafny_output.value)
