...
def _deserialize_create_dynamo_db_encryption_branch_key_id_supplier(
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_CreateDynamoDbEncryptionBranchKeyIdSupplierOutput(
        input.value
    )
...
def _deserialize_get_encrypted_data_key_description(
    ...
    if input.IsFailure():
        return _deserialize_error(input.error)
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionOutput(
        input.value
    )
