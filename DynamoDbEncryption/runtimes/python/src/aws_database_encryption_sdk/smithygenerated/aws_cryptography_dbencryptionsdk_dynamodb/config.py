...
def dafny_config_to_smithy_config(dafny_config) -> DynamoDbEncryptionConfig:
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbEncryptionConfig(
        dafny_config
    )
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyDynamoDbEncryptionConfig:
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbEncryptionConfig(
        smithy_config
    )
