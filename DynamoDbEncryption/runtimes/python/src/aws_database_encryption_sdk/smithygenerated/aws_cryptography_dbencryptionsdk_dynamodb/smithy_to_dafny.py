...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(native_input):
    if isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceSingle,
    ):
        BeaconKeySource_union_value = BeaconKeySource_single(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SingleKeyStore(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceMulti,
    ):
        BeaconKeySource_union_value = BeaconKeySource_multi(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_MultiKeyStore(
                native_input.value
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(native_input):
    if isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStylePartOnly,
    ):
        BeaconStyle_union_value = BeaconStyle_partOnly(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_PartOnly(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleShared,
    ):
        BeaconStyle_union_value = BeaconStyle_shared(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Shared(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleAsSet,
    ):
        BeaconStyle_union_value = BeaconStyle_asSet(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_AsSet(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleSharedSet,
    ):
        BeaconStyle_union_value = BeaconStyle_sharedSet(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SharedSet(
                native_input.value
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_dynamodb_Constructor(native_input):
    return DafnyConstructor(
        parts=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_ConstructorPart(
                    list_element
                )
                for list_element in native_input.parts
            ]
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(native_input):
    return DafnySignedPart(
        ...
        loc=(
            ...
            if (native_input.loc is not None)
            else (Option_None())
        ),
    )
        ...
        encrypted=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedPart(
                                list_element
                            )
                            for list_element in native_input.encrypted
                        ]
                    )
                )
            )
            if (native_input.encrypted is not None)
            else (Option_None())
        ),
        signed=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(
                                list_element
                            )
                            for list_element in native_input.signed
                        ]
                    )
                )
            )
            if (native_input.signed is not None)
            else (Option_None())
        ),
        constructors=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Constructor(
                                list_element
                            )
                            for list_element in native_input.constructors
                        ]
                    )
                )
            )
            if (native_input.constructors is not None)
            else (Option_None())
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(native_input):
    return DafnyStandardBeacon(
        ...
        style=(
            (
                Option_Some(
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(
                        native_input.style
                    )
                )
            )
            if (native_input.style is not None)
            else (Option_None())
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(native_input):
    if isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformUpper,
    ):
        VirtualTransform_union_value = VirtualTransform_upper(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Upper(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformLower,
    ):
        VirtualTransform_union_value = VirtualTransform_lower(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Lower(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformInsert,
    ):
        VirtualTransform_union_value = VirtualTransform_insert(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Insert(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformPrefix,
    ):
        VirtualTransform_union_value = VirtualTransform_prefix(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetPrefix(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSuffix,
    ):
        VirtualTransform_union_value = VirtualTransform_suffix(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSuffix(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSubstring,
    ):
        VirtualTransform_union_value = VirtualTransform_substring(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSubstring(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegment,
    ):
        VirtualTransform_union_value = VirtualTransform_segment(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegment(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegments,
    ):
        VirtualTransform_union_value = VirtualTransform_segments(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegments(
                native_input.value
            )
        )
    else:
        ...
        trans=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(
                                list_element
                            )
                            for list_element in native_input.trans
                        ]
                    )
                )
            )
            if (native_input.trans is not None)
            else (Option_None())
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(native_input):
    return DafnyVirtualField(
        ...
        parts=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(
                    list_element
                )
                for list_element in native_input.parts
            ]
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(native_input):
    return DafnyBeaconVersion(
        ...
        keyStore=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_KeyStoreReference(
            native_input.key_store
        ),
        keySource=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(
            native_input.key_source
        ),
        standardBeacons=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(
                    list_element
                )
                for list_element in native_input.standard_beacons
            ]
        ),
        compoundBeacons=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(
                                list_element
                            )
                            for list_element in native_input.compound_beacons
                        ]
                    )
                )
            )
            if (native_input.compound_beacons is not None)
            else (Option_None())
        ),
        virtualFields=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(
                                list_element
                            )
                            for list_element in native_input.virtual_fields
                        ]
                    )
                )
            )
            if (native_input.virtual_fields is not None)
            else (Option_None())
        ),
        encryptedParts=(
            (
                Option_Some(
                    Seq(
                        [
                            ...
                            for list_element in native_input.encrypted_parts
                        ]
                    )
                )
            )
            if (native_input.encrypted_parts is not None)
            else (Option_None())
        ),
        signedParts=(
            (
                Option_Some(
                    Seq(
                        [
                            ...
                            for list_element in native_input.signed_parts
                        ]
                    )
                )
            )
            if (native_input.signed_parts is not None)
            else (Option_None())
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(native_input):
    return DafnyLegacyOverride(
        policy=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyPolicy(
            native_input.policy
        ),
        encryptor=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyDynamoDbEncryptorReference(
            native_input.encryptor
        ),
        attributeActionsOnEncrypt=Map(
            {
                ...
                ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(
                    value
                )
        ...
        defaultAttributeFlag=(
            (
                Option_Some(
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(
                        native_input.default_attribute_flag
                    )
                )
            )
            if (native_input.default_attribute_flag is not None)
            else (Option_None())
        ),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(native_input):
    return DafnySearchConfig(
        versions=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(
                    list_element
                )
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(
    ...
    return DafnyDynamoDbTableEncryptionConfig(
        ...
        search=(
            (
                Option_Some(
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(
                        native_input.search
                    )
                )
            )
            if (native_input.search is not None)
            else (Option_None())
        ),
        attributeActionsOnEncrypt=Map(
            {
        ...
        legacyOverride=(
            (
                Option_Some(
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(
        ...
        plaintextOverride=(
            (
                Option_Some(
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_PlaintextOverride(
        ...
        tableEncryptionConfigs=Map(
            {
                ...
                ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(
                    value
                )
                for (key, value) in native_input.table_encryption_configs.items()
            }
        ),
    )
