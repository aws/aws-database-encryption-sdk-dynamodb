...
def aws_cryptography_dbencryptionsdk_dynamodb_CreateDynamoDbEncryptionBranchKeyIdSupplierInput(native_input):
    return DafnyCreateDynamoDbEncryptionBranchKeyIdSupplierInput(
        ddbKeyBranchKeyIdSupplier=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbKeyBranchKeyIdSupplierReference(native_input.ddb_key_branch_key_id_supplier),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionInput(native_input):
    return DafnyGetEncryptedDataKeyDescriptionInput(
        input=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionUnion(native_input.input),
    )

def aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionUnion(native_input):
    if isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetEncryptedDataKeyDescriptionUnionHeader):
        GetEncryptedDataKeyDescriptionUnion_union_value = GetEncryptedDataKeyDescriptionUnion_header(Seq(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetEncryptedDataKeyDescriptionUnionItem):
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTablesEncryptionConfig(native_input):
    return DafnyDynamoDbTablesEncryptionConfig(
        tableEncryptionConfigs=Map({Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(key.encode('utf-16-be'))]*2)])): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(value) for (key, value) in native_input.table_encryption_configs.items() }),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(native_input):
    return DafnyDynamoDbTableEncryptionConfig(
        ...
        search=((Option_Some(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(native_input.search))) if (native_input.search is not None) else (Option_None())),
        ...
        algorithmSuiteId=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DBEAlgorithmSuiteId(native_input.algorithm_suite_id))) if (native_input.algorithm_suite_id is not None) else (Option_None())),
        ...
        cmm=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(native_input.cmm))) if ((native_input.cmm is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(native_input.cmm) is not None)) else (Option_None())),
        legacyOverride=((Option_Some(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(native_input.legacy_override))) if (native_input.legacy_override is not None) else (Option_None())),
        plaintextOverride=((Option_Some(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_PlaintextOverride(native_input.plaintext_override))) if (native_input.plaintext_override is not None) else (Option_None())),
    )

def aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(native_input):
    return DafnySearchConfig(
        versions=Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(list_element) for list_element in native_input.versions]),
...
def aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(native_input):
    return DafnyLegacyOverride(
        policy=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyPolicy(native_input.policy),
        encryptor=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyDynamoDbEncryptorReference(native_input.encryptor),
        attributeActionsOnEncrypt=Map({Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(key.encode('utf-16-be'))]*2)])): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(value) for (key, value) in native_input.attribute_actions_on_encrypt.items() }),
        defaultAttributeFlag=((Option_Some(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(native_input.default_attribute_flag))) if (native_input.default_attribute_flag is not None) else (Option_None())),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(native_input):
    return DafnyBeaconVersion(
        ...
        keyStore=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_KeyStoreReference(native_input.key_store),
        keySource=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(native_input.key_source),
        standardBeacons=Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(list_element) for list_element in native_input.standard_beacons]),
        compoundBeacons=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(list_element) for list_element in native_input.compound_beacons]))) if (native_input.compound_beacons is not None) else (Option_None())),
        virtualFields=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(list_element) for list_element in native_input.virtual_fields]))) if (native_input.virtual_fields is not None) else (Option_None())),
        encryptedParts=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedPart(list_element) for list_element in native_input.encrypted_parts]))) if (native_input.encrypted_parts is not None) else (Option_None())),
        signedParts=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(list_element) for list_element in native_input.signed_parts]))) if (native_input.signed_parts is not None) else (Option_None())),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(native_input):
    if isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceSingle):
        BeaconKeySource_union_value = BeaconKeySource_single(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SingleKeyStore(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceMulti):
        BeaconKeySource_union_value = BeaconKeySource_multi(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_MultiKeyStore(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(native_input):
    return DafnyStandardBeacon(
        ...
        style=((Option_Some(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(native_input.style))) if (native_input.style is not None) else (Option_None())),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(native_input):
    return DafnyCompoundBeacon(
        ...
        encrypted=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedPart(list_element) for list_element in native_input.encrypted]))) if (native_input.encrypted is not None) else (Option_None())),
        signed=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(list_element) for list_element in native_input.signed]))) if (native_input.signed is not None) else (Option_None())),
        constructors=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Constructor(list_element) for list_element in native_input.constructors]))) if (native_input.constructors is not None) else (Option_None())),
    )

def aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(native_input):
    return DafnyVirtualField(
        name=Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(native_input.name.encode('utf-16-be'))]*2)])),
        parts=Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(list_element) for list_element in native_input.parts]),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(native_input):
    if isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStylePartOnly):
        BeaconStyle_union_value = BeaconStyle_partOnly(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_PartOnly(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleShared):
        BeaconStyle_union_value = BeaconStyle_shared(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Shared(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleAsSet):
        BeaconStyle_union_value = BeaconStyle_asSet(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_AsSet(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleSharedSet):
        BeaconStyle_union_value = BeaconStyle_sharedSet(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SharedSet(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_dbencryptionsdk_dynamodb_Constructor(native_input):
    return DafnyConstructor(
        parts=Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_ConstructorPart(list_element) for list_element in native_input.parts]),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(native_input):
    return DafnyVirtualPart(
        ...
        trans=((Option_Some(Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(list_element) for list_element in native_input.trans]))) if (native_input.trans is not None) else (Option_None())),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(native_input):
    if isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformUpper):
        VirtualTransform_union_value = VirtualTransform_upper(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Upper(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformLower):
        VirtualTransform_union_value = VirtualTransform_lower(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Lower(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformInsert):
        VirtualTransform_union_value = VirtualTransform_insert(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Insert(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformPrefix):
        VirtualTransform_union_value = VirtualTransform_prefix(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetPrefix(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSuffix):
        VirtualTransform_union_value = VirtualTransform_suffix(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSuffix(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSubstring):
        VirtualTransform_union_value = VirtualTransform_substring(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSubstring(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegment):
        VirtualTransform_union_value = VirtualTransform_segment(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegment(native_input.value))
    elif isinstance(native_input, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegments):
        VirtualTransform_union_value = VirtualTransform_segments(aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegments(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_dbencryptionsdk_dynamodb_CreateDynamoDbEncryptionBranchKeyIdSupplierOutput(native_input):
    return DafnyCreateDynamoDbEncryptionBranchKeyIdSupplierOutput(
        branchKeyIdSupplier=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(native_input.branch_key_id_supplier),
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionOutput(native_input):
    return DafnyGetEncryptedDataKeyDescriptionOutput(
        EncryptedDataKeyDescriptionOutput=Seq([aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedDataKeyDescription(list_element) for list_element in native_input.encrypted_data_key_description_output]),
    )
