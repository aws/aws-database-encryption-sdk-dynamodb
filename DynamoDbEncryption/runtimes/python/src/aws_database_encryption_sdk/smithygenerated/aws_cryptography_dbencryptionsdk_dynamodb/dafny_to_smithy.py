...
def aws_cryptography_dbencryptionsdk_dynamodb_AsSet(dafny_input):
    return (
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.AsSet()
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(dafny_input):
    ...
    if isinstance(dafny_input, BeaconKeySource_single):
        BeaconKeySource_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceSingle(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_SingleKeyStore(
                dafny_input.single
            )
        )
    elif isinstance(dafny_input, BeaconKeySource_multi):
        BeaconKeySource_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceMulti(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_MultiKeyStore(
                dafny_input.multi
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_dynamodb_PartOnly(dafny_input):
    return (
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.PartOnly()
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(dafny_input):
    ...
    if isinstance(dafny_input, BeaconStyle_partOnly):
        BeaconStyle_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStylePartOnly(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_PartOnly(
                dafny_input.partOnly
            )
        )
    elif isinstance(dafny_input, BeaconStyle_shared):
        BeaconStyle_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleShared(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_Shared(
                dafny_input.shared
            )
        )
    elif isinstance(dafny_input, BeaconStyle_asSet):
        BeaconStyle_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleAsSet(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_AsSet(
                dafny_input.asSet
            )
        )
    elif isinstance(dafny_input, BeaconStyle_sharedSet):
        BeaconStyle_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleSharedSet(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_SharedSet(
...
def aws_cryptography_dbencryptionsdk_dynamodb_Constructor(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.Constructor(
        parts=[
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_ConstructorPart(
                list_element
            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.CompoundBeacon(
        ...
        encrypted=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedPart(
                        list_element
                    )
        ...
        signed=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(
                        list_element
                    )
        ...
        constructors=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_Constructor(
                        list_element
                    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.StandardBeacon(
        ...
        style=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(
...
def aws_cryptography_dbencryptionsdk_dynamodb_Lower(dafny_input):
    return (
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.Lower()
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_Upper(dafny_input):
    return (
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.Upper()
    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(dafny_input):
    ...
    if isinstance(dafny_input, VirtualTransform_upper):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformUpper(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_Upper(
                dafny_input.upper
            )
        )
    elif isinstance(dafny_input, VirtualTransform_lower):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformLower(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_Lower(
                dafny_input.lower
            )
        )
    elif isinstance(dafny_input, VirtualTransform_insert):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformInsert(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_Insert(
                dafny_input.insert
            )
        )
    elif isinstance(dafny_input, VirtualTransform_prefix):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformPrefix(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetPrefix(
                dafny_input.prefix
            )
        )
    elif isinstance(dafny_input, VirtualTransform_suffix):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSuffix(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetSuffix(
                dafny_input.suffix
            )
        )
        ...
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSubstring(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetSubstring(
                dafny_input.substring
            )
        )
    elif isinstance(dafny_input, VirtualTransform_segment):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegment(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetSegment(
                dafny_input.segment
            )
        )
    elif isinstance(dafny_input, VirtualTransform_segments):
        VirtualTransform_union_value = aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegments(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetSegments(
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualPart(
        ...
        trans=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(
                        list_element
                    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualField(
        ...
        parts=[
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(
                list_element
            )
            for list_element in dafny_input.parts
        ],
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconVersion(
        ...
        key_store=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_KeyStoreReference(
        ...
        key_source=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(
            dafny_input.keySource
        ),
        standard_beacons=[
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(
                list_element
            )
        ...
        compound_beacons=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(
                        list_element
                    )
        ...
        virtual_fields=(
            (
                [
                    aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(
                        list_element
                    )
...
def aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.LegacyOverride(
        policy=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_LegacyPolicy(
            dafny_input.policy
        ),
        encryptor=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_LegacyDynamoDbEncryptorReference(
        ...
        attribute_actions_on_encrypt={
            b"".join(ord(c).to_bytes(2, "big") for c in key).decode(
                "utf-16-be"
            ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.dafny_to_smithy.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(
                value
            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(dafny_input):
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.SearchConfig(
        versions=[
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(
                list_element
            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.DynamoDbTableEncryptionConfig(
        ...
        search=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(
        ...
        legacy_override=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(
        ...
        plaintext_override=(
            (
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_PlaintextOverride(
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTablesEncryptionConfig(
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.DynamoDbTablesEncryptionConfig(
        table_encryption_configs={
            b"".join(ord(c).to_bytes(2, "big") for c in key).decode(
                "utf-16-be"
            ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(
                value
            )
