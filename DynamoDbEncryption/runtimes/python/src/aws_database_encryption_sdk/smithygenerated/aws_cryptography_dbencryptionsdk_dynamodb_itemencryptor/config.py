...
def dafny_config_to_smithy_config(dafny_config) -> DynamoDbItemEncryptorConfig:
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor_DynamoDbItemEncryptorConfig(
        dafny_config
    )
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyDynamoDbItemEncryptorConfig:
    ...
    return aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor_DynamoDbItemEncryptorConfig(
        smithy_config
    )
