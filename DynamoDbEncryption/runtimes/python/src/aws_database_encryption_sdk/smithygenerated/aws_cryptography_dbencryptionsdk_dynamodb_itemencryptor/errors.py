...
import aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes
...
import aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor.errors
...
class DynamoDbItemEncryptorException(ApiError[Literal["DynamoDbItemEncryptorException"]]):
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the DynamoDbItemEncryptorException to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "DynamoDbItemEncryptorException":
        """Creates a DynamoDbItemEncryptorException from a dictionary.
        ...
        return DynamoDbItemEncryptorException(**kwargs)

    def __repr__(self) -> str:
        result = "DynamoDbItemEncryptorException("
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, DynamoDbItemEncryptorException):
            return False
...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    """
    if isinstance(e, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor.errors.DynamoDbItemEncryptorException):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_DynamoDbItemEncryptorException(message=_dafny.Seq(e.message))

    if isinstance(e, AwsCryptographicPrimitives):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_AwsCryptographyPrimitives(aws_cryptography_primitives_smithy_error_to_dafny_error(e.message))

    if isinstance(e, ComAmazonawsDynamodb):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_ComAmazonawsDynamodb(com_amazonaws_dynamodb_sdk_error_to_dafny_error(e.message))

    if isinstance(e, AwsCryptographicMaterialProviders):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_AwsCryptographyMaterialProviders(aws_cryptography_materialproviders_smithy_error_to_dafny_error(e.message))

    if isinstance(e, StructuredEncryption):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_AwsCryptographyDbEncryptionSdkStructuredEncryption(aws_cryptography_dbencryptionsdk_structuredencryption_smithy_error_to_dafny_error(e.message))

    if isinstance(e, DynamoDbEncryption):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_AwsCryptographyDbEncryptionSdkDynamoDb(aws_cryptography_dbencryptionsdk_dynamodb_smithy_error_to_dafny_error(e.message))

    if isinstance(e, CollectionOfErrors):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_CollectionOfErrors(message=_dafny.Seq(e.message), list=_dafny.Seq(
            _smithy_error_to_dafny_error(native_err) for native_err in e.list
        ))

    if isinstance(e, OpaqueError):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_Opaque(obj=e.obj)

    else:
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error_Opaque(obj=e)
