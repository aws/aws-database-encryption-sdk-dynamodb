...
from aws_database_encryption_sdk.internaldafny.generated.StructuredEncryption import StructuredEncryptionClient
from .dafny_protocol import DafnyRequest

class DafnyImplInterface:
    impl: StructuredEncryptionClient | None = None
    ...
    def handle_request(self, input: DafnyRequest):
        if self.operation_map is None:
            self.operation_map = {
                "EncryptStructure": self.impl.EncryptStructure,
                "DecryptStructure": self.impl.DecryptStructure,
                "EncryptPathStructure": self.impl.EncryptPathStructure,
                "DecryptPathStructure": self.impl.DecryptPathStructure,
                "ResolveAuthActions": self.impl.ResolveAuthActions,
            }
