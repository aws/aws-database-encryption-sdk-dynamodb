...
from .config import Config, Plugin, smithy_config_to_dafny_config, StructuredEncryptionConfig
...
def set_config_impl(config: Config):
    ...
    if isinstance(config, StructuredEncryptionConfig):
        from aws_database_encryption_sdk.internaldafny.generated.StructuredEncryption import default__
        config.dafnyImplInterface.impl = default__.StructuredEncryption(smithy_config_to_dafny_config(config)).value
