        ...
        plaintextStructure=Map(
            {
                ...
                ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_StructuredDataTerminal(
                    value
                )
        ...
        authenticateSchema=Map(
            {
                ...
                ): aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_AuthenticateAction(
                    value
                )
...
def aws_cryptography_dbencryptionsdk_structuredencryption_EncryptPathStructureInput(
    ...
    return DafnyEncryptPathStructureInput(
        ...
        plaintextStructure=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoItem(
                    list_element
                )
...
def aws_cryptography_dbencryptionsdk_structuredencryption_CryptoItem(native_input):
    return DafnyCryptoItem(
        key=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_PathSegment(
                    list_element
                )
                for list_element in native_input.key
            ]
        ),
        data=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_StructuredDataTerminal(
            native_input.data
        ),
        action=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_CryptoAction(
            native_input.action
        ),
    )
...
def aws_cryptography_dbencryptionsdk_structuredencryption_PathSegment(native_input):
    if isinstance(
        native_input,
        aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.models.PathSegmentMember,
    ):
        PathSegment_union_value = PathSegment_member(
            aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_StructureSegment(
                native_input.value
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_structuredencryption_DecryptPathStructureInput(
    ...
    return DafnyDecryptPathStructureInput(
        ...
        encryptedStructure=Seq(
            [
                aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_AuthItem(
                    list_element
                )
...
def aws_cryptography_dbencryptionsdk_structuredencryption_AuthItem(native_input):
    return DafnyAuthItem(
        ...
        action=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_AuthenticateAction(
            native_input.action
        ),
    )
...
def aws_cryptography_dbencryptionsdk_structuredencryption_EncryptStructureOutput(
    ...
    return DafnyEncryptStructureOutput(
        ...
        parsedHeader=aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_structuredencryption.smithy_to_dafny.aws_cryptography_dbencryptionsdk_structuredencryption_ParsedHeader(
