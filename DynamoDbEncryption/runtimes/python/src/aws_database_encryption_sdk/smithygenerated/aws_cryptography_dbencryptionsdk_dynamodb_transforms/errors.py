...
class DynamoDbEncryptionTransformsException(ApiError[Literal["DynamoDbEncryptionTransformsException"]]):
    code: Literal["DynamoDbEncryptionTransformsException"] = "DynamoDbEncryptionTransformsException"
    message: str
    def __init__(
        self,
        *,
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the DynamoDbEncryptionTransformsException to a dictionary.
    ...
    def from_dict(d: Dict[str, Any]) -> "DynamoDbEncryptionTransformsException":
        """Creates a DynamoDbEncryptionTransformsException from a dictionary.
...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    """
    if isinstance(e, aws_database_encryption_sdk.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb_transforms.errors.DynamoDbEncryptionTransformsException):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_DynamoDbEncryptionTransformsException(message=_dafny.Seq(e.message))

    if isinstance(e, ComAmazonawsDynamodb):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_ComAmazonawsDynamodb(com_amazonaws_dynamodb_sdk_error_to_dafny_error(e.message))

    if isinstance(e, DynamoDbEncryption):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_AwsCryptographyDbEncryptionSdkDynamoDb(aws_cryptography_dbencryptionsdk_dynamodb_smithy_error_to_dafny_error(e.message))

    if isinstance(e, DynamoDbItemEncryptor):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptor(aws_cryptography_dbencryptionsdk_dynamodb_itemencryptor_smithy_error_to_dafny_error(e.message))

    if isinstance(e, StructuredEncryption):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_AwsCryptographyDbEncryptionSdkStructuredEncryption(aws_cryptography_dbencryptionsdk_structuredencryption_smithy_error_to_dafny_error(e.message))

    if isinstance(e, CollectionOfErrors):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_CollectionOfErrors(message=_dafny.Seq(e.message), list=_dafny.Seq(
            _smithy_error_to_dafny_error(native_err) for native_err in e.list
        ))

    if isinstance(e, OpaqueError):
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_Opaque(obj=e.obj)

    else:
        return aws_database_encryption_sdk.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error_Opaque(obj=e)
