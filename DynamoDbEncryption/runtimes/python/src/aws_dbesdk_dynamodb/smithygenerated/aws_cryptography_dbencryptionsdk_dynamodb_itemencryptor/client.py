...
from .config import Config, DynamoDbItemEncryptorConfig
...
from .deserialize import _deserialize_decrypt_item, _deserialize_encrypt_item
...
from .serialize import _serialize_decrypt_item, _serialize_encrypt_item
...
class DynamoDbItemEncryptor:
    ...
    def encrypt_item(self, input: EncryptItemInput) -> EncryptItemOutput:
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_encrypt_item,
            deserialize=_deserialize_encrypt_item,
            config=self._config,
            operation_name="EncryptItem",
        )

    def decrypt_item(self, input: DecryptItemInput) -> DecryptItemOutput:
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_decrypt_item,
            deserialize=_deserialize_decrypt_item,
            config=self._config,
