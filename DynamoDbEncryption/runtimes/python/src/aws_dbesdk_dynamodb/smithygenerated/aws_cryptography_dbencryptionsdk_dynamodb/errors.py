...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    """
    if isinstance(e, aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.errors.DynamoDbEncryptionException):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_DynamoDbEncryptionException(message=_dafny.Seq(e.message))

    if isinstance(e, AwsCryptographicPrimitives):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_AwsCryptographyPrimitives(aws_cryptography_primitives_smithy_error_to_dafny_error(e.message))

    if isinstance(e, ComAmazonawsDynamodb):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_ComAmazonawsDynamodb(com_amazonaws_dynamodb_sdk_error_to_dafny_error(e.message))

    if isinstance(e, AwsCryptographicMaterialProviders):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_AwsCryptographyMaterialProviders(aws_cryptography_materialproviders_smithy_error_to_dafny_error(e.message))

    if isinstance(e, StructuredEncryption):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_AwsCryptographyDbEncryptionSdkStructuredEncryption(aws_cryptography_dbencryptionsdk_structuredencryption_smithy_error_to_dafny_error(e.message))

    if isinstance(e, KeyStore):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_AwsCryptographyKeyStore(aws_cryptography_keystore_smithy_error_to_dafny_error(e.message))

    if isinstance(e, CollectionOfErrors):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_CollectionOfErrors(message=_dafny.Seq(e.message), list=_dafny.Seq(
            _smithy_error_to_dafny_error(native_err) for native_err in e.list
        ))

    if isinstance(e, OpaqueError):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_Opaque(obj=e.obj)

    if isinstance(e, OpaqueWithTextError):
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_OpaqueWithText(obj=e.obj, objMessage=e.obj_message)

    else:
        return aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error_Opaque(obj=e)
