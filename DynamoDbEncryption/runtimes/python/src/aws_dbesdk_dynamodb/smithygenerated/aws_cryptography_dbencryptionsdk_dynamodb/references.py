...
class LegacyDynamoDbEncryptor(ILegacyDynamoDbEncryptor):
    ...
    def __init__(self, _impl: aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.ILegacyDynamoDbEncryptor):
        self._impl = _impl
...
class IDynamoDbKeyBranchKeyIdSupplier(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def get_branch_key_id_from_ddb_key(self, param: 'aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyInput') -> 'aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyOutput':
...
class DynamoDbKeyBranchKeyIdSupplier(IDynamoDbKeyBranchKeyIdSupplier):
    ...
    def __init__(self, _impl: aws_dbesdk_dynamodb.internaldafny.generated.AwsCryptographyDbEncryptionSdkDynamoDbTypes.IDynamoDbKeyBranchKeyIdSupplier):
        self._impl = _impl
    ...
    def get_branch_key_id_from_ddb_key(self, param: 'aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyInput') -> 'aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetBranchKeyIdFromDdbKeyOutput':
        ...
        and unwrapping data keys.
        """
        dafny_output = self._impl.GetBranchKeyIdFromDdbKey(aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyInput(param))
        if dafny_output.IsFailure():
            from aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.deserialize import _deserialize_error as aws_cryptography_dbencryptionsdk_dynamodb_deserialize_error
            raise aws_cryptography_dbencryptionsdk_dynamodb_deserialize_error(dafny_output.error)

        else:
            return aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.dafny_to_smithy.aws_cryptography_dbencryptionsdk_dynamodb_GetBranchKeyIdFromDdbKeyOutput(dafny_output.value)
