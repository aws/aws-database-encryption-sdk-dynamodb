...
def aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionUnion(
    ...
    if isinstance(
        ...
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.GetEncryptedDataKeyDescriptionUnionItem,
    ):
...
def aws_cryptography_dbencryptionsdk_dynamodb_GetEncryptedDataKeyDescriptionOutput(
    ...
    return DafnyGetEncryptedDataKeyDescriptionOutput(
        EncryptedDataKeyDescriptionOutput=Seq(
            [
                aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedDataKeyDescription(
                    list_element
                )
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(native_input):
    if isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceSingle,
    ):
        BeaconKeySource_union_value = BeaconKeySource_single(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SingleKeyStore(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconKeySourceMulti,
    ):
        BeaconKeySource_union_value = BeaconKeySource_multi(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_MultiKeyStore(
                native_input.value
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(native_input):
    if isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStylePartOnly,
    ):
        BeaconStyle_union_value = BeaconStyle_partOnly(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_PartOnly(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleShared,
    ):
        ...
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleAsSet,
    ):
        BeaconStyle_union_value = BeaconStyle_asSet(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_AsSet(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.BeaconStyleSharedSet,
    ):
        BeaconStyle_union_value = BeaconStyle_sharedSet(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SharedSet(
                native_input.value
            )
        )
    else:
...
def aws_cryptography_dbencryptionsdk_dynamodb_Constructor(native_input):
    return DafnyConstructor(
        parts=Seq(
            [
                aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_ConstructorPart(
                    list_element
                )
        ...
        encrypted=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_EncryptedPart(
                                list_element
                            )
        ...
        signed=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SignedPart(
                                list_element
                            )
        ...
        constructors=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Constructor(
                                list_element
                            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(native_input):
    return DafnyStandardBeacon(
        ...
        style=(
            (
                Option_Some(
                    aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconStyle(
                        native_input.style
                    )
                )
            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(native_input):
    if isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformUpper,
    ):
        VirtualTransform_union_value = VirtualTransform_upper(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Upper(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformLower,
    ):
        VirtualTransform_union_value = VirtualTransform_lower(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Lower(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformInsert,
    ):
        VirtualTransform_union_value = VirtualTransform_insert(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_Insert(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformPrefix,
    ):
        VirtualTransform_union_value = VirtualTransform_prefix(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetPrefix(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSuffix,
    ):
        VirtualTransform_union_value = VirtualTransform_suffix(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSuffix(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSubstring,
    ):
        VirtualTransform_union_value = VirtualTransform_substring(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSubstring(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegment,
    ):
        VirtualTransform_union_value = VirtualTransform_segment(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegment(
                native_input.value
            )
        )
    elif isinstance(
        native_input,
        aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.models.VirtualTransformSegments,
    ):
        VirtualTransform_union_value = VirtualTransform_segments(
            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_GetSegments(
                native_input.value
            )
        )
    else:
        ...
        trans=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualTransform(
                                list_element
                            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(native_input):
    return DafnyVirtualField(
        ...
        parts=Seq(
            [
                aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualPart(
                    list_element
                )
                for list_element in native_input.parts
            ]
...
def aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(native_input):
    return DafnyBeaconVersion(
        ...
        keyStore=aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_KeyStoreReference(
            native_input.key_store
        ),
        keySource=aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconKeySource(
            native_input.key_source
        ),
        standardBeacons=Seq(
            [
                aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_StandardBeacon(
                    list_element
                )
        ...
        compoundBeacons=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_CompoundBeacon(
                                list_element
                            )
        ...
        virtualFields=(
            (
                Option_Some(
                    Seq(
                        [
                            aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_VirtualField(
                                list_element
                            )
...
def aws_cryptography_dbencryptionsdk_dynamodb_LegacyOverride(native_input):
    return DafnyLegacyOverride(
        policy=aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyPolicy(
            native_input.policy
        ),
        encryptor=aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_LegacyDynamoDbEncryptorReference(
...
def aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(native_input):
    return DafnySearchConfig(
        versions=Seq(
            [
                aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_BeaconVersion(
                    list_element
                )
...
def aws_cryptography_dbencryptionsdk_dynamodb_DynamoDbTableEncryptionConfig(
    ...
    return DafnyDynamoDbTableEncryptionConfig(
        ...
        search=(
            (
                Option_Some(
                    aws_dbesdk_dynamodb.smithygenerated.aws_cryptography_dbencryptionsdk_dynamodb.smithy_to_dafny.aws_cryptography_dbencryptionsdk_dynamodb_SearchConfig(
                        native_input.search
                    )
                )
            )
