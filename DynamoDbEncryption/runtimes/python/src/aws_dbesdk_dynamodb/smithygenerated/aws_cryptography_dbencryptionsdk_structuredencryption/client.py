...
from .config import Config, StructuredEncryptionConfig
...
from .deserialize import (
    _deserialize_decrypt_path_structure,
    _deserialize_decrypt_structure,
    _deserialize_encrypt_path_structure,
    _deserialize_encrypt_structure,
    _deserialize_resolve_auth_actions,
)
...
from .serialize import (
    _serialize_decrypt_path_structure,
    _serialize_decrypt_structure,
    _serialize_encrypt_path_structure,
    _serialize_encrypt_structure,
    _serialize_resolve_auth_actions,
)
...
class StructuredEncryption:
    ...
    def encrypt_structure(self, input: EncryptStructureInput) -> EncryptStructureOutput:
        """Invokes the EncryptStructure operation.
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_encrypt_structure,
            deserialize=_deserialize_encrypt_structure,
            config=self._config,
            operation_name="EncryptStructure",
        )

    def decrypt_structure(self, input: DecryptStructureInput) -> DecryptStructureOutput:
        """Invokes the DecryptStructure operation.
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_decrypt_structure,
            deserialize=_deserialize_decrypt_structure,
            config=self._config,
    ...
    def encrypt_path_structure(
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_encrypt_path_structure,
            deserialize=_deserialize_encrypt_path_structure,
            config=self._config,
    ...
    def decrypt_path_structure(
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_decrypt_path_structure,
            deserialize=_deserialize_decrypt_path_structure,
            config=self._config,
    ...
    def resolve_auth_actions(
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_resolve_auth_actions,
            deserialize=_deserialize_resolve_auth_actions,
            config=self._config,
