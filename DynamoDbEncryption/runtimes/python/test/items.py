...
simple_key_ddb = {
    ...
    "sort_key": simple_item_ddb["sort_key"]
}
...
simple_key_dict = {
    "partition_key": simple_item_dict["partition_key"],
    "sort_key": simple_item_dict["sort_key"]
}
...
complex_key_ddb = {
    "partition_key": complex_item_ddb["partition_key"],
    "sort_key": complex_item_ddb["sort_key"]
}
...
complex_key_dict = {
    "partition_key": complex_item_dict["partition_key"],
    "sort_key": complex_item_dict["sort_key"]
}