...
public class StackValue_Str extends StackValue {
  public Dafny.Com.Amazonaws.Dynamodb.Types.AttributeValue _s;
  public StackValue_Str (Dafny.Com.Amazonaws.Dynamodb.Types.AttributeValue s) {
    this._s = s;
  }
  ...
  public String toString() {
    ...
    ss.append("DynamoDBFilterExpr_Compile.StackValue.Str");
    ss.append("(");
