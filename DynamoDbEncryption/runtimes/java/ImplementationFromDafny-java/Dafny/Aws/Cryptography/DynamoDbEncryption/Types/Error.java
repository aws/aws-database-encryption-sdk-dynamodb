...
public abstract class Error {
  ...
  private static final Error theDefault = Dafny.Aws.Cryptography.DynamoDbEncryption.Types.Error.create_DynamoDbEncryptionException(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
  ...
  public static Error create_AwsCryptographyStructuredEncryption(Dafny.Aws.Cryptography.StructuredEncryption.Types.Error AwsCryptographyStructuredEncryption) {
    return new Error_AwsCryptographyStructuredEncryption(AwsCryptographyStructuredEncryption);
  }
  ...
  public static Error create_AwsCryptographyKeyStore(Dafny.Aws.Cryptography.KeyStore.Types.Error AwsCryptographyKeyStore) {
  ...
  public boolean is_AwsCryptographyStructuredEncryption() { return this instanceof Error_AwsCryptographyStructuredEncryption; }
  ...
  public dafny.DafnySequence<? extends Character> dtor_message() {
    Error d = this;
    return ((Error_DynamoDbEncryptionException)d)._message;
  }
  public Dafny.Aws.Cryptography.StructuredEncryption.Types.Error dtor_AwsCryptographyStructuredEncryption() {
    Error d = this;
    return ((Error_AwsCryptographyStructuredEncryption)d)._AwsCryptographyStructuredEncryption;
  }
  ...
  public Dafny.Aws.Cryptography.KeyStore.Types.Error dtor_AwsCryptographyKeyStore() {
    Error d = this;
