...
public class DafnyCallEvent<I, O> {
  ...
  public String toString() {
    ...
    s.append("Dafny.Aws.Cryptography.StructuredEncryption.Types_Compile.DafnyCallEvent.DafnyCallEvent");
    s.append("(");
  ...
  public static <I, O> DafnyCallEvent<I, O> Default(I _default_I, O _default_O) {
    ...
    return Dafny.Aws.Cryptography.StructuredEncryption.Types.DafnyCallEvent.<I, O>create(_default_I, _default_O);
  }
