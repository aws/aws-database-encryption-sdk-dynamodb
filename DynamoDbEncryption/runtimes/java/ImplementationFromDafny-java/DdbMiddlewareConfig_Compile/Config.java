...
public class Config {
  ...
  public String toString() {
    ...
    s.append("DdbMiddlewareConfig_Compile.Config.Config");
    s.append("(");
  ...
  private static final Config theDefault = DdbMiddlewareConfig_Compile.Config.create(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,TableConfig> empty());
