// Class ValidTableConfig
// Dafny class ValidTableConfig compiled into Java
...
public class ValidTableConfig {
  public ValidTableConfig() {
  }
  private static final dafny.TypeDescriptor<TableConfig> _TYPE = dafny.TypeDescriptor.referenceWithInitializer(TableConfig.class, () -> TableConfig.Default());
