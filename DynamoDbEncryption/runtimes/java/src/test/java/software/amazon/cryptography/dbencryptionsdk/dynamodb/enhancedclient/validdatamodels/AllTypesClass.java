...
public class AllTypesClass {
    ...
    public static AllTypesClass createTestItem(String partitionValue, int sortValue) {
        ...
        testItem.setEncryptStringSet(new HashSet<>(Arrays.asList("encrypt1", "encrypt2", "encrypt3")));
        testItem.setSignStringSet(new HashSet<>(Arrays.asList("sort1", "sort2", "sort3")));
        testItem.setEncryptNumSet(new HashSet<>(Arrays.asList(1, 2, 3)));
        testItem.setSignNumSet(new HashSet<>(Arrays.asList(4, 5, 6)));
        testItem.setEncryptBinarySet(new HashSet<>(Arrays.asList(
                StandardCharsets.UTF_8.encode("encrypt1"),
                StandardCharsets.UTF_8.encode("encrypt2"),
                StandardCharsets.UTF_8.encode("encrypt3")
        )));
        testItem.setSignBinarySet(new HashSet<>(Arrays.asList(
