...
public class OtherTests {
    ...
    // Either we need to make DynamoDbEncryptionException public and require customers use it when
    // implementing our interfaces,
    // or we need to find a way to unwrap the Opaque error,
    // or at the _very least_ get the right message to come out the other side.
    @Test(
