...
public class DynamoDbEncryptionEnhancedClientIntegrationTests {
    ...
    // Currently we don't really handle any errors coming from DDB or KMS that aren't modelled.
    // Should use this eventually, but easier to test without it until we get the right error back
    //@Test(
    //        expectedExceptions = KmsException.class,
    //        expectedExceptionsMessageRegExp = "Resource not found (or something like that)"
    //)
    @Test
