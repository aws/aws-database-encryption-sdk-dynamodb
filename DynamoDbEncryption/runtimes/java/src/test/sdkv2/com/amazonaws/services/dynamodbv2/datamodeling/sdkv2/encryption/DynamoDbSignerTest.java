...
public class DynamoDbSignerTest {
  ...
  public void mac() throws GeneralSecurityException {
    ...
    byte[] signature = signerRsa.calculateSignature(
      itemAttributes,
      attributeFlags,
      new byte[0],
      macKey
  ...
  public void macLists() throws GeneralSecurityException {
    ...
    itemAttributes.put(
      "Key2",
      AttributeValue.builder().ns("100", "200", "300").build()
    );
    attributeFlags.put("Key2", EnumSet.of(EncryptionFlags.SIGN));
    itemAttributes.put(
      "Key3",
  ...
  public void macListsUnsorted() throws GeneralSecurityException {
    ...
    itemAttributes.put(
      "Key1",
      AttributeValue.builder().ss("Value3", "Value1", "Value2").build()
    );
    attributeFlags.put("Key1", EnumSet.of(EncryptionFlags.SIGN));
    itemAttributes.put(
      "Key2",
      AttributeValue.builder().ns("100", "300", "200").build()
    );
    attributeFlags.put("Key2", EnumSet.of(EncryptionFlags.SIGN));
    itemAttributes.put(
      "Key3",
  ...
  public void macWithIgnoredChange() throws GeneralSecurityException {
    ...
    itemAttributes.put(
      "Key4",
      AttributeValue.builder().s("Ignored Value").build()
    );
    byte[] signature = signerRsa.calculateSignature(
      itemAttributes,
      attributeFlags,
    ...
    itemAttributes.put(
      "Key4",
      AttributeValue.builder().s("New Ignored Value").build()
    );
    signerRsa.verifySignature(
      itemAttributes,
      attributeFlags,
  ...
  public void sigEcdsa() throws GeneralSecurityException {
    ...
    attributeFlags.put("Key3", EnumSet.of(EncryptionFlags.SIGN));
    byte[] signature = signerEcdsa.calculateSignature(
      itemAttributes,
      attributeFlags,
      new byte[0],
      privKeyEcdsa
