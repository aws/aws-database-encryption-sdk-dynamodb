 ...
 */
package com.amazonaws.services.dynamodbv2.datamodeling.sdkv2.encryption.utils;
...
import static com.amazonaws.services.dynamodbv2.datamodeling.sdkv2.encryption.utils.EncryptionContextOperators.overrideEncryptionContextTableNameUsingMap;
...
public class EncryptionContextOperatorsTest {
  ...
  public void testNullCasesCreateEncryptionContextTableNameOverride_nullOriginalTableName() {
    assertEncryptionContextUnchanged(
      EncryptionContext.builder().tableName("example").build(),
      null,
      "MyNewTableName"
    );
  }
  ...
  public void testCreateEncryptionContextTableNameOverrideMap_multipleOverrides() {
    ...
    EncryptionContext context2 = EncryptionContext
      .builder()
      .tableName("OriginalTableName2")
      .build();
  ...
  public void testNullCasesCreateEncryptionContextTableNameOverrideFromMap_nullNewTableName() {
    ...
    assertEncryptionContextUnchangedFromMap(
      EncryptionContext.builder().tableName("MyOriginalTableName").build(),
      tableNameOverrides
    );
  }
