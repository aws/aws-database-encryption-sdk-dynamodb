...
public class MapperQueryExpressionCryptoTest {
  ...
  public final class HashOnlyClass {
    ...
    public HashOnlyClass(
      String primaryHashKey,
      String indexHashKey,
      String anotherIndexHashKey
    ) {
  ...
  public void testHashConditionOnly() {
    ...
    assertEquals(
      "primaryHashKey",
      queryRequest.getKeyConditions().keySet().iterator().next()
    );
    assertEquals(
      new Condition()
  ...
  public final class HashRangeClass {
    ...
    @DynamoDBIndexHashKey(
      globalSecondaryIndexNames = {
        "GSI-primary-hash-index-range-1", "GSI-primary-hash-index-range-2",
      }
    )
    public String getPrimaryHashKey() {
      return primaryHashKey;
  ...
  public void testHashAndRangeCondition() {
    ...
    assertEquals(
      RANGE_KEY_CONDITION,
      queryRequest.getKeyConditions().get("primaryRangeKey")
    );
    assertNull(queryRequest.getIndexName());
    ...
    assertEquals(
      RANGE_KEY_CONDITION,
      queryRequest.getKeyConditions().get("indexRangeKey")
    );
  ...
  private static <T> QueryRequest testCreateQueryRequestFromExpression(
    ...
    try {
      QueryRequest request = (QueryRequest) testedMethod.invoke(
        mapper,
        clazz,
        queryExpression,
      ...
      if (expectedErrorMessage != null) {
        ...
        fail(
          "Internal error when calling createQueryRequestFromExpressio method"
        );
      }
    } catch (Exception e) {
      fail(e.getMessage());
