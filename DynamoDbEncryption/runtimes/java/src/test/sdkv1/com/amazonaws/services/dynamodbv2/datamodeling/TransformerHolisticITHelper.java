...
public class TransformerHolisticITHelper {
  ...
  public static void decryptNullTableNameInEC(
    ...
    for (Map<String, AttributeValue> encryptedItem : manifest.get(
      ...
      assertTrue(
        new com.amazonaws.services.dynamodbv2.testing.DdbRecordMatcher(
          expectedAttrMap,
          false
        )
          .matches(decrypted)
  ...
  public static void decryptNonBmpHashKeyVector(String nonBMPinECCipherFile)
    throws IOException, GeneralSecurityException {
    com.amazonaws.services.dynamodbv2.testing.ScenarioManifest scenarioManifest =
      getManifestFromFile(
        SCENARIO_MANIFEST_PATH,
        new TypeReference<
          com.amazonaws.services.dynamodbv2.testing.ScenarioManifest
        >() {}
      );
