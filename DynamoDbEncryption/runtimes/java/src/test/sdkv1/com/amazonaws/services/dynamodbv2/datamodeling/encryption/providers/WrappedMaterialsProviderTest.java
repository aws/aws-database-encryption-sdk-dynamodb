...
public class WrappedMaterialsProviderTest {
  ...
  public void randomEnvelopeKeys() throws GeneralSecurityException {
    ...
    assertFalse(
      ...
      contentEncryptionKey.equals(contentEncryptionKey2)
    );
  }
  ...
  public void wrapUnwrapAsymMatExplicitWrappingAlgorithmPkcs1()
    ...
    desc.put(
      WrappedRawMaterials.KEY_WRAPPING_ALGORITHM,
    ...
    assertEquals(
      ...
      eMat
        ...
        .get(WrappedRawMaterials.KEY_WRAPPING_ALGORITHM)
    );
    assertEquals(contentEncryptionKey, dMat.getDecryptionKey());
    assertEquals(sigPair.getPublic(), dMat.getVerificationKey());
  }
  ...
  public void unwrapAsymMatExplicitEncAlgAes128()
    ...
    EncryptionContext aes128Ctx = new EncryptionContext.Builder()
      .withMaterialDescription(aes128Desc)
      .build();
  ...
  public void unwrapAsymMatExplicitEncAlgAes256()
    ...
    EncryptionContext aes256Ctx = new EncryptionContext.Builder()
      .withMaterialDescription(aes256Desc)
      .build();
