...
public class AutoGeneratedKeysITCase
  ...
  public static class HashKeyRangeKeyBothAutoGenerated {
    ...
    public boolean equals(Object obj) {
      ...
      HashKeyRangeKeyBothAutoGenerated other =
        (HashKeyRangeKeyBothAutoGenerated) obj;
      if (key == null) {
  ...
  public void testHashKeyRangeKeyBothAutogenerated() {
    ...
    HashKeyRangeKeyBothAutoGenerated obj =
      new HashKeyRangeKeyBothAutoGenerated();
    ...
    HashKeyRangeKeyBothAutoGenerated other = mapper.load(
      HashKeyRangeKeyBothAutoGenerated.class,
      obj.getKey(),
      obj.getRangeKey()
    );
  ...
  public void testHashKeyRangeKeyBothAutogeneratedBatchWrite() {
    ...
    HashKeyRangeKeyBothAutoGenerated obj =
      new HashKeyRangeKeyBothAutoGenerated();
    obj.setOtherAttribute("blah");
    HashKeyRangeKeyBothAutoGenerated obj2 =
      new HashKeyRangeKeyBothAutoGenerated();
  ...
  public void testHashKeyAutogenerated() {
    ...
    HashKeyAutoGenerated other = mapper.load(
      HashKeyAutoGenerated.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public void testRangeKeyAutogenerated() {
    ...
    RangeKeyAutoGenerated other = mapper.load(
      RangeKeyAutoGenerated.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public void testNothingAutogenerated() {
    ...
    NothingAutoGenerated other = mapper.load(
      NothingAutoGenerated.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public static class HashKeyRangeKeyBothAutoGeneratedKeyOnly {
    ...
    public boolean equals(Object obj) {
      ...
      HashKeyRangeKeyBothAutoGeneratedKeyOnly other =
        (HashKeyRangeKeyBothAutoGeneratedKeyOnly) obj;
      if (key == null) {
        if (other.key != null) return false;
      } else if (!key.equals(other.key)) return false;
      if (rangeKey == null) {
  ...
  public void testHashKeyRangeKeyBothAutogeneratedKeyOnly() {
    ...
    HashKeyRangeKeyBothAutoGeneratedKeyOnly obj =
      new HashKeyRangeKeyBothAutoGeneratedKeyOnly();
    ...
    HashKeyRangeKeyBothAutoGeneratedKeyOnly other = mapper.load(
      HashKeyRangeKeyBothAutoGeneratedKeyOnly.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public void testHashKeyAutogeneratedKeyOnly() {
    ...
    HashKeyAutoGeneratedKeyOnly other = mapper.load(
      HashKeyAutoGeneratedKeyOnly.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public void testRangeKeyAutogeneratedKeyOnly() {
    ...
    RangeKeyAutoGeneratedKeyOnly other = mapper.load(
      RangeKeyAutoGeneratedKeyOnly.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
  ...
  public void testNothingAutogeneratedKeyOnly() {
    ...
    NothingAutoGeneratedKeyOnly other = mapper.load(
      NothingAutoGeneratedKeyOnly.class,
      obj.getKey(),
      obj.getRangeKey()
    );
    assertEquals(other, obj);
