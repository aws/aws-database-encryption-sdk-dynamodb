...
public class UpdateTableOutputTransformInput {
  ...
  public interface Builder {
    Builder sdkOutput(UpdateTableResponse sdkOutput);

    UpdateTableResponse sdkOutput();

    Builder originalInput(UpdateTableRequest originalInput);
  ...
  static class BuilderImpl implements Builder {
    ...
    public Builder sdkOutput(UpdateTableResponse sdkOutput) {
    ...
    public Builder originalInput(UpdateTableRequest originalInput) {
