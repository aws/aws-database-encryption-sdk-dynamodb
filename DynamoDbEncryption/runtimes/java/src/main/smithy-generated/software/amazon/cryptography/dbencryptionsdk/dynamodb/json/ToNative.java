...
public class ToNative {
  ...
  public static JsonEncryptorException Error(Error_JsonEncryptorException dafnyValue) {
    JsonEncryptorException.Builder nativeBuilder = JsonEncryptorException.builder();
    nativeBuilder.message(software.amazon.smithy.dafny.conversion.ToNative.Simple.String(dafnyValue.dtor_message()));
    return nativeBuilder.build();
  }
  ...
  public static DecryptObjectInput DecryptObjectInput(
    ...
    nativeBuilder.encryptedObject(software.amazon.smithy.dafny.conversion.ToNative.Simple.String(dafnyValue.dtor_encryptedObject()));
    return nativeBuilder.build();
  }
  ...
  public static DecryptObjectOutput DecryptObjectOutput(
    ...
    nativeBuilder.plaintextObject(software.amazon.smithy.dafny.conversion.ToNative.Simple.String(dafnyValue.dtor_plaintextObject()));
  ...
  public static JsonEncryptorConfig JsonEncryptorConfig(
    ...
    if (dafnyValue.dtor_allowedUnsignedAttributes().is_Some()) {
      nativeBuilder.allowedUnsignedAttributes(ToNative.AttributeNameList(dafnyValue.dtor_allowedUnsignedAttributes().dtor_value()));
    }
