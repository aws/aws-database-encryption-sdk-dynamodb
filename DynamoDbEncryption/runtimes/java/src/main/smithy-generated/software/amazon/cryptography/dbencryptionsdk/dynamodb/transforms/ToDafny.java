...
public class ToDafny {
  ...
  public static BatchExecuteStatementInputTransformInput BatchExecuteStatementInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchExecuteStatementInput(nativeValue.sdkInput());
  ...
  public static BatchExecuteStatementInputTransformOutput BatchExecuteStatementInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchExecuteStatementInput(nativeValue.transformedInput());
  ...
  public static BatchExecuteStatementOutputTransformInput BatchExecuteStatementOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchExecuteStatementOutput(nativeValue.sdkOutput());
    BatchExecuteStatementInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchExecuteStatementInput(nativeValue.originalInput());
  ...
  public static BatchExecuteStatementOutputTransformOutput BatchExecuteStatementOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchExecuteStatementOutput(nativeValue.transformedOutput());
  ...
  public static BatchGetItemInputTransformInput BatchGetItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchGetItemInput(nativeValue.sdkInput());
  ...
  public static BatchGetItemInputTransformOutput BatchGetItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchGetItemInput(nativeValue.transformedInput());
  ...
  public static BatchGetItemOutputTransformInput BatchGetItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchGetItemOutput(nativeValue.sdkOutput());
  ...
  public static BatchGetItemOutputTransformOutput BatchGetItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchGetItemOutput(nativeValue.transformedOutput());
  ...
  public static BatchWriteItemInputTransformInput BatchWriteItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchWriteItemInput(nativeValue.sdkInput());
  ...
  public static BatchWriteItemInputTransformOutput BatchWriteItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchWriteItemInput(nativeValue.transformedInput());
  ...
  public static BatchWriteItemOutputTransformInput BatchWriteItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchWriteItemOutput(nativeValue.sdkOutput());
  ...
  public static BatchWriteItemOutputTransformOutput BatchWriteItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.BatchWriteItemOutput(nativeValue.transformedOutput());
  ...
  public static CreateTableInputTransformInput CreateTableInputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.CreateTableInputTransformInput nativeValue) {
    CreateTableInput sdkInput;
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.CreateTableInput(nativeValue.sdkInput());
  ...
  public static CreateTableInputTransformOutput CreateTableInputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.CreateTableInputTransformOutput nativeValue) {
    CreateTableInput transformedInput;
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.CreateTableInput(nativeValue.transformedInput());
  ...
  public static CreateTableOutputTransformInput CreateTableOutputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.CreateTableOutputTransformInput nativeValue) {
    CreateTableOutput sdkOutput;
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.CreateTableOutput(nativeValue.sdkOutput());
    CreateTableInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.CreateTableInput(nativeValue.originalInput());
  ...
  public static CreateTableOutputTransformOutput CreateTableOutputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.CreateTableOutputTransformOutput nativeValue) {
    CreateTableOutput transformedOutput;
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.CreateTableOutput(nativeValue.transformedOutput());
  ...
  public static DeleteItemInputTransformInput DeleteItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DeleteItemInput(nativeValue.sdkInput());
  ...
  public static DeleteItemInputTransformOutput DeleteItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DeleteItemInput(nativeValue.transformedInput());
  ...
  public static DeleteItemOutputTransformInput DeleteItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DeleteItemOutput(nativeValue.sdkOutput());
  ...
  public static DeleteItemOutputTransformOutput DeleteItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DeleteItemOutput(nativeValue.transformedOutput());
  ...
  public static DescribeTableInputTransformInput DescribeTableInputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.DescribeTableInputTransformInput nativeValue) {
    DescribeTableInput sdkInput;
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DescribeTableInput(nativeValue.sdkInput());
  ...
  public static DescribeTableInputTransformOutput DescribeTableInputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.DescribeTableInputTransformOutput nativeValue) {
    DescribeTableInput transformedInput;
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DescribeTableInput(nativeValue.transformedInput());
  ...
  public static DescribeTableOutputTransformInput DescribeTableOutputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.DescribeTableOutputTransformInput nativeValue) {
    DescribeTableOutput sdkOutput;
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DescribeTableOutput(nativeValue.sdkOutput());
    DescribeTableInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DescribeTableInput(nativeValue.originalInput());
  ...
  public static DescribeTableOutputTransformOutput DescribeTableOutputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.DescribeTableOutputTransformOutput nativeValue) {
    DescribeTableOutput transformedOutput;
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.DescribeTableOutput(nativeValue.transformedOutput());
  ...
  public static ExecuteStatementInputTransformInput ExecuteStatementInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteStatementInput(nativeValue.sdkInput());
  ...
  public static ExecuteStatementInputTransformOutput ExecuteStatementInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteStatementInput(nativeValue.transformedInput());
  ...
  public static ExecuteStatementOutputTransformInput ExecuteStatementOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteStatementOutput(nativeValue.sdkOutput());
  ...
  public static ExecuteStatementOutputTransformOutput ExecuteStatementOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteStatementOutput(nativeValue.transformedOutput());
  ...
  public static ExecuteTransactionInputTransformInput ExecuteTransactionInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteTransactionInput(nativeValue.sdkInput());
  ...
  public static ExecuteTransactionInputTransformOutput ExecuteTransactionInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteTransactionInput(nativeValue.transformedInput());
  ...
  public static ExecuteTransactionOutputTransformInput ExecuteTransactionOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteTransactionOutput(nativeValue.sdkOutput());
  ...
  public static ExecuteTransactionOutputTransformOutput ExecuteTransactionOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ExecuteTransactionOutput(nativeValue.transformedOutput());
  ...
  public static GetItemInputTransformInput GetItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.GetItemInput(nativeValue.sdkInput());
  ...
  public static GetItemInputTransformOutput GetItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.GetItemInput(nativeValue.transformedInput());
  ...
  public static GetItemOutputTransformInput GetItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.GetItemOutput(nativeValue.sdkOutput());
  ...
  public static GetItemOutputTransformOutput GetItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.GetItemOutput(nativeValue.transformedOutput());
  ...
  public static PutItemInputTransformInput PutItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.PutItemInput(nativeValue.sdkInput());
  ...
  public static PutItemInputTransformOutput PutItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.PutItemInput(nativeValue.transformedInput());
  ...
  public static PutItemOutputTransformInput PutItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.PutItemOutput(nativeValue.sdkOutput());
  ...
  public static PutItemOutputTransformOutput PutItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.PutItemOutput(nativeValue.transformedOutput());
  ...
  public static QueryInputTransformInput QueryInputTransformInput(
    ...
    QueryInput sdkInput;
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.QueryInput(nativeValue.sdkInput());
  ...
  public static QueryInputTransformOutput QueryInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.QueryInput(nativeValue.transformedInput());
  ...
  public static QueryOutputTransformInput QueryOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.QueryOutput(nativeValue.sdkOutput());
  ...
  public static QueryOutputTransformOutput QueryOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.QueryOutput(nativeValue.transformedOutput());
  ...
  public static ScanInputTransformInput ScanInputTransformInput(
    ...
    ScanInput sdkInput;
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ScanInput(nativeValue.sdkInput());
  ...
  public static ScanInputTransformOutput ScanInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ScanInput(nativeValue.transformedInput());
  ...
  public static ScanOutputTransformInput ScanOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ScanOutput(nativeValue.sdkOutput());
  ...
  public static ScanOutputTransformOutput ScanOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.ScanOutput(nativeValue.transformedOutput());
  ...
  public static TransactGetItemsInputTransformInput TransactGetItemsInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactGetItemsInput(nativeValue.sdkInput());
  ...
  public static TransactGetItemsInputTransformOutput TransactGetItemsInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactGetItemsInput(nativeValue.transformedInput());
  ...
  public static TransactGetItemsOutputTransformInput TransactGetItemsOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactGetItemsOutput(nativeValue.sdkOutput());
    TransactGetItemsInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactGetItemsInput(nativeValue.originalInput());
  ...
  public static TransactGetItemsOutputTransformOutput TransactGetItemsOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactGetItemsOutput(nativeValue.transformedOutput());
  ...
  public static TransactWriteItemsInputTransformInput TransactWriteItemsInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactWriteItemsInput(nativeValue.sdkInput());
  ...
  public static TransactWriteItemsInputTransformOutput TransactWriteItemsInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactWriteItemsInput(nativeValue.transformedInput());
  ...
  public static TransactWriteItemsOutputTransformInput TransactWriteItemsOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactWriteItemsOutput(nativeValue.sdkOutput());
    TransactWriteItemsInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactWriteItemsInput(nativeValue.originalInput());
  ...
  public static TransactWriteItemsOutputTransformOutput TransactWriteItemsOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.TransactWriteItemsOutput(nativeValue.transformedOutput());
  ...
  public static UpdateItemInputTransformInput UpdateItemInputTransformInput(
    ...
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateItemInput(nativeValue.sdkInput());
  ...
  public static UpdateItemInputTransformOutput UpdateItemInputTransformOutput(
    ...
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateItemInput(nativeValue.transformedInput());
  ...
  public static UpdateItemOutputTransformInput UpdateItemOutputTransformInput(
    ...
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateItemOutput(nativeValue.sdkOutput());
  ...
  public static UpdateItemOutputTransformOutput UpdateItemOutputTransformOutput(
    ...
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateItemOutput(nativeValue.transformedOutput());
  ...
  public static UpdateTableInputTransformInput UpdateTableInputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.UpdateTableInputTransformInput nativeValue) {
    UpdateTableInput sdkInput;
    sdkInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateTableInput(nativeValue.sdkInput());
  ...
  public static UpdateTableInputTransformOutput UpdateTableInputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.UpdateTableInputTransformOutput nativeValue) {
    UpdateTableInput transformedInput;
    transformedInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateTableInput(nativeValue.transformedInput());
  ...
  public static UpdateTableOutputTransformInput UpdateTableOutputTransformInput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.UpdateTableOutputTransformInput nativeValue) {
    UpdateTableOutput sdkOutput;
    sdkOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateTableOutput(nativeValue.sdkOutput());
    UpdateTableInput originalInput;
    originalInput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateTableInput(nativeValue.originalInput());
  ...
  public static UpdateTableOutputTransformOutput UpdateTableOutputTransformOutput(
      software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.model.UpdateTableOutputTransformOutput nativeValue) {
    UpdateTableOutput transformedOutput;
    transformedOutput = software.amazon.cryptography.services.dynamodb.internaldafny.ToDafny.UpdateTableOutput(nativeValue.transformedOutput());
