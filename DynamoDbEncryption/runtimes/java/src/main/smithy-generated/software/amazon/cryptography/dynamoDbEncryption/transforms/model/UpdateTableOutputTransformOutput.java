...
public class UpdateTableOutputTransformOutput {
  ...
  public interface Builder {
    Builder transformedOutput(UpdateTableResponse transformedOutput);

    UpdateTableResponse transformedOutput();

    UpdateTableOutputTransformOutput build();
  }

  static class BuilderImpl implements Builder {
    protected UpdateTableResponse transformedOutput;
    ...
    public Builder transformedOutput(UpdateTableResponse transformedOutput) {
