...
public class CryptoSchemaItem {
  ...
  protected CryptoSchemaItem(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(CryptoSchemaItem model) {
      this.key = model.key();
    ...
    public CryptoSchemaItem build() {
      ...
      return new CryptoSchemaItem(this);
    }
  }
}
