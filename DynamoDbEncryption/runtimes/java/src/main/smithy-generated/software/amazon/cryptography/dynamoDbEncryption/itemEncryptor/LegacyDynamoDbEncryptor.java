...
public final class LegacyDynamoDbEncryptor implements ILegacyDynamoDbEncryptor {
  private final Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.ILegacyDynamoDbEncryptor _impl;

  private LegacyDynamoDbEncryptor(
      Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.ILegacyDynamoDbEncryptor iLegacyDynamoDbEncryptor) {
  ...
  public static <I extends ILegacyDynamoDbEncryptor> LegacyDynamoDbEncryptor wrap(
    ...
    Objects.requireNonNull(iLegacyDynamoDbEncryptor, "Missing value for required argument `iLegacyDynamoDbEncryptor`");
    if (iLegacyDynamoDbEncryptor instanceof software.amazon.cryptography.dynamoDbEncryption.itemEncryptor.LegacyDynamoDbEncryptor) {
  ...
  public Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.ILegacyDynamoDbEncryptor impl(
      ) {
    return this._impl;
  }

  private static final class NativeWrapper implements Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.ILegacyDynamoDbEncryptor {
