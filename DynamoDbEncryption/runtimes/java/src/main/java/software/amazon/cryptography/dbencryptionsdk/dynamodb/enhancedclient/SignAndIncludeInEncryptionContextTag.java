...
public class SignAndIncludeInEncryptionContextTag
  implements StaticAttributeTag {

  public static final String CUSTOM_DDB_ENCRYPTION_SIGN_AND_INCLUDE_PREFIX =
    "DynamoDbEncryption:SignAndIncludeInEncryptionContext";
