...
import com.amazonaws.services.dynamodbv2.datamodeling.sdkv2.internal.TTLCache;
import com.amazonaws.services.dynamodbv2.datamodeling.sdkv2.internal.TTLCache.EntryLoader;
...
public class CachingMostRecentProvider implements EncryptionMaterialsProvider {
  ...
  public CachingMostRecentProvider(
    ...
    this.keystore =
      ObjectUtil.checkNotNull(keystore, "keystore must not be null");
