...
public class DirectKmsMaterialProvider implements EncryptionMaterialsProvider {
  ...
  public DirectKmsMaterialProvider(
    ...
    dataKeyDesc =
      description.getOrDefault(
        WrappedRawMaterials.CONTENT_KEY_ALGORITHM,
        DEFAULT_ENC_ALG
      );
  ...
  public EncryptionMaterials getEncryptionMaterials(EncryptionContext context) {
    ...
    final GenerateDataKeyResponse dataKeyResult = generateDataKey(
      req.build(),
      context
    );
   ...
   */
  private static void populateKmsEcFromEc(
    EncryptionContext context,
    ...
    if (hashKeyName != null) {
      ...
      if (hashKey.n() != null) {
        ...
        kmsEc.put(
          hashKeyName,
          Base64.encodeToString(hashKey.b().asByteArray())
        );
      } else {
    ...
    if (rangeKeyName != null) {
      ...
      if (rangeKey.n() != null) {
        ...
        kmsEc.put(
          rangeKeyName,
          Base64.encodeToString(rangeKey.b().asByteArray())
        );
      } else {
        throw new UnsupportedOperationException(
