...
public class MetaStore extends ProviderStore {
  ...
  public EncryptionMaterialsProvider getProvider(
    ...
    final Map<String, AttributeValue> item = getMaterialItem(
      materialName,
      version
    );
  ...
  private Map<String, AttributeValue> createMaterialItem(
    ...
    plaintext.put(
      ...
      AttributeValue.builder().s(encryptionKey.getAlgorithm()).build()
    );
    plaintext.put(
      INTEGRITY_KEY_FIELD,
      AttributeValue
    ...
    plaintext.put(
      ...
      AttributeValue.builder().s(integrityKey.getAlgorithm()).build()
    );
  ...
  private Map<String, String> buildDescription(
    ...
    return Collections.singletonMap(
      META_ID,
      plaintext.get(DEFAULT_HASH_KEY).s() +
      "#" +
