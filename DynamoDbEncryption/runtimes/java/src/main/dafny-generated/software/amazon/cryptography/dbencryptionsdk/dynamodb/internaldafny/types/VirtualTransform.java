...
public abstract class VirtualTransform {
  ...
  private static final dafny.TypeDescriptor<VirtualTransform> _TYPE = dafny.TypeDescriptor.<VirtualTransform>referenceWithInitializer(VirtualTransform.class, () -> VirtualTransform.Default());
  ...
  private static final VirtualTransform theDefault = VirtualTransform.create_upper(Upper.Default());
