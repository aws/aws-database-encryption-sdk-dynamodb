...
public class CreateDynamoDbEncryptionBranchKeyIdSupplierInput {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.CreateDynamoDbEncryptionBranchKeyIdSupplierInput.CreateDynamoDbEncryptionBranchKeyIdSupplierInput");
    s.append("(");
    s.append(dafny.Helpers.toString(this._ddbKeyBranchKeyIdSupplier));
    s.append(")");
    return s.toString();
  }
  private static final dafny.TypeDescriptor<CreateDynamoDbEncryptionBranchKeyIdSupplierInput> _TYPE = dafny.TypeDescriptor.<CreateDynamoDbEncryptionBranchKeyIdSupplierInput>referenceWithInitializer(CreateDynamoDbEncryptionBranchKeyIdSupplierInput.class, () -> CreateDynamoDbEncryptionBranchKeyIdSupplierInput.Default());
  ...
  private static final CreateDynamoDbEncryptionBranchKeyIdSupplierInput theDefault = CreateDynamoDbEncryptionBranchKeyIdSupplierInput.create(null);
