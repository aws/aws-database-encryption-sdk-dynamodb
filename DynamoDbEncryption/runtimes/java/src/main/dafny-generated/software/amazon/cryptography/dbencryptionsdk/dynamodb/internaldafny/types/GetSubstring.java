...
public class GetSubstring {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.GetSubstring.GetSubstring");
    s.append("(");
    s.append(this._low);
    s.append(", ");
    s.append(this._high);
  ...
  private static final dafny.TypeDescriptor<GetSubstring> _TYPE = dafny.TypeDescriptor.<GetSubstring>referenceWithInitializer(GetSubstring.class, () -> GetSubstring.Default());
  ...
  private static final GetSubstring theDefault = GetSubstring.create(0, 0);
