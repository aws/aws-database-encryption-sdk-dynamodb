...
public class GetSuffix {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.GetSuffix.GetSuffix");
    s.append("(");
    s.append(this._length);
    s.append(")");
    return s.toString();
  }
  private static final dafny.TypeDescriptor<GetSuffix> _TYPE = dafny.TypeDescriptor.<GetSuffix>referenceWithInitializer(GetSuffix.class, () -> GetSuffix.Default());
  ...
  private static final GetSuffix theDefault = GetSuffix.create(0);
