...
public abstract class _ExternBase___default {
  ...
  public static boolean IsValid__EncryptedPartsList(dafny.DafnySequence<? extends EncryptedPart> x) {
    return (java.math.BigInteger.ONE).compareTo(java.math.BigInteger.valueOf((x).length())) <= 0;
  }
  public static boolean IsValid__Prefix(dafny.DafnySequence<? extends Character> x) {
    return (java.math.BigInteger.ONE).compareTo(java.math.BigInteger.valueOf((x).length())) <= 0;
  }
  public static boolean IsValid__SignedPartsList(dafny.DafnySequence<? extends SignedPart> x) {
    return (java.math.BigInteger.ONE).compareTo(java.math.BigInteger.valueOf((x).length())) <= 0;
  }
