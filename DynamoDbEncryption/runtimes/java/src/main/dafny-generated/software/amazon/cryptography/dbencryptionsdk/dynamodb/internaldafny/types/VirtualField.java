...
public class VirtualField {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualField.VirtualField");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<VirtualField> _TYPE = dafny.TypeDescriptor.<VirtualField>referenceWithInitializer(VirtualField.class, () -> VirtualField.Default());
  ...
  private static final VirtualField theDefault = VirtualField.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<VirtualPart> empty(VirtualPart._typeDescriptor()));
