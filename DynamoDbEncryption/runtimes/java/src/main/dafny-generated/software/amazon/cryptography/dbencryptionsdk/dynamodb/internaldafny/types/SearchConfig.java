...
public class SearchConfig {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.SearchConfig.SearchConfig");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<SearchConfig> _TYPE = dafny.TypeDescriptor.<SearchConfig>referenceWithInitializer(SearchConfig.class, () -> SearchConfig.Default());
  ...
  private static final SearchConfig theDefault = SearchConfig.create(dafny.DafnySequence.<BeaconVersion> empty(BeaconVersion._typeDescriptor()), 0);
