...
public class StructuredDataTerminal {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal.StructuredDataTerminal");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<StructuredDataTerminal> _TYPE = dafny.TypeDescriptor.<StructuredDataTerminal>referenceWithInitializer(StructuredDataTerminal.class, () -> StructuredDataTerminal.Default());
  ...
  private static final StructuredDataTerminal theDefault = StructuredDataTerminal.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
