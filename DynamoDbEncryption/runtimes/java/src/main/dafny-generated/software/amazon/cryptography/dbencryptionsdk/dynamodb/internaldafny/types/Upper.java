...
public class Upper {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.Upper.Upper");
    return s.toString();
  }
  private static final dafny.TypeDescriptor<Upper> _TYPE = dafny.TypeDescriptor.<Upper>referenceWithInitializer(Upper.class, () -> Upper.Default());
  public static dafny.TypeDescriptor<Upper> _typeDescriptor() {
    return (dafny.TypeDescriptor<Upper>) (dafny.TypeDescriptor<?>) _TYPE;
  }

  private static final Upper theDefault = Upper.create();
