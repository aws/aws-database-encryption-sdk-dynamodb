...
public class DynamoDbTablesEncryptionConfig {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTablesEncryptionConfig.DynamoDbTablesEncryptionConfig");
    s.append("(");
    s.append(dafny.Helpers.toString(this._tableEncryptionConfigs));
    s.append(")");
    return s.toString();
  }
  private static final dafny.TypeDescriptor<DynamoDbTablesEncryptionConfig> _TYPE = dafny.TypeDescriptor.<DynamoDbTablesEncryptionConfig>referenceWithInitializer(DynamoDbTablesEncryptionConfig.class, () -> DynamoDbTablesEncryptionConfig.Default());
  ...
  private static final DynamoDbTablesEncryptionConfig theDefault = DynamoDbTablesEncryptionConfig.create(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,DynamoDbTableEncryptionConfig> empty());
