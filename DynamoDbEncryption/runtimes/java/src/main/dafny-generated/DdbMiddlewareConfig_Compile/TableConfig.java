...
public class TableConfig {
  ...
  public software.amazon.cryptography.dbencryptionsdk.dynamodb.itemencryptor.internaldafny.DynamoDbItemEncryptorClient _itemEncryptor;
  ...
  public boolean equals(Object other) {
    ...
    return true && java.util.Objects.equals(this._physicalTableName, o._physicalTableName) && java.util.Objects.equals(this._logicalTableName, o._logicalTableName) && java.util.Objects.equals(this._partitionKeyName, o._partitionKeyName) && java.util.Objects.equals(this._sortKeyName, o._sortKeyName) && this._itemEncryptor == o._itemEncryptor && java.util.Objects.equals(this._search, o._search) && java.util.Objects.equals(this._plaintextOverride, o._plaintextOverride);
  }
  @Override
  public int hashCode() {
    long hash = 5381;
  ...
  public String toString() {
    ...
    s.append("DdbMiddlewareConfig.TableConfig.TableConfig");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<TableConfig> _TYPE = dafny.TypeDescriptor.<TableConfig>referenceWithInitializer(TableConfig.class, () -> TableConfig.Default());
  ...
  private static final TableConfig theDefault = TableConfig.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), null, Wrappers_Compile.Option.<SearchableEncryptionInfo_Compile.SearchInfo>Default(SearchableEncryptionInfo_Compile.ValidSearchInfo._typeDescriptor()), software.amazon.cryptography.dbencryptionsdk.dynamodb.internaldafny.types.PlaintextOverride.Default());
