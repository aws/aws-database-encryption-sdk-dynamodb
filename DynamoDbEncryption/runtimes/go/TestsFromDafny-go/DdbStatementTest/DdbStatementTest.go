// Package DdbStatementTest
// Dafny module DdbStatementTest compiled into Go
...
func (*Default__) String() string {
	return "DdbStatementTest.Default__"
}
...
func (_static *CompanionStruct_Default___) ExpectEqual(actual interface{}, expected interface{}) {
	...
	if !(_dafny.AreEqual(actual, expected)) {
		panic("dafny/DynamoDbEncryptionTransforms/test/DdbStatement.dfy(17,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) NoTable() m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) TestEmptyStatement() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("")), Companion_Default___.NoTable())
}
func (_static *CompanionStruct_Default___) TestInvalidStatement() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("stuff junk")), Companion_Default___.NoTable())
}
func (_static *CompanionStruct_Default___) TestStatementInvalidTable() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select blah blah from f where")), Companion_Default___.NoTable())
}
func (_static *CompanionStruct_Default___) TestSelectStatementCase() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("SeLeCt blah blah FrOm foo where")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
}
func (_static *CompanionStruct_Default___) TestInvalidStatements() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select blah blah blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select blah blah from")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert blah blah blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert into")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert !into blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete blah blah blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete from")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete !from blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("update")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("  update        ")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("update b")), Companion_Default___.NoTable())
}
func (_static *CompanionStruct_Default___) TestTableQuotes() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select * from foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select * from \"foo\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select * from \"f o o\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("f o o")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert into foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert into \"foo\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("insert into \" foo \"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString(" foo ")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete from foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete from \"foo\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("delete from \"   fo   o\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("   fo   o")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("update foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("update \"foo\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("update \"f\to\no\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("f\to\no")))
}
func (_static *CompanionStruct_Default___) TestExistsStatement() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select * from foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("\t  ExIsTs \r(\t\n SeLeCt * from foo")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select * from \"foo\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select * from \"foo.bar\"")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
}
func (_static *CompanionStruct_Default___) TestExistsStatementErrors() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists()")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists select blah")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select)")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select * )")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(select * from)")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(update blah)")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(delete from blah)")), Companion_Default___.NoTable())
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("exists(insert into blah)")), Companion_Default___.NoTable())
}
func (_static *CompanionStruct_Default___) TestSelectStatement() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select blah blah from foo where")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select\nblah\nblah\n\t  from\t\n  \t\n  foo where")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
}
func (_static *CompanionStruct_Default___) TestSelectStatementWithIndex() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("select * from foo.bar where")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("foo")))
}
func (_static *CompanionStruct_Default___) TestUpdateFromDocs() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("UPDATE \"Music\" SET AwardsWon=1 SET AwardDetail={'Grammys':[2020, 2018]}  WHERE Artist='Acme Band' AND SongTitle='PartiQL Rocks")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Music")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("UPDATE \"Music\"\nSET AwardsWon=1\nSET AwardDetail={'Grammys':[2020, 2018]}\nWHERE Artist='Acme Band' AND SongTitle='PartiQL Rocks'\nRETURNING ALL OLD *")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Music")))
}
func (_static *CompanionStruct_Default___) TestSelectFromDocs() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("SELECT OrderID, Total\nFROM \"Orders\"\nWHERE OrderID IN [1, 2, 3] ORDER BY OrderID DESC")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Orders")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("SELECT Devices.FireStick.DateWatched[0]\nFROM WatchList\nWHERE CustomerID= 'C1' AND MovieID= 'M1'")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("WatchList")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("SELECT *\nFROM \"Orders\"\nWHERE OrderID IN [100, 300, 234]")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Orders")))
}
func (_static *CompanionStruct_Default___) TestDeleteFromDocs() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("DELETE FROM \"Music\" WHERE \"Artist\" = 'Acme Band' AND \"SongTitle\" = 'PartiQL Rocks' RETURNING ALL OLD *\n")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Music")))
}
func (_static *CompanionStruct_Default___) TestExistsFromDocs() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("EXISTS(\n    SELECT * FROM \"Music\"\n    WHERE \"Artist\" = 'Acme Band' AND \"SongTitle\" = 'PartiQL Rocks')\n")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Music")))
}
func (_static *CompanionStruct_Default___) TestInsertFromDocs() {
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("INSERT INTO \"Music\" value {'Artist' : 'Acme Band','SongTitle' : 'PartiQL Rocks'}\n")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Music")))
	Companion_Default___.ExpectEqual(m_DdbStatement.Companion_Default___.TableFromStatement(_dafny.SeqOfString("INSERT INTO \"Mu s ic\" value {'Artist' : 'Acme Band','SongTitle' : 'PartiQL Rocks'}\n")), m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOfString("Mu s ic")))
}
