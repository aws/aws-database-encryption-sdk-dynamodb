// Package PutItemTransformTest
// Dafny module PutItemTransformTest compiled into Go
...
func (*Default__) String() string {
	return "PutItemTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestPutItemInputPassthrough() {
	...
	_1_tableName = _out1
	var _2_input m_ComAmazonawsDynamodbTypes.PutItemInput
	_ = _2_input
	_2_input = m_ComAmazonawsDynamodbTypes.Companion_PutItemInput_.Create_PutItemInput_(_1_tableName, _dafny.NewMapBuilder().ToMap(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_transformed m_Wrappers.Result
	_ = _3_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).PutItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_PutItemInputTransformInput_.Create_PutItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("PutItemInput"), _3_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("PutItemInput"), ((_3_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.PutItemInputTransformOutput)).Dtor_transformedInput(), _2_input)
}
func (_static *CompanionStruct_Default___) TestPutItemInputMultiFail(plaintextOverride m_Wrappers.Option) {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransformsMulti(plaintextOverride)
	_0_middlewareUnderTest = _out0
	var _1_tableName _dafny.Sequence
	_ = _1_tableName
	var _out1 _dafny.Sequence
	...
	var _2_input m_ComAmazonawsDynamodbTypes.PutItemInput
	_ = _2_input
	_2_input = m_ComAmazonawsDynamodbTypes.Companion_PutItemInput_.Create_PutItemInput_(_1_tableName, Companion_Default___.BasicItem(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_transformed m_Wrappers.Result
	_ = _3_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).PutItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_PutItemInputTransformInput_.Create_PutItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	if !((_3_transformed).Is_Failure()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/PutItemTransform.dfy(46,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_3_transformed).Dtor_error().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error)).Equals(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_Error_.Create_DynamoDbEncryptionTransformsException_(_dafny.SeqOfString("In multi-tenant mode, keyProviderId must be aws-kms-hierarchy")))) {
		panic("dafny/DynamoDbEncryptionTransforms/test/PutItemTransform.dfy(47,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestPutItemInputMulti() {
	Companion_Default___.TestPutItemInputMultiFail(m_Wrappers.Companion_Option_.Create_None_())
	Companion_Default___.TestPutItemInputMultiFail(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_PlaintextOverride_.Create_FORBID__PLAINTEXT__WRITE__FORBID__PLAINTEXT__READ_()))
	Companion_Default___.TestPutItemInputMultiFail(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_PlaintextOverride_.Create_FORBID__PLAINTEXT__WRITE__ALLOW__PLAINTEXT__READ_()))
}
func (_static *CompanionStruct_Default___) TestPutItemInputMultiForceAllow() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransformsMulti(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_PlaintextOverride_.Create_FORCE__PLAINTEXT__WRITE__ALLOW__PLAINTEXT__READ_()))
	_0_middlewareUnderTest = _out0
	var _1_tableName _dafny.Sequence
	_ = _1_tableName
	var _out1 _dafny.Sequence
	...
	_out2 = (_0_middlewareUnderTest).PutItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_PutItemInputTransformInput_.Create_PutItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	if !((_3_transformed).Is_Success()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/PutItemTransform.dfy(73,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestPutItemOutputPassthrough() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.PutItemOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_PutItemOutput_.Create_PutItemOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).PutItemOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_PutItemOutputTransformInput_.Create_PutItemOutputTransformInput_(_1_output, _3_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("PutItemOutput"), _4_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("PutItemOutput"), ((_4_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.PutItemOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
func (_static *CompanionStruct_Default___) BasicItem() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString("bar"), m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(_dafny.SeqOfString("baz")))
}
