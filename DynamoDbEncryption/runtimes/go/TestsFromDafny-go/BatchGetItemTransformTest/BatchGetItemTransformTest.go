// Package BatchGetItemTransformTest
// Dafny module BatchGetItemTransformTest compiled into Go
...
func (*Default__) String() string {
	return "BatchGetItemTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestBatchGetItemInputTransform() {
	...
	_1_tableName = _out1
	var _2_keyList _dafny.Sequence
	_ = _2_keyList
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetKeyList(_dafny.SeqOf(_dafny.NewMapBuilder().ToMap()))
	_2_keyList = _out2
	var _3_val m_ComAmazonawsDynamodbTypes.KeysAndAttributes
	_ = _3_val
	_3_val = m_ComAmazonawsDynamodbTypes.Companion_KeysAndAttributes_.Create_KeysAndAttributes_(_2_keyList, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _4_theMap _dafny.Map
	_ = _4_theMap
	var _out3 _dafny.Map
	_ = _out3
	_out3 = m_TestFixtures.Companion_Default___.GetBatchGetRequestMap(_dafny.NewMapBuilder().ToMap().UpdateUnsafe(_1_tableName, _3_val))
	_4_theMap = _out3
	var _5_input m_ComAmazonawsDynamodbTypes.BatchGetItemInput
	_ = _5_input
	_5_input = m_ComAmazonawsDynamodbTypes.Companion_BatchGetItemInput_.Create_BatchGetItemInput_(_4_theMap, m_Wrappers.Companion_Option_.Create_None_())
	var _6_transformed m_Wrappers.Result
	_ = _6_transformed
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = (_0_middlewareUnderTest).BatchGetItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_BatchGetItemInputTransformInput_.Create_BatchGetItemInputTransformInput_(_5_input))
	_6_transformed = _out4
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("BatchGetItemInput"), _6_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("BatchGetItemInput"), ((_6_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.BatchGetItemInputTransformOutput)).Dtor_transformedInput(), _5_input)
}
func (_static *CompanionStruct_Default___) TestBatchGetItemOutputTransform() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.BatchGetItemOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_BatchGetItemOutput_.Create_BatchGetItemOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_out1 = m_TestFixtures.Companion_Default___.GetTableName(_dafny.SeqOfString("foo"))
	_2_tableName = _out1
	var _3_keyList _dafny.Sequence
	_ = _3_keyList
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetKeyList(_dafny.SeqOf(_dafny.NewMapBuilder().ToMap()))
	_3_keyList = _out2
	var _4_val m_ComAmazonawsDynamodbTypes.KeysAndAttributes
	_ = _4_val
	_4_val = m_ComAmazonawsDynamodbTypes.Companion_KeysAndAttributes_.Create_KeysAndAttributes_(_3_keyList, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _5_theMap _dafny.Map
	_ = _5_theMap
	var _out3 _dafny.Map
	_ = _out3
	_out3 = m_TestFixtures.Companion_Default___.GetBatchGetRequestMap(_dafny.NewMapBuilder().ToMap().UpdateUnsafe(_2_tableName, _4_val))
	_5_theMap = _out3
	var _6_input m_ComAmazonawsDynamodbTypes.BatchGetItemInput
	_ = _6_input
	_6_input = m_ComAmazonawsDynamodbTypes.Companion_BatchGetItemInput_.Create_BatchGetItemInput_(_5_theMap, m_Wrappers.Companion_Option_.Create_None_())
	var _7_transformed m_Wrappers.Result
	_ = _7_transformed
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = (_0_middlewareUnderTest).BatchGetItemOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_BatchGetItemOutputTransformInput_.Create_BatchGetItemOutputTransformInput_(_1_output, _6_input))
	_7_transformed = _out4
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("BatchGetItemOutput"), _7_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("BatchGetItemOutput"), ((_7_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.BatchGetItemOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
