// Package StructuredDataTestFixtures
// Dafny module StructuredDataTestFixtures compiled into Go
...
func (*Default__) String() string {
	return "StructuredDataTestFixtures.Default__"
}
...
func (_static *CompanionStruct_Default___) GetDefaultCMMWithKMSKeyring() m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager {
	var cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager = (m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager)(nil)
	_ = cmm
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/StructuredEncryption/test/StructuredDataTestFixtures.dfy(62,19): " + (_0_valueOrError0).String())
	}
	...
	if !(!((_3_valueOrError1).IsFailure())) {
		panic("dafny/StructuredEncryption/test/StructuredDataTestFixtures.dfy(69,19): " + (_3_valueOrError1).String())
	}
	var _4_keyring m_AwsCryptographyMaterialProvidersTypes.IKeyring
	_ = _4_keyring
	_4_keyring = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.CastTo_((_3_valueOrError1).Extract())
	var _5_cmmInput m_AwsCryptographyMaterialProvidersTypes.CreateDefaultCryptographicMaterialsManagerInput
	_ = _5_cmmInput
	_5_cmmInput = m_AwsCryptographyMaterialProvidersTypes.Companion_CreateDefaultCryptographicMaterialsManagerInput_.Create_CreateDefaultCryptographicMaterialsManagerInput_(_4_keyring)
	...
	if !(!((_6_valueOrError2).IsFailure())) {
		panic("dafny/StructuredEncryption/test/StructuredDataTestFixtures.dfy(73,11): " + (_6_valueOrError2).String())
	}
	cmm = m_AwsCryptographyMaterialProvidersTypes.Companion_ICryptographicMaterialsManager_.CastTo_((_6_valueOrError2).Extract())
	return cmm
}
func (_static *CompanionStruct_Default___) TEST__BLOB__VALUE() _dafny.Sequence {
	return _dafny.SeqOf(uint8(33), uint8(100), uint8(108), uint8(114), uint8(111), uint8(119), uint8(32), uint8(44), uint8(111), uint8(108), uint8(108), uint8(101), uint8(104))
}
func (_static *CompanionStruct_Default___) TEST__TYPE__ID() _dafny.Sequence {
	return _dafny.SeqOf(uint8(255), uint8(255))
}
func (_static *CompanionStruct_Default___) TEST__STRUCTURED__DATA() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString("foo"), m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_StructuredDataTerminal_.Create_StructuredDataTerminal_(Companion_Default___.TEST__BLOB__VALUE(), Companion_Default___.TEST__TYPE__ID())).UpdateUnsafe(_dafny.SeqOfString("bar"), m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_StructuredDataTerminal_.Create_StructuredDataTerminal_(Companion_Default___.TEST__BLOB__VALUE(), Companion_Default___.TEST__TYPE__ID())).UpdateUnsafe(_dafny.SeqOfString("fizzbuzz"), m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_StructuredDataTerminal_.Create_StructuredDataTerminal_(Companion_Default___.TEST__BLOB__VALUE(), Companion_Default___.TEST__TYPE__ID()))
}
...
func (_static *CompanionStruct_Default___) TEST__CRYPTO__SCHEMA() _dafny.Map {
