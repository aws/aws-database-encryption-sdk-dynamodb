// Package TransactGetItemsTransformTest
// Dafny module TransactGetItemsTransformTest compiled into Go
...
func (*Default__) String() string {
	return "TransactGetItemsTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestTransactGetItemsInputPassthrough() {
	...
	_1_tableName = _out1
	var _2_item m_ComAmazonawsDynamodbTypes.TransactGetItem
	_ = _2_item
	_2_item = m_ComAmazonawsDynamodbTypes.Companion_TransactGetItem_.Create_TransactGetItem_(m_ComAmazonawsDynamodbTypes.Companion_Get_.Create_Get_(_dafny.NewMapBuilder().ToMap(), _1_tableName, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_()))
	var _3_items _dafny.Sequence
	_ = _3_items
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetTransactGetItemList(_dafny.SeqOf(_2_item))
	_3_items = _out2
	var _4_input m_ComAmazonawsDynamodbTypes.TransactGetItemsInput
	_ = _4_input
	_4_input = m_ComAmazonawsDynamodbTypes.Companion_TransactGetItemsInput_.Create_TransactGetItemsInput_(_3_items, m_Wrappers.Companion_Option_.Create_None_())
	var _5_transformed m_Wrappers.Result
	_ = _5_transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).TransactGetItemsInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_TransactGetItemsInputTransformInput_.Create_TransactGetItemsInputTransformInput_(_4_input))
	_5_transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("TransactGetItemsInput"), _5_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("TransactGetItemsInput"), ((_5_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.TransactGetItemsInputTransformOutput)).Dtor_transformedInput(), _4_input)
}
func (_static *CompanionStruct_Default___) TestTransactGetItemsOutputPassthrough() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.TransactGetItemsOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_TransactGetItemsOutput_.Create_TransactGetItemsOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_out1 = m_TestFixtures.Companion_Default___.GetTableName(_dafny.SeqOfString("no_such_table"))
	_2_tableName = _out1
	var _3_item m_ComAmazonawsDynamodbTypes.TransactGetItem
	_ = _3_item
	_3_item = m_ComAmazonawsDynamodbTypes.Companion_TransactGetItem_.Create_TransactGetItem_(m_ComAmazonawsDynamodbTypes.Companion_Get_.Create_Get_(_dafny.NewMapBuilder().ToMap(), _2_tableName, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_()))
	var _4_items _dafny.Sequence
	_ = _4_items
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetTransactGetItemList(_dafny.SeqOf(_3_item))
	_4_items = _out2
	var _5_input m_ComAmazonawsDynamodbTypes.TransactGetItemsInput
	_ = _5_input
	_5_input = m_ComAmazonawsDynamodbTypes.Companion_TransactGetItemsInput_.Create_TransactGetItemsInput_(_4_items, m_Wrappers.Companion_Option_.Create_None_())
	var _6_transformed m_Wrappers.Result
	_ = _6_transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).TransactGetItemsOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_TransactGetItemsOutputTransformInput_.Create_TransactGetItemsOutputTransformInput_(_1_output, _5_input))
	_6_transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("TransactGetItemsOutput"), _6_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("TransactGetItemsOutput"), ((_6_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.TransactGetItemsOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
