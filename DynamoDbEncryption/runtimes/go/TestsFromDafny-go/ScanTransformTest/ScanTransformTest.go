// Package ScanTransformTest
// Dafny module ScanTransformTest compiled into Go
...
func (*Default__) String() string {
	return "ScanTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestScanInputPassthrough() {
	...
	_1_tableName = _out1
	var _2_input m_ComAmazonawsDynamodbTypes.ScanInput
	_ = _2_input
	_2_input = m_ComAmazonawsDynamodbTypes.Companion_ScanInput_.Create_ScanInput_(_1_tableName, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_transformed m_Wrappers.Result
	_ = _3_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).ScanInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ScanInputTransformInput_.Create_ScanInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ScanInput"), _3_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ScanInput"), ((_3_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ScanInputTransformOutput)).Dtor_transformedInput(), _2_input)
}
func (_static *CompanionStruct_Default___) TestScanOutputPassthrough() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.ScanOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_ScanOutput_.Create_ScanOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_out1 = m_TestFixtures.Companion_Default___.GetTableName(_dafny.SeqOfString("no_such_table"))
	_2_tableName = _out1
	var _3_input m_ComAmazonawsDynamodbTypes.ScanInput
	_ = _3_input
	...
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).ScanOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ScanOutputTransformInput_.Create_ScanOutputTransformInput_(_1_output, _3_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ScanOutput"), _4_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ScanOutput"), ((_4_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ScanOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
