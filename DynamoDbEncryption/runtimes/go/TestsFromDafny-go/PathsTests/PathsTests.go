// Package PathsTests
// Dafny module PathsTests compiled into Go
...
func (_static *CompanionStruct_Default___) TestSpecExamples() {
	var _0_tableName _dafny.Sequence
	_ = _0_tableName
	_0_tableName = _dafny.SeqOfString("example_table")
	var _1_pathToTest _dafny.Sequence
	_ = _1_pathToTest
	_1_pathToTest = m_StructuredEncryptionPaths.Companion_Default___.StringToUniPath(_dafny.SeqOfString("name"))
	if !(_dafny.Companion_Sequence_.Equal(m_StructuredEncryptionPaths.Companion_Default___.CanonPath(_0_tableName, _1_pathToTest), _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(Companion_Default___.Example__table(), _dafny.SeqOf(uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(1))), _dafny.SeqOf(uint8(_dafny.Char('$')))), _dafny.SeqOf(uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(0), uint8(4))), Companion_Default___.Name()))) {
		panic("dafny/StructuredEncryption/test/Paths.dfy(26,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) Example__table() _dafny.Sequence {
	var _0_s _dafny.Sequence = _dafny.SeqOf(uint8(101), uint8(120), uint8(97), uint8(109), uint8(112), uint8(108), uint8(101), uint8(95), uint8(116), uint8(97), uint8(98), uint8(108), uint8(101))
	_ = _0_s
	return _0_s
}
func (_static *CompanionStruct_Default___) Name() _dafny.Sequence {
	var _0_s _dafny.Sequence = _dafny.SeqOf(uint8(110), uint8(97), uint8(109), uint8(101))
	_ = _0_s
	return _0_s
}
