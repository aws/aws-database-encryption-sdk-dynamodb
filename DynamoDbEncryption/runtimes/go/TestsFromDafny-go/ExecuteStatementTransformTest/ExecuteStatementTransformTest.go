// Package ExecuteStatementTransformTest
// Dafny module ExecuteStatementTransformTest compiled into Go
...
func (*Default__) String() string {
	return "ExecuteStatementTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestExecuteStatementInputPassthrough() {
	...
	_1_statement = _out1
	var _2_good__input m_ComAmazonawsDynamodbTypes.ExecuteStatementInput
	_ = _2_good__input
	_2_good__input = m_ComAmazonawsDynamodbTypes.Companion_ExecuteStatementInput_.Create_ExecuteStatementInput_(_1_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_good__transformed m_Wrappers.Result
	_ = _3_good__transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).ExecuteStatementInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteStatementInputTransformInput_.Create_ExecuteStatementInputTransformInput_(_2_good__input))
	_3_good__transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ExecuteStatement"), _3_good__transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ExecuteStatement"), ((_3_good__transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ExecuteStatementInputTransformOutput)).Dtor_transformedInput(), _2_good__input)
}
func (_static *CompanionStruct_Default___) TestExecuteStatementInputEncrypted() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_1_statement = _out1
	var _2_bad__input m_ComAmazonawsDynamodbTypes.ExecuteStatementInput
	_ = _2_bad__input
	...
	var _3_bad__transformed m_Wrappers.Result
	_ = _3_bad__transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).ExecuteStatementInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteStatementInputTransformInput_.Create_ExecuteStatementInputTransformInput_(_2_bad__input))
	_3_bad__transformed = _out2
	if !((_3_bad__transformed).Is_Failure()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/ExecuteStatementTransform.dfy(51,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_3_bad__transformed).Dtor_error().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error)).Is_DynamoDbEncryptionTransformsException()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/ExecuteStatementTransform.dfy(52,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Companion_Sequence_.Equal(((_3_bad__transformed).Dtor_error().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error)).Dtor_message(), _dafny.SeqOfString("ExecuteStatement not Supported on encrypted tables."))) {
		panic("dafny/DynamoDbEncryptionTransforms/test/ExecuteStatementTransform.dfy(53,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestExecuteStatementOutput() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.ExecuteStatementOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_ExecuteStatementOutput_.Create_ExecuteStatementOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_2_statement = _out1
	var _3_input m_ComAmazonawsDynamodbTypes.ExecuteStatementInput
	_ = _3_input
	...
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).ExecuteStatementOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteStatementOutputTransformInput_.Create_ExecuteStatementOutputTransformInput_(_1_output, _3_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ExecuteStatement"), _4_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ExecuteStatement"), ((_4_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ExecuteStatementOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
