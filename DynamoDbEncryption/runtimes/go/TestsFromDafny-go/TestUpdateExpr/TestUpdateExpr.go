// Package TestUpdateExpr
// Dafny module TestUpdateExpr compiled into Go
...
func (*Default__) String() string {
	return "TestUpdateExpr.Default__"
}
...
func (_static *CompanionStruct_Default___) Expect__equal(a interface{}, b interface{}) {
	...
	if !(_dafny.AreEqual(a, b)) {
		panic("dafny/DynamoDbEncryption/test/UpdateExpr.dfy(16,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestExamples() {
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET ProductCategory = :c, Price = :p")), _dafny.SeqOf(_dafny.SeqOfString("ProductCategory"), _dafny.SeqOfString("Price")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET RelatedItems[1] = :ri")), _dafny.SeqOf(_dafny.SeqOfString("RelatedItems")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET #pr.#5star[1] = :r5, #pr.#3star = :r3")), _dafny.SeqOf(_dafny.SeqOfString("#pr"), _dafny.SeqOfString("#pr")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET Price = Price - :p")), _dafny.SeqOf(_dafny.SeqOfString("Price"), _dafny.SeqOfString("Price")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET #ri = list_append(#ri, :vals)")), _dafny.SeqOf(_dafny.SeqOfString("#ri"), _dafny.SeqOfString("#ri")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET #ri = list_append(:vals, #ri)")), _dafny.SeqOf(_dafny.SeqOfString("#ri"), _dafny.SeqOfString("#ri")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("SET Price = if_not_exists(Price, :p)")), _dafny.SeqOf(_dafny.SeqOfString("Price"), _dafny.SeqOfString("Price")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("REMOVE Brand, InStock, QuantityOnHand")), _dafny.SeqOf(_dafny.SeqOfString("Brand"), _dafny.SeqOfString("InStock"), _dafny.SeqOfString("QuantityOnHand")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("REMOVE RelatedItems[1], RelatedItems[2]")), _dafny.SeqOf(_dafny.SeqOfString("RelatedItems"), _dafny.SeqOfString("RelatedItems")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("ADD QuantityOnHand :q")), _dafny.SeqOf(_dafny.SeqOfString("QuantityOnHand")))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttrs(_dafny.SeqOfString("DELETE Color :p")), _dafny.SeqOf(_dafny.SeqOfString("Color")))
	var _0_m _dafny.Map
	_ = _0_m
	_0_m = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString("#pr"), _dafny.SeqOfString("foo"))
	Companion_Default___.Expect__equal(m_DynamoDbUpdateExpr.Companion_Default___.ExtractAttributes(_dafny.SeqOfString("SET #pr.#5star[1] = :r5, #pr.#3star = :r3"), m_Wrappers.Companion_Option_.Create_Some_(_0_m)), _dafny.SeqOf(_dafny.SeqOfString("foo"), _dafny.SeqOfString("foo")))
}
