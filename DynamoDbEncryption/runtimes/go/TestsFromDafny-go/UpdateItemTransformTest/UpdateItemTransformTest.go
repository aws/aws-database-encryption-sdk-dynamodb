// Package UpdateItemTransformTest
// Dafny module UpdateItemTransformTest compiled into Go
...
func (*Default__) String() string {
	return "UpdateItemTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestUpdateItemInputPassthrough() {
	...
	_1_tableName = _out1
	var _2_input m_ComAmazonawsDynamodbTypes.UpdateItemInput
	_ = _2_input
	_2_input = m_ComAmazonawsDynamodbTypes.Companion_UpdateItemInput_.Create_UpdateItemInput_(_1_tableName, _dafny.NewMapBuilder().ToMap(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_transformed m_Wrappers.Result
	_ = _3_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).UpdateItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_UpdateItemInputTransformInput_.Create_UpdateItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("UpdateItemInput"), _3_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("UpdateItemInput"), ((_3_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.UpdateItemInputTransformOutput)).Dtor_transformedInput(), _2_input)
}
func (_static *CompanionStruct_Default___) TestUpdateItemInputUpdateExpressionSigned() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_out2 = (_0_middlewareUnderTest).UpdateItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_UpdateItemInputTransformInput_.Create_UpdateItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.ExpectFailure(_3_transformed, _dafny.SeqOfString("Update Expressions forbidden on signed attributes : sign"))
}
func (_static *CompanionStruct_Default___) TestUpdateItemInputUpdateExpressionEncrypted() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_out2 = (_0_middlewareUnderTest).UpdateItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_UpdateItemInputTransformInput_.Create_UpdateItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.ExpectFailure(_3_transformed, _dafny.SeqOfString("Update Expressions forbidden on signed attributes : encrypt"))
}
func (_static *CompanionStruct_Default___) TestUpdateItemInputUpdateExpressionPlain() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
...
func (_static *CompanionStruct_Default___) TestUpdateItemOutputPassthrough() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.UpdateItemOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_UpdateItemOutput_.Create_UpdateItemOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_out1 = m_TestFixtures.Companion_Default___.GetTableName(_dafny.SeqOfString("no_such_table"))
	_2_tableName = _out1
	var _3_input m_ComAmazonawsDynamodbTypes.UpdateItemInput
	_ = _3_input
	...
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).UpdateItemOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_UpdateItemOutputTransformInput_.Create_UpdateItemOutputTransformInput_(_1_output, _3_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("UpdateItemOutput"), _4_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("UpdateItemOutput"), ((_4_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.UpdateItemOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
