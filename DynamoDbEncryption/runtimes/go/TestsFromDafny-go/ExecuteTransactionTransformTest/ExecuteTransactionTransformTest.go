// Package ExecuteTransactionTransformTest
// Dafny module ExecuteTransactionTransformTest compiled into Go
...
func (*Default__) String() string {
	return "ExecuteTransactionTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestExecuteTransactionInputPassthrough() {
	...
	_1_statement = _out1
	var _2_pstatement m_ComAmazonawsDynamodbTypes.ParameterizedStatement
	_ = _2_pstatement
	_2_pstatement = m_ComAmazonawsDynamodbTypes.Companion_ParameterizedStatement_.Create_ParameterizedStatement_(_1_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_pstatements _dafny.Sequence
	_ = _3_pstatements
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetPStatements(_dafny.SeqOf(_2_pstatement))
	_3_pstatements = _out2
	var _4_good__input m_ComAmazonawsDynamodbTypes.ExecuteTransactionInput
	_ = _4_good__input
	_4_good__input = m_ComAmazonawsDynamodbTypes.Companion_ExecuteTransactionInput_.Create_ExecuteTransactionInput_(_3_pstatements, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _5_good__transformed m_Wrappers.Result
	_ = _5_good__transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).ExecuteTransactionInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteTransactionInputTransformInput_.Create_ExecuteTransactionInputTransformInput_(_4_good__input))
	_5_good__transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ExecuteTransaction"), _5_good__transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ExecuteTransaction"), ((_5_good__transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ExecuteTransactionInputTransformOutput)).Dtor_transformedInput(), _4_good__input)
}
func (_static *CompanionStruct_Default___) TestExecuteTransactionInput() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_out2 = m_TestFixtures.Companion_Default___.GetPStatements(_dafny.SeqOf(_2_pstatement))
	_3_pstatements = _out2
	var _4_bad__input m_ComAmazonawsDynamodbTypes.ExecuteTransactionInput
	_ = _4_bad__input
	_4_bad__input = m_ComAmazonawsDynamodbTypes.Companion_ExecuteTransactionInput_.Create_ExecuteTransactionInput_(_3_pstatements, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _5_bad__transformed m_Wrappers.Result
	_ = _5_bad__transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).ExecuteTransactionInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteTransactionInputTransformInput_.Create_ExecuteTransactionInputTransformInput_(_4_bad__input))
	_5_bad__transformed = _out3
	m_TestFixtures.Companion_Default___.ExpectFailure(_5_bad__transformed, _dafny.SeqOfString("ExecuteTransaction not Supported on encrypted tables."))
}
func (_static *CompanionStruct_Default___) TestExecuteTransactionOutputTransform() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.ExecuteTransactionOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_ExecuteTransactionOutput_.Create_ExecuteTransactionOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_2_statement = _out1
	var _3_pstatement m_ComAmazonawsDynamodbTypes.ParameterizedStatement
	_ = _3_pstatement
	_3_pstatement = m_ComAmazonawsDynamodbTypes.Companion_ParameterizedStatement_.Create_ParameterizedStatement_(_2_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _4_pstatements _dafny.Sequence
	_ = _4_pstatements
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetPStatements(_dafny.SeqOf(_3_pstatement))
	_4_pstatements = _out2
	var _5_input m_ComAmazonawsDynamodbTypes.ExecuteTransactionInput
	_ = _5_input
	_5_input = m_ComAmazonawsDynamodbTypes.Companion_ExecuteTransactionInput_.Create_ExecuteTransactionInput_(_4_pstatements, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _6_transformed m_Wrappers.Result
	_ = _6_transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).ExecuteTransactionOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_ExecuteTransactionOutputTransformInput_.Create_ExecuteTransactionOutputTransformInput_(_1_output, _5_input))
	_6_transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("ExecuteTransactionOutput"), _6_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("ExecuteTransactionOutput"), ((_6_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ExecuteTransactionOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
