// Package BatchExecuteStatementTransformTest
// Dafny module BatchExecuteStatementTransformTest compiled into Go
...
func (*Default__) String() string {
	return "BatchExecuteStatementTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestBatchExecuteStatementInputPassthrough() {
	...
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetStatement(_dafny.SeqOfString("update \"no_such_table\""))
	_1_statement = _out1
	var _2_request m_ComAmazonawsDynamodbTypes.BatchStatementRequest
	_ = _2_request
	_2_request = m_ComAmazonawsDynamodbTypes.Companion_BatchStatementRequest_.Create_BatchStatementRequest_(_1_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_requests _dafny.Sequence
	_ = _3_requests
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetPartiQLBatchRequest(_dafny.SeqOf(_2_request))
	_3_requests = _out2
	var _4_good__input m_ComAmazonawsDynamodbTypes.BatchExecuteStatementInput
	_ = _4_good__input
	_4_good__input = m_ComAmazonawsDynamodbTypes.Companion_BatchExecuteStatementInput_.Create_BatchExecuteStatementInput_(_3_requests, m_Wrappers.Companion_Option_.Create_None_())
	var _5_good__transformed m_Wrappers.Result
	_ = _5_good__transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).BatchExecuteStatementInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_BatchExecuteStatementInputTransformInput_.Create_BatchExecuteStatementInputTransformInput_(_4_good__input))
	_5_good__transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("BatchExecuteStatement"), _5_good__transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("BatchExecuteStatement"), ((_5_good__transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.BatchExecuteStatementInputTransformOutput)).Dtor_transformedInput(), _4_good__input)
}
func (_static *CompanionStruct_Default___) TestBatchExecuteStatementInputEncrypted() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	var _out1 _dafny.Sequence
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetStatement(_dafny.SeqOfString("update \"foo\""))
	_1_statement = _out1
	var _2_request m_ComAmazonawsDynamodbTypes.BatchStatementRequest
	_ = _2_request
	_2_request = m_ComAmazonawsDynamodbTypes.Companion_BatchStatementRequest_.Create_BatchStatementRequest_(_1_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	...
	_out2 = m_TestFixtures.Companion_Default___.GetPartiQLBatchRequest(_dafny.SeqOf(_2_request))
	_3_requests = _out2
	var _4_bad__input m_ComAmazonawsDynamodbTypes.BatchExecuteStatementInput
	_ = _4_bad__input
	_4_bad__input = m_ComAmazonawsDynamodbTypes.Companion_BatchExecuteStatementInput_.Create_BatchExecuteStatementInput_(_3_requests, m_Wrappers.Companion_Option_.Create_None_())
	var _5_bad__transformed m_Wrappers.Result
	_ = _5_bad__transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).BatchExecuteStatementInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_BatchExecuteStatementInputTransformInput_.Create_BatchExecuteStatementInputTransformInput_(_4_bad__input))
	_5_bad__transformed = _out3
	if !((_5_bad__transformed).Is_Failure()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/BatchExecuteStatementTransform.dfy(55,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_5_bad__transformed).Dtor_error().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error)).Is_DynamoDbEncryptionTransformsException()) {
		panic("dafny/DynamoDbEncryptionTransforms/test/BatchExecuteStatementTransform.dfy(56,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Companion_Sequence_.Equal(((_5_bad__transformed).Dtor_error().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error)).Dtor_message(), _dafny.SeqOfString("BatchExecuteStatement not Supported on encrypted tables."))) {
		panic("dafny/DynamoDbEncryptionTransforms/test/BatchExecuteStatementTransform.dfy(57,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestBatchExecuteStatementOutputTransform() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.BatchExecuteStatementOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_BatchExecuteStatementOutput_.Create_BatchExecuteStatementOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _2_statement _dafny.Sequence
	_ = _2_statement
	var _out1 _dafny.Sequence
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetStatement(_dafny.SeqOfString("foo"))
	_2_statement = _out1
	var _3_request m_ComAmazonawsDynamodbTypes.BatchStatementRequest
	_ = _3_request
	_3_request = m_ComAmazonawsDynamodbTypes.Companion_BatchStatementRequest_.Create_BatchStatementRequest_(_2_statement, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _4_requests _dafny.Sequence
	_ = _4_requests
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetPartiQLBatchRequest(_dafny.SeqOf(_3_request))
	_4_requests = _out2
	var _5_input m_ComAmazonawsDynamodbTypes.BatchExecuteStatementInput
	_ = _5_input
	_5_input = m_ComAmazonawsDynamodbTypes.Companion_BatchExecuteStatementInput_.Create_BatchExecuteStatementInput_(_4_requests, m_Wrappers.Companion_Option_.Create_None_())
	var _6_transformed m_Wrappers.Result
	_ = _6_transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).BatchExecuteStatementOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_BatchExecuteStatementOutputTransformInput_.Create_BatchExecuteStatementOutputTransformInput_(_1_output, _5_input))
	_6_transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("BatchExecuteStatement"), _6_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("BatchExecuteStatement"), ((_6_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.BatchExecuteStatementOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
