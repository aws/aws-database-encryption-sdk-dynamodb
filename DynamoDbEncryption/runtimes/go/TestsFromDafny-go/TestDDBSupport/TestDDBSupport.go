// Package TestDDBSupport
// Dafny module TestDDBSupport compiled into Go
...
func (*Default__) String() string {
	return "TestDDBSupport.Default__"
}
...
func (_static *CompanionStruct_Default___) TestAddSignedBeacons() {
	...
	if !(!((_2_valueOrError0).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(23,14): " + (_2_valueOrError0).String())
	}
	...
	var _4_search m_SearchableEncryptionInfo.SearchInfo
	_ = _4_search
	_4_search = m_SearchableEncryptionInfo.Companion_SearchInfo_.Create_SearchInfo_(_dafny.SeqOf(_3_bv), _dafny.Zero)
	var _5_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptyMap)
	_ = _5_valueOrError1
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = m_DynamoDBSupport.Companion_Default___.AddSignedBeacons(m_Wrappers.Companion_Option_.Create_Some_(_4_search), m_BeaconTestFixtures.Companion_Default___.SimpleItem())
	_5_valueOrError1 = _out3
	if !(!((_5_valueOrError1).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(25,19): " + (_5_valueOrError1).String())
	}
	var _6_newItem _dafny.Map
	_ = _6_newItem
	_6_newItem = (_5_valueOrError1).Extract().(_dafny.Map)
	var _7_expectedNew _dafny.Map
	_ = _7_expectedNew
	...
	if !((_6_newItem).Equals((m_BeaconTestFixtures.Companion_Default___.SimpleItem()).Merge(_7_expectedNew))) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(32,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
...
func (_static *CompanionStruct_Default___) TestMulti() {
	var _0_version m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconVersion
	_ = _0_version
	var _out0 m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconVersion
	_ = _out0
	_out0 = m_BeaconTestFixtures.Companion_Default___.GetLotsaBeaconsMulti()
	_0_version = _out0
	var _1_src m_SearchableEncryptionInfo.KeySource
	_ = _1_src
	var _out1 m_SearchableEncryptionInfo.KeySource
	_ = _out1
	_out1 = m_BeaconTestFixtures.Companion_Default___.GetMultiSource(_dafny.SeqOfString("TheKeyField"), _0_version)
	_1_src = _out1
	var _2_valueOrError0 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _2_valueOrError0
	var _out2 m_Wrappers.Result
	...
	_2_valueOrError0 = _out2
	if !(!((_2_valueOrError0).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(44,14): " + (_2_valueOrError0).String())
	}
	var _3_bv m_SearchableEncryptionInfo.BeaconVersion
	_ = _3_bv
	_3_bv = (_2_valueOrError0).Extract().(m_SearchableEncryptionInfo.BeaconVersion)
	...
	_ = _4_search
	_4_search = m_SearchableEncryptionInfo.Companion_SearchInfo_.Create_SearchInfo_(_dafny.SeqOf(_3_bv), _dafny.Zero)
	var _5_expressionAttributeValues _dafny.Map
	_ = _5_expressionAttributeValues
	_5_expressionAttributeValues = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString(":value"), Companion_Default___.DS(_dafny.SeqOfString("0ad21413-51aa-42e1-9c3d-6a4b1edf7e10")))
	var _6_queryInput m_ComAmazonawsDynamodbTypes.QueryInput
	_ = _6_queryInput
	...
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = m_DynamoDBSupport.Companion_Default___.QueryInputForBeacons(m_Wrappers.Companion_Option_.Create_Some_(_4_search), (m_BeaconTestFixtures.Companion_Default___.FullTableConfig()).Dtor_attributeActionsOnEncrypt(), _6_queryInput)
	_7_valueOrError1 = _out3
	if !(!((_7_valueOrError1).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(54,18): " + (_7_valueOrError1).String())
	}
	var _8_result m_ComAmazonawsDynamodbTypes.QueryInput
	_ = _8_result
	_8_result = (_7_valueOrError1).Extract().(m_ComAmazonawsDynamodbTypes.QueryInput)
	_5_expressionAttributeValues = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString(":value"), Companion_Default___.DS(_dafny.SeqOfString("0ad21413-51aa-42e1-9c3d-6a4b1edf7e10"))).UpdateUnsafe(_dafny.SeqOfString(":other"), Companion_Default___.DS(_dafny.SeqOfString("junk")))
	...
	_ = _out4
	_out4 = m_DynamoDBSupport.Companion_Default___.QueryInputForBeacons(m_Wrappers.Companion_Option_.Create_Some_(_4_search), (m_BeaconTestFixtures.Companion_Default___.FullTableConfig()).Dtor_attributeActionsOnEncrypt(), _6_queryInput)
	_9_valueOrError2 = _out4
	if !(!((_9_valueOrError2).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(66,14): " + (_9_valueOrError2).String())
	}
	_8_result = (_9_valueOrError2).Extract().(m_ComAmazonawsDynamodbTypes.QueryInput)
	_6_queryInput = m_ComAmazonawsDynamodbTypes.Companion_QueryInput_.Create_QueryInput_(_dafny.SeqOfString("foo"), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_dafny.SeqOfString("std2 = :other")), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_5_expressionAttributeValues))
	var _10_result2 m_Wrappers.Result
	_ = _10_result2
	var _out5 m_Wrappers.Result
	_ = _out5
	_out5 = m_DynamoDBSupport.Companion_Default___.QueryInputForBeacons(m_Wrappers.Companion_Option_.Create_Some_(_4_search), (m_BeaconTestFixtures.Companion_Default___.FullTableConfig()).Dtor_attributeActionsOnEncrypt(), _6_queryInput)
	_10_result2 = _out5
	if !((_10_result2).Equals(m_Wrappers.Companion_Result_.Create_Failure_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_Error_.Create_DynamoDbEncryptionException_(_dafny.SeqOfString("Need KeyId because of beacon std2 but no KeyId found in query"))))) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(75,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _11_expressionAttributeNames _dafny.Map
	_ = _11_expressionAttributeNames
	_11_expressionAttributeNames = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(_dafny.SeqOfString("#beacon"), _dafny.SeqOfString("std2")).UpdateUnsafe(_dafny.SeqOfString("#keyfield"), _dafny.SeqOfString("TheKeyField"))
	...
	_ = _out6
	_out6 = m_DynamoDBSupport.Companion_Default___.QueryInputForBeacons(m_Wrappers.Companion_Option_.Create_Some_(_4_search), (m_BeaconTestFixtures.Companion_Default___.FullTableConfig()).Dtor_attributeActionsOnEncrypt(), _6_queryInput)
	_12_valueOrError3 = _out6
	if !(!((_12_valueOrError3).IsFailure())) {
		panic("dafny/DynamoDbEncryption/test/DDBSupport.dfy(89,14): " + (_12_valueOrError3).String())
	}
	_8_result = (_12_valueOrError3).Extract().(m_ComAmazonawsDynamodbTypes.QueryInput)
}
