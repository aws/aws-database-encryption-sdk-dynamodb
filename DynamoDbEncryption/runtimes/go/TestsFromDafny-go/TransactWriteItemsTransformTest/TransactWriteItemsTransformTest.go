// Package TransactWriteItemsTransformTest
// Dafny module TransactWriteItemsTransformTest compiled into Go
...
func (*Default__) String() string {
	return "TransactWriteItemsTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestTransactWriteItemsInputPassthrough() {
	...
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetTableName(_dafny.SeqOfString("bar"))
	_1_tableName = _out1
	var _2_thisAttr _dafny.Sequence
	_ = _2_thisAttr
	_2_thisAttr = m_TestFixtures.Companion_Default___.GetAttrName(_dafny.SeqOfString("this"))
	var _3_item m_ComAmazonawsDynamodbTypes.TransactWriteItem
	_ = _3_item
	_3_item = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItem_.Create_TransactWriteItem_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(m_ComAmazonawsDynamodbTypes.Companion_Delete_.Create_Delete_(_dafny.NewMapBuilder().ToMap().UpdateUnsafe(_2_thisAttr, m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(_dafny.SeqOfString("that"))), _1_tableName, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())), m_Wrappers.Companion_Option_.Create_None_())
	var _4_items _dafny.Sequence
	_ = _4_items
	var _out2 _dafny.Sequence
	_ = _out2
	_out2 = m_TestFixtures.Companion_Default___.GetTransactWriteItemList(_dafny.SeqOf(_3_item))
	_4_items = _out2
	var _5_input m_ComAmazonawsDynamodbTypes.TransactWriteItemsInput
	_ = _5_input
	_5_input = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItemsInput_.Create_TransactWriteItemsInput_(_4_items, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _6_transformed m_Wrappers.Result
	_ = _6_transformed
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_0_middlewareUnderTest).TransactWriteItemsInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_TransactWriteItemsInputTransformInput_.Create_TransactWriteItemsInputTransformInput_(_5_input))
	_6_transformed = _out3
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("TransactWriteItemsInput"), _6_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("TransactWriteItemsInput"), ((_6_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.TransactWriteItemsInputTransformOutput)).Dtor_transformedInput(), _5_input)
}
func (_static *CompanionStruct_Default___) TestTransactWriteItemsInputEmpty() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_ = _1_item
	_1_item = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItem_.Create_TransactWriteItem_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _2_items _dafny.Sequence
	_ = _2_items
	var _out1 _dafny.Sequence
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetTransactWriteItemList(_dafny.SeqOf(_1_item))
	_2_items = _out1
	var _3_input m_ComAmazonawsDynamodbTypes.TransactWriteItemsInput
	_ = _3_input
	_3_input = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItemsInput_.Create_TransactWriteItemsInput_(_2_items, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _4_transformed m_Wrappers.Result
	_ = _4_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).TransactWriteItemsInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_TransactWriteItemsInputTransformInput_.Create_TransactWriteItemsInputTransformInput_(_3_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.ExpectFailure(_4_transformed, _dafny.SeqOfString("Each item in TransactWriteItems must specify at least one supported operation"))
}
func (_static *CompanionStruct_Default___) TestTransactWriteItemsOutputTransform() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	_out0 = m_TestFixtures.Companion_Default___.GetDynamoDbEncryptionTransforms()
	_0_middlewareUnderTest = _out0
	var _1_output m_ComAmazonawsDynamodbTypes.TransactWriteItemsOutput
	_ = _1_output
	_1_output = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItemsOutput_.Create_TransactWriteItemsOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _2_item m_ComAmazonawsDynamodbTypes.TransactWriteItem
	_ = _2_item
	_2_item = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItem_.Create_TransactWriteItem_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_items _dafny.Sequence
	_ = _3_items
	var _out1 _dafny.Sequence
	_ = _out1
	_out1 = m_TestFixtures.Companion_Default___.GetTransactWriteItemList(_dafny.SeqOf(_2_item))
	_3_items = _out1
	var _4_input m_ComAmazonawsDynamodbTypes.TransactWriteItemsInput
	_ = _4_input
	_4_input = m_ComAmazonawsDynamodbTypes.Companion_TransactWriteItemsInput_.Create_TransactWriteItemsInput_(_3_items, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _5_transformed m_Wrappers.Result
	_ = _5_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).TransactWriteItemsOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_TransactWriteItemsOutputTransformInput_.Create_TransactWriteItemsOutputTransformInput_(_1_output, _4_input))
	_5_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("TransactWriteItemsOutput"), _5_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("TransactWriteItemsOutput"), ((_5_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.TransactWriteItemsOutputTransformOutput)).Dtor_transformedOutput(), _1_output)
}
