// Package HappyCaseTests
// Dafny module HappyCaseTests compiled into Go
...
func (*Default__) String() string {
	return "HappyCaseTests.Default__"
}
...
func (_static *CompanionStruct_Default___) TestRoundTrip() {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(28,6): " + (_0_valueOrError0).String())
	}
	var _1_structuredEncryption *m_StructuredEncryption.StructuredEncryptionClient
	_ = _1_structuredEncryption
	_1_structuredEncryption = (_0_valueOrError0).Extract().(*m_StructuredEncryption.StructuredEncryptionClient)
	var _2_cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager
	_ = _2_cmm
	var _out1 m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager
	_ = _out1
	_out1 = m_StructuredDataTestFixtures.Companion_Default___.GetDefaultCMMWithKMSKeyring()
	_2_cmm = _out1
	var _3_encContext _dafny.Map
	_ = _3_encContext
	_3_encContext = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Some(), Companion_Default___.Value())
	var _4_algSuiteId m_AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId
	_ = _4_algSuiteId
	_4_algSuiteId = ((m_AlgorithmSuites.Companion_Default___.DBE__ALG__AES__256__GCM__HKDF__SHA512__COMMIT__KEY__ECDSA__P384__SYMSIG__HMAC__SHA384()).Dtor_id()).Dtor_DBE()
	var _5_encryptRes m_Wrappers.Result
	_ = _5_encryptRes
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_1_structuredEncryption).EncryptStructure(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_EncryptStructureInput_.Create_EncryptStructureInput_(_dafny.SeqOfString("myTable"), m_StructuredDataTestFixtures.Companion_Default___.TEST__STRUCTURED__DATA(), m_StructuredDataTestFixtures.Companion_Default___.TEST__CRYPTO__SCHEMA(), _2_cmm, m_Wrappers.Companion_Option_.Create_Some_(_4_algSuiteId), m_Wrappers.Companion_Option_.Create_Some_(_3_encContext)))
	_5_encryptRes = _out2
	if (_5_encryptRes).Is_Failure() {
		_dafny.Print(_5_encryptRes)
	}
	if !((_5_encryptRes).Is_Success()) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(51,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _6_newData _dafny.Map
	_ = _6_newData
	_6_newData = ((_5_encryptRes).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptStructureOutput)).Dtor_encryptedStructure()
	var _7_testData _dafny.Map
	_ = _7_testData
	_7_testData = m_StructuredDataTestFixtures.Companion_Default___.TEST__STRUCTURED__DATA()
	if !(((_6_newData).Keys()).Equals(((_7_testData).Keys()).Union(_dafny.SetOf(m_StructuredEncryptionUtil.Companion_Default___.HeaderField(), m_StructuredEncryptionUtil.Companion_Default___.FooterField())))) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(54,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(!((_6_newData).Get(_dafny.SeqOfString("foo")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal)).Equals((_7_testData).Get(_dafny.SeqOfString("foo")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(55,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_6_newData).Get(_dafny.SeqOfString("bar")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal)).Equals((_7_testData).Get(_dafny.SeqOfString("bar")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(56,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_6_newData).Get(_dafny.SeqOfString("fizzbuzz")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal)).Equals((_7_testData).Get(_dafny.SeqOfString("fizzbuzz")).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(57,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _8_decryptRes m_Wrappers.Result
	_ = _8_decryptRes
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = (_1_structuredEncryption).DecryptStructure(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_DecryptStructureInput_.Create_DecryptStructureInput_(_dafny.SeqOfString("myTable"), ((_5_encryptRes).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptStructureOutput)).Dtor_encryptedStructure(), m_StructuredDataTestFixtures.Companion_Default___.TEST__AUTHENTICATE__SCHEMA(), _2_cmm, m_Wrappers.Companion_Option_.Create_None_()))
	_8_decryptRes = _out3
	if (_8_decryptRes).Is_Failure() {
		_dafny.Print((_dafny.SeqOfString("\n\n")).SetString())
		_dafny.Print(_8_decryptRes)
		_dafny.Print((_dafny.SeqOfString("\n\n")).SetString())
	}
	if !((_8_decryptRes).Is_Success()) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(72,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _9_newResult _dafny.Map
	_ = _9_newResult
	_9_newResult = ((_8_decryptRes).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptStructureOutput)).Dtor_plaintextStructure()
	var _10_testResult _dafny.Map
	_ = _10_testResult
	_10_testResult = m_StructuredDataTestFixtures.Companion_Default___.TEST__STRUCTURED__DATA()
	if !((_9_newResult).Equals(_10_testResult)) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(75,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _11_parsedHeader m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.ParsedHeader
	_ = _11_parsedHeader
	_11_parsedHeader = ((_8_decryptRes).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptStructureOutput)).Dtor_parsedHeader()
	if !((((_8_decryptRes).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptStructureOutput)).Dtor_cryptoSchema()).Equals(m_StructuredDataTestFixtures.Companion_Default___.TEST__CRYPTO__SCHEMA__AUTH__ONLY())) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(83,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_11_parsedHeader).Dtor_algorithmSuiteId()).Equals(_4_algSuiteId)) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(84,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_3_encContext).Keys()).IsSubsetOf(((_11_parsedHeader).Dtor_storedEncryptionContext()).Keys())) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(85,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Quantifier(((_3_encContext).Keys()).Elements(), true, func(_forall_var_0 _dafny.Sequence) bool {
		var _12_k _dafny.Sequence
		_12_k = interface{}(_forall_var_0).(_dafny.Sequence)
		return !(((_3_encContext).Keys()).Contains(_12_k)) || (_dafny.Companion_Sequence_.Equal(((_11_parsedHeader).Dtor_storedEncryptionContext()).Get(_12_k).(_dafny.Sequence), (_3_encContext).Get(_12_k).(_dafny.Sequence)))
	})) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(86,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !((_dafny.IntOfUint32(((_11_parsedHeader).Dtor_encryptedDataKeys()).Cardinality())).Cmp(_dafny.One) == 0) {
		panic("dafny/StructuredEncryption/test/HappyCaseTests.dfy(87,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) Some() _dafny.Sequence {
	var _0_s _dafny.Sequence = _dafny.SeqOf(uint8(115), uint8(111), uint8(109), uint8(101))
	_ = _0_s
	return _0_s
}
func (_static *CompanionStruct_Default___) Value() _dafny.Sequence {
	var _0_s _dafny.Sequence = _dafny.SeqOf(uint8(118), uint8(97), uint8(108), uint8(117), uint8(101))
	_ = _0_s
	return _0_s
}
