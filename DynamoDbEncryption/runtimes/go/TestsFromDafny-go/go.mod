module github.com/aws/aws-database-encryption-sdk-dynamodb/releases/go/dynamodb-esdk/test
...
replace (
	...
	github.com/aws/aws-database-encryption-sdk-dynamodb/releases/go/dynamodb-esdk => ../ImplementationFromDafny-go
)
