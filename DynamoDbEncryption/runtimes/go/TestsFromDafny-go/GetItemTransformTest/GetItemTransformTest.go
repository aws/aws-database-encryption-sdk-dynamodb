// Package GetItemTransformTest
// Dafny module GetItemTransformTest compiled into Go
...
func (*Default__) String() string {
	return "GetItemTransformTest.Default__"
}
...
func (_static *CompanionStruct_Default___) TestGetItemInputPassthrough() {
	...
	_ = _out2
	_out2 = (_0_middlewareUnderTest).GetItemInputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_GetItemInputTransformInput_.Create_GetItemInputTransformInput_(_2_input))
	_3_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("GetItemInput"), _3_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("GetItemInput"), ((_3_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetItemInputTransformOutput)).Dtor_transformedInput(), _2_input)
}
func (_static *CompanionStruct_Default___) TestGetItemOutputPassthrough() {
	var _0_middlewareUnderTest *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _0_middlewareUnderTest
	var _out0 *m_DynamoDbEncryptionTransforms.DynamoDbEncryptionTransformsClient
	_ = _out0
	...
	_ = _2_input
	_2_input = m_ComAmazonawsDynamodbTypes.Companion_GetItemInput_.Create_GetItemInput_(_1_tableName, _dafny.NewMapBuilder().ToMap(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _3_output m_ComAmazonawsDynamodbTypes.GetItemOutput
	_ = _3_output
	_3_output = m_ComAmazonawsDynamodbTypes.Companion_GetItemOutput_.Create_GetItemOutput_(m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _4_transformed m_Wrappers.Result
	_ = _4_transformed
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = (_0_middlewareUnderTest).GetItemOutputTransform(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_GetItemOutputTransformInput_.Create_GetItemOutputTransformInput_(_3_output, _2_input))
	_4_transformed = _out2
	m_TestFixtures.Companion_Default___.Expect__ok(_dafny.SeqOfString("GetItemOutput"), _4_transformed)
	m_TestFixtures.Companion_Default___.Expect__equal(_dafny.SeqOfString("GetItemOutput"), ((_4_transformed).Dtor_value().(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetItemOutputTransformOutput)).Dtor_transformedOutput(), _3_output)
}
