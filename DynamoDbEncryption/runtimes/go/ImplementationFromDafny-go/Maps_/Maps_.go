// Package _Maps
// Dafny module _Maps compiled into Go
...
func (_static *CompanionStruct_Default___) Get(m _dafny.Map, x interface{}) m_Wrappers.Option {
	if (m).Contains(x) {
		return m_Wrappers.Companion_Option_.Create_Some_((m).Get(x).(interface{}))
	} else {
...
func (_static *CompanionStruct_Default___) Remove(m _dafny.Map, x interface{}) _dafny.Map {
	var _0_m_k _dafny.Map = func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter9 := _dafny.Iterate((m).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) Restrict(m _dafny.Map, xs _dafny.Set) _dafny.Map {
	return func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter10 := _dafny.Iterate((xs).Elements()); ; {
