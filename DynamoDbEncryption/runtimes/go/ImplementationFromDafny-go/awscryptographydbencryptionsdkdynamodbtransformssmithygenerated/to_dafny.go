...
func GetNumberOfQueriesInput_ToDafny(nativeInput awscryptographydbencryptionsdkdynamodbtransformssmithygeneratedtypes.GetNumberOfQueriesInput) AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetNumberOfQueriesInput {

	return func() AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetNumberOfQueriesInput {

		return AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_GetNumberOfQueriesInput_.Create_GetNumberOfQueriesInput_(Aws_cryptography_dbEncryptionSdk_dynamoDb_transforms_GetNumberOfQueriesInput_input_ToDafny(nativeInput.Input))
	}()

}

func GetNumberOfQueriesOutput_ToDafny(nativeOutput awscryptographydbencryptionsdkdynamodbtransformssmithygeneratedtypes.GetNumberOfQueriesOutput) AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetNumberOfQueriesOutput {

	return func() AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.GetNumberOfQueriesOutput {

		return AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_GetNumberOfQueriesOutput_.Create_GetNumberOfQueriesOutput_(Aws_cryptography_dbEncryptionSdk_dynamoDb_transforms_GetNumberOfQueriesOutput_numberOfQueries_ToDafny(nativeOutput.NumberOfQueries))
	}()
...
func Aws_cryptography_dbEncryptionSdk_dynamoDb_transforms_GetNumberOfQueriesInput_input_ToDafny(input dynamodb.QueryInput) ComAmazonawsDynamodbTypes.QueryInput {
...
func Aws_cryptography_dbEncryptionSdk_dynamoDb_transforms_GetNumberOfQueriesOutput_numberOfQueries_ToDafny(input int32) int32 {
	return func() int32 {
