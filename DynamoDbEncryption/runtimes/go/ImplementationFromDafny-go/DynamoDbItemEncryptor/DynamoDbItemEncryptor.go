...
func (_static *CompanionStruct_Default___) DynamoDbItemEncryptor(config m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DynamoDbItemEncryptorConfig) m_Wrappers.Result {
	...
	_ = _7_attributeNames
	_7_attributeNames = m_SortedSets.SetToOrderedSequence2(((config).Dtor_attributeActionsOnEncrypt()).Keys(), func(coer71 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg101 interface{}, arg102 interface{}) bool {
			return coer71(arg101.(_dafny.Char), arg102.(_dafny.Char))
		}
	...
	_ = _12_valueOrError4
	_12_valueOrError4 = (_11_structuredEncryptionRes).MapFailure(func(coer72 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg103 interface{}) interface{} {
			return coer72(arg103.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	if ((config).Dtor_cmm()).Is_Some() {
		...
		_ = _21_valueOrError6
		_21_valueOrError6 = (_20_maybeCmm).MapFailure(func(coer73 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
			return func(arg104 interface{}) interface{} {
				return coer73(arg104.(m_AwsCryptographyMaterialProvidersTypes.Error))
			}
	...
	_ = _26_valueOrError8
	_26_valueOrError8 = (_23_maybeCmpClient).MapFailure(func(coer74 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg105 interface{}) interface{} {
			return coer74(arg105.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
