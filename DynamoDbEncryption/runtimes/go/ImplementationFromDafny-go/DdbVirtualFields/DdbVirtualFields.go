...
func (_static *CompanionStruct_Default___) ParseVirtualFieldConfig(vf m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualField) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = m_StandardLibrary_Sequence.Companion_Default___.MapWithResult(func(coer83 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualPart) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
		return func(arg114 interface{}) m_Wrappers.Result {
			return coer83(arg114.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualPart))
		}
	...
	}), (vf).Dtor_parts(), _dafny.Zero, _dafny.SeqOf())
	_ = _0_valueOrError0
...
func (_static *CompanionStruct_Default___) UpperCase(s _dafny.Sequence) _dafny.Sequence {
	return m_Seq.Companion_Default___.Map(func(coer84 func(_dafny.Char) _dafny.Char) func(interface{}) interface{} {
		return func(arg115 interface{}) interface{} {
			return coer84(arg115.(_dafny.Char))
		}
...
func (_static *CompanionStruct_Default___) LowerCase(s _dafny.Sequence) _dafny.Sequence {
	return m_Seq.Companion_Default___.Map(func(coer85 func(_dafny.Char) _dafny.Char) func(interface{}) interface{} {
		return func(arg116 interface{}) interface{} {
			return coer85(arg116.(_dafny.Char))
		}
	}(func(_0_c _dafny.Char) _dafny.Char {
	...
	if ((_dafny.IntOfUint32((loc).Cardinality())).Cmp(_dafny.One) == 0) && ((vf).Contains(((loc).Select(0).(m_TermLoc.Selector)).Dtor_key())) {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			if (_1_str).Is_None() {
				...
				var _2_valueOrError1 m_Wrappers.Result = (m_UTF8.Encode((_1_str).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer86 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg117 interface{}) interface{} {
						return coer86(arg117.(_dafny.Sequence))
					}
...
func (_this VirtField) GetFields() _dafny.Sequence {
	{
		return m_Seq.Companion_Default___.Map(func(coer87 func(VirtPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg118 interface{}) interface{} {
				return coer87(arg118.(VirtPart))
			}
...
func (_this VirtField) GetLocs() _dafny.Set {
	{
		return func() _dafny.Set {
			...
			_ = _coll0
			for _iter25 := _dafny.Iterate(((_this).Dtor_parts()).Elements()); ; {
