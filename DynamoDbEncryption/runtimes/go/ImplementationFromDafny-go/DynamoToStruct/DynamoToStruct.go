...
func (_static *CompanionStruct_Default___) StructuredToItemEncrypt(s _dafny.Map, orig _dafny.Map, actions _dafny.Map) m_Wrappers.Result {
	var _0_ddbMap _dafny.Map = func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter12 := _dafny.Iterate((orig).Keys().Elements()); ; {
			...
			_1_k = interface{}(_compr_0).(_dafny.Sequence)
			if m_ComAmazonawsDynamodbTypes.Companion_AttributeName_.Is_(_1_k) {
				if (orig).Contains(_1_k) {
					_coll0.Add(_1_k, (func() m_Wrappers.Result {
						if (((s).Contains(_1_k)) && ((actions).Contains(_1_k))) && (((actions).Get(_1_k).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoAction)).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_ENCRYPT__AND__SIGN_())) {
							return Companion_Default___.StructuredToAttr((s).Get(_1_k).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))
						}
						return m_Wrappers.Companion_Result_.Create_Success_((orig).Get(_1_k).(m_ComAmazonawsDynamodbTypes.AttributeValue))
					})())
				}
			}
		}
	...
	_ = _0_ddbMap
	var _2_valueOrError0 m_Wrappers.Result = Companion_Default___.MapError(Companion_Default___.SimplifyMapValue(_0_ddbMap))
	_ = _2_valueOrError0
	if (_2_valueOrError0).IsFailure() {
		return (_2_valueOrError0).PropagateFailure()
	} else {
		var _3_oldMap _dafny.Map = (_2_valueOrError0).Extract().(_dafny.Map)
		_ = _3_oldMap
		var _4_ddbMap2 _dafny.Map = func() _dafny.Map {
			...
			for _iter13 := _dafny.Iterate((s).Keys().Elements()); ; {
				...
				_5_k = interface{}(_compr_1).(_dafny.Sequence)
				if m_ComAmazonawsDynamodbTypes.Companion_AttributeName_.Is_(_5_k) {
					if ((s).Contains(_5_k)) && (!(orig).Contains(_5_k)) {
						_coll1.Add(_5_k, Companion_Default___.StructuredToAttr((s).Get(_5_k).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal)))
					}
				}
			}
			return _coll1.ToMap()
		...
		_ = _4_ddbMap2
		var _6_valueOrError1 m_Wrappers.Result = Companion_Default___.MapError(Companion_Default___.SimplifyMapValue(_4_ddbMap2))
		_ = _6_valueOrError1
		if (_6_valueOrError1).IsFailure() {
			return (_6_valueOrError1).PropagateFailure()
		} else {
			var _7_newMap _dafny.Map = (_6_valueOrError1).Extract().(_dafny.Map)
			_ = _7_newMap
			return m_Wrappers.Companion_Result_.Create_Success_((_3_oldMap).Merge(_7_newMap))
		}
	}
}
func (_static *CompanionStruct_Default___) StructuredToItemDecrypt(s _dafny.Map, orig _dafny.Map, actions _dafny.Map) m_Wrappers.Result {
	var _0_ddbMap _dafny.Map = func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter14 := _dafny.Iterate((orig).Keys().Elements()); ; {
			...
			_1_k = interface{}(_compr_0).(_dafny.Sequence)
			if m_ComAmazonawsDynamodbTypes.Companion_AttributeName_.Is_(_1_k) {
				if ((orig).Contains(_1_k)) && (!(_dafny.Companion_Sequence_.IsPrefixOf(m_DynamoDbEncryptionUtil.Companion_Default___.ReservedPrefix(), _1_k))) {
					_coll0.Add(_1_k, (func() m_Wrappers.Result {
						if (((s).Contains(_1_k)) && ((actions).Contains(_1_k))) && (((actions).Get(_1_k).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoAction)).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_ENCRYPT__AND__SIGN_())) {
							return Companion_Default___.StructuredToAttr((s).Get(_1_k).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))
						}
	...
	_ = _0_ddbMap
	return Companion_Default___.MapError(Companion_Default___.SimplifyMapValue(_0_ddbMap))
}
func (_static *CompanionStruct_Default___) ItemToStructured(item _dafny.Map) m_Wrappers.Result {
	var _0_structuredMap _dafny.Map = func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter15 := _dafny.Iterate((item).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) StructuredToItem(s _dafny.Map) m_Wrappers.Result {
	if _dafny.Quantifier((s).Keys().Elements(), true, func(_forall_var_0 _dafny.Sequence) bool {
		...
		var _1_structuredData _dafny.Map = func() _dafny.Map {
			var _coll0 = _dafny.NewMapBuilder()
			_ = _coll0
			for _iter16 := _dafny.Iterate((s).Keys().Elements()); ; {
		...
		var _3_badNames _dafny.Set = func() _dafny.Set {
			...
			_ = _coll1
			for _iter17 := _dafny.Iterate((s).Keys().Elements()); ; {
				_compr_1, _ok17 := _iter17()
				if !_ok17 {
					break
				}
		...
		_ = _3_badNames
		var _5_orderedAttrNames _dafny.Sequence = m_StandardLibrary.Companion_Default___.SetToOrderedSequence(_3_badNames, func(coer47 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg66 interface{}, arg67 interface{}) bool {
				return coer47(arg66.(_dafny.Char), arg67.(_dafny.Char))
			}
...
func (_static *CompanionStruct_Default___) BigEndianPosToU32(x _dafny.Sequence, pos uint64) m_Wrappers.Result {
	if (uint64((x).Cardinality())) < (m_MemoryMath.Companion_Default___.Add(pos, Companion_Default___.LENGTH__LEN64())) {
		return m_Wrappers.Companion_Result_.Create_Failure_(_dafny.SeqOfString("Length of 4-byte integer was less than 4"))
	} else {
		return m_Wrappers.Companion_Result_.Create_Success_(Companion_Default___.SeqPosToUInt32(x, pos))
	}
}
func (_static *CompanionStruct_Default___) BigEndianPosToU32As64(x _dafny.Sequence, pos uint64) m_Wrappers.Result {
	if (uint64((x).Cardinality())) < (m_MemoryMath.Companion_Default___.Add(pos, Companion_Default___.LENGTH__LEN64())) {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(uint64(Companion_Default___.SeqPosToUInt32(x, pos)))
	}
}
...
func (_static *CompanionStruct_Default___) StringSetAttrToBytes(ss _dafny.Sequence) m_Wrappers.Result {
	...
	if (_1_valueOrError0).IsFailure() {
		...
		var _2_sortedList _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_asSet, func(coer48 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg68 interface{}, arg69 interface{}) bool {
				return coer48(arg68.(_dafny.Char), arg69.(_dafny.Char))
			}
		}(Companion_Default___.CharLess))
		_ = _2_sortedList
		...
		if (_3_valueOrError1).IsFailure() {
			...
			_ = _4_count
			var _5_valueOrError2 m_Wrappers.Result = Companion_Default___.CollectString(_2_sortedList, _dafny.Zero, _dafny.SeqOf())
			_ = _5_valueOrError2
...
func (_static *CompanionStruct_Default___) NumberSetAttrToBytes(ns _dafny.Sequence) m_Wrappers.Result {
	...
	if (_1_valueOrError0).IsFailure() {
		...
		var _2_valueOrError1 m_Wrappers.Result = m_StandardLibrary_Sequence.Companion_Default___.MapWithResult(func(coer49 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
			return func(arg70 interface{}) m_Wrappers.Result {
				return coer49(arg70.(_dafny.Sequence))
			}
		}(func(_3_n _dafny.Sequence) m_Wrappers.Result {
			return m_DynamoDbNormalizeNumber.Companion_Default___.NormalizeNumber(_3_n)
		}), ns, _dafny.Zero, _dafny.SeqOf())
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			...
			if (_6_valueOrError2).IsFailure() {
				...
				var _7_sortedList _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_5_asSet, func(coer50 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
				...
				if (_8_valueOrError3).IsFailure() {
					...
					_ = _9_count
					var _10_valueOrError4 m_Wrappers.Result = Companion_Default___.CollectString(_7_sortedList, _dafny.Zero, _dafny.SeqOf())
					_ = _10_valueOrError4
...
func (_static *CompanionStruct_Default___) BinarySetAttrToBytes(bs _dafny.Sequence) m_Wrappers.Result {
	...
	if (_1_valueOrError0).IsFailure() {
		...
		var _2_sortedList _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_asSet, func(coer51 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
			return func(arg73 interface{}, arg74 interface{}) bool {
				return coer51(arg73.(uint8), arg74.(uint8))
			}
		...
		if (_3_valueOrError1).IsFailure() {
			...
			var _4_count _dafny.Sequence = (_3_valueOrError1).Extract().(_dafny.Sequence)
			_ = _4_count
			var _5_valueOrError2 m_Wrappers.Result = Companion_Default___.CollectBinary(_2_sortedList, _dafny.Zero, _dafny.SeqOf())
			_ = _5_valueOrError2
			if (_5_valueOrError2).IsFailure() {
				return (_5_valueOrError2).PropagateFailure()
			} else {
...
func (_static *CompanionStruct_Default___) MapAttrToBytes(m _dafny.Map, depth uint64) m_Wrappers.Result {
	var _0_bytesResults _dafny.Map = func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter18 := _dafny.Iterate((m).Keys().Elements()); ; {
			...
			if m_ComAmazonawsDynamodbTypes.Companion_AttributeName_.Is_(_1_k) {
				if (m).Contains(_1_k) {
					_coll0.Add(_1_k, Companion_Default___.AttrToBytes((m).Get(_1_k).(m_ComAmazonawsDynamodbTypes.AttributeValue), true, (depth)+(uint64(1))))
				}
			}
		}
		return _coll0.ToMap()
...
func (_static *CompanionStruct_Default___) BigEndianToU32As32(x _dafny.Sequence) m_Wrappers.Result {
	if (_dafny.IntOfUint32((x).Cardinality())).Cmp(Companion_Default___.LENGTH__LEN()) < 0 {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt32((x).Take((Companion_Default___.LENGTH__LEN()).Uint32())))
	}
}
func (_static *CompanionStruct_Default___) BigEndianToU32As64(x _dafny.Sequence) m_Wrappers.Result {
	if (_dafny.IntOfUint32((x).Cardinality())).Cmp(Companion_Default___.LENGTH__LEN()) < 0 {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(uint64(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt32((x).Take((Companion_Default___.LENGTH__LEN()).Uint32()))))
	}
}
...
func (_static *CompanionStruct_Default___) CollectString(setToSerialize _dafny.Sequence, pos _dafny.Int, serialized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((setToSerialize).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(serialized)
	} else {
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.EncodeString((setToSerialize).Select((pos).Uint32()).(_dafny.Sequence))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
...
func (_static *CompanionStruct_Default___) CollectBinary(setToSerialize _dafny.Sequence, pos _dafny.Int, serialized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((setToSerialize).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(serialized)
	} else {
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.SerializeBinaryValue((setToSerialize).Select((pos).Uint32()).(_dafny.Sequence))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
...
func (_static *CompanionStruct_Default___) CollectMap(mapToSerialize _dafny.Map, serialized _dafny.Sequence) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((mapToSerialize).Keys(), func(coer52 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg75 interface{}, arg76 interface{}) bool {
			return coer52(arg75.(_dafny.Char), arg76.(_dafny.Char))
		}
	}(Companion_Default___.CharLess))
	_ = _0_keys
	return Companion_Default___.CollectOrderedMapSubset(_0_keys, mapToSerialize, _dafny.Zero, serialized)
}
func (_static *CompanionStruct_Default___) CollectOrderedMapSubset(keys _dafny.Sequence, mapToSerialize _dafny.Map, pos _dafny.Int, serialized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(serialized)
	} else {
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.SerializeMapItem((keys).Select((pos).Uint32()).(_dafny.Sequence), (mapToSerialize).Get((keys).Select((pos).Uint32()).(_dafny.Sequence)).(_dafny.Sequence))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
...
func (_static *CompanionStruct_Default___) IsUnique(s _dafny.Sequence) bool {
	return ((func() _dafny.Set {
		...
		_ = _coll0
		for _iter19 := _dafny.Iterate((s).Elements()); ; {
...
TAIL_CALL_START:
	if (remainingCount) == (uint64(0)) {
		...
		if (_1_valueOrError1).IsFailure() {
			...
			_ = _3_serialized
			if (_dafny.IntOfUint32((_3_serialized).Cardinality())).Cmp(_dafny.IntOfUint64(_2_len)) < 0 {
		...
		if (_2_valueOrError0).IsFailure() {
			...
			if ((_0_serialized__size) - (func() uint64 { return (_4_new__pos) })()) < (_3_len) {
				...
				if (_5_valueOrError1).IsFailure() {
					...
					_ = _6_nval
					var _7_new__pos uint64 = m_MemoryMath.Companion_Default___.Add(_4_new__pos, (_6_nval).Dtor_len())
					_ = _7_new__pos
					...
					_ = _8_nattr
					var _9_nResultList AttrValueAndLength = Companion_AttrValueAndLength_.Create_AttrValueAndLength_(_8_nattr, m_MemoryMath.Companion_Default___.Add((resultList).Dtor_len(), (_7_new__pos)-(func() uint64 { return (pos) })()))
					_ = _9_nResultList
						...
						if (_13_valueOrError5).IsFailure() {
							...
							if (_14_valueOrError6).IsFailure() {
								...
								if (_17_valueOrError7).IsFailure() {
									...
									_ = _18_nval
									var _19_pos uint64 = m_MemoryMath.Companion_Default___.Add(_16_pos, (_18_nval).Dtor_len())
									_ = _19_pos
									...
									if (_20_valueOrError8).IsFailure() {
										...
										_ = _21_nattr
										var _22_newResultMap AttrValueAndLength = Companion_AttrValueAndLength_.Create_AttrValueAndLength_(_21_nattr, m_MemoryMath.Companion_Default___.Add((resultMap).Dtor_len(), (_19_pos)-(func() uint64 { return (_1_orig__pos) })()))
										_ = _22_newResultMap
	...
	if (_1_valueOrError0).IsFailure() {
		...
		if (_2_valueOrError1).IsFailure() {
			...
			var _4_pos uint64 = (func() uint64 {
				if (totalBytes).Is_None() {
					return m_MemoryMath.Companion_Default___.Add(pos, Companion_Default___.LENGTH__LEN64())
				}
				return pos
			})()
			_ = _4_pos
			...
			if ((_0_value__size) - (func() uint64 { return (_4_pos) })()) < (_3_len) {
				...
				if (_0_value__size) < (m_MemoryMath.Companion_Default___.Add(Companion_Default___.LENGTH__LEN64(), _4_pos)) {
...
func (_static *CompanionStruct_Default___) FlattenValueMap(m _dafny.Map) _dafny.Map {
	return func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter20 := _dafny.Iterate((m).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) FlattenErrors(m _dafny.Map) _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter21 := _dafny.Iterate((m).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) SimplifyMapValue(m _dafny.Map) m_Wrappers.Result {
	if _dafny.Quantifier((m).Keys().Elements(), true, func(_forall_var_0 interface{}) bool {
		...
		_ = _2_badValues
		var _3_badValueSeq _dafny.Sequence = m_StandardLibrary.Companion_Default___.SetToOrderedSequence(_2_badValues, func(coer53 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg77 interface{}, arg78 interface{}) bool {
				return coer53(arg77.(_dafny.Char), arg78.(_dafny.Char))
			}
		}(Companion_Default___.CharLess))
		_ = _3_badValueSeq
...
func (_static *CompanionStruct_Default___) UINT64__MAX() _dafny.Int {
	return _dafny.IntOfString("18446744073709551615")
}
