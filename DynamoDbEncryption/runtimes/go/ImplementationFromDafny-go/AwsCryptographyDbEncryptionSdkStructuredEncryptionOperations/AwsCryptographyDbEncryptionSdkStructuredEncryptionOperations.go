...
func (_static *CompanionStruct_Default___) ResolveAuthActions(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.ResolveAuthActionsInput) m_Wrappers.Result {
	...
	output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_ResolveAuthActionsOutput_.Create_ResolveAuthActionsOutput_(m_Canonize.Companion_Default___.UnCanon(_9_canonData, _dafny.Zero, _dafny.SeqOf())))
	return output
	return output
}
func (_static *CompanionStruct_Default___) GetBinary(data _dafny.Sequence, path _dafny.Sequence) m_Wrappers.Result {
	var _0_pos m_Wrappers.Option = Companion_Default___.FindAuth(data, path, _dafny.Zero)
	_ = _0_pos
	if (_0_pos).Is_None() {
	...
	} else if !_dafny.Companion_Sequence_.Equal((((data).Select(((_0_pos).Dtor_value().(_dafny.Int)).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_data()).Dtor_typeId(), m_StructuredEncryptionUtil.Companion_Default___.BYTES__TYPE__ID()) {
	...
	} else if !(((data).Select(((_0_pos).Dtor_value().(_dafny.Int)).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_AuthenticateAction_.Create_DO__NOT__SIGN_()) {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(((data).Select(((_0_pos).Dtor_value().(_dafny.Int)).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_data())
	}
}
func (_static *CompanionStruct_Default___) SumValueSize(fields _dafny.Sequence) _dafny.Int {
	var _hresult _dafny.Int = _dafny.Zero
	_ = _hresult
	...
	_ = _lo0
	for _1_i := _dafny.IntOfUint32((fields).Cardinality()); _lo0.Cmp(_1_i) < 0; {
		_1_i = _1_i.Minus(_dafny.One)
		if (((fields).Select((_1_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_ENCRYPT__AND__SIGN_()) {
			_0_sum = (_dafny.IntOfUint32(((((fields).Select((_1_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data()).Dtor_value()).Cardinality())).Plus(_0_sum)
		}
	}
	_hresult = _0_sum
	return _hresult
...
func (_static *CompanionStruct_Default___) GetStructuredEncryptionMaterials(cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager, encryptionContext m_Wrappers.Option, algorithmSuiteId m_Wrappers.Option, encryptedTerminalDataNum _dafny.Int, totalEncryptedTerminalValuesSize _dafny.Int) m_Wrappers.Result {
	...
	_ = ret
	var _0_maxLength _dafny.Int
	_ = _0_maxLength
	_0_maxLength = ((encryptedTerminalDataNum).Times(_dafny.IntOfInt64(2))).Plus(totalEncryptedTerminalValuesSize)
	var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _1_valueOrError0
	_1_valueOrError0 = m_Wrappers.Companion_Default___.Need((_0_maxLength).Cmp(m_StandardLibrary_UInt.Companion_Default___.INT64__MAX__LIMIT()) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Encrypted Size too long.")))
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_matR).MapFailure(func(coer26 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg38 interface{}) interface{} {
			return coer26(arg38.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContextCanon(schema _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_canonAttrs
	_0_canonAttrs = m_Seq.Companion_Default___.Filter(func(coer27 func(m_StructuredEncryptionUtil.CanonCryptoItem) bool) func(interface{}) bool {
		return func(arg39 interface{}) bool {
			return coer27(arg39.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
	...
	_ = _2_contextAttrs
	_2_contextAttrs = m_Seq.Companion_Default___.Map(func(coer28 func(m_StructuredEncryptionUtil.CanonCryptoItem) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) func(interface{}) interface{} {
		return func(arg40 interface{}) interface{} {
			return coer28(arg40.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContext(schema _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_contextAttrs
	_0_contextAttrs = m_Seq.Companion_Default___.Filter(func(coer29 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) bool) func(interface{}) bool {
		return func(arg41 interface{}) bool {
			return coer29(arg41.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
		}
...
func (_static *CompanionStruct_Default___) Find(haystack _dafny.Sequence, needle _dafny.Sequence, start _dafny.Int) m_Wrappers.Result {
	var res m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.Zero)
	_ = res
	var _hi0 _dafny.Int = _dafny.IntOfUint32((haystack).Cardinality())
	_ = _hi0
	for _0_i := _dafny.Zero; _0_i.Cmp(_hi0) < 0; _0_i = _0_i.Plus(_dafny.One) {
		if _dafny.Companion_Sequence_.Equal(((haystack).Select((_0_i).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key(), needle) {
...
func (_static *CompanionStruct_Default___) FindAuth(haystack _dafny.Sequence, needle _dafny.Sequence, start _dafny.Int) m_Wrappers.Option {
	var res m_Wrappers.Option = m_Wrappers.Companion_Option_.Default()
	_ = res
	var _hi0 _dafny.Int = _dafny.IntOfUint32((haystack).Cardinality())
	_ = _hi0
	for _0_i := _dafny.Zero; _0_i.Cmp(_hi0) < 0; _0_i = _0_i.Plus(_dafny.One) {
		if _dafny.Companion_Sequence_.Equal(((haystack).Select((_0_i).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_key(), needle) {
...
func (_static *CompanionStruct_Default___) CountEncrypted(list _dafny.Sequence) _dafny.Int {
	var _hresult _dafny.Int = _dafny.Zero
	_ = _hresult
	var _0_result _dafny.Int
	_ = _0_result
	_0_result = _dafny.Zero
	var _lo0 _dafny.Int = _dafny.Zero
	_ = _lo0
	for _1_i := _dafny.IntOfUint32((list).Cardinality()); _lo0.Cmp(_1_i) < 0; {
		_1_i = _1_i.Minus(_dafny.One)
		if (((list).Select((_1_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_ENCRYPT__AND__SIGN_()) {
			_0_result = (_0_result).Plus(_dafny.One)
		}
	}
	_hresult = _0_result
	return _hresult
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContext2(fields _dafny.Sequence) m_Wrappers.Result {
	...
	var _hi0 _dafny.Int = _dafny.IntOfUint32((fields).Cardinality())
	_ = _hi0
	for _1_i := _dafny.Zero; _1_i.Cmp(_hi0) < 0; _1_i = _1_i.Plus(_dafny.One) {
		var _2_keyVal _dafny.Sequence
		_ = _2_keyVal
		_2_keyVal = _dafny.Companion_Sequence_.Concatenate(m_StructuredEncryptionUtil.Companion_Default___.ATTR__PREFIX(), m_StructuredEncryptionPaths.Companion_Default___.PathToString(((fields).Select((_1_i).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key()))
		var _3_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_UTF8.Companion_ValidUTF8Bytes_.Witness())
		_ = _3_valueOrError0
		_3_valueOrError0 = (m_UTF8.Encode(_2_keyVal)).MapFailure(func(coer30 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
			return func(arg42 interface{}) interface{} {
				return coer30(arg42.(_dafny.Sequence))
			}
		...
		_0_fieldMap = (_0_fieldMap).Update(_5_utf8Value, ((fields).Select((_1_i).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key())
	}
	var _6_keys _dafny.Sequence
	_ = _6_keys
	_6_keys = m_SortedSets.SetToOrderedSequence2((_0_fieldMap).Keys(), func(coer31 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg43 interface{}, arg44 interface{}) bool {
			return coer31(arg43.(uint8), arg44.(uint8))
		}
	...
	var _hi1 _dafny.Int = _dafny.IntOfUint32((_6_keys).Cardinality())
	_ = _hi1
	for _9_i := _dafny.Zero; _9_i.Cmp(_hi1) < 0; _9_i = _9_i.Plus(_dafny.One) {
		var _10_fieldUtf8 _dafny.Sequence
		_ = _10_fieldUtf8
		_10_fieldUtf8 = (_6_keys).Select((_9_i).Uint32()).(_dafny.Sequence)
		var _11_fieldStr _dafny.Sequence
		_ = _11_fieldStr
		_11_fieldStr = (_0_fieldMap).Get(_10_fieldUtf8).(_dafny.Sequence)
		var _12_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.Zero)
		_ = _12_valueOrError1
		_12_valueOrError1 = Companion_Default___.Find(fields, (_0_fieldMap).Get(_10_fieldUtf8).(_dafny.Sequence), _dafny.Zero)
		if (_12_valueOrError1).IsFailure() {
			output = (_12_valueOrError1).PropagateFailure()
			return output
		}
		var _13_item _dafny.Int
		_ = _13_item
		_13_item = (_12_valueOrError1).Extract().(_dafny.Int)
		var _14_attr m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal
		_ = _14_attr
		_14_attr = ((fields).Select((_13_item).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_data()
		...
		if _dafny.Companion_Sequence_.Equal((_14_attr).Dtor_typeId(), m_StructuredEncryptionUtil.Companion_Default___.NULL()) {
			...
			if !(!((_18_valueOrError3).IsFailure())) {
				panic("dafny/StructuredEncryption/src/AwsCryptographyDbEncryptionSdkStructuredEncryptionOperations.dfy(417,18): " + (_18_valueOrError3).String())
			}
			...
			_ = _21_valueOrError5
			_21_valueOrError5 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32(((_14_attr).Dtor_value()).Cardinality())).Cmp(_dafny.One) == 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Internal Error : boolean was not of length 1.")))
			if (_21_valueOrError5).IsFailure() {
				output = (_21_valueOrError5).PropagateFailure()
				return output
			}
			if (((_14_attr).Dtor_value()).Select(0).(uint8)) == (uint8(0)) {
	...
	_ = _22_valueOrError6
	_22_valueOrError6 = (m_UTF8.Encode(_8_legend)).MapFailure(func(coer32 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg45 interface{}) interface{} {
			return coer32(arg45.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) BuildCryptoMap2(keys _dafny.Sequence, plaintextStructure _dafny.Map, cryptoSchema _dafny.Map, pos _dafny.Int, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(acc)
	} else {
		var _0_key _dafny.Sequence = (keys).Select((pos).Uint32()).(_dafny.Sequence)
		_ = _0_key
		...
		_ = _in2
		var _in3 _dafny.Int = (pos).Plus(_dafny.One)
		_ = _in3
...
func (_static *CompanionStruct_Default___) BuildCryptoMap(plaintextStructure _dafny.Map, cryptoSchema _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((plaintextStructure).Keys(), func(coer33 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg46 interface{}, arg47 interface{}) bool {
			return coer33(arg46.(_dafny.Char), arg47.(_dafny.Char))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_keys
	return Companion_Default___.BuildCryptoMap2(_0_keys, plaintextStructure, cryptoSchema, _dafny.Zero, _dafny.SeqOf())
}
func (_static *CompanionStruct_Default___) BuildAuthMap2(keys _dafny.Sequence, plaintextStructure _dafny.Map, authSchema _dafny.Map, pos _dafny.Int, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(acc)
...
func (_static *CompanionStruct_Default___) BuildAuthMap(plaintextStructure _dafny.Map, authSchema _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((plaintextStructure).Keys(), func(coer34 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg48 interface{}, arg49 interface{}) bool {
			return coer34(arg48.(_dafny.Char), arg49.(_dafny.Char))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_keys
	return Companion_Default___.BuildAuthMap2(_0_keys, plaintextStructure, authSchema, _dafny.Zero, _dafny.SeqOf())
}
func (_static *CompanionStruct_Default___) UnBuildCryptoMap(list _dafny.Sequence, pos _dafny.Int, dataSoFar _dafny.Map, actionsSoFar _dafny.Map) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((list).Cardinality())).Cmp(pos) == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(dataSoFar, actionsSoFar))
	} else {
		var _0_valueOrError0 m_Wrappers.Result = m_StructuredEncryptionPaths.Companion_Default___.UniPathToString(((list).Select((pos).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key())
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			...
			if (_2_valueOrError1).IsFailure() {
			...
			} else if m_StructuredEncryptionUtil.Companion_Default___.IsAuthAttr(((list).Select((pos).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_action()) {
				var _in0 _dafny.Sequence = list
				_ = _in0
				var _in1 _dafny.Int = (pos).Plus(_dafny.One)
				_ = _in1
				var _in2 _dafny.Map = (dataSoFar).Update(_1_key, ((list).Select((pos).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_data())
				_ = _in2
				var _in3 _dafny.Map = (actionsSoFar).Update(_1_key, ((list).Select((pos).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_action())
				_ = _in3
				list = _in0
				pos = _in1
				dataSoFar = _in2
				...
				_ = _in4
				var _in5 _dafny.Int = (pos).Plus(_dafny.One)
				_ = _in5
				var _in6 _dafny.Map = (dataSoFar).Update(_1_key, ((list).Select((pos).Uint32()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_data())
				_ = _in6
...
func (_static *CompanionStruct_Default___) EncryptStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptStructureInput) m_Wrappers.Result {
	...
	_ = _6_valueOrError3
	_6_valueOrError3 = m_Wrappers.Companion_Default___.Need(_dafny.Quantifier(((_5_pathOutput).Dtor_encryptedStructure()).UniqueElements(), true, func(_forall_var_0 m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) bool {
		var _7_k m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem
		_7_k = interface{}(_forall_var_0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)
		return !(_dafny.Companion_Sequence_.Contains((_5_pathOutput).Dtor_encryptedStructure(), _7_k)) || ((_dafny.IntOfUint32(((_7_k).Dtor_key()).Cardinality())).Cmp(_dafny.One) == 0)
	}), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Internal Error")))
	if (_6_valueOrError3).IsFailure() {
		output = (_6_valueOrError3).PropagateFailure()
		return output
	}
	var _8_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf(_dafny.EmptyMap, _dafny.EmptyMap))
	_ = _8_valueOrError4
	_8_valueOrError4 = Companion_Default___.UnBuildCryptoMap((_5_pathOutput).Dtor_encryptedStructure(), _dafny.Zero, _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap())
	if (_8_valueOrError4).IsFailure() {
		output = (_8_valueOrError4).PropagateFailure()
		return output
	}
	var _9_parts _dafny.Tuple
	_ = _9_parts
	_9_parts = (_8_valueOrError4).Extract().(_dafny.Tuple)
	var _10_plainOutput m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptStructureOutput
	_ = _10_plainOutput
	_10_plainOutput = m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_EncryptStructureOutput_.Create_EncryptStructureOutput_((*(_9_parts).IndexInt(0)).(_dafny.Map), (*(_9_parts).IndexInt(1)).(_dafny.Map), (_5_pathOutput).Dtor_parsedHeader())
	output = m_Wrappers.Companion_Result_.Create_Success_(_10_plainOutput)
	return output
	return output
}
func (_static *CompanionStruct_Default___) EncryptPathStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptPathStructureInput) m_Wrappers.Result {
	...
	if _dafny.Quantifier(((input).Dtor_plaintextStructure()).UniqueElements(), false, func(_exists_var_3 m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) bool {
		...
		if ((_14_newEncryptionContext).Cardinality()).Sign() != 0 {
			...
			_ = _16_contextKeysX
			_16_contextKeysX = m_SortedSets.SetToOrderedSequence2((_14_newEncryptionContext).Keys(), func(coer35 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
				return func(arg50 interface{}, arg51 interface{}) bool {
					return coer35(arg50.(uint8), arg51.(uint8))
				}
			}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
			...
			_ = _19_valueOrError8
			_19_valueOrError8 = (_18_cmmR).MapFailure(func(coer36 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
				return func(arg52 interface{}) interface{} {
					return coer36(arg52.(m_AwsCryptographyMaterialProvidersTypes.Error))
				}
	...
	_ = _out3
	_out3 = m_Random.Companion_Default___.GenerateBytes((m_StructuredEncryptionUtil.Companion_Default___.MSGID__LEN()).Int32())
	_26_randBytes = _out3
	var _27_valueOrError11 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _27_valueOrError11
	_27_valueOrError11 = (_26_randBytes).MapFailure(func(coer37 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg53 interface{}) interface{} {
			return coer37(arg53.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	_37_valueOrError15 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((_9_canonData).Cardinality())).Cmp((m_StandardLibrary_UInt.Companion_Default___.UINT32__LIMIT()).DivBy(_dafny.IntOfInt64(3))) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too many encrypted fields")))
...
func (_static *CompanionStruct_Default___) DescribeMismatch(inputFields _dafny.Sequence, inputContext _dafny.Map, headContext _dafny.Map) _dafny.Sequence {
	...
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((inputFields).Cardinality())).Sign() == 0 {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOfString(""))
	} else {
		var _1_key _dafny.Sequence = (inputFields).Select(0).(_dafny.Sequence)
		_ = _1_key
		if ((headContext).Contains(_1_key)) && (!_dafny.Companion_Sequence_.Equal((headContext).Get(_1_key).(_dafny.Sequence), (inputContext).Get(_1_key).(_dafny.Sequence))) {
			...
			var _in0 _dafny.Sequence = (inputFields).Drop(1)
			_ = _in0
			...
			var _in3 _dafny.Sequence = (inputFields).Drop(1)
			_ = _in3
...
func (_static *CompanionStruct_Default___) DetectMismatch(inputContext _dafny.Map, headContext _dafny.Map) m_Wrappers.Outcome {
	var _0_inputFields _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((inputContext).Keys(), func(coer38 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg54 interface{}, arg55 interface{}) bool {
			return coer38(arg54.(uint8), arg55.(uint8))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
	_ = _0_inputFields
	var _1_str _dafny.Sequence = Companion_Default___.DescribeMismatch(_0_inputFields, inputContext, headContext)
	_ = _1_str
	if (_dafny.IntOfUint32((_1_str).Cardinality())).Sign() == 0 {
...
func (_static *CompanionStruct_Default___) NewCmm(config Config, cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager, context _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_contextKeysX
	_0_contextKeysX = m_SortedSets.SetToOrderedSequence2((context).Keys(), func(coer39 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg56 interface{}, arg57 interface{}) bool {
			return coer39(arg56.(uint8), arg57.(uint8))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
	...
	_ = _3_valueOrError0
	_3_valueOrError0 = (_2_cmmR).MapFailure(func(coer40 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg58 interface{}) interface{} {
			return coer40(arg58.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) DecryptStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptStructureInput) m_Wrappers.Result {
	...
	_ = _6_valueOrError3
	_6_valueOrError3 = Companion_Default___.UnBuildCryptoMap((_5_pathOutput).Dtor_plaintextStructure(), _dafny.Zero, _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap())
	if (_6_valueOrError3).IsFailure() {
		output = (_6_valueOrError3).PropagateFailure()
		return output
	}
...
func (_static *CompanionStruct_Default___) DecryptPathStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptPathStructureInput) m_Wrappers.Result {
	...
	if ((_8_head).Dtor_version()) == (uint8(2)) {
		...
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.GetV2EncryptionContext(m_Canonize.Companion_Default___.UnCanon(_13_canonData, _dafny.Zero, _dafny.SeqOf()))
		...
		if ((_17_newEncryptionContext).Cardinality()).Sign() != 0 {
			...
			_ = _19_contextKeysX
			_19_contextKeysX = m_SortedSets.SetToOrderedSequence2((_17_newEncryptionContext).Keys(), func(coer41 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
				return func(arg59 interface{}, arg60 interface{}) bool {
					return coer41(arg59.(uint8), arg60.(uint8))
				}
			}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
			...
			_22_valueOrError10 = (_21_cmmR).MapFailure(func(coer42 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
				return func(arg61 interface{}) interface{} {
					return coer42(arg61.(m_AwsCryptographyMaterialProvidersTypes.Error))
				}
	...
	_25_valueOrError11 = (_24_matR).MapFailure(func(coer43 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg62 interface{}) interface{} {
			return coer43(arg62.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
