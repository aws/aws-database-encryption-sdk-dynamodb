...
func (_static *CompanionStruct_Default___) Below(x _dafny.Sequence, y _dafny.Sequence) bool {
	...
	_ = _hresult
	if (m_StandardLibrary_UInt.Companion_Default___.HasUint64Len(x)) && (m_StandardLibrary_UInt.Companion_Default___.HasUint64Len(y)) {
	...
	if (_dafny.IntOfUint32((y).Cardinality())).Sign() == 0 {
		_hresult = false
		return _hresult
	}
	var _hi0 _dafny.Int = _dafny.IntOfUint32((x).Cardinality())
	_ = _hi0
	for _0_i := _dafny.Zero; _0_i.Cmp(_hi0) < 0; _0_i = _0_i.Plus(_dafny.One) {
		if (_dafny.IntOfUint32((y).Cardinality())).Cmp(_0_i) <= 0 {
			_hresult = false
			return _hresult
		} else if ((y).Select((_0_i).Uint32()).(uint8)) < ((x).Select((_0_i).Uint32()).(uint8)) {
			_hresult = false
			return _hresult
		} else if ((x).Select((_0_i).Uint32()).(uint8)) < ((y).Select((_0_i).Uint32()).(uint8)) {
			_hresult = true
			return _hresult
		} else {
		}
...
func (_static *CompanionStruct_Default___) AuthSort(x _dafny.Sequence) _dafny.Sequence {
	...
	_ = result
	result = m_OptimizedMergeSort.Companion_Default___.MergeSortNat(x, func(coer17 func(m_StructuredEncryptionUtil.CanonAuthItem, m_StructuredEncryptionUtil.CanonAuthItem) bool) func(interface{}, interface{}) bool {
		return func(arg27 interface{}, arg28 interface{}) bool {
			return coer17(arg27.(m_StructuredEncryptionUtil.CanonAuthItem), arg28.(m_StructuredEncryptionUtil.CanonAuthItem))
		}
...
func (_static *CompanionStruct_Default___) CryptoSort(x _dafny.Sequence) _dafny.Sequence {
	var result _dafny.Sequence = _dafny.EmptySeq
	_ = result
	result = m_OptimizedMergeSort.Companion_Default___.MergeSortNat(x, func(coer18 func(m_StructuredEncryptionUtil.CanonCryptoItem, m_StructuredEncryptionUtil.CanonCryptoItem) bool) func(interface{}, interface{}) bool {
		return func(arg29 interface{}, arg30 interface{}) bool {
			return coer18(arg29.(m_StructuredEncryptionUtil.CanonCryptoItem), arg30.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
