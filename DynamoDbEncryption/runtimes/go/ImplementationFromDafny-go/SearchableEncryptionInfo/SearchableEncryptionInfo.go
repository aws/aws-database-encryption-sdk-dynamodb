...
func (_static *CompanionStruct_Default___) GetBeaconKey(client *m_AtomicPrimitives.AtomicPrimitivesClient, key _dafny.Sequence, name _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_valueOrError0
	_0_valueOrError0 = (m_UTF8.Encode(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("AWS_DBE_SCAN_BEACON"), name))).MapFailure(func(coer104 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg135 interface{}) interface{} {
			return coer104(arg135.(_dafny.Sequence))
		}
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_keyR).MapFailure(func(coer105 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg136 interface{}) interface{} {
			return coer105(arg136.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) GenerateUuidBytes() m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_uuid_q).MapFailure(func(coer106 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg137 interface{}) interface{} {
			return coer106(arg137.(_dafny.Sequence))
		}
	...
	output = (m_UUID.ToByteArray(_3_uuid)).MapFailure(func(coer107 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg138 interface{}) interface{} {
			return coer107(arg138.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) MakeBeaconVersion(version uint8, keySource KeySource, beacons _dafny.Map, virtualFields _dafny.Map, actions _dafny.Map) m_Wrappers.Result {
	var _0_beaconNames _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((beacons).Keys(), func(coer108 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg139 interface{}, arg140 interface{}) bool {
			return coer108(arg139.(_dafny.Char), arg140.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_beaconNames
	var _1_stdKeys _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer109 func(_dafny.Sequence) bool) func(interface{}) bool {
		return func(arg141 interface{}) bool {
			return coer109(arg141.(_dafny.Sequence))
		}
	...
	var _4_encrypted _dafny.Set = func() _dafny.Set {
		...
		_ = _coll0
		for _iter27 := _dafny.Iterate((actions).Keys().Elements()); ; {
...
func (_this KeySource) GetKeysCache(client *m_AtomicPrimitives.AtomicPrimitivesClient, stdNames _dafny.Sequence, keyId _dafny.Sequence, cacheTTL int64, partitionIdBytes _dafny.Sequence, logicalKeyStoreNameBytes _dafny.Sequence, now int64) m_Wrappers.Result {
	{
		...
		_ = _3_valueOrError0
		_3_valueOrError0 = (_2_keyIdBytesR).MapFailure(func(coer110 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg142 interface{}) interface{} {
				return coer110(arg142.(_dafny.Sequence))
			}
		}(func(_4_e _dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
		...
		_ = _11_valueOrError1
		_11_valueOrError1 = (_10_maybeCacheDigest).MapFailure(func(coer111 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg143 interface{}) interface{} {
				return coer111(arg143.(m_AwsCryptographyPrimitivesTypes.Error))
			}
		...
		if ((_15_getCacheOutput).Is_Failure()) || (!((_this).CacheEntryWithinLimits(((_15_getCacheOutput).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.GetCacheEntryOutput)).Dtor_creationTime(), now, cacheTTL))) {
			...
			_ = _17_valueOrError2
			_17_valueOrError2 = (_16_maybeRawBeaconKeyMaterials).MapFailure(func(coer112 func(m_AwsCryptographyKeyStoreTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg144 interface{}) interface{} {
					return coer112(arg144.(m_AwsCryptographyKeyStoreTypes.Error))
				}
...
func (_this BeaconVersion) ListSignedBeacons() _dafny.Sequence {
	{
		return m_Seq.Companion_Default___.Filter(func(coer113 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg145 interface{}) bool {
				return coer113(arg145.(_dafny.Sequence))
			}
