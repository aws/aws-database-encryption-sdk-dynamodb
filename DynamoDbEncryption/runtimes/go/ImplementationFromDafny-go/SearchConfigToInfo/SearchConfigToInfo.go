...
func (_static *CompanionStruct_Default___) MakeKeySource(outer m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTableEncryptionConfig, keyStore m_AwsCryptographyKeyStoreTypes.IKeyStoreClient, config m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconKeySource, client *m_AtomicPrimitives.AtomicPrimitivesClient) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_mplR).MapFailure(func(coer130 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg167 interface{}) interface{} {
			return coer130(arg167.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	...
	if (_4_cacheType).Is_Shared() {
		...
		_ = _8_valueOrError1
		_8_valueOrError1 = (_7_maybeCache).MapFailure(func(coer131 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg168 interface{}) interface{} {
				return coer131(arg168.(m_AwsCryptographyMaterialProvidersTypes.Error))
			}
	...
	if ((config).Is_multi()) && ((((config).Dtor_multi()).Dtor_partitionId()).Is_Some()) {
		...
		_ = _11_valueOrError2
		_11_valueOrError2 = (m_UTF8.Encode((((config).Dtor_multi()).Dtor_partitionId()).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer132 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg169 interface{}) interface{} {
				return coer132(arg169.(_dafny.Sequence))
			}
		...
		_ = _13_valueOrError3
		_13_valueOrError3 = (m_UTF8.Encode((((config).Dtor_single()).Dtor_partitionId()).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer133 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg170 interface{}) interface{} {
				return coer133(arg170.(_dafny.Sequence))
			}
	...
	_ = _17_valueOrError5
	_17_valueOrError5 = (_16_getKeyStoreInfoOutput_q).MapFailure(func(coer134 func(m_AwsCryptographyKeyStoreTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg171 interface{}) interface{} {
			return coer134(arg171.(m_AwsCryptographyKeyStoreTypes.Error))
		}
	...
	_ = _21_valueOrError6
	_21_valueOrError6 = (m_UTF8.Encode(_20_logicalKeyStoreName)).MapFailure(func(coer135 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg172 interface{}) interface{} {
			return coer135(arg172.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) ConvertVersion(outer m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTableEncryptionConfig, config m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconVersion) m_Wrappers.Result {
	...
	var _3_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _3_valueOrError2
	_3_valueOrError2 = (_2_maybePrimitives).MapFailure(func(coer136 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg173 interface{}) interface{} {
			return coer136(arg173.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) FindVirtualFieldWithThisLocation(fields _dafny.Map, locs _dafny.Set) m_Wrappers.Option {
	var _0_badNames _dafny.Set = func() _dafny.Set {
		...
		_ = _coll0
		for _iter34 := _dafny.Iterate((fields).Keys().Elements()); ; {
	...
	if ((_0_badNames).Cardinality()).Sign() == 0 {
		...
		var _2_badSeq _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_badNames, func(coer137 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg174 interface{}, arg175 interface{}) bool {
				return coer137(arg174.(_dafny.Char), arg175.(_dafny.Char))
			}
...
func (_static *CompanionStruct_Default___) ExistsConstructorWithTheseRequired(cons _dafny.Sequence, locs _dafny.Set) bool {
	return (Companion_Default___.SeqCount(func(coer138 func(m_CompoundBeacon.Constructor) bool) func(interface{}) bool {
		return func(arg176 interface{}) bool {
			return coer138(arg176.(m_CompoundBeacon.Constructor))
		}
...
func (_static *CompanionStruct_Default___) GetPartsString(c m_CompoundBeacon.Constructor) _dafny.Sequence {
	var _0_req _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer139 func(m_CompoundBeacon.ConstructorPart) bool) func(interface{}) bool {
		return func(arg177 interface{}) bool {
			return coer139(arg177.(m_CompoundBeacon.ConstructorPart))
		}
	}(func(_1_p m_CompoundBeacon.ConstructorPart) bool {
		return (_1_p).Dtor_required()
	}), (c).Dtor_parts())
	_ = _0_req
	var _2_names _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer140 func(m_CompoundBeacon.ConstructorPart) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg178 interface{}) interface{} {
			return coer140(arg178.(m_CompoundBeacon.ConstructorPart))
		}
...
func (_static *CompanionStruct_Default___) FindBeaconWithThisLocation(beacons _dafny.Map, loc _dafny.Sequence) m_Wrappers.Option {
	var _0_badNames _dafny.Set = func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter35 := _dafny.Iterate((beacons).Keys().Elements()); ; {
	...
	if ((_0_badNames).Cardinality()).Sign() == 0 {
		...
		var _2_badSeq _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_badNames, func(coer141 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg179 interface{}, arg180 interface{}) bool {
				return coer141(arg179.(_dafny.Char), arg180.(_dafny.Char))
			}
		}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
		_ = _2_badSeq
		return m_Wrappers.Companion_Option_.Create_Some_((_2_badSeq).Select(0).(_dafny.Sequence))
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((c).Cardinality())).Sign() == 0 {
		...
		var _0_thePart _dafny.Sequence = Companion_Default___.MyFilter(func(coer142 func(m_CompoundBeacon.BeaconPart) bool) func(interface{}) bool {
			return func(arg181 interface{}) bool {
				return coer142(arg181.(m_CompoundBeacon.BeaconPart))
			}
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((constructors).Cardinality())).Sign() == 0 {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			var _1_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((Companion_Default___.SeqCount(func(coer143 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.ConstructorPart) bool) func(interface{}) bool {
				return func(arg182 interface{}) bool {
					return coer143(arg182.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.ConstructorPart))
				}
...
func (_static *CompanionStruct_Default___) CheckBeacons(data _dafny.Map) m_Wrappers.Result {
	var _0_beaconNames _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((data).Keys(), func(coer144 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg183 interface{}, arg184 interface{}) bool {
			return coer144(arg183.(_dafny.Char), arg184.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_beaconNames
...
func (_this PartSet) GetSetAsString(strings _dafny.Set) _dafny.Sequence {
	{
		var _0_names _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(strings, func(coer145 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg185 interface{}, arg186 interface{}) bool {
				return coer145(arg185.(_dafny.Char), arg186.(_dafny.Char))
			}
		}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
		_ = _0_names
