		...
		if (_3_valueOrError1).IsFailure() {
			...
			if (_4_valueOrError2).IsFailure() {
				...
				if (_6_valueOrError3).IsFailure() {
					...
					var _7_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((context).Keys(), func(coer54 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
						return func(arg79 interface{}, arg80 interface{}) bool {
							return coer54(arg79.(uint8), arg80.(uint8))
						}
					...
					if (context).Contains(m_StructuredEncryptionUtil.Companion_Default___.LEGEND__UTF8()) {
						...
						if (_8_valueOrError4).IsFailure() {
							...
							_ = _9_legend
							var _10_valueOrError5 m_Wrappers.Result = Companion_Default___.GetV2AttrMap(_7_keys, context, _9_legend, _dafny.Zero, _dafny.Zero, _dafny.NewMapBuilder().ToMap())
							_ = _10_valueOrError5
...
func (_static *CompanionStruct_Default___) GetV2AttrMap(keys _dafny.Sequence, context _dafny.Map, legend _dafny.Sequence, keyPos _dafny.Int, legendPos _dafny.Int, attrMap _dafny.Map) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Cmp(keyPos) == 0 {
		if (_dafny.IntOfUint32((legend).Cardinality())).Cmp(legendPos) == 0 {
		...
		var _0_key _dafny.Sequence = (keys).Select((keyPos).Uint32()).(_dafny.Sequence)
		_ = _0_key
		if _dafny.Companion_Sequence_.IsProperPrefixOf(m_StructuredEncryptionUtil.Companion_Default___.EC__ATTR__PREFIX(), _0_key) {
			var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((legendPos).Cmp(_dafny.IntOfUint32((legend).Cardinality())) < 0, _dafny.SeqOfString("Encryption Context Legend is too short."))
			_ = _1_valueOrError0
			if (_1_valueOrError0).IsFailure() {
				return (_1_valueOrError0).PropagateFailure()
			} else {
				...
				if (_2_valueOrError1).IsFailure() {
					...
					_ = _3_attrName
					var _4_valueOrError2 m_Wrappers.Result = Companion_Default___.GetAttrValue((context).Get(_0_key).(_dafny.Sequence), (legend).Select((legendPos).Uint32()).(_dafny.Char))
					_ = _4_valueOrError2
					if (_4_valueOrError2).IsFailure() {
						return (_4_valueOrError2).PropagateFailure()
					} else {
						...
						_ = _in2
						var _in3 _dafny.Int = (keyPos).Plus(_dafny.One)
						_ = _in3
						var _in4 _dafny.Int = (legendPos).Plus(_dafny.One)
						_ = _in4
			...
			_ = _in8
			var _in9 _dafny.Int = (keyPos).Plus(_dafny.One)
			_ = _in9
			var _in10 _dafny.Int = legendPos
			_ = _in10
