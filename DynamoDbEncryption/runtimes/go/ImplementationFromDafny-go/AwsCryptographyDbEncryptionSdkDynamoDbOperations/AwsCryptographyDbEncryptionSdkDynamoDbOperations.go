...
Lmatch0:
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (m_StructuredEncryptionHeader.Companion_Default___.PartialDeserialize(_0_header)).MapFailure(func(coer77 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg108 interface{}) interface{} {
			return coer77(arg108.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	for _9_i := _dafny.Zero; _9_i.Cmp(_hi0) < 0; _9_i = _9_i.Plus(_dafny.One) {
		...
		_ = _10_valueOrError2
		_10_valueOrError2 = (m_UTF8.Decode(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_keyProviderId())).MapFailure(func(coer78 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg109 interface{}) interface{} {
				return coer78(arg109.(_dafny.Sequence))
			}
		...
		if _dafny.Companion_Sequence_.IsPrefixOf(_dafny.SeqOfString("aws-kms"), _12_extractedKeyProviderId) {
			...
			_ = _17_valueOrError4
			_17_valueOrError4 = (m_UTF8.Decode(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_keyProviderInfo())).MapFailure(func(coer79 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg110 interface{}) interface{} {
					return coer79(arg110.(_dafny.Sequence))
				}
			...
			if _dafny.Companion_Sequence_.Equal(_12_extractedKeyProviderId, _dafny.SeqOfString("aws-kms-hierarchy")) {
				...
				_ = _20_valueOrError5
				_20_valueOrError5 = (m_EdkWrapping.Companion_Default___.GetProviderWrappedMaterial(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_ciphertext(), _16_algorithmSuite)).MapFailure(func(coer80 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg111 interface{}) interface{} {
						return coer80(arg111.(m_AwsCryptographyMaterialProvidersTypes.Error))
					}
				...
				_ = _28_valueOrError8
				_28_valueOrError8 = (m_UUID.FromByteArray(_27_branchKeyVersionUuid)).MapFailure(func(coer81 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg112 interface{}) interface{} {
						return coer81(arg112.(_dafny.Sequence))
					}
