...
func (_static *CompanionStruct_Default___) ConstantTimeCompare(a _dafny.Sequence, b _dafny.Sequence, pos _dafny.Int, acc uint8) uint8 {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((a).Cardinality())).Cmp(pos) == 0 {
		return acc
	} else {
		var _0_x uint8 = (uint8((a).Select((pos).Uint32()).(uint8))) ^ (uint8((b).Select((pos).Uint32()).(uint8)))
		_ = _0_x
...
func (_static *CompanionStruct_Default___) ConstantTimeEquals(a _dafny.Sequence, b _dafny.Sequence) bool {
	return (Companion_Default___.ConstantTimeCompare(a, b, _dafny.Zero, uint8(0))) == (uint8(0))
}
...
func (_static *CompanionStruct_Default___) EcAsString(ec _dafny.Map) _dafny.Map {
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		if !(!((_3_valueOrError0).IsFailure())) {
			panic("dafny/StructuredEncryption/src/Util.dfy(292,17): " + (_3_valueOrError0).String())
		}
		...
		if !(!((_5_valueOrError1).IsFailure())) {
			panic("dafny/StructuredEncryption/src/Util.dfy(293,19): " + (_5_valueOrError1).String())
		}
...
func (_static *CompanionStruct_Default___) PrintEncryptionContext(ec _dafny.Map, name _dafny.Sequence) {
	...
	for _1_i := _dafny.Zero; _1_i.Cmp(_hi0) < 0; _1_i = _1_i.Plus(_dafny.One) {
		...
		if !(!((_2_valueOrError0).IsFailure())) {
			panic("dafny/StructuredEncryption/src/Util.dfy(304,17): " + (_2_valueOrError0).String())
		}
		...
		if !(!((_4_valueOrError1).IsFailure())) {
			panic("dafny/StructuredEncryption/src/Util.dfy(305,19): " + (_4_valueOrError1).String())
		}
