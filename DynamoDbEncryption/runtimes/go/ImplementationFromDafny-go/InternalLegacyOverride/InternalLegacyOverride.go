...
// Dafny module InternalLegacyOverride compiled into Go
...
// Definition of class InternalLegacyOverride
type InternalLegacyOverride struct {
	dummy byte
}

func New_InternalLegacyOverride_() *InternalLegacyOverride {
	_this := InternalLegacyOverride{}

	return &_this
}

type CompanionStruct_InternalLegacyOverride_ struct {
}

var Companion_InternalLegacyOverride_ = CompanionStruct_InternalLegacyOverride_{}

func (_this *InternalLegacyOverride) Equals(other *InternalLegacyOverride) bool {
	return _this == other
}

func (_this *InternalLegacyOverride) EqualsGeneric(x interface{}) bool {
	other, ok := x.(*InternalLegacyOverride)
	return ok && _this.Equals(other)
}

func (*InternalLegacyOverride) String() string {
	return "InternalLegacyOverride.InternalLegacyOverride"
}

func Type_InternalLegacyOverride_() _dafny.TypeDescriptor {
	return type_InternalLegacyOverride_{}
}

type type_InternalLegacyOverride_ struct {
}

func (_this type_InternalLegacyOverride_) Default() interface{} {
	return (*InternalLegacyOverride)(nil)
}

func (_this type_InternalLegacyOverride_) String() string {
	return "InternalLegacyOverride.InternalLegacyOverride"
}
func (_this *InternalLegacyOverride) ParentTraits_() []*_dafny.TraitID {
	return [](*_dafny.TraitID){}
}

var _ _dafny.TraitOffspring = &InternalLegacyOverride{}

func (_static *CompanionStruct_InternalLegacyOverride_) CreateBuildSuccess(value m_Wrappers.Option) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Success_(value)
}
func (_static *CompanionStruct_InternalLegacyOverride_) CreateBuildFailure(error_ m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Failure_(error_)
}
func (_static *CompanionStruct_InternalLegacyOverride_) CreateInternalLegacyOverrideSome(value *InternalLegacyOverride) m_Wrappers.Option {
	return m_Wrappers.Companion_Option_.Create_Some_(value)
}
func (_static *CompanionStruct_InternalLegacyOverride_) CreateInternalLegacyOverrideNone() m_Wrappers.Option {
	return m_Wrappers.Companion_Option_.Create_None_()
}
func (_this *InternalLegacyOverride) CreateEncryptItemSuccess(value m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.EncryptItemOutput) m_Wrappers.Result {
	{
		return m_Wrappers.Companion_Result_.Create_Success_(value)
	}
}
func (_this *InternalLegacyOverride) CreateEncryptItemFailure(error_ m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) m_Wrappers.Result {
	{
		return m_Wrappers.Companion_Result_.Create_Failure_(error_)
	}
}
func (_this *InternalLegacyOverride) CreateDecryptItemSuccess(value m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DecryptItemOutput) m_Wrappers.Result {
	{
		return m_Wrappers.Companion_Result_.Create_Success_(value)
	}
}
func (_this *InternalLegacyOverride) CreateDecryptItemFailure(error_ m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) m_Wrappers.Result {
	{
		return m_Wrappers.Companion_Result_.Create_Failure_(error_)
	}
}

// End of class InternalLegacyOverride
