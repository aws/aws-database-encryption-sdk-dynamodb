...
func (_static *CompanionStruct_Default___) MapError(r m_Wrappers.Result) m_Wrappers.Result {
	return (r).MapFailure(func(coer146 func(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
		return func(arg187 interface{}) interface{} {
			return coer146(arg187.(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) MapString(r m_Wrappers.Result) m_Wrappers.Result {
	return (r).MapFailure(func(coer147 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
		return func(arg188 interface{}) interface{} {
			return coer147(arg188.(_dafny.Sequence))
		}
