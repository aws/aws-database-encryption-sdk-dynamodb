...
using System.Linq; using System; namespace AWS.Cryptography.DynamoDbEncryption.ItemEncryptor {
 ...
 internal static AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemInput FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDecryptItemInput value) {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemInput concrete = (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemInput)value; AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemInput converted = new AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemInput();  converted.EncryptedItem = (System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput__M13_encryptedItem(concrete._encryptedItem); return converted;
}
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDecryptItemInput ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemInput value) {

 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemInput ( ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput__M13_encryptedItem(value.EncryptedItem) ) ;
}
 internal static AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemOutput FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDecryptItemOutput value) {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemOutput concrete = (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemOutput)value; AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemOutput converted = new AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemOutput();  converted.PlaintextItem = (System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput__M13_plaintextItem(concrete._plaintextItem); return converted;
}
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDecryptItemOutput ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DecryptItemOutput value) {

 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DecryptItemOutput ( ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput__M13_plaintextItem(value.PlaintextItem) ) ;
}
 internal static AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DynamoDbItemEncryptorConfig FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDynamoDbItemEncryptorConfig value) {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DynamoDbItemEncryptorConfig concrete = (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DynamoDbItemEncryptorConfig)value; AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DynamoDbItemEncryptorConfig converted = new AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DynamoDbItemEncryptorConfig();  converted.TableName = (string) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M9_tableName(concrete._tableName);
  converted.PartitionKeyName = (string) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_partitionKeyName(concrete._partitionKeyName);
 if (concrete._sortKeyName.is_Some) converted.SortKeyName = (string) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M11_sortKeyName(concrete._sortKeyName);
  converted.AttributeActions = (System.Collections.Generic.Dictionary<string, AWS.Cryptography.StructuredEncryption.CryptoAction>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_attributeActions(concrete._attributeActions);
 if (concrete._allowedUnauthenticatedAttributes.is_Some) converted.AllowedUnauthenticatedAttributes = (System.Collections.Generic.List<string>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M32_allowedUnauthenticatedAttributes(concrete._allowedUnauthenticatedAttributes);
 if (concrete._allowedUnauthenticatedAttributePrefix.is_Some) converted.AllowedUnauthenticatedAttributePrefix = (string) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M37_allowedUnauthenticatedAttributePrefix(concrete._allowedUnauthenticatedAttributePrefix);
 if (concrete._algorithmSuiteId.is_Some) converted.AlgorithmSuiteId = (AWS.Cryptography.MaterialProviders.DBEAlgorithmSuiteId) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_algorithmSuiteId(concrete._algorithmSuiteId);
 if (concrete._keyring.is_Some) converted.Keyring = (AWS.Cryptography.MaterialProviders.IKeyring) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M7_keyring(concrete._keyring);
 if (concrete._cmm.is_Some) converted.Cmm = (AWS.Cryptography.MaterialProviders.ICryptographicMaterialsManager) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M3_cmm(concrete._cmm); return converted;
}
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDynamoDbItemEncryptorConfig ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DynamoDbItemEncryptorConfig value) {
 ...
 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.DynamoDbItemEncryptorConfig ( ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M9_tableName(value.TableName) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_partitionKeyName(value.PartitionKeyName) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M11_sortKeyName(var_sortKeyName) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_attributeActions(value.AttributeActions) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M32_allowedUnauthenticatedAttributes(var_allowedUnauthenticatedAttributes) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M37_allowedUnauthenticatedAttributePrefix(var_allowedUnauthenticatedAttributePrefix) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_algorithmSuiteId(var_algorithmSuiteId) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M7_keyring(var_keyring) , ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M3_cmm(var_cmm) ) ;
}
 ...
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.Error_DynamoDbItemEncryptorException ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S30_DynamoDbItemEncryptorException (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.DynamoDbItemEncryptorException value) {

 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.Error_DynamoDbItemEncryptorException (
 ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S30_DynamoDbItemEncryptorException__M7_message(value.Message)
 ) ;
}
 internal static AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemInput FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IEncryptItemInput value) {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemInput concrete = (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemInput)value; AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemInput converted = new AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemInput();  converted.PlaintextItem = (System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput__M13_plaintextItem(concrete._plaintextItem); return converted;
}
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IEncryptItemInput ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemInput value) {

 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemInput ( ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput__M13_plaintextItem(value.PlaintextItem) ) ;
}
 internal static AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemOutput FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IEncryptItemOutput value) {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemOutput concrete = (Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemOutput)value; AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemOutput converted = new AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemOutput();  converted.EncryptedItem = (System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue>) FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput__M13_encryptedItem(concrete._encryptedItem); return converted;
}
 internal static Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IEncryptItemOutput ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput (AWS.Cryptography.DynamoDbEncryption.ItemEncryptor.EncryptItemOutput value) {

 return new Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types.EncryptItemOutput ( ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput__M13_encryptedItem(value.EncryptedItem) ) ;
}
 internal static System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput__M13_encryptedItem (Dafny.IMap<Dafny.ISequence<char>, Dafny.Com.Amazonaws.Dynamodb.Types._IAttributeValue> value) {
 ...
 internal static System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput__M13_plaintextItem (Dafny.IMap<Dafny.ISequence<char>, Dafny.Com.Amazonaws.Dynamodb.Types._IAttributeValue> value) {
 return FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S12_AttributeMap(value);
}
 ...
 internal static string FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M9_tableName (Dafny.ISequence<char> value) {
 return FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S9_TableName(value);
}
 internal static Dafny.ISequence<char> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M9_tableName (string value) {
 return ToDafny_N3_com__N9_amazonaws__N8_dynamodb__S9_TableName(value);
}
 internal static string FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_partitionKeyName (Dafny.ISequence<char> value) {
 return FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S22_KeySchemaAttributeName(value);
}
 internal static Dafny.ISequence<char> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_partitionKeyName (string value) {
 return ToDafny_N3_com__N9_amazonaws__N8_dynamodb__S22_KeySchemaAttributeName(value);
}
 internal static string FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M11_sortKeyName (Wrappers_Compile._IOption<Dafny.ISequence<char>> value) {
 return value.is_None ? (string) null : FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S22_KeySchemaAttributeName(value.Extract());
}
 internal static Wrappers_Compile._IOption<Dafny.ISequence<char>> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M11_sortKeyName (string value) {
 ...
 internal static System.Collections.Generic.Dictionary<string, AWS.Cryptography.StructuredEncryption.CryptoAction> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_attributeActions (Dafny.IMap<Dafny.ISequence<char>, Dafny.Aws.Cryptography.StructuredEncryption.Types._ICryptoAction> value) {
 ...
 internal static System.Collections.Generic.List<string> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M32_allowedUnauthenticatedAttributes (Wrappers_Compile._IOption<Dafny.ISequence<Dafny.ISequence<char>>> value) {
 ...
 internal static Wrappers_Compile._IOption<Dafny.ISequence<Dafny.ISequence<char>>> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M32_allowedUnauthenticatedAttributes (System.Collections.Generic.List<string> value) {
 ...
 internal static string FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M37_allowedUnauthenticatedAttributePrefix (Wrappers_Compile._IOption<Dafny.ISequence<char>> value) {
 return value.is_None ? (string) null : FromDafny_N6_smithy__N3_api__S6_String(value.Extract());
}
 internal static Wrappers_Compile._IOption<Dafny.ISequence<char>> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M37_allowedUnauthenticatedAttributePrefix (string value) {
 ...
 internal static AWS.Cryptography.MaterialProviders.DBEAlgorithmSuiteId FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_algorithmSuiteId (Wrappers_Compile._IOption<Dafny.Aws.Cryptography.MaterialProviders.Types._IDBEAlgorithmSuiteId> value) {
 ...
 internal static Wrappers_Compile._IOption<Dafny.Aws.Cryptography.MaterialProviders.Types._IDBEAlgorithmSuiteId> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M16_algorithmSuiteId (AWS.Cryptography.MaterialProviders.DBEAlgorithmSuiteId value) {
 ...
 internal static AWS.Cryptography.MaterialProviders.IKeyring FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M7_keyring (Wrappers_Compile._IOption<Dafny.Aws.Cryptography.MaterialProviders.Types.IKeyring> value) {
 ...
 internal static Wrappers_Compile._IOption<Dafny.Aws.Cryptography.MaterialProviders.Types.IKeyring> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M7_keyring (AWS.Cryptography.MaterialProviders.IKeyring value) {
 ...
 internal static AWS.Cryptography.MaterialProviders.ICryptographicMaterialsManager FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig__M3_cmm (Wrappers_Compile._IOption<Dafny.Aws.Cryptography.MaterialProviders.Types.ICryptographicMaterialsManager> value) {
 ...
 internal static string FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S30_DynamoDbItemEncryptorException__M7_message (Dafny.ISequence<char> value) {
 return FromDafny_N6_smithy__N3_api__S6_String(value);
}
 internal static Dafny.ISequence<char> ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S30_DynamoDbItemEncryptorException__M7_message (string value) {
 return ToDafny_N6_smithy__N3_api__S6_String(value);
}
 internal static System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput__M13_plaintextItem (Dafny.IMap<Dafny.ISequence<char>, Dafny.Com.Amazonaws.Dynamodb.Types._IAttributeValue> value) {
 return FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S12_AttributeMap(value);
}
 ...
 internal static System.Collections.Generic.Dictionary<string, Amazon.DynamoDBv2.Model.AttributeValue> FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput__M13_encryptedItem (Dafny.IMap<Dafny.ISequence<char>, Dafny.Com.Amazonaws.Dynamodb.Types._IAttributeValue> value) {
 return FromDafny_N3_com__N9_amazonaws__N8_dynamodb__S12_AttributeMap(value);
}
