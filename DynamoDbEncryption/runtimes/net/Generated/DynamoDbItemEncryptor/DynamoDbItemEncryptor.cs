...
using System;
 ...
 {
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDynamoDbItemEncryptorConfig internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S27_DynamoDbItemEncryptorConfig(input);
 ...
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IEncryptItemInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_EncryptItemInput(input);
 ...
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_EncryptItemOutput(result.dtor_value);
}
 ...
 Dafny.Aws.Cryptography.DynamoDbEncryption.ItemEncryptor.Types._IDecryptItemInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S16_DecryptItemInput(input);
 ...
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__N13_itemEncryptor__S17_DecryptItemOutput(result.dtor_value);
}
}
}
