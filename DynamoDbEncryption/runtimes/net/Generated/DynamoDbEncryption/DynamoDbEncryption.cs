...
using System;
 ...
 {
 Dafny.Aws.Cryptography.DynamoDbEncryption.Types._IDynamoDbEncryptionConfig internalInput = AWS.Cryptography.DynamoDbEncryption.TypeConversion.ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__S24_DynamoDbEncryptionConfig(input);
 ...
 Dafny.Aws.Cryptography.DynamoDbEncryption.Types._ICreateDynamoDbEncryptionBranchKeyIdSupplierInput internalInput = AWS.Cryptography.DynamoDbEncryption.TypeConversion.ToDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__S48_CreateDynamoDbEncryptionBranchKeyIdSupplierInput(input);
 ...
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return AWS.Cryptography.DynamoDbEncryption.TypeConversion.FromDafny_N3_aws__N12_cryptography__N18_dynamoDbEncryption__S49_CreateDynamoDbEncryptionBranchKeyIdSupplierOutput(result.dtor_value);
}
}
}
