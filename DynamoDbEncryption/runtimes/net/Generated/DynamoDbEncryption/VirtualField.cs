...
namespace AWS.Cryptography.DbEncryptionSDK.DynamoDb
{
  public class VirtualField
  {
    ...
    private System.Collections.Generic.List<AWS.Cryptography.DbEncryptionSDK.DynamoDb.VirtualPart> _parts;
    public string Name
    {
    ...
    public System.Collections.Generic.List<AWS.Cryptography.DbEncryptionSDK.DynamoDb.VirtualPart> Parts
    {
