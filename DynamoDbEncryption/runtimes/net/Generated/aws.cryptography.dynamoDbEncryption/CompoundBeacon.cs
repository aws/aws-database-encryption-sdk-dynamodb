...
using System;
 ...
 private System.Collections.Generic.List<AWS.Cryptography.DynamoDbEncryption.SensitivePart> _sensitive ;
 private System.Collections.Generic.List<AWS.Cryptography.DynamoDbEncryption.NonSensitivePart> _nonSensitive ;
 private System.Collections.Generic.List<AWS.Cryptography.DynamoDbEncryption.Constructor> _constructors ;
 public string Name {
 ...
 if (!IsSetSensitive()) throw new System.ArgumentException("Missing value for required property 'Sensitive'");
