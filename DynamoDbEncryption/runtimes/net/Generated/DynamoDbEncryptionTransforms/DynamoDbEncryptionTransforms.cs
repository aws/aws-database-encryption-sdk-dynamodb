...
using System;
 ...
 using software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types; namespace AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms {
 ...
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.CreateTableInputTransformOutput CreateTableInputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.CreateTableInputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._ICreateTableInputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S30_CreateTableInputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._ICreateTableInputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.CreateTableInputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S31_CreateTableInputTransformOutput(result.dtor_value);
}
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.CreateTableOutputTransformOutput CreateTableOutputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.CreateTableOutputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._ICreateTableOutputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S31_CreateTableOutputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._ICreateTableOutputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.CreateTableOutputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S32_CreateTableOutputTransformOutput(result.dtor_value);
}
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.UpdateTableInputTransformOutput UpdateTableInputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.UpdateTableInputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IUpdateTableInputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S30_UpdateTableInputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IUpdateTableInputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.UpdateTableInputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S31_UpdateTableInputTransformOutput(result.dtor_value);
}
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.UpdateTableOutputTransformOutput UpdateTableOutputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.UpdateTableOutputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IUpdateTableOutputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S31_UpdateTableOutputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IUpdateTableOutputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.UpdateTableOutputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S32_UpdateTableOutputTransformOutput(result.dtor_value);
}
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.DescribeTableInputTransformOutput DescribeTableInputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.DescribeTableInputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IDescribeTableInputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S32_DescribeTableInputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IDescribeTableInputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.DescribeTableInputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S33_DescribeTableInputTransformOutput(result.dtor_value);
}
 public AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.DescribeTableOutputTransformOutput DescribeTableOutputTransform(AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms.DescribeTableOutputTransformInput input) {
 software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IDescribeTableOutputTransformInput internalInput = TypeConversion.ToDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S33_DescribeTableOutputTransformInput(input);
 Wrappers_Compile._IResult<software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IDescribeTableOutputTransformOutput, software.amazon.cryptography.dbencryptionsdk.dynamodb.transforms.internaldafny.types._IError> result = _impl.DescribeTableOutputTransform(internalInput);
 if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
 return TypeConversion.FromDafny_N3_aws__N12_cryptography__N15_dbEncryptionSdk__N8_dynamoDb__N10_transforms__S34_DescribeTableOutputTransformOutput(result.dtor_value);
}
}
}
