...
namespace AWS.Cryptography.DbEncryptionSDK.DynamoDb.Transforms
{
  ...
  {
    private Amazon.DynamoDBv2.Model.TransactWriteItemsResponse _sdkOutput;
    private Amazon.DynamoDBv2.Model.TransactWriteItemsRequest _originalInput;
    public Amazon.DynamoDBv2.Model.TransactWriteItemsResponse SdkOutput
    {
    ...
    public Amazon.DynamoDBv2.Model.TransactWriteItemsRequest OriginalInput
    {
