...
module AwsCryptographyDynamoDbEncryptionTransformsOperations refines AbstractAwsCryptographyDynamoDbEncryptionTransformsOperations {
  import opened DdbMiddlewareConfig
  import DDB = ComAmazonawsDynamodbTypes
  import AwsCryptographyDynamoDbEncryptionItemEncryptorTypes
  import DynamoDbItemEncryptor
  import DynamoToStruct
  import ENC = AwsCryptographyDynamoDbEncryptionItemEncryptorOperations
