...
include "../../../../submodules/MaterialProviders/StandardLibrary/src/Index.dfy"
 ...
 datatype DecryptAs = | DecryptAs (
 nameonly encrypt: Option<string> := Option.None ,
 nameonly decrypt: Option<string> := Option.None
 )
 type DecryptAsList = seq<string>
...
// Modifies := {History};
 ...
 nameonly encrypt: DbesdkEncrypt ,
 nameonly decryptAs: Option<DecryptAsList> := Option.None
 )
 ...
 modifies set tmps2 <- set t2 <- config.attributeActionsOnEncrypt.Values
  | t2.esdk? && t2.esdk.materialsManager.Some? 
