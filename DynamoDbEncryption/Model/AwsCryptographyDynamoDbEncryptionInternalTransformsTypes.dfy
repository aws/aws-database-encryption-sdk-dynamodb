...
include "../../submodules/MaterialProviders/StandardLibrary/src/Index.dfy"
 ...
 module {:extern "Dafny.Aws.Cryptography.DynamoDbEncryption.Internal.Transforms.Types" } AwsCryptographyDynamoDbEncryptionInternalTransformsTypes
 {
...
// Modifies := {History};
 ...
 abstract module AbstractAwsCryptographyDynamoDbEncryptionInternalTransformsService
 {
 import opened Wrappers
 import opened StandardLibrary.UInt
 import opened UTF8
 import opened Types = AwsCryptographyDynamoDbEncryptionInternalTransformsTypes
 import Operations : AbstractAwsCryptographyDynamoDbEncryptionInternalTransformsOperations
 function method DefaultDynamoDbTablesEncryptionConfig(): DynamoDbTablesEncryptionConfig
 method DynamoDbEncryptionTransforms(config: DynamoDbTablesEncryptionConfig := DefaultDynamoDbTablesEncryptionConfig())
...
, t1 | t0 in tmps15 && t1 in t0 :: t1.Modifies;
 ...
 abstract module AbstractAwsCryptographyDynamoDbEncryptionInternalTransformsOperations {
 import opened Wrappers
 import opened StandardLibrary.UInt
 import opened UTF8
 import opened Types = AwsCryptographyDynamoDbEncryptionInternalTransformsTypes
