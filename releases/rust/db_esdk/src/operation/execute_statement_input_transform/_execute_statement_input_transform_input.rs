...
pub struct ExecuteStatementInputTransformInput {
    #[allow(missing_docs)]
pub sdk_input: ::std::option::Option<aws_sdk_dynamodb::operation::execute_statement::ExecuteStatementInput>,
}
impl ExecuteStatementInputTransformInput {
    #[allow(missing_docs)]
pub fn sdk_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::execute_statement::ExecuteStatementInput> {
    &self.sdk_input
}
}
impl ExecuteStatementInputTransformInput {
...
pub struct ExecuteStatementInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<aws_sdk_dynamodb::operation::execute_statement::ExecuteStatementInput>,
}
