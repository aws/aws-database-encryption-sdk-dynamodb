...
impl PutItemOutputTransformInput {
    #[allow(missing_docs)]
pub fn original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::put_item::PutItemInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::put_item::PutItemOutput> {
    &self.sdk_output
}
}
impl PutItemOutputTransformInput {
...
pub struct PutItemOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<aws_sdk_dynamodb::operation::put_item::PutItemInput>,
pub(crate) sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::put_item::PutItemOutput>,
}
