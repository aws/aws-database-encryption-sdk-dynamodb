...
impl GetItemInputTransformInput {
    #[allow(missing_docs)]
pub fn sdk_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput> {
    &self.sdk_input
}
}
impl GetItemInputTransformInput {
...
pub struct GetItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput>,
}
