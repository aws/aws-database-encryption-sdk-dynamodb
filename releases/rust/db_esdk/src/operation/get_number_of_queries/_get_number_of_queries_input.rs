...
impl GetNumberOfQueriesInput {
    /// Creates a new builder-style object to manufacture [`GetNumberOfQueriesInput`](crate::operation::get_number_of_queries::builders::GetNumberOfQueriesInput).
    pub fn builder(
    ) -> crate::operation::get_number_of_queries::builders::GetNumberOfQueriesInputBuilder {
        crate::operation::get_number_of_queries::builders::GetNumberOfQueriesInputBuilder::default()
    }
}

/// A builder for [`GetNumberOfQueriesInput`](crate::operation::operation::GetNumberOfQueriesInput).
#[non_exhaustive]
#[derive(
...
impl GetNumberOfQueriesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetNumberOfQueriesInput`](crate::operation::operation::GetNumberOfQueriesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(
            crate::operation::get_number_of_queries::GetNumberOfQueriesInput { input: self.input },
        )
    }
}
