...
impl ScanInputTransformOutput {
    #[allow(missing_docs)]
pub fn transformed_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanInput> {
...
pub struct ScanInputTransformOutputBuilder {
    pub(crate) transformed_input: ::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanInput>,
}
impl ScanInputTransformOutputBuilder {
    #[allow(missing_docs)]
pub fn transformed_input(mut self, input: impl ::std::convert::Into<aws_sdk_dynamodb::operation::scan::ScanInput>) -> Self {
    self.transformed_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_transformed_input(mut self, input: ::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanInput>) -> Self {
    self.transformed_input = input;
    self
}
#[allow(missing_docs)]
pub fn get_transformed_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanInput> {
    &self.transformed_input
}
