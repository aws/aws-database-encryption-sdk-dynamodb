...
impl ResolveAttributesOutput {
    /// Creates a new builder-style object to manufacture [`ResolveAttributesOutput`](crate::types::ResolveAttributesOutput).
    pub fn builder() -> crate::types::builders::ResolveAttributesOutputBuilder {
        crate::types::builders::ResolveAttributesOutputBuilder::default()
    }
}

/// A builder for [`ResolveAttributesOutput`](crate::types::ResolveAttributesOutput).
#[non_exhaustive]
#[derive(
...
impl ResolveAttributesOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`ResolveAttributesOutput`](crate::types::ResolveAttributesOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::ResolveAttributesOutput {
