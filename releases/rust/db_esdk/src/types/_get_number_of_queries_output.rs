...
impl GetNumberOfQueriesOutput {
    /// Creates a new builder-style object to manufacture [`GetNumberOfQueriesOutput`](crate::types::GetNumberOfQueriesOutput).
    pub fn builder() -> crate::types::builders::GetNumberOfQueriesOutputBuilder {
        crate::types::builders::GetNumberOfQueriesOutputBuilder::default()
    }
}

/// A builder for [`GetNumberOfQueriesOutput`](crate::types::GetNumberOfQueriesOutput).
#[non_exhaustive]
#[derive(
...
impl GetNumberOfQueriesOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetNumberOfQueriesOutput`](crate::types::GetNumberOfQueriesOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::GetNumberOfQueriesOutput {
