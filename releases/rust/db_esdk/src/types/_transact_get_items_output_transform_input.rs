...
pub struct TransactGetItemsOutputTransformInput {
    #[allow(missing_docs)]
pub original_input: ::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsInput>,
#[allow(missing_docs)]
pub sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsOutput>,
}
impl TransactGetItemsOutputTransformInput {
    #[allow(missing_docs)]
pub fn original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsOutput> {
    &self.sdk_output
}
}
impl TransactGetItemsOutputTransformInput {
...
pub struct TransactGetItemsOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsInput>,
pub(crate) sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::transact_get_items::TransactGetItemsOutput>,
}
