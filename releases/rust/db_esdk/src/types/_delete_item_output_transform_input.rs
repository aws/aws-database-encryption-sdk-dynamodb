...
impl DeleteItemOutputTransformInput {
    ...
    pub fn builder() -> crate::types::builders::DeleteItemOutputTransformInputBuilder {
        crate::types::builders::DeleteItemOutputTransformInputBuilder::default()
    }
}

/// A builder for [`DeleteItemOutputTransformInput`](crate::types::DeleteItemOutputTransformInput).
#[non_exhaustive]
#[derive(
