...
impl ScanOutputTransformInput {
    #[allow(missing_docs)]
pub fn original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanOutput> {
    &self.sdk_output
}
}
impl ScanOutputTransformInput {
    /// Creates a new builder-style object to manufacture [`ScanOutputTransformInput`](crate::types::ScanOutputTransformInput).
    pub fn builder() -> crate::types::builders::ScanOutputTransformInputBuilder {
        crate::types::builders::ScanOutputTransformInputBuilder::default()
    }
}

/// A builder for [`ScanOutputTransformInput`](crate::types::ScanOutputTransformInput).
#[non_exhaustive]
#[derive(
...
pub fn get_sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::scan::ScanOutput> {
    ...
    /// Consumes the builder and constructs a [`ScanOutputTransformInput`](crate::types::ScanOutputTransformInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::ScanOutputTransformInput {
