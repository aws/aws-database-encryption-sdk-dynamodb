...
pub item: ::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>,
...
impl ResolveAttributesInput {
    /// The Item to be examined.
pub fn item(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>> {
    &self.item
}
/// Use the config for this Table.
...
impl ResolveAttributesInput {
    /// Creates a new builder-style object to manufacture [`ResolveAttributesInput`](crate::types::ResolveAttributesInput).
    pub fn builder() -> crate::types::builders::ResolveAttributesInputBuilder {
        crate::types::builders::ResolveAttributesInputBuilder::default()
    }
}

/// A builder for [`ResolveAttributesInput`](crate::types::ResolveAttributesInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct ResolveAttributesInputBuilder {
    pub(crate) item: ::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>,
...
pub fn get_version(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    /// Consumes the builder and constructs a [`ResolveAttributesInput`](crate::types::ResolveAttributesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::ResolveAttributesInput {
            item: self.item,
