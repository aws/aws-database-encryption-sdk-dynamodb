...
pub struct BatchExecuteStatementOutputTransformInput {
    #[allow(missing_docs)]
pub original_input: ::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementInput>,
#[allow(missing_docs)]
pub sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementOutput>,
}
impl BatchExecuteStatementOutputTransformInput {
    #[allow(missing_docs)]
pub fn original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementOutput> {
    &self.sdk_output
}
}
impl BatchExecuteStatementOutputTransformInput {
...
pub struct BatchExecuteStatementOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementInput>,
pub(crate) sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::batch_execute_statement::BatchExecuteStatementOutput>,
}
