...
impl DeleteItemInputTransformInput {
    #[allow(missing_docs)]
pub fn sdk_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::delete_item::DeleteItemInput> {
    &self.sdk_input
}
}
impl DeleteItemInputTransformInput {
...
pub struct DeleteItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<aws_sdk_dynamodb::operation::delete_item::DeleteItemInput>,
}
