...
impl GetItemInputTransformOutput {
    /// Creates a new builder-style object to manufacture [`GetItemInputTransformOutput`](crate::types::GetItemInputTransformOutput).
    pub fn builder() -> crate::types::builders::GetItemInputTransformOutputBuilder {
        crate::types::builders::GetItemInputTransformOutputBuilder::default()
    }
}

/// A builder for [`GetItemInputTransformOutput`](crate::types::GetItemInputTransformOutput).
#[non_exhaustive]
#[derive(
...
impl GetItemInputTransformOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetItemInputTransformOutput`](crate::types::GetItemInputTransformOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::GetItemInputTransformOutput {
