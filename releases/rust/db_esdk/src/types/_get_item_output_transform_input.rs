...
impl GetItemOutputTransformInput {
    #[allow(missing_docs)]
pub fn original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemOutput> {
    &self.sdk_output
}
}
impl GetItemOutputTransformInput {
...
pub struct GetItemOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput>,
pub(crate) sdk_output: ::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemOutput>,
}
impl GetItemOutputTransformInputBuilder {
    #[allow(missing_docs)]
pub fn original_input(mut self, input: impl ::std::convert::Into<aws_sdk_dynamodb::operation::get_item::GetItemInput>) -> Self {
    self.original_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_original_input(mut self, input: ::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput>) -> Self {
    self.original_input = input;
    self
}
#[allow(missing_docs)]
pub fn get_original_input(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemInput> {
    &self.original_input
}
#[allow(missing_docs)]
pub fn sdk_output(mut self, input: impl ::std::convert::Into<aws_sdk_dynamodb::operation::get_item::GetItemOutput>) -> Self {
    self.sdk_output = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_sdk_output(mut self, input: ::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemOutput>) -> Self {
    self.sdk_output = input;
    self
}
#[allow(missing_docs)]
pub fn get_sdk_output(&self) -> &::std::option::Option<aws_sdk_dynamodb::operation::get_item::GetItemOutput> {
    &self.sdk_output
}
