...
impl ExecuteTransactionOutputTransformOutput {
    ...
    pub fn builder() -> crate::types::builders::ExecuteTransactionOutputTransformOutputBuilder {
        crate::types::builders::ExecuteTransactionOutputTransformOutputBuilder::default()
    }
}

/// A builder for [`ExecuteTransactionOutputTransformOutput`](crate::types::ExecuteTransactionOutputTransformOutput).
#[non_exhaustive]
#[derive(
...
impl ExecuteTransactionOutputTransformOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::types::ExecuteTransactionOutputTransformOutput {
