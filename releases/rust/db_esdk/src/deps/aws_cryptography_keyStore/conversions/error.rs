...
> {
    ...
    ::dafny_runtime::Rc::new(
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::OpaqueWithText {
            obj: error_obj,
...
crate::deps::aws_cryptography_keyStore::types::error::Error::TrentServiceError { error } =>
    crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsKms {
        ...
        crate::deps::aws_cryptography_keyStore::types::error::Error::ValidationError(inner) =>
            ...
            crate::deps::aws_cryptography_keyStore::types::error::Error::OpaqueWithText { obj, objMessage } =>
            crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::OpaqueWithText {
                obj: ::dafny_runtime::Object(obj.0),
...
crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsKms { ComAmazonawsKms } =>
    crate::deps::aws_cryptography_keyStore::types::error::Error::TrentServiceError {
        ...
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::Opaque { obj } =>
            ...
            crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::OpaqueWithText { obj, objMessage } =>
            {
                use ::std::any::Any;
                if ::dafny_runtime::is_object!(obj, crate::deps::aws_cryptography_keyStore::types::error::ValidationError) {
                    let typed = ::dafny_runtime::cast_object!(obj.clone(), crate::deps::aws_cryptography_keyStore::types::error::ValidationError);
