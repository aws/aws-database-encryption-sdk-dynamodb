...
pub struct ResolveAuthActionsInput {
    #[allow(missing_docs)]
pub auth_actions: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>>,
#[allow(missing_docs)]
...
impl ResolveAuthActionsInput {
    #[allow(missing_docs)]
pub fn auth_actions(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>> {
    &self.auth_actions
}
#[allow(missing_docs)]
...
impl ResolveAuthActionsInput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::operation::resolve_auth_actions::builders::ResolveAuthActionsInputBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::operation::resolve_auth_actions::builders::ResolveAuthActionsInputBuilder::default()
    }
}
...
pub struct ResolveAuthActionsInputBuilder {
    pub(crate) auth_actions: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>>,
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::operation::resolve_auth_actions::ResolveAuthActionsInput {
