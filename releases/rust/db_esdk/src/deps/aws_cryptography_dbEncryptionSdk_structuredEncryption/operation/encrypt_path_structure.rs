...
impl EncryptPathStructure {
    ...
    >{
        ...
        "table_name",
        "table_name was not specified but it is required when building EncryptPathStructureInput",
        ...
        if input.plaintext_structure.is_none() {
            return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field(
        "plaintext_structure",
        "plaintext_structure was not specified but it is required when building EncryptPathStructureInput",
    )).map_err(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::error::Error::wrap_validation_err);
        }
        if input.cmm.is_none() {
            return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field(
        "cmm",
        "cmm was not specified but it is required when building EncryptPathStructureInput",
    )).map_err(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::error::Error::wrap_validation_err);
        }
