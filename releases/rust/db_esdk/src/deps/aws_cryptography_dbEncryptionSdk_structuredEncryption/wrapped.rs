...
impl crate::r#software::amazon::cryptography::dbencryptionsdk::structuredencryption::internaldafny::wrapped::_default {
  pub fn WrappedStructuredEncryption(config: &::std::rc::Rc<
  ...
  >>{
      crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::wrapped::client::Client::from_conf(config)
  }
}
