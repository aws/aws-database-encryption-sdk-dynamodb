...
impl DecryptStructureInput {
    /// Creates a new builder-style object to manufacture [`DecryptStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureInput).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptStructureInputBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptStructureInputBuilder::default()
    }
}

/// A builder for [`DecryptStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureInput).
#[non_exhaustive]
#[derive(
...
impl DecryptStructureInputBuilder {
    #[allow(missing_docs)]
pub fn authenticate_schema(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthenticateAction>>) -> Self {
    self.authenticate_schema = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_authenticate_schema(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthenticateAction>>) -> Self {
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`DecryptStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureInput {
