...
#[allow(missing_docs)]
pub fn encrypted_structure(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>> {
...
impl DecryptPathStructureInput {
    /// Creates a new builder-style object to manufacture [`DecryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptPathStructureInput).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptPathStructureInputBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptPathStructureInputBuilder::default()
    }
}

/// A builder for [`DecryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptPathStructureInput).
#[non_exhaustive]
#[derive(
...
#[allow(missing_docs)]
pub fn encrypted_structure(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>>) -> Self {
    self.encrypted_structure = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_encrypted_structure(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>>) -> Self {
    self.encrypted_structure = input;
    self
}
#[allow(missing_docs)]
pub fn get_encrypted_structure(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::AuthItem>> {
    &self.encrypted_structure
}
#[allow(missing_docs)]
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`DecryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptPathStructureInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptPathStructureInput {
            cmm: self.cmm,
