...
#[allow(missing_docs)]
pub fn plaintext_structure(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoItem>> {
...
impl EncryptPathStructureInput {
    /// Creates a new builder-style object to manufacture [`EncryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::EncryptPathStructureInput).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::EncryptPathStructureInputBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::EncryptPathStructureInputBuilder::default()
    }
}

/// A builder for [`EncryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::EncryptPathStructureInput).
#[non_exhaustive]
#[derive(
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`EncryptPathStructureInput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::EncryptPathStructureInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::EncryptPathStructureInput {
