...
impl DecryptStructureOutput {
    /// Creates a new builder-style object to manufacture [`DecryptStructureOutput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureOutput).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptStructureOutputBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::builders::DecryptStructureOutputBuilder::default()
    }
}

/// A builder for [`DecryptStructureOutput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureOutput).
#[non_exhaustive]
#[derive(
...
#[allow(missing_docs)]
pub fn plaintext_structure(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::StructuredDataTerminal>>) -> Self {
    self.plaintext_structure = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_plaintext_structure(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::StructuredDataTerminal>>) -> Self {
...
pub fn get_plaintext_structure(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::StructuredDataTerminal>> {
    ...
    /// Consumes the builder and constructs a [`DecryptStructureOutput`](crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::DecryptStructureOutput {
