...
impl CryptoItem {
    #[allow(missing_docs)]
pub fn action(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction> {
    &self.action
}
#[allow(missing_docs)]
...
impl CryptoItemBuilder {
    #[allow(missing_docs)]
pub fn action(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>) -> Self {
    self.action = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)]
pub fn set_action(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>) -> Self {
    self.action = input;
    self
}
#[allow(missing_docs)]
pub fn get_action(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction> {
    &self.action
}
#[allow(missing_docs)]
...
pub fn get_key(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::PathSegment>> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoItem {
            action: self.action,
data: self.data,
key: self.key,
        })
