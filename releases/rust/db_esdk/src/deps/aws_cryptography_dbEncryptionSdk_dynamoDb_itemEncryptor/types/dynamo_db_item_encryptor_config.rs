...
pub struct DynamoDbItemEncryptorConfig {
...
impl DynamoDbItemEncryptorConfig {
    /// An ID for the algorithm suite to use during encryption and decryption.
...
/// A prefix such that, if during decryption any attribute has a name with this prefix, it is treated as unsigned.
pub fn allowed_unsigned_attribute_prefix(&self) -> &::std::option::Option<::std::string::String> {
    &self.allowed_unsigned_attribute_prefix
}
/// A list of attribute names such that, if encountered during decryption, those attributes are treated as unsigned.
pub fn allowed_unsigned_attributes(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    &self.allowed_unsigned_attributes
}
/// A map that describes what attributes should be encrypted and/or signed on encrypt. This map must contain all attributes that might be encountered during encryption.
pub fn attribute_actions_on_encrypt(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>> {
...
/// A configuration that override encryption and/or decryption to instead perform legacy encryption and/or decryption. Used as part of migration from version 2.x to version 3.x.
pub fn legacy_override(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyOverride> {
...
/// A configuration that override encryption and/or decryption to instead passthrough and write and/or read plaintext. Used to update plaintext tables to fully use client-side encryption.
pub fn plaintext_override(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::PlaintextOverride> {
...
impl DynamoDbItemEncryptorConfig {
    /// Creates a new builder-style object to manufacture [`DynamoDbItemEncryptorConfig`](crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::DynamoDbItemEncryptorConfig).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::dynamo_db_item_encryptor_config::DynamoDbItemEncryptorConfigBuilder {
        crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::dynamo_db_item_encryptor_config::DynamoDbItemEncryptorConfigBuilder::default()
    }
}

/// A builder for [`DynamoDbItemEncryptorConfig`](crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::DynamoDbItemEncryptorConfig).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct DynamoDbItemEncryptorConfigBuilder {
...
impl DynamoDbItemEncryptorConfigBuilder {
    /// An ID for the algorithm suite to use during encryption and decryption.
...
/// A prefix such that, if during decryption any attribute has a name with this prefix, it is treated as unsigned.
pub fn allowed_unsigned_attribute_prefix(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.allowed_unsigned_attribute_prefix = ::std::option::Option::Some(input.into());
    self
}
/// A prefix such that, if during decryption any attribute has a name with this prefix, it is treated as unsigned.
pub fn set_allowed_unsigned_attribute_prefix(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
    self.allowed_unsigned_attribute_prefix = input;
    self
}
/// A prefix such that, if during decryption any attribute has a name with this prefix, it is treated as unsigned.
pub fn get_allowed_unsigned_attribute_prefix(&self) -> &::std::option::Option<::std::string::String> {
    &self.allowed_unsigned_attribute_prefix
}
/// A list of attribute names such that, if encountered during decryption, those attributes are treated as unsigned.
pub fn allowed_unsigned_attributes(mut self, input: impl ::std::convert::Into<::std::vec::Vec<::std::string::String>>) -> Self {
    self.allowed_unsigned_attributes = ::std::option::Option::Some(input.into());
    self
}
/// A list of attribute names such that, if encountered during decryption, those attributes are treated as unsigned.
pub fn set_allowed_unsigned_attributes(mut self, input: ::std::option::Option<::std::vec::Vec<::std::string::String>>) -> Self {
    self.allowed_unsigned_attributes = input;
    self
}
/// A list of attribute names such that, if encountered during decryption, those attributes are treated as unsigned.
pub fn get_allowed_unsigned_attributes(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    &self.allowed_unsigned_attributes
}
/// A map that describes what attributes should be encrypted and/or signed on encrypt. This map must contain all attributes that might be encountered during encryption.
pub fn attribute_actions_on_encrypt(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>>) -> Self {
    self.attribute_actions_on_encrypt = ::std::option::Option::Some(input.into());
    self
}
/// A map that describes what attributes should be encrypted and/or signed on encrypt. This map must contain all attributes that might be encountered during encryption.
pub fn set_attribute_actions_on_encrypt(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>>) -> Self {
    self.attribute_actions_on_encrypt = input;
    self
}
/// A map that describes what attributes should be encrypted and/or signed on encrypt. This map must contain all attributes that might be encountered during encryption.
pub fn get_attribute_actions_on_encrypt(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>> {
    &self.attribute_actions_on_encrypt
}
/// The Cryptographic Materials Manager that is used to obtain materials for encryption and decryption.  Either a Keyring or a Cryptographic Materials Manager must be specified.
...
/// A configuration that override encryption and/or decryption to instead perform legacy encryption and/or decryption. Used as part of migration from version 2.x to version 3.x.
pub fn legacy_override(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyOverride>) -> Self {
    self.legacy_override = ::std::option::Option::Some(input.into());
    self
}
/// A configuration that override encryption and/or decryption to instead perform legacy encryption and/or decryption. Used as part of migration from version 2.x to version 3.x.
pub fn set_legacy_override(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyOverride>) -> Self {
    self.legacy_override = input;
    self
}
/// A configuration that override encryption and/or decryption to instead perform legacy encryption and/or decryption. Used as part of migration from version 2.x to version 3.x.
pub fn get_legacy_override(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyOverride> {
    &self.legacy_override
}
/// The logical table name for this table. This is the name that is cryptographically bound with your data. This can be the same as the actual DynamoDB table name. It's purpose is to be distinct from the DynamoDB table name so that the data may still be authenticated if being read from different (but logically similar) tables, such as a backup table.
pub fn logical_table_name(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.logical_table_name = ::std::option::Option::Some(input.into());
    self
}
/// The logical table name for this table. This is the name that is cryptographically bound with your data. This can be the same as the actual DynamoDB table name. It's purpose is to be distinct from the DynamoDB table name so that the data may still be authenticated if being read from different (but logically similar) tables, such as a backup table.
pub fn set_logical_table_name(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
...
/// The name of the partition key on the table this item will be written to or was read from.
pub fn partition_key_name(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.partition_key_name = ::std::option::Option::Some(input.into());
    self
}
/// The name of the partition key on the table this item will be written to or was read from.
pub fn set_partition_key_name(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
...
/// A configuration that override encryption and/or decryption to instead passthrough and write and/or read plaintext. Used to update plaintext tables to fully use client-side encryption.
pub fn plaintext_override(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::PlaintextOverride>) -> Self {
    self.plaintext_override = ::std::option::Option::Some(input.into());
    self
}
/// A configuration that override encryption and/or decryption to instead passthrough and write and/or read plaintext. Used to update plaintext tables to fully use client-side encryption.
pub fn set_plaintext_override(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::PlaintextOverride>) -> Self {
    self.plaintext_override = input;
    self
}
/// A configuration that override encryption and/or decryption to instead passthrough and write and/or read plaintext. Used to update plaintext tables to fully use client-side encryption.
pub fn get_plaintext_override(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::PlaintextOverride> {
    &self.plaintext_override
}
/// If this table contains a sort key, the name of the sort key on the table this item will be written to or was read from.
pub fn sort_key_name(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.sort_key_name = ::std::option::Option::Some(input.into());
    self
}
/// If this table contains a sort key, the name of the sort key on the table this item will be written to or was read from.
pub fn set_sort_key_name(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
...
pub fn get_sort_key_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`DynamoDbItemEncryptorConfig`](crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::DynamoDbItemEncryptorConfig).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb_itemEncryptor::types::dynamo_db_item_encryptor_config::DynamoDbItemEncryptorConfig {
