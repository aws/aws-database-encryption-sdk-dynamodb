...
pub selector_context: ::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>,
/// The portion of the encryption context that was stored in the header of this item.
pub stored_encryption_context: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
}
impl ParsedHeader {
    /// The ID of the algorithm suite that was used to encrypt this item.
...
/// The encryption context as presented to the branch key selector.
pub fn selector_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>> {
    &self.selector_context
}
/// The portion of the encryption context that was stored in the header of this item.
pub fn stored_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
...
pub(crate) selector_context: ::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>,
pub(crate) stored_encryption_context: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>,
}
...
/// The encryption context as presented to the branch key selector.
pub fn selector_context(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>) -> Self {
    self.selector_context = ::std::option::Option::Some(input.into());
    self
}
/// The encryption context as presented to the branch key selector.
pub fn set_selector_context(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>>) -> Self {
    self.selector_context = input;
    self
}
/// The encryption context as presented to the branch key selector.
pub fn get_selector_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>> {
    &self.selector_context
}
/// The portion of the encryption context that was stored in the header of this item.
pub fn stored_encryption_context(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, ::std::string::String>>) -> Self {
    self.stored_encryption_context = ::std::option::Option::Some(input.into());
    self
}
/// The portion of the encryption context that was stored in the header of this item.
pub fn set_stored_encryption_context(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>) -> Self {
    self.stored_encryption_context = input;
    self
}
/// The portion of the encryption context that was stored in the header of this item.
pub fn get_stored_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    &self.stored_encryption_context
}
