...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::services::kms::internaldafny::types::DisconnectCustomKeyStoreRequest::DisconnectCustomKeyStoreRequest {
...
pub fn from_dafny(
    ...
    aws_sdk_kms::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput::builder()
        .set_custom_key_store_id(Some(
            dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(
                dafny_value.CustomKeyStoreId(),
            ),
        ))
        .build()
        .unwrap()
