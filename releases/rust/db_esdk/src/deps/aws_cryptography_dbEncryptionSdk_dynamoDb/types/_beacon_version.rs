...
impl BeaconVersion {
    /// The Compound Beacons to be written with items.
pub fn compound_beacons(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::CompoundBeacon>> {
    &self.compound_beacons
}
/// The list of Encrypted Parts that may be included in any compound beacon.
pub fn encrypted_parts(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedPart>> {
    &self.encrypted_parts
}
/// The configuration for what beacon key(s) to use.
pub fn key_source(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconKeySource> {
    &self.key_source
}
/// The Key Store that contains the Beacon Keys to use with searchable encryption.
...
/// The list of Signed Parts that may be included in any compound beacon.
pub fn signed_parts(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SignedPart>> {
    &self.signed_parts
}
/// The Standard Beacons to be written with items.
pub fn standard_beacons(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::StandardBeacon>> {
...
/// The Virtual Fields to be calculated, supporting other searchable enryption configurations.
pub fn virtual_fields(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualField>> {
    &self.virtual_fields
}
}
impl BeaconVersion {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::BeaconVersionBuilder {
...
impl BeaconVersionBuilder {
    /// The Compound Beacons to be written with items.
pub fn compound_beacons(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::CompoundBeacon>>) -> Self {
    self.compound_beacons = ::std::option::Option::Some(input.into());
    self
}
/// The Compound Beacons to be written with items.
pub fn set_compound_beacons(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::CompoundBeacon>>) -> Self {
    self.compound_beacons = input;
    self
}
/// The Compound Beacons to be written with items.
pub fn get_compound_beacons(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::CompoundBeacon>> {
    &self.compound_beacons
}
/// The list of Encrypted Parts that may be included in any compound beacon.
pub fn encrypted_parts(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedPart>>) -> Self {
    self.encrypted_parts = ::std::option::Option::Some(input.into());
    self
}
/// The list of Encrypted Parts that may be included in any compound beacon.
pub fn set_encrypted_parts(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedPart>>) -> Self {
    self.encrypted_parts = input;
    self
}
/// The list of Encrypted Parts that may be included in any compound beacon.
pub fn get_encrypted_parts(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedPart>> {
    &self.encrypted_parts
}
/// The configuration for what beacon key(s) to use.
pub fn key_source(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconKeySource>) -> Self {
    self.key_source = ::std::option::Option::Some(input.into());
    self
}
/// The configuration for what beacon key(s) to use.
pub fn set_key_source(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconKeySource>) -> Self {
    self.key_source = input;
    self
}
/// The configuration for what beacon key(s) to use.
pub fn get_key_source(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconKeySource> {
    &self.key_source
}
/// The Key Store that contains the Beacon Keys to use with searchable encryption.
...
/// The list of Signed Parts that may be included in any compound beacon.
pub fn signed_parts(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SignedPart>>) -> Self {
    self.signed_parts = ::std::option::Option::Some(input.into());
    self
}
/// The list of Signed Parts that may be included in any compound beacon.
pub fn set_signed_parts(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SignedPart>>) -> Self {
    self.signed_parts = input;
    self
}
/// The list of Signed Parts that may be included in any compound beacon.
pub fn get_signed_parts(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SignedPart>> {
    &self.signed_parts
}
/// The Standard Beacons to be written with items.
pub fn standard_beacons(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::StandardBeacon>>) -> Self {
    self.standard_beacons = ::std::option::Option::Some(input.into());
    self
}
/// The Standard Beacons to be written with items.
pub fn set_standard_beacons(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::StandardBeacon>>) -> Self {
    self.standard_beacons = input;
    self
}
/// The Standard Beacons to be written with items.
pub fn get_standard_beacons(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::StandardBeacon>> {
    &self.standard_beacons
}
/// The version of searchable encryption configured. This must be '1'.
...
/// The Virtual Fields to be calculated, supporting other searchable enryption configurations.
pub fn virtual_fields(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualField>>) -> Self {
    self.virtual_fields = ::std::option::Option::Some(input.into());
    self
}
/// The Virtual Fields to be calculated, supporting other searchable enryption configurations.
pub fn set_virtual_fields(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualField>>) -> Self {
    self.virtual_fields = input;
    self
}
/// The Virtual Fields to be calculated, supporting other searchable enryption configurations.
pub fn get_virtual_fields(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualField>> {
    &self.virtual_fields
}
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconVersion {
