...
impl GetSubstring {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::GetSubstringBuilder {
...
pub fn get_low(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetSubstring {
            high: self.high,
low: self.low,
        })
    }
