...
impl EncryptedPart {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::EncryptedPartBuilder {
...
pub fn get_prefix(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedPart {
            name: self.name,
prefix: self.prefix,
        })
    }
