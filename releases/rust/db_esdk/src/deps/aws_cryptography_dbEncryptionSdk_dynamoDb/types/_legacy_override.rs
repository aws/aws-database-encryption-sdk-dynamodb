...
/// This input is not used in the Java Client and should not be specified.
pub fn default_attribute_flag(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction> {
...
/// A policy which configurates whether legacy behavior overrides encryption and/or decryption.
pub fn policy(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyPolicy> {
    &self.policy
}
}
impl LegacyOverride {
...
/// This input is not used in the Java Client and should not be specified.
pub fn default_attribute_flag(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>) -> Self {
    self.default_attribute_flag = ::std::option::Option::Some(input.into());
    self
}
/// This input is not used in the Java Client and should not be specified.
pub fn set_default_attribute_flag(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction>) -> Self {
    self.default_attribute_flag = input;
    self
}
/// This input is not used in the Java Client and should not be specified.
pub fn get_default_attribute_flag(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_structuredEncryption::types::CryptoAction> {
    &self.default_attribute_flag
}
/// A configuration for the legacy DynamoDB Encryption Client's Encryptor.
pub fn encryptor(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::legacy_dynamo_db_encryptor::LegacyDynamoDbEncryptorRef>) -> Self {
    self.encryptor = ::std::option::Option::Some(input.into());
    self
}
/// A configuration for the legacy DynamoDB Encryption Client's Encryptor.
pub fn set_encryptor(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::legacy_dynamo_db_encryptor::LegacyDynamoDbEncryptorRef>) -> Self {
...
/// A policy which configurates whether legacy behavior overrides encryption and/or decryption.
pub fn policy(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyPolicy>) -> Self {
    self.policy = ::std::option::Option::Some(input.into());
    self
}
/// A policy which configurates whether legacy behavior overrides encryption and/or decryption.
pub fn set_policy(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyPolicy>) -> Self {
    self.policy = input;
    self
}
/// A policy which configurates whether legacy behavior overrides encryption and/or decryption.
pub fn get_policy(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyPolicy> {
    &self.policy
}
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::LegacyOverride {
