...
pub style: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle>,
}
impl StandardBeacon {
    /// The length of the calculated beacon.
...
/// Optional augmented behavior.
pub fn style(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle> {
    &self.style
}
}
impl StandardBeacon {
...
pub(crate) style: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle>,
}
...
/// Optional augmented behavior.
pub fn style(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle>) -> Self {
    self.style = ::std::option::Option::Some(input.into());
    self
}
/// Optional augmented behavior.
pub fn set_style(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle>) -> Self {
    self.style = input;
    self
}
/// Optional augmented behavior.
pub fn get_style(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle> {
    &self.style
}
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::StandardBeacon {
            length: self.length,
loc: self.loc,
name: self.name,
style: self.style,
