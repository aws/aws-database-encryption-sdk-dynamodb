...
impl SignedPart {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::SignedPartBuilder {
...
pub fn get_prefix(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SignedPart {
            loc: self.loc,
name: self.name,
prefix: self.prefix,
        })
