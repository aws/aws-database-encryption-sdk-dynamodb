...
pub fn as_part_only(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::PartOnly, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_shared(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::Shared, &Self> {
    if let crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle::Shared(val) = &self {
        ::std::result::Result::Ok(val)
    } else {
        ::std::result::Result::Err(self)
    }
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_as_set(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::AsSet, &Self> {
    if let crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::BeaconStyle::AsSet(val) = &self {
        ::std::result::Result::Ok(val)
    } else {
        ::std::result::Result::Err(self)
    }
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_shared_set(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SharedSet, &Self> {
