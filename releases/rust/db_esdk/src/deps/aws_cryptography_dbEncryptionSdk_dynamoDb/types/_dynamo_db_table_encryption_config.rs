...
/// The configuration for searchable encryption.
pub fn search(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SearchConfig> {
    &self.search
}
/// If this table contains a sort key, the name of the sort key on this table.
...
/// The configuration for searchable encryption.
pub fn search(mut self, input: impl ::std::convert::Into<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SearchConfig>) -> Self {
    self.search = ::std::option::Option::Some(input.into());
    self
}
/// The configuration for searchable encryption.
pub fn set_search(mut self, input: ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SearchConfig>) -> Self {
    self.search = input;
    self
}
/// The configuration for searchable encryption.
pub fn get_search(&self) -> &::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SearchConfig> {
    &self.search
}
/// If this table contains a sort key, the name of the sort key on this table.
