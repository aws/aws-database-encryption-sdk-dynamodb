...
pub trans: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>>,
}
impl VirtualPart {
    /// The DynamoDB document path to the value for this part.
...
/// A list of transformations performed on the value for this part.
pub fn trans(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>> {
    &self.trans
}
}
impl VirtualPart {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::VirtualPartBuilder {
...
pub(crate) trans: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>>,
}
...
/// A list of transformations performed on the value for this part.
pub fn trans(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>>) -> Self {
    self.trans = ::std::option::Option::Some(input.into());
    self
}
/// A list of transformations performed on the value for this part.
pub fn set_trans(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>>) -> Self {
    self.trans = input;
    self
}
/// A list of transformations performed on the value for this part.
pub fn get_trans(&self) -> &::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualTransform>> {
    &self.trans
}
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualPart {
            loc: self.loc,
trans: self.trans,
        })
    }
