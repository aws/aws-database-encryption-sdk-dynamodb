...
impl GetEncryptedDataKeyDescriptionOutputBuilder {
    /// A list of encrypted data key description.
pub fn encrypted_data_key_description_output(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedDataKeyDescription>>) -> Self {
    self.encrypted_data_key_description_output = ::std::option::Option::Some(input.into());
    self
}
/// A list of encrypted data key description.
pub fn set_encrypted_data_key_description_output(mut self, input: ::std::option::Option<::std::vec::Vec<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::EncryptedDataKeyDescription>>) -> Self {
