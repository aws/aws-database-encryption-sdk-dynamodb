...
/// Key provider information of the encrypted data key.
pub fn key_provider_info(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.key_provider_info = ::std::option::Option::Some(input.into());
    self
}
/// Key provider information of the encrypted data key.
pub fn set_key_provider_info(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
