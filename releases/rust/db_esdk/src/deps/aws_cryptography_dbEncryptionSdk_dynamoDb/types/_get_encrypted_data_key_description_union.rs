...
/// A DynamoDB item.
Item(::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>),
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_item(&self) -> ::std::result::Result<&::std::collections::HashMap<::std::string::String, aws_sdk_dynamodb::types::AttributeValue>, &Self> {
