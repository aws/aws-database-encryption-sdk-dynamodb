...
impl MultiKeyStore {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::builders::MultiKeyStoreBuilder {
...
/// The name of the field that stores the Beacon Key. This may be a Virtual Field.
pub fn key_field_name(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
    self.key_field_name = ::std::option::Option::Some(input.into());
    self
}
/// The name of the field that stores the Beacon Key. This may be a Virtual Field.
pub fn set_key_field_name(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
...
pub fn get_key_field_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::MultiKeyStore {
            cache: self.cache,
