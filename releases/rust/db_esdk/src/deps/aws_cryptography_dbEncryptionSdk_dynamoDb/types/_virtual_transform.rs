...
pub fn as_upper(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::Upper, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_lower(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::Lower, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_insert(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::Insert, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_prefix(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetPrefix, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_suffix(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetSuffix, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_substring(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetSubstring, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_segment(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetSegment, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_segments(&self) -> ::std::result::Result<&crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::GetSegments, &Self> {
