...
impl GetPartitionNumberInput {
    /// Creates a new builder-style object to manufacture [`GetPartitionNumberInput`](crate::operation::get_partition_number::builders::GetPartitionNumberInput).
    pub fn builder() -> crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::operation::get_partition_number::builders::GetPartitionNumberInputBuilder{
        crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::operation::get_partition_number::builders::GetPartitionNumberInputBuilder::default()
    }
}

/// A builder for [`GetPartitionNumberInput`](crate::operation::operation::GetPartitionNumberInput).
#[non_exhaustive]
#[derive(
...
impl GetPartitionNumberInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetPartitionNumberInput`](crate::operation::operation::GetPartitionNumberInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    >{
        ::std::result::Result::Ok(crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::operation::get_partition_number::GetPartitionNumberInput {
            item: self.item,
