...
pub fn plain_from_dafny(
    ...
    |v: &::std::rc::Rc<crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::DynamoDbTableEncryptionConfig>| crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::conversions::dynamo_db_table_encryption_config::from_dafny(v.clone())
,
)
 ))
                .build()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::DynamoDbTablesEncryptionConfig,
    >>>,
) -> ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::DynamoDbTablesEncryptionConfig> {
    match &*dafny_value {
