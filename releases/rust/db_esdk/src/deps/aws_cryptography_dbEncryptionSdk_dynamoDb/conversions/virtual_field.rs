...
pub fn plain_from_dafny(
 ...
 .set_parts(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.parts(),
    |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::VirtualPart>| crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::conversions::virtual_part::from_dafny(e.clone())
,
)
 ))
                .build()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::VirtualField,
    >>>,
) -> ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::VirtualField> {
    match &*dafny_value {
