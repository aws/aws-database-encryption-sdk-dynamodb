...
pub fn plain_from_dafny(
    ...
    |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::BeaconVersion>| crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::conversions::beacon_version::from_dafny(e.clone())
,
)
 ))
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::dbencryptionsdk::dynamodb::internaldafny::types::SearchConfig,
    >>>,
) -> ::std::option::Option<crate::deps::aws_cryptography_dbEncryptionSdk_dynamoDb::types::SearchConfig> {
    match &*dafny_value {
