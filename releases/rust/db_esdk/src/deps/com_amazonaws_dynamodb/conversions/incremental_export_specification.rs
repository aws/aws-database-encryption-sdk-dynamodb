...
pub fn to_dafny(
...
) -> ::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::IncrementalExportSpecification>{
  ::std::rc::Rc::new(
 ...
 ExportViewType: ::std::rc::Rc::new(match &value.export_view_type {
...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::IncrementalExportSpecification::builder()
          .set_export_from_time(crate::standard_library_conversions::otimestamp_from_dafny(dafny_value.ExportFromTime().clone()))
 .set_export_to_time(crate::standard_library_conversions::otimestamp_from_dafny(dafny_value.ExportToTime().clone()))
 .set_export_view_type(match &**dafny_value.ExportViewType() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::deps::com_amazonaws_dynamodb::conversions::export_view_type::from_dafny(value)
    ),
    _ => None,
}
)
