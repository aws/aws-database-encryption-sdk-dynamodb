...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ListGlobalTablesOutput::ListGlobalTablesOutput {
        GlobalTables: ::dafny_runtime::Rc::new(match &value.global_tables {
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::dafny_runtime::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::GlobalTable>| crate::deps::com_amazonaws_dynamodb::conversions::global_table::from_dafny(e.clone())
,
            )
        ),
    _ => None
