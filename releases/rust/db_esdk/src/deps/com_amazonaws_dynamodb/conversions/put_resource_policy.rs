...
> {
    match value {
      aws_sdk_dynamodb::error::SdkError::ServiceError(service_error) => match service_error.err() {
                aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::InternalServerError(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::internal_server_error::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::InvalidEndpointException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::invalid_endpoint_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::LimitExceededException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::limit_exceeded_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::PolicyNotFoundException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::policy_not_found_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::ResourceInUseException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::resource_in_use_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::put_resource_policy::PutResourcePolicyError::ResourceNotFoundException(e) =>
...
pub mod _put_resource_policy_request;
