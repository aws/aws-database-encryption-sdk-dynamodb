...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::KinesisDataStreamDestination::builder()
        .set_stream_arn(crate::standard_library_conversions::ostring_from_dafny(
            dafny_value.StreamArn().clone(),
        ))
        .set_destination_status(match &**dafny_value.DestinationStatus() {
            crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                crate::deps::com_amazonaws_dynamodb::conversions::destination_status::from_dafny(
                    value,
                ),
            ),
            _ => None,
        })
        .set_destination_status_description(
            crate::standard_library_conversions::ostring_from_dafny(
                dafny_value.DestinationStatusDescription().clone(),
            ),
        )
        .build()
}
