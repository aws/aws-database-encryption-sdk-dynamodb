...
>{
    ::std::rc::Rc::new(crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::PutResourcePolicyInput::PutResourcePolicyInput {
...
pub fn from_dafny(
 ...
 .set_confirm_remove_self_resource_access(crate::standard_library_conversions::obool_from_dafny(dafny_value.ConfirmRemoveSelfResourceAccess().clone()))
          .build()
          .unwrap()
}
