...
#[allow(dead_code)]
pub fn to_dafny(
    value: &aws_sdk_dynamodb::types::KinesisStreamingDestinationOutput,
) -> ::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::KinesisStreamingDestinationOutput>{
  ::std::rc::Rc::new(
    crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::KinesisStreamingDestinationOutput::KinesisStreamingDestinationOutput {
...
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<
        crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::KinesisStreamingDestinationOutput,
    >,
) -> aws_sdk_dynamodb::types::KinesisStreamingDestinationOutput {
    aws_sdk_dynamodb::types::KinesisStreamingDestinationOutput::builder()
