...
) -> ::dafny_runtime::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::UpdateKinesisStreamingConfiguration>{
    ::dafny_runtime::Rc::new(
    crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::UpdateKinesisStreamingConfiguration::UpdateKinesisStreamingConfiguration {
...
pub fn from_dafny(
    dafny_value: ::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::UpdateKinesisStreamingConfiguration,
    >,
) -> aws_sdk_dynamodb::types::UpdateKinesisStreamingConfiguration {
