...
) -> ::dafny_runtime::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ReplicaUpdate>{
    ...
    aws_sdk_dynamodb::types::ReplicaUpdate::builder()
        .set_create(match (*dafny_value.Create()).as_ref() {
            crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                crate::deps::com_amazonaws_dynamodb::conversions::create_replica_action::from_dafny(
                    value.clone(),
                ),
            ),
            _ => None,
        ...
        .set_delete(match (*dafny_value.Delete()).as_ref() {
            crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                crate::deps::com_amazonaws_dynamodb::conversions::delete_replica_action::from_dafny(
                    value.clone(),
                ),
            ),
            _ => None,
