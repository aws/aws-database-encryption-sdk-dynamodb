...
func (_static *CompanionStruct_Default___) ExtractAttributes(s _dafny.Sequence, ex m_Wrappers.Option) _dafny.Sequence {
	var _0_tokens _dafny.Sequence = Companion_Default___.ParseExpr(s, uint64(0))
	_ = _0_tokens
	return Companion_Default___.ExtractAttributes2(_0_tokens, ex, _dafny.IntOfInt64(-1), uint64(0))
}
...
func (_static *CompanionStruct_Default___) ExtractAttributes2(tokens _dafny.Sequence, names m_Wrappers.Option, tokensUntilSkip _dafny.Int, pos uint64) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((tokens).Cardinality())) == (pos) {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf())
	} else if Companion_Default___.IsSpecial((tokens).Select(uint32(pos)).(Token)) {
		var _in0 _dafny.Sequence = tokens
		_ = _in0
		...
		pos = _in3
		goto TAIL_CALL_START
	} else if (((tokens).Select(uint32(pos)).(Token)).Is_Attr()) && ((tokensUntilSkip).Sign() == 0) {
		var _in4 _dafny.Sequence = tokens
		_ = _in4
		var _in5 m_Wrappers.Option = names
		_ = _in5
		var _in6 _dafny.Int = _dafny.IntOfInt64(-1)
		_ = _in6
		var _in7 uint64 = (pos) + (uint64(1))
		_ = _in7
		tokens = _in4
		names = _in5
		...
		pos = _in7
		goto TAIL_CALL_START
	} else if ((tokens).Select(uint32(pos)).(Token)).Is_Attr() {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf(Companion_Default___.GetAttrName((tokens).Select(uint32(pos)).(Token), names)))
		var _in8 _dafny.Sequence = tokens
		_ = _in8
		var _in9 m_Wrappers.Option = names
		_ = _in9
		var _in10 _dafny.Int = _dafny.IntOfInt64(-1)
		_ = _in10
		var _in11 uint64 = (pos) + (uint64(1))
		_ = _in11
		tokens = _in8
		names = _in9
		...
		var _in12 _dafny.Sequence = tokens
		_ = _in12
		var _in13 m_Wrappers.Option = names
		_ = _in13
		var _in14 _dafny.Int = (tokensUntilSkip).Minus(_dafny.One)
		_ = _in14
		var _in15 uint64 = (pos) + (uint64(1))
		_ = _in15
		tokens = _in12
		names = _in13
...
func (_static *CompanionStruct_Default___) RemoveCommonPrefix(x _dafny.Sequence, y _dafny.Sequence, pos uint64) _dafny.Tuple {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (((uint64((x).Cardinality())) == (pos)) || ((uint64((y).Cardinality())) == (pos))) || (!_dafny.Companion_Sequence_.Equal((x).Select(uint32(pos)).(_dafny.Sequence), (y).Select(uint32(pos)).(_dafny.Sequence))) {
		return _dafny.TupleOf((x).Drop(uint32(pos)), (y).Drop(uint32(pos)))
	} else {
		var _in0 _dafny.Sequence = x
		_ = _in0
		var _in1 _dafny.Sequence = y
		_ = _in1
	...
	if (b).Is_Standard() {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			if (_2_valueOrError1).IsFailure() {
				...
				_ = _5_rightParts
				var _let_tmp_rhs0 _dafny.Tuple = Companion_Default___.RemoveCommonPrefix(_4_leftParts, _5_rightParts, uint64(0))
				_ = _let_tmp_rhs0
...
func (_static *CompanionStruct_Default___) ParsedExprToString(t _dafny.Sequence) _dafny.Sequence {
	var _0_x _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer113 func(Token) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg142 interface{}) interface{} {
			return coer113(arg142.(Token))
		}
...
func (_static *CompanionStruct_Default___) ParseExpr(s _dafny.Sequence, pos uint64) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	var _1_tup _dafny.Tuple = Companion_Default___.FindIndexToken(s, pos)
	_ = _1_tup
	if (uint64(0)) < ((*(_1_tup).IndexInt(0)).(uint64)) {
		...
		_ = _in0
		var _in1 uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, (*(_1_tup).IndexInt(0)).(uint64))
		_ = _in1
		s = _in0
		pos = _in1
		goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) EqualLower(pre _dafny.Sequence, s _dafny.Sequence, pos uint64, diff uint64) bool {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((pre).Cardinality())) == (pos) {
		return true
	} else if ((pre).Select(uint32(pos)).(_dafny.Char)) != (Companion_Default___.CharLower((s).Select(uint32((pos) + (diff))).(_dafny.Char))) /* dircomp */ {
		return false
	} else {
		var _in0 _dafny.Sequence = pre
		_ = _in0
		var _in1 _dafny.Sequence = s
		_ = _in1
		var _in2 uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1))
		_ = _in2
		var _in3 uint64 = diff
		_ = _in3
		pre = _in0
		s = _in1
		pos = _in2
...
func (_static *CompanionStruct_Default___) PrefixLower(pre _dafny.Sequence, s _dafny.Sequence, pos uint64) bool {
	if (m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64((pre).Cardinality()))) > (uint64((s).Cardinality())) {
		return false
	} else {
		return Companion_Default___.EqualLower(pre, s, uint64(0), pos)
	}
}
...
func (_static *CompanionStruct_Default___) ValueLen(s _dafny.Sequence, pos uint64) uint64 {
	if (pos) == (uint64((s).Cardinality())) {
		return uint64(0)
	} else if Companion_Default___.ValueChar((s).Select(uint32(pos)).(_dafny.Char)) {
		return m_StandardLibrary_MemoryMath.Companion_Default___.Add(Companion_Default___.ValueLen(s, m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1))), uint64(1))
	} else {
		return uint64(0)
	}
}
func (_static *CompanionStruct_Default___) AttributeLen(s _dafny.Sequence, pos uint64) uint64 {
	if (pos) == (uint64((s).Cardinality())) {
		return uint64(0)
	} else if Companion_Default___.AttributeChar((s).Select(uint32(pos)).(_dafny.Char)) {
		return m_StandardLibrary_MemoryMath.Companion_Default___.Add(Companion_Default___.AttributeLen(s, m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1))), uint64(1))
	} else {
		return uint64(0)
	}
}
...
func (_static *CompanionStruct_Default___) FindIndexToken(s _dafny.Sequence, pos uint64) _dafny.Tuple {
	if (pos) == (uint64((s).Cardinality())) {
		return _dafny.TupleOf(uint64(0), Companion_Token_.Create_Close_())
	} else {
		var _0_ch _dafny.Char = (s).Select(uint32(pos)).(_dafny.Char)
		_ = _0_ch
		var _1_remaining uint64 = (uint64((s).Cardinality())) - (func() uint64 { return (pos) })()
		_ = _1_remaining
		if (_0_ch) == (_dafny.Char(' ')) {
			var _2_foo _dafny.Tuple = Companion_Default___.FindIndexToken(s, m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1)))
			_ = _2_foo
			if ((*(_2_foo).IndexInt(0)).(uint64)) == (uint64(0)) {
				return _dafny.TupleOf((*(_2_foo).IndexInt(0)).(uint64), (*(_2_foo).IndexInt(1)).(Token))
			} else {
				return _dafny.TupleOf(m_StandardLibrary_MemoryMath.Companion_Default___.Add((*(_2_foo).IndexInt(0)).(uint64), uint64(1)), (*(_2_foo).IndexInt(1)).(Token))
			}
		} else if (_0_ch) == (_dafny.Char('(')) {
			return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Open_())
		} else if (_0_ch) == (_dafny.Char(')')) {
			return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Close_())
		} else if (_0_ch) == (_dafny.Char(',')) {
			return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Comma_())
		} else if (_0_ch) == (_dafny.Char('=')) {
			return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Eq_())
		} else if (_0_ch) == (_dafny.Char('<')) {
			if (_1_remaining) == (uint64(1)) {
				return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Lt_())
			} else if ((s).Select(uint32((pos) + (uint64(1)))).(_dafny.Char)) == (_dafny.Char('=')) {
				return _dafny.TupleOf(uint64(2), Companion_Token_.Create_Le_())
			} else if ((s).Select(uint32((pos) + (uint64(1)))).(_dafny.Char)) == (_dafny.Char('>')) {
				return _dafny.TupleOf(uint64(2), Companion_Token_.Create_Ne_())
			} else {
				return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Lt_())
			}
		} else if (_0_ch) == (_dafny.Char('>')) {
			if (_1_remaining) == (uint64(1)) {
				return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Gt_())
			} else if ((s).Select(uint32((pos) + (uint64(1)))).(_dafny.Char)) == (_dafny.Char('=')) {
				return _dafny.TupleOf(uint64(2), Companion_Token_.Create_Ge_())
			} else {
				return _dafny.TupleOf(uint64(1), Companion_Token_.Create_Gt_())
			}
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("in"), s, pos) {
			return _dafny.TupleOf(uint64(2), Companion_Token_.Create_In_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("between"), s, pos) {
			return _dafny.TupleOf(uint64(7), Companion_Token_.Create_Between_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("and"), s, pos) {
			return _dafny.TupleOf(uint64(3), Companion_Token_.Create_And_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("or"), s, pos) {
			return _dafny.TupleOf(uint64(2), Companion_Token_.Create_Or_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("not"), s, pos) {
			return _dafny.TupleOf(uint64(3), Companion_Token_.Create_Not_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("attribute_not_exists"), s, pos) {
			return _dafny.TupleOf(uint64(20), Companion_Token_.Create_AttributeNotExists_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("attribute_type"), s, pos) {
			return _dafny.TupleOf(uint64(14), Companion_Token_.Create_AttributeType_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("begins_with"), s, pos) {
			return _dafny.TupleOf(uint64(11), Companion_Token_.Create_BeginsWith_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("attribute_exists"), s, pos) {
			return _dafny.TupleOf(uint64(16), Companion_Token_.Create_AttributeExists_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("contains"), s, pos) {
			return _dafny.TupleOf(uint64(8), Companion_Token_.Create_Contains_())
		} else if Companion_Default___.PrefixLower(_dafny.SeqOfString("size"), s, pos) {
			return _dafny.TupleOf(uint64(4), Companion_Token_.Create_Size_())
		} else if (_0_ch) == (_dafny.Char(':')) {
			var _3_x uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(Companion_Default___.ValueLen(s, m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1))), uint64(1))
			_ = _3_x
			return _dafny.TupleOf(_3_x, Companion_Token_.Create_Value_((s).Subsequence(uint32(pos), uint32((pos)+(_3_x)))))
		} else if (_0_ch) == (_dafny.Char('#')) {
			var _4_x uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(Companion_Default___.ValueLen(s, m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(1))), uint64(1))
			_ = _4_x
			return _dafny.TupleOf(_4_x, Companion_Default___.MakeAttr((s).Subsequence(uint32(pos), uint32((pos)+(_4_x)))))
		} else {
			var _5_x uint64 = Companion_Default___.AttributeLen(s, pos)
			_ = _5_x
			return _dafny.TupleOf(_5_x, Companion_Default___.MakeAttr((s).Subsequence(uint32(pos), uint32((pos)+(_5_x)))))
		}
	}
}
func (_static *CompanionStruct_Default___) VarOrSize(input _dafny.Sequence, pos uint64) uint64 {
	if (uint64((input).Cardinality())) == (pos) {
		return uint64(0)
	} else if (((input).Select(uint32(pos)).(Token)).Is_Value()) || (((input).Select(uint32(pos)).(Token)).Is_Attr()) {
		return uint64(1)
	} else if (((((m_StandardLibrary_MemoryMath.Companion_Default___.Add(uint64(3), pos)) < (uint64((input).Cardinality()))) && (((input).Select(uint32(pos)).(Token)).Is_Size())) && (((input).Select(uint32((pos) + (uint64(1)))).(Token)).Is_Open())) && (Companion_Default___.IsVar((input).Select(uint32((pos) + (uint64(2)))).(Token)))) && (((input).Select(uint32((pos) + (uint64(3)))).(Token)).Is_Close()) {
		return uint64(4)
	} else {
		return uint64(0)
	}
}
func (_static *CompanionStruct_Default___) IsBetween(input _dafny.Sequence, pos uint64) m_Wrappers.Option {
	var _0_input__size uint64 = uint64((input).Cardinality())
	_ = _0_input__size
	if (_0_input__size) < (m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(5))) {
		return m_Wrappers.Companion_Option_.Create_None_()
	} else {
		var _1_p1 uint64 = Companion_Default___.VarOrSize(input, pos)
		_ = _1_p1
		if (((uint64(0)) < (_1_p1)) && ((m_StandardLibrary_MemoryMath.Companion_Default___.Add((pos)+(_1_p1), uint64(1))) < (_0_input__size))) && (((input).Select(uint32((pos) + (_1_p1))).(Token)).Is_Between()) {
			var _2_p2 uint64 = Companion_Default___.VarOrSize(input, ((pos)+(_1_p1))+(uint64(1)))
			_ = _2_p2
			if (((uint64(0)) < (_2_p2)) && ((m_StandardLibrary_MemoryMath.Companion_Default___.Add(((pos)+(_1_p1))+(_2_p2), uint64(2))) < (_0_input__size))) && (((input).Select(uint32((((pos) + (_1_p1)) + (_2_p2)) + (uint64(1)))).(Token)).Is_And()) {
				var _3_p3 uint64 = Companion_Default___.VarOrSize(input, (((pos)+(_1_p1))+(_2_p2))+(uint64(2)))
				_ = _3_p3
				if (uint64(0)) < (_3_p3) {
					return m_Wrappers.Companion_Option_.Create_Some_(_dafny.TupleOf(_1_p1, _2_p2, _3_p3))
				} else {
					return m_Wrappers.Companion_Option_.Create_None_()
				}
			} else {
...
func (_static *CompanionStruct_Default___) IsIN(input _dafny.Sequence, pos uint64) bool {
	if (uint64((input).Cardinality())) < (m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(3))) {
		return false
	} else if !(Companion_Default___.IsVar((input).Select(uint32(pos)).(Token))) {
		return false
	} else if !((input).Select(uint32((pos) + (uint64(1)))).(Token)).Equals(Companion_Token_.Create_In_()) {
		return false
	} else if !((input).Select(uint32((pos) + (uint64(2)))).(Token)).Equals(Companion_Token_.Create_Open_()) {
		return false
	} else {
		return true
	}
}
func (_static *CompanionStruct_Default___) ConvertToPrefix(input _dafny.Sequence, pos uint64) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((input).Cardinality())) < (m_StandardLibrary_MemoryMath.Companion_Default___.Add(pos, uint64(5))) {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, (input).Drop(uint32(pos)))
	} else if Companion_Default___.IsIN(input, pos) {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf((input).Select(uint32((pos)+(uint64(1)))).(Token), (input).Select(uint32((pos)+(uint64(2)))).(Token), (input).Select(uint32(pos)).(Token), Companion_Token_.Create_Comma_()))
		var _in0 _dafny.Sequence = input
		_ = _in0
		var _in1 uint64 = (pos) + (uint64(3))
		_ = _in1
		input = _in0
		pos = _in1
		goto TAIL_CALL_START
	} else {
		var _1_between m_Wrappers.Option = Companion_Default___.IsBetween(input, pos)
		_ = _1_between
		if (_1_between).Is_Some() {
			var _2_b _dafny.Tuple = (_1_between).Dtor_value().(_dafny.Tuple)
			_ = _2_b
			_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(Companion_Token_.Create_Between_(), Companion_Token_.Create_Open_()), (input).Subsequence(uint32(pos), uint32((pos)+((*(_2_b).IndexInt(0)).(uint64))))), _dafny.SeqOf(Companion_Token_.Create_Comma_())), (input).Subsequence(uint32(((pos)+((*(_2_b).IndexInt(0)).(uint64)))+(uint64(1))), uint32((((pos)+((*(_2_b).IndexInt(0)).(uint64)))+((*(_2_b).IndexInt(1)).(uint64)))+(uint64(1))))), _dafny.SeqOf(Companion_Token_.Create_Comma_())), (input).Subsequence(uint32((((pos)+((*(_2_b).IndexInt(0)).(uint64)))+((*(_2_b).IndexInt(1)).(uint64)))+(uint64(2))), uint32(((((pos)+((*(_2_b).IndexInt(0)).(uint64)))+((*(_2_b).IndexInt(1)).(uint64)))+((*(_2_b).IndexInt(2)).(uint64)))+(uint64(2))))), _dafny.SeqOf(Companion_Token_.Create_Close_())))
			var _in2 _dafny.Sequence = input
			_ = _in2
			var _in3 uint64 = ((((pos) + ((*(_2_b).IndexInt(0)).(uint64))) + ((*(_2_b).IndexInt(1)).(uint64))) + ((*(_2_b).IndexInt(2)).(uint64))) + (uint64(2))
			_ = _in3
			input = _in2
			pos = _in3
			goto TAIL_CALL_START
		} else {
			_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf((input).Select(uint32(pos)).(Token)))
			var _in4 _dafny.Sequence = input
			_ = _in4
...
func (_static *CompanionStruct_Default___) ConvertToRpn(input _dafny.Sequence) _dafny.Sequence {
	...
	_ = _0_stack
	return Companion_Default___.ConvertToRpn__inner(input, _0_stack, uint64(0))
}
func (_static *CompanionStruct_Default___) ConvertToRpn__inner(input _dafny.Sequence, stack _dafny.Sequence, pos uint64) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (pos) == (uint64((input).Cardinality())) {
		...
		var _source0 Token = (input).Select(uint32(pos)).(Token)
		_ = _source0
		{
			if _source0.Is_Attr() {
				var _1_s _dafny.Sequence = _source0.Get_().(Token_Attr).S
				...
				var _2_loc _dafny.Sequence = _source0.Get_().(Token_Attr).Loc
				_ = _2_loc
				return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((input).Select(uint32(pos)).(Token)), Companion_Default___.ConvertToRpn__inner(input, stack, (pos)+(uint64(1))))
			}
		}
		{
			if _source0.Is_Value() {
		...
		}
		{
			...
			if disjunctiveMatch0 {
				var _in3 _dafny.Sequence = input
				_ = _in3
				var _in4 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(stack, _dafny.SeqOf((input).Select(uint32(pos)).(Token)))
				_ = _in4
				var _in5 uint64 = (pos) + (uint64(1))
				_ = _in5
				input = _in3
			...
			if _source0.Is_Comma() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Sign() == 1 {
					if Companion_Default___.IsFunction((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(Token)) {
						var _in6 _dafny.Sequence = input
						_ = _in6
						var _in7 _dafny.Sequence = stack
						_ = _in7
						var _in8 uint64 = (pos) + (uint64(1))
						_ = _in8
						input = _in6
						stack = _in7
						pos = _in8
						...
						return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(Token)), Companion_Default___.ConvertToRpn__inner(input, (stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()), (pos)+(uint64(1))))
					}
				} else {
					var _in9 _dafny.Sequence = input
					_ = _in9
					var _in10 _dafny.Sequence = stack
					_ = _in10
					var _in11 uint64 = (pos) + (uint64(1))
					_ = _in11
					input = _in9
		...
		}
		{
			if _source0.Is_Close() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Sign() == 0 {
					var _in12 _dafny.Sequence = input
					_ = _in12
					var _in13 _dafny.Sequence = stack
					_ = _in13
					var _in14 uint64 = (pos) + (uint64(1))
					_ = _in14
					input = _in12
					stack = _in13
					pos = _in14
					...
					var _in15 _dafny.Sequence = input
					_ = _in15
					var _in16 _dafny.Sequence = (stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32())
					_ = _in16
					var _in17 uint64 = (pos) + (uint64(1))
					_ = _in17
					input = _in15
					stack = _in16
					pos = _in17
		...
		}
		{
			...
			if disjunctiveMatch1 {
				if (_dafny.IntOfUint32((stack).Cardinality())).Sign() == 0 {
					var _in18 _dafny.Sequence = input
					_ = _in18
					var _in19 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(stack, _dafny.SeqOf((input).Select(uint32(pos)).(Token)))
					_ = _in19
					var _in20 uint64 = (pos) + (uint64(1))
					_ = _in20
					input = _in18
					stack = _in19
					pos = _in20
					goto TAIL_CALL_START
				} else if (Companion_Default___.Precedence((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(Token))).Cmp(Companion_Default___.Precedence((input).Select(uint32(pos)).(Token))) >= 0 {
					return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(Token)), Companion_Default___.ConvertToRpn__inner(input, (stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()), pos))
				} else {
					var _in21 _dafny.Sequence = input
					_ = _in21
					var _in22 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(stack, _dafny.SeqOf((input).Select(uint32(pos)).(Token)))
					_ = _in22
					var _in23 uint64 = (pos) + (uint64(1))
					_ = _in23
					input = _in21
					stack = _in22
					pos = _in23
		...
		{
			var _in24 _dafny.Sequence = input
			_ = _in24
			var _in25 _dafny.Sequence = stack
			_ = _in25
			var _in26 uint64 = (pos) + (uint64(1))
			_ = _in26
			input = _in24
			stack = _in25
			pos = _in26
...
func (_static *CompanionStruct_Default___) GetParsedExpr(input _dafny.Sequence) m_Wrappers.Result {
	var _0_seq1 _dafny.Sequence = Companion_Default___.ParseExpr(input, uint64(0))
	_ = _0_seq1
	var _1_seq2 _dafny.Sequence = Companion_Default___.ConvertToPrefix(_0_seq1, uint64(0))
	_ = _1_seq2
...
func (_static *CompanionStruct_Default___) EvalExpr(input _dafny.Sequence, item _dafny.Map, names m_Wrappers.Option, values _dafny.Map) m_Wrappers.Result {
	...
	_ = _out0
	_out0 = Companion_Default___.InnerEvalExpr(input, _dafny.SeqOf(), item, names, values, uint64(0))
	ret = _out0
	return ret
}
...
func (_static *CompanionStruct_Default___) Seq__contains(haystack _dafny.Sequence, needle _dafny.Sequence) bool {
	var ret bool = false
	_ = ret
	var _0_result m_Wrappers.Option
	_ = _0_result
	var _out0 m_Wrappers.Option
	_ = _out0
	_out0 = m_StandardLibrary_String.Companion_Default___.HasSubString(haystack, needle)
	_0_result = _out0
	...
	{
		{
			if _source0.Is_S() {
				...
				if (needle).Is_S() {
					var _out0 bool
					_ = _out0
					_out0 = Companion_Default___.Seq__contains((haystack).Dtor_S(), (needle).Dtor_S())
					ret = _out0
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_N() {
				...
				if (needle).Is_N() {
					var _out1 bool
					_ = _out1
					_out1 = Companion_Default___.Seq__contains((haystack).Dtor_N(), (needle).Dtor_N())
					ret = _out1
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_B() {
				...
				if (needle).Is_B() {
					var _out2 bool
					_ = _out2
					_out2 = Companion_Default___.Seq__contains((haystack).Dtor_B(), (needle).Dtor_B())
					ret = _out2
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_SS() {
				...
				_ = _3_s
				if (needle).Is_S() {
					ret = _dafny.Companion_Sequence_.Contains((haystack).Dtor_SS(), (needle).Dtor_S())
					return ret
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_NS() {
				...
				_ = _4_s
				if (needle).Is_N() {
					ret = _dafny.Companion_Sequence_.Contains((haystack).Dtor_NS(), (needle).Dtor_N())
					return ret
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_BS() {
				...
				_ = _5_s
				if (needle).Is_B() {
					ret = _dafny.Companion_Sequence_.Contains((haystack).Dtor_BS(), (needle).Dtor_B())
					return ret
				} else {
					ret = false
					return ret
		...
		}
		{
			if _source0.Is_L() {
				...
				_ = _6_list
				ret = _dafny.Companion_Sequence_.Contains(_6_list, needle)
				return ret
				goto Lmatch0
			}
		}
...
func (_static *CompanionStruct_Default___) Is__in(target m_ComAmazonawsDynamodbTypes.AttributeValue, list _dafny.Sequence, pos uint64) bool {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((list).Cardinality())) == (pos) {
		return false
	} else if (Companion_Default___.GetStr((list).Select(uint32(pos)).(StackValue))).Equals(target) {
		return true
	} else {
		var _in0 m_ComAmazonawsDynamodbTypes.AttributeValue = target
		_ = _in0
		var _in1 _dafny.Sequence = list
		_ = _in1
...
func (_static *CompanionStruct_Default___) Apply__function(input Token, stack _dafny.Sequence, num__args _dafny.Int) m_Wrappers.Result {
	var result m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(Companion_StackValue_.Default())
	_ = result
	...
	{
		{
			if _source0.Is_Between() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.IntOfInt64(3)) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for Between")))
					return result
					...
					var _1_ret bool
					_ = _1_ret
					_1_ret = (_0_valueOrError0).Extract().(bool)
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(_1_ret))
					return result
				} else {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Wrong Types for Between")))
					return result
				}
				goto Lmatch0
			}
		...
		{
			if _source0.Is_In() {
				var _2_num _dafny.Int
				_ = _2_num
				_2_num = Companion_Default___.StringsFollowing(stack)
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_2_num) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Tautology False")))
					return result
				} else if (_2_num).Sign() == 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("In has no args")))
					return result
				} else {
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(Companion_Default___.Is__in(Companion_Default___.GetStr((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_2_num)).Uint32()).(StackValue)), (stack).Drop((((_dafny.IntOfUint32((stack).Cardinality())).Minus(_2_num)).Plus(_dafny.One)).Uint32()), uint64(0))))
					return result
				}
				goto Lmatch0
			}
		}
		{
			if _source0.Is_AttributeExists() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.One) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for AttributeExists")))
					return result
				} else {
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(!(((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue)).Is_DoesNotExist())))
					return result
				}
				goto Lmatch0
			}
		...
		}
		{
			if _source0.Is_AttributeType() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.IntOfInt64(2)) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for AttributeType")))
					return result
				} else {
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(Companion_Default___.IsAttrType((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint32()).(StackValue), (stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue))))
					return result
				}
				goto Lmatch0
			}
		}
		{
			if _source0.Is_BeginsWith() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.IntOfInt64(2)) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for BeginsWith")))
					return result
					...
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Wrong Types for BeginsWith")))
					return result
				}
				goto Lmatch0
			}
		}
		{
			if _source0.Is_Contains() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.IntOfInt64(2)) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for contains")))
					return result
				} else if (((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue)).Is_Str()) && (((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint32()).(StackValue)).Is_Str()) {
					var _3_xxx bool
					_ = _3_xxx
					var _out0 bool
					_ = _out0
					_out0 = Companion_Default___.Does__contain(((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint32()).(StackValue)).Dtor_s(), ((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue)).Dtor_s())
					_3_xxx = _out0
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(_3_xxx))
					return result
				} else {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Wrong Types for contains")))
					return result
				}
				goto Lmatch0
			}
		}
		{
			if _source0.Is_Size() {
				if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.One) < 0 {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("No Stack for Size")))
					return result
				} else if !(((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue)).Is_Str()) {
					result = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Wrong Types for Size")))
					return result
				} else {
					var _4_n _dafny.Int
					_ = _4_n
					_4_n = Companion_Default___.GetSize(((stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue)).Dtor_s())
					result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Str_(m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_N_(m_StandardLibrary_String.Companion_Default___.Base10Int2String(_4_n))))
					return result
				}
				goto Lmatch0
			}
		...
		{
			result = m_Wrappers.Companion_Result_.Create_Success_(Companion_StackValue_.Create_Bool_(true))
			return result
		}
		goto Lmatch0
	}
...
func (_static *CompanionStruct_Default___) CompareFloat(x _dafny.Sequence, y _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (m_DynamoDbNormalizeNumber.Companion_Default___.NormalizeNumber(x)).MapFailure(func(coer114 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg143 interface{}) interface{} {
			return coer114(arg143.(_dafny.Sequence))
		}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _2_newX
		var _3_valueOrError1 m_Wrappers.Result = (m_DynamoDbNormalizeNumber.Companion_Default___.NormalizeNumber(y)).MapFailure(func(coer115 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg144 interface{}) interface{} {
				return coer115(arg144.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) AttributeLE(a m_ComAmazonawsDynamodbTypes.AttributeValue, b m_ComAmazonawsDynamodbTypes.AttributeValue) m_Wrappers.Result {
	if ((a).Is_N()) && ((b).Is_N()) {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(m_StandardLibrary.Companion_Default___.LexicographicLessOrEqual((a).Dtor_B(), (b).Dtor_B(), func(coer116 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
			return func(arg145 interface{}, arg146 interface{}) bool {
				return coer116(arg145.(uint8), arg146.(uint8))
			}
...
func (_static *CompanionStruct_Default___) InnerEvalExpr(input _dafny.Sequence, stack _dafny.Sequence, item _dafny.Map, names m_Wrappers.Option, values _dafny.Map, pos uint64) m_Wrappers.Result {
	var ret m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
	_ = ret
	if (pos) == (uint64((input).Cardinality())) {
		if ((_dafny.One).Cmp(_dafny.IntOfUint32((stack).Cardinality())) == 0) && (((stack).Select(0).(StackValue)).Is_Bool()) {
			ret = m_Wrappers.Companion_Result_.Create_Success_(((stack).Select(0).(StackValue)).Dtor_b())
			return ret
		} else {
			ret = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("ended with bad stack")))
			return ret
		}
	} else {
		var _0_t Token
		_ = _0_t
		_0_t = (input).Select(uint32(pos)).(Token)
		if (_0_t).Is_Value() {
			var _out0 m_Wrappers.Result
			_ = _out0
			_out0 = Companion_Default___.InnerEvalExpr(input, _dafny.Companion_Sequence_.Concatenate(stack, _dafny.SeqOf(Companion_Default___.StackValueFromValue((_0_t).Dtor_s(), values))), item, names, values, (pos)+(uint64(1)))
			ret = _out0
		} else if (_0_t).Is_Attr() {
			var _out1 m_Wrappers.Result
			_ = _out1
			_out1 = Companion_Default___.InnerEvalExpr(input, _dafny.Companion_Sequence_.Concatenate(stack, _dafny.SeqOf(Companion_Default___.StackValueFromAttr(_0_t, item, names))), item, names, values, (pos)+(uint64(1)))
			ret = _out1
		} else if Companion_Default___.IsUnary(_0_t) {
			if (_dafny.IntOfUint32((stack).Cardinality())).Sign() == 0 {
				ret = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Empty stack for unary op")))
			} else {
				var _1_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(Companion_StackValue_.Default())
				_ = _1_valueOrError0
				_1_valueOrError0 = Companion_Default___.Apply__unary(_0_t, (stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue))
				if (_1_valueOrError0).IsFailure() {
					ret = (_1_valueOrError0).PropagateFailure()
					return ret
				}
				var _2_val StackValue
				_ = _2_val
				_2_val = (_1_valueOrError0).Extract().(StackValue)
				var _out2 m_Wrappers.Result
				_ = _out2
				_out2 = Companion_Default___.InnerEvalExpr(input, _dafny.Companion_Sequence_.Concatenate((stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()), _dafny.SeqOf(_2_val)), item, names, values, (pos)+(uint64(1)))
				ret = _out2
			}
		} else if Companion_Default___.IsBinary(_0_t) {
			if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_dafny.IntOfInt64(2)) < 0 {
				ret = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Empty stack for binary op")))
			} else {
				var _3_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(Companion_StackValue_.Default())
				_ = _3_valueOrError1
				_3_valueOrError1 = Companion_Default___.Apply__binary(_0_t, (stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint32()).(StackValue), (stack).Select(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.One)).Uint32()).(StackValue))
				if (_3_valueOrError1).IsFailure() {
					ret = (_3_valueOrError1).PropagateFailure()
					return ret
				}
				var _4_val StackValue
				_ = _4_val
				_4_val = (_3_valueOrError1).Extract().(StackValue)
				var _out3 m_Wrappers.Result
				_ = _out3
				_out3 = Companion_Default___.InnerEvalExpr(input, _dafny.Companion_Sequence_.Concatenate((stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint32()), _dafny.SeqOf(_4_val)), item, names, values, (pos)+(uint64(1)))
				ret = _out3
			}
		} else if Companion_Default___.IsFunction(_0_t) {
			var _5_num__args _dafny.Int
			_ = _5_num__args
			_5_num__args = Companion_Default___.NumArgs(_0_t, stack)
			if (_dafny.IntOfUint32((stack).Cardinality())).Cmp(_5_num__args) < 0 {
				ret = m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Empty stack for function call")))
			} else {
				var _6_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(Companion_StackValue_.Default())
				_ = _6_valueOrError2
				var _out4 m_Wrappers.Result
				_ = _out4
				_out4 = Companion_Default___.Apply__function(_0_t, stack, _5_num__args)
				_6_valueOrError2 = _out4
				if (_6_valueOrError2).IsFailure() {
					ret = (_6_valueOrError2).PropagateFailure()
					return ret
				}
				var _7_val StackValue
				_ = _7_val
				_7_val = (_6_valueOrError2).Extract().(StackValue)
				var _out5 m_Wrappers.Result
				_ = _out5
				_out5 = Companion_Default___.InnerEvalExpr(input, _dafny.Companion_Sequence_.Concatenate((stack).Take(((_dafny.IntOfUint32((stack).Cardinality())).Minus(_5_num__args)).Uint32()), _dafny.SeqOf(_7_val)), item, names, values, (pos)+(uint64(1)))
				ret = _out5
			}
		} else {
...
func (_static *CompanionStruct_Default___) FilterItems(b m_SearchableEncryptionInfo.BeaconVersion, parsed _dafny.Sequence, ItemList _dafny.Sequence, names m_Wrappers.Option, values _dafny.Map) m_Wrappers.Result {
	...
	for _1_i := _dafny.Zero; _1_i.Cmp(_hi0) < 0; _1_i = _1_i.Plus(_dafny.One) {
		...
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.EvalExpr(parsed, ((ItemList).Select((_1_i).Uint32()).(_dafny.Map)).Merge(_3_newAttrs), names, values)
...
func (_static *CompanionStruct_Default___) FilterResults(b m_SearchableEncryptionInfo.BeaconVersion, ItemList _dafny.Sequence, KeyExpression m_Wrappers.Option, FilterExpression m_Wrappers.Option, names m_Wrappers.Option, values m_Wrappers.Option) m_Wrappers.Result {
	...
	if ((_dafny.IntOfUint32((ItemList).Cardinality())).Sign() == 0) || (((KeyExpression).Is_None()) && ((FilterExpression).Is_None())) {
		...
		if (KeyExpression).Is_Some() {
			...
			_ = _1_parsed
			_1_parsed = Companion_Default___.ParseExpr((KeyExpression).Dtor_value().(_dafny.Sequence), uint64(0))
			...
			_ = _4_expr1
			_4_expr1 = Companion_Default___.ConvertToPrefix((_3_expr).Dtor_expr(), uint64(0))
		...
		if (FilterExpression).Is_Some() {
			...
			_ = _7_parsed
			_7_parsed = Companion_Default___.ParseExpr((FilterExpression).Dtor_value().(_dafny.Sequence), uint64(0))
			...
			_ = _10_expr1
			_10_expr1 = Companion_Default___.ConvertToPrefix((_9_expr).Dtor_expr(), uint64(0))
...
func (_static *CompanionStruct_Default___) KeyIdFromPart(bv m_SearchableEncryptionInfo.BeaconVersion, keyIdField _dafny.Sequence, attr _dafny.Sequence, value _dafny.Sequence) m_Wrappers.Option {
	if (!((bv).Dtor_beacons()).Contains(attr)) || ((((bv).Dtor_beacons()).Get(attr).(m_SearchableEncryptionInfo.Beacon)).Is_Standard()) {
		...
		_ = _0_parts
		var _1_theParts _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer117 func(m_CompoundBeacon.BeaconPart) bool) func(interface{}) bool {
			return func(arg147 interface{}) bool {
				return coer117(arg147.(m_CompoundBeacon.BeaconPart))
			}
		...
		if (_dafny.IntOfUint32((_1_theParts).Cardinality())).Cmp(_dafny.One) != 0 {
			...
			_ = _4_pieces
			var _5_piece _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer118 func(_dafny.Sequence) bool) func(interface{}) bool {
				return func(arg148 interface{}) bool {
					return coer118(arg148.(_dafny.Sequence))
				}
...
func (_static *CompanionStruct_Default___) GetBeaconKeyIds(bv m_SearchableEncryptionInfo.BeaconVersion, expr m_Wrappers.Option, values _dafny.Map, names m_Wrappers.Option, soFar _dafny.Sequence) m_Wrappers.Result {
	if (expr).Is_None() {
		...
		var _0_parsed _dafny.Sequence = Companion_Default___.ParseExpr((expr).Dtor_value().(_dafny.Sequence), uint64(0))
		_ = _0_parsed
...
func (_static *CompanionStruct_Default___) Beaconize(b m_SearchableEncryptionInfo.BeaconVersion, context ExprContext, keyId m_DynamoDbEncryptionUtil.MaybeKeyId, naked bool) m_Wrappers.Result {
	...
	if (((context).Dtor_keyExpr()).Is_None()) && (((context).Dtor_filterExpr()).Is_None()) {
		...
		if ((context).Dtor_keyExpr()).Is_Some() {
			var _7_parsed _dafny.Sequence
			_ = _7_parsed
			_7_parsed = Companion_Default___.ParseExpr(((context).Dtor_keyExpr()).Dtor_value().(_dafny.Sequence), uint64(0))
		...
		if ((context).Dtor_filterExpr()).Is_Some() {
			...
			_ = _10_parsed
			_10_parsed = Companion_Default___.ParseExpr(((context).Dtor_filterExpr()).Dtor_value().(_dafny.Sequence), uint64(0))
...
func (_static *CompanionStruct_Default___) TestBeaconize(actions _dafny.Map, keyExpr m_Wrappers.Option, filterExpr m_Wrappers.Option, names m_Wrappers.Option) m_Wrappers.Result {
	...
	_0_encrypted = func() _dafny.Set {
		...
		_ = _coll0
		for _iter22 := _dafny.Iterate((actions).Keys().Elements()); ; {
	...
	if (keyExpr).Is_Some() {
		...
		_ = _out0
		_out0 = Companion_Default___.TestParsedExpr(Companion_Default___.ParseExpr((keyExpr).Dtor_value().(_dafny.Sequence), uint64(0)), _0_encrypted, names)
		_2_valueOrError0 = _out0
		if (_2_valueOrError0).IsFailure() {
			output = (_2_valueOrError0).PropagateFailure()
			return output
	...
	if (filterExpr).Is_Some() {
		...
		_ = _out1
		_out1 = Companion_Default___.TestParsedExpr(Companion_Default___.ParseExpr((filterExpr).Dtor_value().(_dafny.Sequence), uint64(0)), _0_encrypted, names)
