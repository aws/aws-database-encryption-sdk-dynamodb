...
func (_static *CompanionStruct_Default___) ResolveLegend(fields _dafny.Sequence, legend _dafny.Sequence, pos uint64, legendPos uint64, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((fields).Cardinality())) == (pos) {
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64((legend).Cardinality())) == (legendPos), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Schema changed : something that was signed is now unsigned.")))
		_ = _0_valueOrError0
	...
	} else if (((fields).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonAuthItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_AuthenticateAction_.Create_DO__NOT__SIGN_()) {
		...
		_ = _in2
		var _in3 uint64 = legendPos
		_ = _in3
		var _in4 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(Companion_Default___.MakeCryptoItem((fields).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonAuthItem), m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_DO__NOTHING_())))
		_ = _in4
		fields = _in0
		legend = _in1
		pos = _in2
		...
		var _1_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((legendPos) < (uint64((legend).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Schema changed : something that was unsigned is now signed.")))
		_ = _1_valueOrError1
		if (_1_valueOrError1).IsFailure() {
			...
			_ = _in7
			var _in8 uint64 = (legendPos) + (uint64(1))
			_ = _in8
			var _in9 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(Companion_Default___.MakeCryptoItem((fields).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonAuthItem), Companion_Default___.LegendToAction((legend).Select(uint32(legendPos)).(uint8)))))
			_ = _in9
			fields = _in5
			legend = _in6
			pos = _in7
...
func (_static *CompanionStruct_Default___) AuthToCanonAuth(tableName _dafny.Sequence, data _dafny.Sequence) _dafny.Sequence {
	var _0_canonList _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer16 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem) m_StructuredEncryptionUtil.CanonAuthItem) func(interface{}) interface{} {
		return func(arg25 interface{}) interface{} {
			return coer16(arg25.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem))
		}
...
func (_static *CompanionStruct_Default___) CryptoToCanonCrypto(tableName _dafny.Sequence, data _dafny.Sequence) _dafny.Sequence {
	var _0_canonList _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer17 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) m_StructuredEncryptionUtil.CanonCryptoItem) func(interface{}) interface{} {
		return func(arg26 interface{}) interface{} {
			return coer17(arg26.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
		}
...
func (_static *CompanionStruct_Default___) DoResolveLegend(canonSorted _dafny.Sequence, legend _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.ResolveLegend(canonSorted, legend, uint64(0), uint64(0), _dafny.SeqOf())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) UnCanon(input _dafny.Sequence, pos uint64, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((input).Cardinality())) == (pos) {
		return acc
	} else {
		var _0_newItem m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem = m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoItem_.Create_CryptoItem_(((input).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_origKey(), ((input).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data(), ((input).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action())
		_ = _0_newItem
...
func (_static *CompanionStruct_Default___) UnCanonDecrypt(input _dafny.Sequence) _dafny.Sequence {
	var _0_results _dafny.Sequence = Companion_Default___.UnCanon(input, uint64(0), _dafny.SeqOf())
	_ = _0_results
	return _0_results
}
...
func (_static *CompanionStruct_Default___) RemoveHeaderPaths(xs _dafny.Sequence, pos uint64, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((xs).Cardinality())) == (pos) {
		return acc
	} else if _dafny.Companion_Sequence_.Contains(_dafny.SeqOf(m_StructuredEncryptionUtil.Companion_Default___.HeaderPath(), m_StructuredEncryptionUtil.Companion_Default___.FooterPath()), ((xs).Select(uint32(pos)).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key()) {
		...
		_ = _in4
		var _in5 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf((xs).Select(uint32(pos)).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)))
		_ = _in5
		xs = _in3
		pos = _in4
		acc = _in5
...
func (_static *CompanionStruct_Default___) RemoveHeaders(input _dafny.Sequence) _dafny.Sequence {
	var _0_finalData _dafny.Sequence = Companion_Default___.RemoveHeaderPaths(input, uint64(0), _dafny.SeqOf())
	_ = _0_finalData
	return _0_finalData
}
