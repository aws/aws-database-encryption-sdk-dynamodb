...
func (_static *CompanionStruct_Default___) StructuredEncryption(config m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredEncryptionConfig) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_maybePrimitives).MapFailure(func(coer41 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg57 interface{}) interface{} {
			return coer41(arg57.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	_ = _5_valueOrError1
	_5_valueOrError1 = (_4_maybeMatProv).MapFailure(func(coer42 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg58 interface{}) interface{} {
			return coer42(arg58.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
