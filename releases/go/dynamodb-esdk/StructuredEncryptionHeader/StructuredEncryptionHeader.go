...
func (_static *CompanionStruct_Default___) ValidEncryptionContext(x _dafny.Map) bool {
	return ((uint64((x).CardinalityInt())) < ((m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()).Uint64())) && (_dafny.Quantifier((x).Keys().Elements(), true, func(_forall_var_0 _dafny.Sequence) bool {
		var _0_k _dafny.Sequence
		_0_k = interface{}(_forall_var_0).(_dafny.Sequence)
		return !((x).Contains(_0_k)) || (((uint64((_0_k).Cardinality())) < ((m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()).Uint64())) && ((uint64(((x).Get(_0_k).(_dafny.Sequence)).Cardinality())) < ((m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()).Uint64())))
	}))
}
...
func (_static *CompanionStruct_Default___) Create(tableName _dafny.Sequence, schema _dafny.Sequence, msgID _dafny.Sequence, mat m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64((schema).Cardinality())) < ((m_StandardLibrary_UInt.Companion_Default___.UINT32__LIMIT()).Uint64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected large schema")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		...
		if (_1_valueOrError1).IsFailure() {
			...
			var _2_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(0)) < (uint64(((mat).Dtor_encryptedDataKeys()).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("There must be at least one data key")))
			_ = _2_valueOrError2
			if (_2_valueOrError2).IsFailure() {
				return (_2_valueOrError2).PropagateFailure()
			} else {
				var _3_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(((mat).Dtor_encryptedDataKeys()).Cardinality())) < (Companion_Default___.UINT8__LIMIT64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too many data keys.")))
				_ = _3_valueOrError3
				if (_3_valueOrError3).IsFailure() {
					...
					if (_4_valueOrError4).IsFailure() {
						...
						var _6_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Cardinality())) == (uint64(2)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid Algorithm Suite Binary ID")))
						_ = _6_valueOrError5
						if (_6_valueOrError5).IsFailure() {
							return (_6_valueOrError5).PropagateFailure()
						} else {
							var _7_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(uint32(uint32(0))).(uint8)) == (m_StructuredEncryptionUtil.Companion_Default___.DbeAlgorithmFamily()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Algorithm Suite not suitable for structured encryption.")))
							_ = _7_valueOrError6
							if (_7_valueOrError6).IsFailure() {
								return (_7_valueOrError6).PropagateFailure()
							} else {
								var _8_valueOrError7 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.ValidFlavor((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(uint32(uint32(1))).(uint8)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Algorithm Suite has unexpected flavor.")))
								_ = _8_valueOrError7
								if (_8_valueOrError7).IsFailure() {
									...
									if (_9_valueOrError8).IsFailure() {
										...
										if (_13_valueOrError9).IsFailure() {
											...
											return m_Wrappers.Companion_Result_.Create_Success_(Companion_PartialHeader_.Create_PartialHeader_(Companion_Default___.VersionFromSchema(schema), (((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(uint32(uint32(1))).(uint8), msgID, _10_legend, _11_storedEC, (mat).Dtor_encryptedDataKeys()))
										}
									}
								}
							}
...
func (_static *CompanionStruct_Default___) PartialDeserialize(data _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((Companion_Default___.PREFIX__LEN64()) <= (uint64((data).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Serialized PartialHeader too short.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_version uint8 = (data).Select(uint32(uint32(0))).(uint8)
		_ = _1_version
		...
		if (_2_valueOrError1).IsFailure() {
			...
			var _3_flavor uint8 = (data).Select(uint32(uint32(1))).(uint8)
			_ = _3_flavor
			...
			if (_4_valueOrError2).IsFailure() {
				...
				var _5_msgID _dafny.Sequence = (data).Subsequence(uint32(uint32(2)), uint32(Companion_Default___.PREFIX__LEN64()))
				_ = _5_msgID
				var _6_legendData _dafny.Sequence = (data).Drop(uint32(Companion_Default___.PREFIX__LEN64()))
				_ = _6_legendData
				...
				if (_7_valueOrError3).IsFailure() {
					...
					_ = _9_legend
					var _10_contextData _dafny.Sequence = (_6_legendData).Drop(uint32((*(_8_legendAndLen).IndexInt(1)).(uint64)))
					_ = _10_contextData
					...
					if (_11_valueOrError4).IsFailure() {
						...
						_ = _13_encContext
						var _14_keysData _dafny.Sequence = (_10_contextData).Drop(uint32((*(_12_contextAndLen).IndexInt(1)).(uint64)))
						_ = _14_keysData
						...
						if (_15_valueOrError5).IsFailure() {
							...
							_ = _17_dataKeys
							var _18_trailingData _dafny.Sequence = (_14_keysData).Drop(uint32((*(_16_keysAndLen).IndexInt(1)).(uint64)))
							_ = _18_trailingData
							var _19_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64((_18_trailingData).Cardinality())) >= (Companion_Default___.COMMITMENT__LEN64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid header serialization: unexpected end of data.")))
							_ = _19_valueOrError6
							if (_19_valueOrError6).IsFailure() {
								return (_19_valueOrError6).PropagateFailure()
							} else {
								var _20_valueOrError7 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64((_18_trailingData).Cardinality())) <= (Companion_Default___.COMMITMENT__LEN64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid header serialization: unexpected bytes.")))
								_ = _20_valueOrError7
...
func (_static *CompanionStruct_Default___) CalculateHeaderCommitment(client m_AwsCryptographyPrimitivesTypes.IAwsCryptographicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, commitKey _dafny.Sequence, data _dafny.Sequence) m_Wrappers.Result {
	...
	if (_2_valueOrError0).IsFailure() {
		...
		_ = _4_output
		if (uint64((_4_output).Cardinality())) < (Companion_Default___.COMMITMENT__LEN64()) {
			...
			return m_Wrappers.Companion_Result_.Create_Success_((_4_output).Take(uint32(Companion_Default___.COMMITMENT__LEN64())))
		}
	}
}
...
func (_static *CompanionStruct_Default___) MakeLegend(schema _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.MakeLegend2(schema, uint64(0), Companion_Default___.EmptyLegend())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		_ = _1_legend
		var _2_authCount uint64 = Companion_Default___.CountAuthAttrs(schema, uint64(0), uint64(0))
		_ = _2_authCount
		var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_2_authCount) == (uint64((_1_legend).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Internal Error : bad legend calculation.")))
		_ = _3_valueOrError1
...
func (_static *CompanionStruct_Default___) MakeLegend2(data _dafny.Sequence, pos uint64, serialized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((data).Cardinality())) == (pos) {
		return m_Wrappers.Companion_Result_.Create_Success_(serialized)
	} else if m_StructuredEncryptionUtil.Companion_Default___.IsAuthAttr(((data).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()) {
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((uint64((serialized).Cardinality()))+(uint64(1))) < ((m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()).Uint64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Legend Too Long.")))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			var _1_legendChar uint8 = Companion_Default___.GetActionLegend(((data).Select(uint32(pos)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action())
			_ = _1_legendChar
			var _in0 _dafny.Sequence = data
			_ = _in0
...
func (_static *CompanionStruct_Default___) CountAuthAttrs(data _dafny.Sequence, pos uint64, acc uint64) uint64 {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((data).Cardinality())) == (pos) {
		return acc
		...
		var _in1 uint64 = (pos) + (uint64(1))
		_ = _in1
		var _in2 uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(acc, uint64(1))
		_ = _in2
		data = _in0
		pos = _in1
		acc = _in2
...
func (_static *CompanionStruct_Default___) GetLegend(data _dafny.Sequence) m_Wrappers.Result {
	var _0_data__size uint64 = uint64((data).Cardinality())
	_ = _0_data__size
	var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(2)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _1_valueOrError0
	if (_1_valueOrError0).IsFailure() {
		return (_1_valueOrError0).PropagateFailure()
	} else {
		var _2_len uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, uint64(0)))
		_ = _2_len
		var _3_size uint64 = m_StandardLibrary_MemoryMath.Companion_Default___.Add(_2_len, uint64(2))
		_ = _3_size
		var _4_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_3_size) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
		_ = _4_valueOrError1
		if (_4_valueOrError1).IsFailure() {
			return (_4_valueOrError1).PropagateFailure()
		} else {
			var _5_legend _dafny.Sequence = (data).Subsequence(uint32(uint32(2)), uint32(_3_size))
			_ = _5_legend
			var _6_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(_dafny.Quantifier((_5_legend).UniqueElements(), true, func(_forall_var_0 uint8) bool {
				var _7_x uint8
				_7_x = interface{}(_forall_var_0).(uint8)
				if true {
					return !(_dafny.Companion_Sequence_.Contains(_5_legend, _7_x)) || (Companion_Default___.ValidLegendByte(_7_x))
				} else {
					return true
				}
			...
			if (_6_valueOrError2).IsFailure() {
				...
				return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(_5_legend, _3_size))
			}
		}
	}
}
func (_static *CompanionStruct_Default___) GetContext(data _dafny.Sequence) m_Wrappers.Result {
	...
	if (_1_valueOrError0).IsFailure() {
		...
		var _2_count uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, uint64(0)))
		_ = _2_count
		var _3_valueOrError1 m_Wrappers.Result = Companion_Default___.GetContext2(_2_count, data, _dafny.TupleOf(_dafny.NewMapBuilder().ToMap(), uint64(2)), _dafny.SeqOf())
		_ = _3_valueOrError1
		if (_3_valueOrError1).IsFailure() {
			return (_3_valueOrError1).PropagateFailure()
		} else {
			var _4_context _dafny.Tuple = (_3_valueOrError1).Extract().(_dafny.Tuple)
			_ = _4_context
			return m_Wrappers.Companion_Result_.Create_Success_(_4_context)
		}
	}
}
func (_static *CompanionStruct_Default___) GetOneKVPair(data _dafny.Sequence, pos uint64) m_Wrappers.Result {
	var _0_data__size uint64 = uint64((data).Cardinality())
	_ = _0_data__size
	var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add(uint64(2), pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _1_valueOrError0
	if (_1_valueOrError0).IsFailure() {
		return (_1_valueOrError0).PropagateFailure()
	} else {
		var _2_keyLen uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, pos))
		_ = _2_keyLen
		var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_2_keyLen, uint64(4), pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
		_ = _3_valueOrError1
		if (_3_valueOrError1).IsFailure() {
			return (_3_valueOrError1).PropagateFailure()
		} else {
			var _4_key _dafny.Sequence = (data).Subsequence(uint32((uint64(2))+(pos)), uint32(m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_2_keyLen, uint64(2), pos)))
			_ = _4_key
			var _5_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_UTF8.Companion_Default___.ValidUTF8Seq(_4_key), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid UTF8 found in header.")))
			_ = _5_valueOrError2
			if (_5_valueOrError2).IsFailure() {
				return (_5_valueOrError2).PropagateFailure()
			} else {
				var _6_valueLen uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_2_keyLen, uint64(2), pos)))
				_ = _6_valueLen
				var _7_kvLen uint64 = (((uint64(2)) + (_2_keyLen)) + (uint64(2))) + (_6_valueLen)
				_ = _7_kvLen
				var _8_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add(_7_kvLen, pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
				_ = _8_valueOrError3
				if (_8_valueOrError3).IsFailure() {
					return (_8_valueOrError3).PropagateFailure()
				} else {
					var _9_value _dafny.Sequence = (data).Subsequence(uint32(((_2_keyLen)+(uint64(4)))+(pos)), uint32((_7_kvLen)+(pos)))
					_ = _9_value
					var _10_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_UTF8.Companion_Default___.ValidUTF8Seq(_9_value), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid UTF8 found in header.")))
					_ = _10_valueOrError4
					if (_10_valueOrError4).IsFailure() {
						return (_10_valueOrError4).PropagateFailure()
					} else {
						return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(_4_key, _9_value, _7_kvLen))
					}
				}
			}
		}
...
func (_static *CompanionStruct_Default___) BytesLess(a _dafny.Sequence, b _dafny.Sequence, pos uint64) bool {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if _dafny.Companion_Sequence_.Equal(a, b) {
		return false
	} else if (uint64((a).Cardinality())) == (pos) {
		return true
	} else if (uint64((b).Cardinality())) == (pos) {
		return false
	} else if ((a).Select(uint32(pos)).(uint8)) != ((b).Select(uint32(pos)).(uint8)) /* dircomp */ {
		return ((a).Select(uint32(pos)).(uint8)) < ((b).Select(uint32(pos)).(uint8))
	} else {
...
func (_static *CompanionStruct_Default___) GetContext2(count uint64, data _dafny.Sequence, deserialized _dafny.Tuple, prevKey _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (count) == (uint64(0)) {
		return m_Wrappers.Companion_Result_.Create_Success_(deserialized)
	} else {
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((uint64(((*(deserialized).IndexInt(0)).(_dafny.Map)).CardinalityInt()))+(uint64(1))) < ((m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()).Uint64()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too much context")))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			var _1_valueOrError1 m_Wrappers.Result = Companion_Default___.GetOneKVPair(data, (*(deserialized).IndexInt(1)).(uint64))
			_ = _1_valueOrError1
			if (_1_valueOrError1).IsFailure() {
				return (_1_valueOrError1).PropagateFailure()
			} else {
				...
				_ = _2_kv
				var _3_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.BytesLess(prevKey, (*(_2_kv).IndexInt(0)).(_dafny.Sequence), uint64(0)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Context keys out of order.")))
				_ = _3_valueOrError2
				if (_3_valueOrError2).IsFailure() {
					return (_3_valueOrError2).PropagateFailure()
				} else {
					var _in0 uint64 = (count) - (func() uint64 { return (uint64(1)) })()
					_ = _in0
					var _in1 _dafny.Sequence = data
					_ = _in1
					var _in2 _dafny.Tuple = _dafny.TupleOf(((*(deserialized).IndexInt(0)).(_dafny.Map)).Update((*(_2_kv).IndexInt(0)).(_dafny.Sequence), (*(_2_kv).IndexInt(1)).(_dafny.Sequence)), m_StandardLibrary_MemoryMath.Companion_Default___.Add((*(deserialized).IndexInt(1)).(uint64), (*(_2_kv).IndexInt(2)).(uint64)))
					_ = _in2
...
func (_static *CompanionStruct_Default___) SerializeContext(x _dafny.Map) _dafny.Sequence {
	...
	_ = _0_keys
	return _dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt16ToSeq(uint16((x).CardinalityInt())), Companion_Default___.SerializeContext2(_0_keys, x, uint64(0), _dafny.SeqOf()))
}
...
func (_static *CompanionStruct_Default___) GetOneDataKey(data _dafny.Sequence, pos uint64) m_Wrappers.Result {
	var _0_data__size uint64 = uint64((data).Cardinality())
	_ = _0_data__size
	var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add(uint64(2), pos)) < (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _1_valueOrError0
	if (_1_valueOrError0).IsFailure() {
		...
		var _2_provIdSize uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, pos))
		_ = _2_provIdSize
		var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_2_provIdSize, uint64(2), pos)) < (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
		_ = _3_valueOrError1
		if (_3_valueOrError1).IsFailure() {
			return (_3_valueOrError1).PropagateFailure()
		} else {
			var _4_provId _dafny.Sequence = (data).Subsequence(uint32((pos)+(uint64(2))), uint32(((pos)+(uint64(2)))+(_2_provIdSize)))
			_ = _4_provId
			var _5_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_UTF8.Companion_Default___.ValidUTF8Seq(_4_provId), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid UTF8 found in header.")))
			_ = _5_valueOrError2
			if (_5_valueOrError2).IsFailure() {
				return (_5_valueOrError2).PropagateFailure()
			} else {
				var _6_part1Size uint64 = (uint64(2)) + (_2_provIdSize)
				_ = _6_part1Size
				var _7_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_6_part1Size, uint64(2), pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
				_ = _7_valueOrError3
				if (_7_valueOrError3).IsFailure() {
					return (_7_valueOrError3).PropagateFailure()
				} else {
					var _8_provInfoSize uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, (pos)+(_6_part1Size)))
					_ = _8_provInfoSize
					var _9_part2Size uint64 = ((_6_part1Size) + (uint64(2))) + (_8_provInfoSize)
					_ = _9_part2Size
					var _10_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add(_9_part2Size, pos)) < (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
					_ = _10_valueOrError4
					if (_10_valueOrError4).IsFailure() {
						return (_10_valueOrError4).PropagateFailure()
					} else {
						var _11_provInfo _dafny.Sequence = (data).Subsequence(uint32(((pos)+(_6_part1Size))+(uint64(2))), uint32((pos)+(_9_part2Size)))
						_ = _11_provInfo
						var _12_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add3(_9_part2Size, uint64(2), pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
						_ = _12_valueOrError5
						if (_12_valueOrError5).IsFailure() {
							return (_12_valueOrError5).PropagateFailure()
						} else {
							var _13_cipherSize uint64 = uint64(m_StandardLibrary_UInt.Companion_Default___.SeqPosToUInt16(data, (pos)+(_9_part2Size)))
							_ = _13_cipherSize
							var _14_part3Size uint64 = ((_9_part2Size) + (uint64(2))) + (_13_cipherSize)
							_ = _14_part3Size
							var _15_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((m_StandardLibrary_MemoryMath.Companion_Default___.Add(_14_part3Size, pos)) <= (_0_data__size), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
							_ = _15_valueOrError6
							if (_15_valueOrError6).IsFailure() {
								return (_15_valueOrError6).PropagateFailure()
							} else {
								var _16_cipher _dafny.Sequence = (data).Subsequence(uint32(((pos)+(_9_part2Size))+(uint64(2))), uint32((pos)+(_14_part3Size)))
								_ = _16_cipher
								var _17_edk m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey = m_AwsCryptographyMaterialProvidersTypes.Companion_EncryptedDataKey_.Create_EncryptedDataKey_(_4_provId, _11_provInfo, _16_cipher)
								_ = _17_edk
								return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(_17_edk, _14_part3Size))
							}
						}
					}
				}
...
func (_static *CompanionStruct_Default___) SerializeContext2(keys _dafny.Sequence, x _dafny.Map, pos uint64, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((keys).Cardinality())) == (pos) {
		...
		var _in2 uint64 = (pos) + (uint64(1))
		_ = _in2
		var _in3 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, Companion_Default___.SerializeOneKVPair((keys).Select(uint32(pos)).(_dafny.Sequence), (x).Get((keys).Select(uint32(pos)).(_dafny.Sequence)).(_dafny.Sequence)))
		_ = _in3
		keys = _in0
		x = _in1
		pos = _in2
...
func (_static *CompanionStruct_Default___) SerializeDataKeys(x _dafny.Sequence) _dafny.Sequence {
	var _0_body _dafny.Sequence = Companion_Default___.SerializeDataKeys2(x, uint64(0), _dafny.SeqOf())
	_ = _0_body
	return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(uint8((x).Cardinality())), _0_body)
}
func (_static *CompanionStruct_Default___) SerializeDataKeys2(x _dafny.Sequence, pos uint64, acc _dafny.Sequence) _dafny.Sequence {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((x).Cardinality())) == (pos) {
		return acc
	} else {
		...
		var _in1 uint64 = (pos) + (uint64(1))
		_ = _in1
		var _in2 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, Companion_Default___.SerializeOneDataKey((x).Select(uint32(pos)).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)))
		_ = _in2
		x = _in0
		pos = _in1
		acc = _in2
...
func (_static *CompanionStruct_Default___) GetDataKeys(data _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(1)) <= (uint64((data).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_count uint64 = uint64((data).Select(uint32(uint32(0))).(uint8))
		_ = _1_count
		var _2_valueOrError1 m_Wrappers.Result = Companion_Default___.GetDataKeys2(_1_count, _1_count, data, _dafny.TupleOf(_dafny.SeqOf(), uint64(1)))
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			...
			_ = _3_keys
			if (uint64(((*(_3_keys).IndexInt(0)).(_dafny.Sequence)).Cardinality())) == (uint64(0)) {
...
func (_static *CompanionStruct_Default___) GetDataKeys2(count uint64, origCount uint64, data _dafny.Sequence, deserialized _dafny.Tuple) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (count) == (uint64(0)) {
		return m_Wrappers.Companion_Result_.Create_Success_(deserialized)
	} else if (uint64(((*(deserialized).IndexInt(0)).(_dafny.Sequence)).Cardinality())) >= (uint64(255)) {
		...
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.GetOneDataKey(data, (*(deserialized).IndexInt(1)).(uint64))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			...
			var _in0 uint64 = (count) - (func() uint64 { return (uint64(1)) })()
			_ = _in0
			var _in1 uint64 = origCount
			_ = _in1
			var _in2 _dafny.Sequence = data
			_ = _in2
			var _in3 _dafny.Tuple = _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate((*(deserialized).IndexInt(0)).(_dafny.Sequence), _dafny.SeqOf((*(_1_edk).IndexInt(0)).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey))), ((*(deserialized).IndexInt(1)).(uint64))+((*(_1_edk).IndexInt(1)).(uint64)))
			_ = _in3
			count = _in0
			origCount = _in1
			data = _in2
...
func (_static *CompanionStruct_Default___) VERSION__LEN64() uint64 {
	return uint64(1)
}
func (_static *CompanionStruct_Default___) FLAVOR__LEN64() uint64 {
	return uint64(1)
}
func (_static *CompanionStruct_Default___) PREFIX__LEN64() uint64 {
	return ((Companion_Default___.VERSION__LEN64()) + (Companion_Default___.FLAVOR__LEN64())) + (m_StructuredEncryptionUtil.Companion_Default___.MSGID__LEN64())
}
...
func (_static *CompanionStruct_Default___) COMMITMENT__LEN64() uint64 {
	return uint64(32)
}
func (_static *CompanionStruct_Default___) UINT8__LIMIT64() uint64 {
	return uint64(256)
}
...
func (_this *CompanionStruct_CMPEncryptedDataKey_) Is_(__source m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey) bool {
	var _2_x m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey = (__source)
	_ = _2_x
	return Companion_Default___.ValidEncryptedDataKey(_2_x)
}
...
func (_this *CompanionStruct_CMPEncryptionContext_) Is_(__source _dafny.Map) bool {
	var _3_x _dafny.Map = (__source)
	_ = _3_x
	return Companion_Default___.ValidEncryptionContext(_3_x)
}
...
func (_this *CompanionStruct_LegendByte_) Is_(__source uint8) bool {
	var _4_x uint8 = (__source)
	_ = _4_x
	if true {
		return Companion_Default___.ValidLegendByte(_4_x)
	}
	return false
}
...
func (_this *CompanionStruct_Legend_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _5_x
	return (_dafny.IntOfUint32((_5_x).Cardinality())).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()) < 0
}
...
func (_this *CompanionStruct_CMPUtf8Bytes_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _6_x
	if m_UTF8.Companion_ValidUTF8Bytes_.Is_(_6_x) {
		return (_dafny.IntOfUint32((_6_x).Cardinality())).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT16__LIMIT()) < 0
	}
	return false
}
...
func (_this PartialHeader) VerifyCommitment(client m_AwsCryptographyPrimitivesTypes.IAwsCryptographicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, commitKey _dafny.Sequence, data _dafny.Sequence) m_Wrappers.Result {
	{
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((Companion_Default___.COMMITMENT__LEN64()) < (uint64((data).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Serialized header too short")))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			var _1_storedCommitment _dafny.Sequence = (data).Drop(uint32((uint64((data).Cardinality())) - (func() uint64 { return (Companion_Default___.COMMITMENT__LEN64()) })()))
			_ = _1_storedCommitment
			var _2_valueOrError1 m_Wrappers.Result = Companion_Default___.CalculateHeaderCommitment(client, alg, commitKey, (data).Take(uint32((uint64((data).Cardinality()))-(func() uint64 { return (Companion_Default___.COMMITMENT__LEN64()) })())))
			_ = _2_valueOrError1
			if (_2_valueOrError1).IsFailure() {
				return (_2_valueOrError1).PropagateFailure()
			} else {
