...
func (_this *DynamoDbEncryptionBranchKeyIdSupplier) GetBranchKeyId_k(input m_AwsCryptographyMaterialProvidersTypes.GetBranchKeyIdInput) m_Wrappers.Result {
	{
		...
		_ = _1_valueOrError0
		_1_valueOrError0 = (_0_attrMapR).MapFailure(func(coer74 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
			return func(arg102 interface{}) interface{} {
				return coer74(arg102.(_dafny.Sequence))
			}
		...
		_ = _5_valueOrError1
		_5_valueOrError1 = (_4_branchKeyIdR).MapFailure(func(coer75 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
			return func(arg103 interface{}) interface{} {
				return coer75(arg103.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
			}
