...
func (_static *CompanionStruct_Default___) GetCanonicalType(value m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal, isEncrypted bool) m_Wrappers.Result {
	var _0_value__len uint64 = uint64(((value).Dtor_value()).Cardinality())
	_ = _0_value__len
	if isEncrypted {
		var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(2)) <= (_0_value__len), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad length.")))
		_ = _1_valueOrError0
		if (_1_valueOrError0).IsFailure() {
			return (_1_valueOrError0).PropagateFailure()
		} else {
			return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt64ToSeq((_0_value__len)-(func() uint64 { return (uint64(2)) })()), Companion_Default___.ENCRYPTED()))
		}
	} else {
		var _2_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_StandardLibrary_UInt.Companion_Default___.HasUint64Len((value).Dtor_value()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad length.")))
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt64ToSeq(_0_value__len), Companion_Default___.PLAINTEXT()), (value).Dtor_typeId()))
		}
	}
}
func (_static *CompanionStruct_Default___) GetCanonicalEncryptedField(fieldName _dafny.Sequence, value m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((uint64(2)) <= (uint64(((value).Dtor_value()).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad length.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(fieldName, m_StandardLibrary_UInt.Companion_Default___.UInt64ToSeq((uint64(((value).Dtor_value()).Cardinality()))-(func() uint64 { return (uint64(2)) })())), Companion_Default___.ENCRYPTED()), (value).Dtor_value()))
	}
}
func (_static *CompanionStruct_Default___) GetCanonicalPlaintextField(fieldName _dafny.Sequence, value m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_StandardLibrary_UInt.Companion_Default___.HasUint64Len((value).Dtor_value()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad length.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) CanonContent(data _dafny.Sequence) m_Wrappers.Result {
	...
	var _0_i uint64
	_ = _0_i
	_0_i = uint64((data).Cardinality())
	var _1_vectors _dafny.Sequence
	_ = _1_vectors
	_1_vectors = _dafny.SeqOf()
	for (_0_i) != (uint64(0)) /* dircomp */ {
		_0_i = (_0_i) - (func() uint64 { return (uint64(1)) })()
		if !(((data).Select(uint32(_0_i)).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_DO__NOTHING_()) {
			var _2_test m_Wrappers.Result
			_ = _2_test
			_2_test = Companion_Default___.GetCanonicalItem((data).Select(uint32(_0_i)).(m_StructuredEncryptionUtil.CanonCryptoItem))
...
func (_static *CompanionStruct_Default___) CanonRecord(data _dafny.Sequence, header _dafny.Sequence, enc _dafny.Map) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _2_AAD
		var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(m_StandardLibrary_UInt.Companion_Default___.HasUint64Len(_2_AAD), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("AAD too long.")))
		_ = _3_valueOrError1
...
func (_static *CompanionStruct_Default___) CreateFooter(client *m_AtomicPrimitives.AtomicPrimitivesClient, mat m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials, data _dafny.Sequence, header _dafny.Sequence) m_Wrappers.Result {
	...
	var _hi0 uint64 = uint64(((mat).Dtor_encryptedDataKeys()).Cardinality())
	_ = _hi0
	for _3_i := uint64(0); _3_i < _hi0; _3_i++ {
		var _4_input m_AwsCryptographyPrimitivesTypes.HMacInput
		_ = _4_input
		_4_input = m_AwsCryptographyPrimitivesTypes.Companion_HMacInput_.Create_HMacInput_((((mat).Dtor_algorithmSuite()).Dtor_symmetricSignature()).Dtor_HMAC(), (((mat).Dtor_symmetricSigningKeys()).Dtor_value().(_dafny.Sequence)).Select(uint32(_3_i)).(_dafny.Sequence), _1_canonicalHash)
		...
		_ = _9_valueOrError2
		_9_valueOrError2 = m_Wrappers.Companion_Default___.Need((uint64((_8_hash).Cardinality())) == (uint64(48)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad hash length")))
...
func (_static *CompanionStruct_Default___) SerializeTags(tags _dafny.Sequence) _dafny.Sequence {
	...
	_ = _lo0
	for _1_i := uint64((tags).Cardinality()); _lo0 < _1_i; {
		_1_i--
		_0_result = _dafny.Companion_Sequence_.Concatenate((tags).Select(uint32(_1_i)).(_dafny.Sequence), _0_result)
	}
	_hresult = _0_result
	return _hresult
	return _hresult
...
TAIL_CALL_START:
	if (uint64((data).Cardinality())) == (uint64(0)) {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf())
	} else {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf((data).Subsequence(uint32(uint32(0)), uint32(Companion_Default___.RecipientTagSize()))))
		var _in0 _dafny.Sequence = (data).Drop(uint32(Companion_Default___.RecipientTagSize()))
		_ = _in0
		data = _in0
		goto TAIL_CALL_START
	}
...
func (_static *CompanionStruct_Default___) DeserializeFooter(data _dafny.Sequence, hasSig bool) m_Wrappers.Result {
	var _0_data__len uint64 = uint64((data).Cardinality())
	_ = _0_data__len
	if hasSig {
		var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_0_data__len) >= ((Companion_Default___.RecipientTagSize())+(Companion_Default___.SignatureSize())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Footer too short.")))
		_ = _1_valueOrError0
		if (_1_valueOrError0).IsFailure() {
			return (_1_valueOrError0).PropagateFailure()
		} else {
			var _2_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((((_0_data__len)-(func() uint64 { return (Companion_Default___.SignatureSize()) })())%(Companion_Default___.RecipientTagSize())) == (uint64(0)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Mangled signed footer has strange size")))
			_ = _2_valueOrError1
			if (_2_valueOrError1).IsFailure() {
				return (_2_valueOrError1).PropagateFailure()
			} else {
				return m_Wrappers.Companion_Result_.Create_Success_(Companion_Footer_.Create_Footer_(Companion_Default___.GatherTags((data).Take(uint32((_0_data__len)-(func() uint64 { return (Companion_Default___.SignatureSize()) })()))), m_Wrappers.Companion_Option_.Create_Some_((data).Drop(uint32((_0_data__len)-(func() uint64 { return (Companion_Default___.SignatureSize()) })())))))
			}
		}
	} else {
		var _3_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_0_data__len)%(Companion_Default___.RecipientTagSize())) == (uint64(0)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Mangled unsigned footer has strange size")))
		_ = _3_valueOrError2
		if (_3_valueOrError2).IsFailure() {
			return (_3_valueOrError2).PropagateFailure()
		} else {
			var _4_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_0_data__len) >= (Companion_Default___.RecipientTagSize()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Footer too short.")))
			_ = _4_valueOrError3
...
func (_static *CompanionStruct_Default___) RecipientTagSize() uint64 {
	return uint64(48)
}
func (_static *CompanionStruct_Default___) SignatureSize() uint64 {
	return uint64(103)
}
...
func (_this *CompanionStruct_RecipientTag_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _0_x
	return (_dafny.IntOfUint32((_0_x).Cardinality())).Cmp(_dafny.IntOfUint64(Companion_Default___.RecipientTagSize())) == 0
}
...
func (_this *CompanionStruct_Signature_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _1_x
	return (_dafny.IntOfUint32((_1_x).Cardinality())).Cmp(_dafny.IntOfUint64(Companion_Default___.SignatureSize())) == 0
}
...
func (_this Footer) Validate(client *m_AtomicPrimitives.AtomicPrimitivesClient, mat m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials, edks _dafny.Sequence, data _dafny.Sequence, header _dafny.Sequence) m_Wrappers.Result {
	{
		...
		_ = _0_valueOrError0
		_0_valueOrError0 = m_Wrappers.Companion_Default___.Need((uint64((edks).Cardinality())) == (uint64(((_this).Dtor_tags()).Cardinality())), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("There are a different number of recipient tags in the stored header than there are in the decryption materials.")))
		if (_0_valueOrError0).IsFailure() {
			ret = (_0_valueOrError0).PropagateFailure()
			return ret
		}
		...
		_ = _8_valueOrError3
		_8_valueOrError3 = m_Wrappers.Companion_Default___.Need((uint64((_7_hash).Cardinality())) == (uint64(48)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Bad hash length")))
		...
		_9_foundTag = false
		{
			var _hi0 uint64 = uint64(((_this).Dtor_tags()).Cardinality())
			_ = _hi0
			for _10_i := uint64(0); _10_i < _hi0; _10_i++ {
				{
					if m_StructuredEncryptionUtil.Companion_Default___.ConstantTimeEquals(_7_hash, ((_this).Dtor_tags()).Select(uint32(_10_i)).(_dafny.Sequence)) {
						_9_foundTag = true
						goto L0
					}
					goto C0
