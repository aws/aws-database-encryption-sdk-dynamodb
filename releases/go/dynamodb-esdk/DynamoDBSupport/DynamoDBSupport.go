...
func (_static *CompanionStruct_Default___) IsWriteable(item _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_keys
	_0_keys = m_SortedSets.SetToOrderedSequence2((item).Keys(), func(coer119 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg149 interface{}, arg150 interface{}) bool {
			return coer119(arg149.(_dafny.Char), arg150.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
	var _1_rp _dafny.Sequence
	_ = _1_rp
	_1_rp = m_DynamoDbEncryptionUtil.Companion_Default___.ReservedPrefix()
	var _hi0 uint64 = uint64((_0_keys).Cardinality())
	_ = _hi0
	for _2_i := uint64(0); _2_i < _hi0; _2_i++ {
		if _dafny.Companion_Sequence_.IsPrefixOf(_1_rp, (_0_keys).Select(uint32(_2_i)).(_dafny.Sequence)) {
			var _3_result _dafny.Sequence
			_ = _3_result
			_3_result = _dafny.SeqOfString("Writing reserved attributes not allowed : ")
			var _hi1 uint64 = uint64((_0_keys).Cardinality())
			_ = _hi1
			for _4_j := _2_i; _4_j < _hi1; _4_j++ {
				if _dafny.Companion_Sequence_.IsPrefixOf(_1_rp, (_0_keys).Select(uint32(_2_i)).(_dafny.Sequence)) {
					_3_result = _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_3_result, (_0_keys).Select(uint32(_2_i)).(_dafny.Sequence)), _dafny.SeqOfString("\n"))
				}
			}
			ret = m_Wrappers.Companion_Result_.Create_Failure_(_3_result)
			return ret
		}
	}
...
func (_static *CompanionStruct_Default___) GetEncryptedAttributes(actions _dafny.Map, expr m_Wrappers.Option, attrNames m_Wrappers.Option) _dafny.Sequence {
	if (expr).Is_None() {
		...
		_ = _0_attrs
		return m_Seq.Companion_Default___.Filter(func(coer120 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg151 interface{}) bool {
				return coer120(arg151.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) TestConditionExpression(actions _dafny.Map, expr m_Wrappers.Option, attrNames m_Wrappers.Option, attrValues m_Wrappers.Option) m_Wrappers.Result {
	if (expr).Is_Some() {
		...
		_ = _0_attrs
		if (uint64((_0_attrs).Cardinality())) == (uint64(0)) {
...
func (_static *CompanionStruct_Default___) TestUpdateExpression(actions _dafny.Map, expr m_Wrappers.Option, attrNames m_Wrappers.Option, attrValues m_Wrappers.Option) m_Wrappers.Result {
	if (expr).Is_Some() {
		...
		_ = _0_attrs
		var _1_encryptedAttrs _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer121 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg152 interface{}) bool {
				return coer121(arg152.(_dafny.Sequence))
			}
		...
		_ = _1_encryptedAttrs
		if (uint64((_1_encryptedAttrs).Cardinality())) == (uint64(0)) {
			return m_Wrappers.Companion_Result_.Create_Success_(true)
		} else {
...
func (_static *CompanionStruct_Default___) AddSignedBeacons(search m_Wrappers.Option, item _dafny.Map) m_Wrappers.Result {
	...
	if (search).Is_None() {
		...
		_2_badAttrs = func() _dafny.Set {
			...
			_ = _coll0
			for _iter23 := _dafny.Iterate((_1_newAttrs).Keys().Elements()); ; {
		...
		_ = _4_valueOrError1
		_4_valueOrError1 = m_Wrappers.Companion_Default___.Need((uint64((_2_badAttrs).CardinalityInt())) == (uint64(0)), m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Signed beacons have generated values different from supplied values.")))
		...
		_7_bad = func() _dafny.Set {
			...
			_ = _coll1
			for _iter24 := _dafny.Iterate((_6_both).Elements()); ; {
				_compr_1, _ok24 := _iter24()
				if !_ok24 {
					break
				}
		...
		if (uint64(0)) < (uint64((_7_bad).CardinalityInt())) {
			var _9_badSeq _dafny.Sequence
			_ = _9_badSeq
			_9_badSeq = m_SortedSets.SetToOrderedSequence2(_7_bad, func(coer122 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
				return func(arg153 interface{}, arg154 interface{}) bool {
					return coer122(arg153.(_dafny.Char), arg154.(_dafny.Char))
				}
			}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
		...
		if ((((((search).Dtor_value().(m_SearchableEncryptionInfo.SearchInfo)).Curr()).Dtor_keySource()).Dtor_keyLoc()).Is_MultiLoc()) && ((((((search).Dtor_value().(m_SearchableEncryptionInfo.SearchInfo)).Curr()).Dtor_keySource()).Dtor_keyLoc()).Dtor_deleteKey()) {
			...
			_10_newItem = func() _dafny.Map {
				...
				_ = _coll2
				for _iter25 := _dafny.Iterate((item).Keys().Elements()); ; {
					_compr_2, _ok25 := _iter25()
					if !_ok25 {
						break
					}
...
func (_static *CompanionStruct_Default___) DoRemoveBeacons(item _dafny.Map) _dafny.Map {
	return func() _dafny.Map {
		...
		_ = _coll0
		for _iter26 := _dafny.Iterate((item).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) QueryOutputForBeacons(search m_Wrappers.Option, req m_ComAmazonawsDynamodbTypes.QueryInput, resp m_ComAmazonawsDynamodbTypes.QueryOutput) m_Wrappers.Result {
	...
	if (search).Is_None() {
		...
		_ = _0_trimmedItems
		_0_trimmedItems = m_Seq.Companion_Default___.Map(func(coer123 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg155 interface{}) interface{} {
				return coer123(arg155.(_dafny.Map))
			}
		...
		_ = _6_valueOrError1
		_6_valueOrError1 = m_Wrappers.Companion_Default___.Need((uint64((_5_newItems).Cardinality())) < ((m_StandardLibrary_UInt.Companion_Default___.INT32__MAX__LIMIT()).Uint64()), m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("This is impossible.")))
		...
		_ = _7_trimmedItems
		_7_trimmedItems = m_Seq.Companion_Default___.Map(func(coer124 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg156 interface{}) interface{} {
				return coer124(arg156.(_dafny.Map))
			}
...
func (_static *CompanionStruct_Default___) ScanOutputForBeacons(search m_Wrappers.Option, req m_ComAmazonawsDynamodbTypes.ScanInput, resp m_ComAmazonawsDynamodbTypes.ScanOutput) m_Wrappers.Result {
	...
	if (search).Is_None() {
		var _0_trimmedItems _dafny.Sequence
		_ = _0_trimmedItems
		_0_trimmedItems = m_Seq.Companion_Default___.Map(func(coer125 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg157 interface{}) interface{} {
				return coer125(arg157.(_dafny.Map))
			}
		}(func(_1_i _dafny.Map) _dafny.Map {
			return Companion_Default___.DoRemoveBeacons(_1_i)
		}), ((resp).Dtor_Items()).Dtor_value().(_dafny.Sequence))
		...
		var _7_trimmedItems _dafny.Sequence
		_ = _7_trimmedItems
		_7_trimmedItems = m_Seq.Companion_Default___.Map(func(coer126 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg158 interface{}) interface{} {
				return coer126(arg158.(_dafny.Map))
			}
		}(func(_8_i _dafny.Map) _dafny.Map {
			return Companion_Default___.DoRemoveBeacons(_8_i)
		}), _5_newItems)
...
TAIL_CALL_START:
	if (uint64((fields).Cardinality())) == (uint64(0)) {
		return m_Wrappers.Companion_Result_.Create_Success_(results)
	} else {
		var _0_valueOrError0 m_Wrappers.Result = m_DdbVirtualFields.Companion_Default___.GetVirtField(((bv).Dtor_virtualFields()).Get((fields).Select(uint32(uint32(0))).(_dafny.Sequence)).(m_DdbVirtualFields.VirtField), item)
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			...
			if (_1_optValue).Is_Some() {
				var _in0 _dafny.Sequence = (fields).Drop(uint32(uint32(1)))
				_ = _in0
				var _in1 m_SearchableEncryptionInfo.BeaconVersion = bv
				_ = _in1
				var _in2 _dafny.Map = item
				_ = _in2
				var _in3 _dafny.Map = (results).Update((fields).Select(uint32(uint32(0))).(_dafny.Sequence), (_1_optValue).Dtor_value().(_dafny.Sequence))
				_ = _in3
				fields = _in0
				bv = _in1
				item = _in2
				...
				var _in4 _dafny.Sequence = (fields).Drop(uint32(uint32(1)))
				_ = _in4
...
func (_static *CompanionStruct_Default___) GetVirtualFields(beaconVersion m_SearchableEncryptionInfo.BeaconVersion, item _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_fieldNames
	_0_fieldNames = m_SortedSets.SetToOrderedSequence2(((beaconVersion).Dtor_virtualFields()).Keys(), func(coer127 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg159 interface{}, arg160 interface{}) bool {
			return coer127(arg159.(_dafny.Char), arg160.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
...
TAIL_CALL_START:
	if (uint64((fields).Cardinality())) == (uint64(0)) {
		...
		var _0_beacon m_SearchableEncryptionInfo.Beacon = ((bv).Dtor_beacons()).Get((fields).Select(uint32(uint32(0))).(_dafny.Sequence)).(m_SearchableEncryptionInfo.Beacon)
		_ = _0_beacon
		if (_0_beacon).Is_Compound() {
			...
			var _in8 _dafny.Sequence = (fields).Drop(uint32(uint32(1)))
			_ = _in8
...
func (_static *CompanionStruct_Default___) GetCompoundBeacons(beaconVersion m_SearchableEncryptionInfo.BeaconVersion, item _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_beaconNames
	_0_beaconNames = m_SortedSets.SetToOrderedSequence2(((beaconVersion).Dtor_beacons()).Keys(), func(coer128 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg161 interface{}, arg162 interface{}) bool {
			return coer128(arg161.(_dafny.Char), arg162.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
