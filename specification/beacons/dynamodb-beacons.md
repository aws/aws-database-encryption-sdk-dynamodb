 ...
 * transformKeySchema MUST return a KeySchema
with the name given in the Primary Key Parts and type "B" binary.
 ...
 * If only a primary key is specified, then an HMAC384 must be generated from it 
 * Otherwise, an HMAC384 must be generated from the concatenation of the partition key,
...
value of type String with value the empty string.
