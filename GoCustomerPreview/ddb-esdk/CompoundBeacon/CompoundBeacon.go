...
func (_static *CompanionStruct_Default___) MakeDefaultConstructor(parts _dafny.Sequence) Constructor {
	var _0_cons _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer92 func(BeaconPart) ConstructorPart) func(interface{}) interface{} {
		return func(arg120 interface{}) interface{} {
			return coer92(arg120.(BeaconPart))
		}
...
func (_this Constructor) GetReqParts() _dafny.Set {
	{
		return func() _dafny.Set {
			...
			_ = _coll0
			for _iter20 := _dafny.Iterate(((_this).Dtor_parts()).Elements()); ; {
...
func (_this CompoundBeacon) PartsToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer93 func(BeaconPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg121 interface{}) interface{} {
				return coer93(arg121.(BeaconPart))
			}
...
func (_this CompoundBeacon) CPartsToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer94 func(ConstructorPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg122 interface{}) interface{} {
				return coer94(arg122.(ConstructorPart))
			}
...
func (_this CompoundBeacon) CListToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer95 func(Constructor) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg123 interface{}) interface{} {
				return coer95(arg123.(Constructor))
			}
...
func (_this CompoundBeacon) GetFields(virtualFields _dafny.Map) _dafny.Sequence {
	{
		return m_StandardLibrary_Sequence.Companion_Default___.Flatten(m_Seq.Companion_Default___.Map(func(coer96 func(BeaconPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg124 interface{}) interface{} {
				return coer96(arg124.(BeaconPart))
			}
		...
		})(virtualFields)), (_this).Dtor_parts()), uint64(0), _dafny.SeqOf())
	}
}
...
func (_this CompoundBeacon) GetBeaconValue(value m_ComAmazonawsDynamodbTypes.AttributeValue, keys m_DynamoDbEncryptionUtil.MaybeKeyMap, forEquality bool) m_Wrappers.Result {
	{
		if !((value).Is_S()) {
			...
			_ = _0_parts
			var _1_valueOrError0 m_Wrappers.Result = m_StandardLibrary_Sequence.Companion_Default___.MapWithResult(func(coer97 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
				return func(arg125 interface{}) m_Wrappers.Result {
					return coer97(arg125.(_dafny.Sequence))
				}
			}(func(_2_s _dafny.Sequence) m_Wrappers.Result {
				return (_this).GetPartFromPrefix(_2_s)
			}), _0_parts, uint64(0), _dafny.SeqOf())
			_ = _1_valueOrError0
			if (_1_valueOrError0).IsFailure() {
				return (_1_valueOrError0).PropagateFailure()
			} else {
				...
				if (_4_valueOrError1).IsFailure() {
					...
					_ = _5___v1
					var _6_valueOrError2 m_Wrappers.Result = m_StandardLibrary_Sequence.Companion_Default___.MapWithResult(func(coer98 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
						return func(arg126 interface{}) m_Wrappers.Result {
							return coer98(arg126.(_dafny.Sequence))
						}
					...
					})(keys)), _0_parts, uint64(0), _dafny.SeqOf())
					_ = _6_valueOrError2
...
func (_this CompoundBeacon) FindPart(val _dafny.Sequence) m_Wrappers.Result {
	{
		var _0_thePart _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer99 func(BeaconPart) bool) func(interface{}) bool {
			return func(arg127 interface{}) bool {
				return coer99(arg127.(BeaconPart))
			}
...
func (_this CompoundBeacon) CheckOnePrefix(pos _dafny.Int) m_Wrappers.Result {
	{
		var _0_partNumbers _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32(((_this).Dtor_parts()).Cardinality())).Uint32(), func(coer100 func(_dafny.Int) _dafny.Int) func(_dafny.Int) interface{} {
			return func(arg128 _dafny.Int) interface{} {
				return coer100(arg128)
			}
		}(func(_1_i _dafny.Int) _dafny.Int {
			return _1_i
		}))
		_ = _0_partNumbers
		var _2_valueOrError0 m_Wrappers.Result = m_StandardLibrary_Sequence.Companion_Default___.MapWithResult(func(coer101 func(_dafny.Int) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
			return func(arg129 interface{}) m_Wrappers.Result {
				return coer101(arg129.(_dafny.Int))
			}
		...
		})(pos)), _dafny.SeqCreate((_dafny.IntOfUint32(((_this).Dtor_parts()).Cardinality())).Uint32(), func(coer102 func(_dafny.Int) _dafny.Int) func(_dafny.Int) interface{} {
			return func(arg130 _dafny.Int) interface{} {
				return coer102(arg130)
			}
		}(func(_5_i _dafny.Int) _dafny.Int {
			return _5_i
		})), uint64(0), _dafny.SeqOf())
		_ = _2_valueOrError0
