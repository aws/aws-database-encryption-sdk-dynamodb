...
func (_static *CompanionStruct_Default___) MakeEncryptionContextForDecrypt(config Config, header _dafny.Sequence, item _dafny.Map) m_Wrappers.Result {
	if ((header).Select(uint32(uint32(0))).(uint8)) == (uint8(2)) {
		return Companion_Default___.MakeEncryptionContextV2(config, item)
	} else if ((header).Select(uint32(uint32(0))).(uint8)) == (uint8(1)) {
		return Companion_Default___.MakeEncryptionContextV1(config, item)
	} else {
...
func (_static *CompanionStruct_Default___) MakeEncryptionContextV1(config Config, item _dafny.Map) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.FNeed((item).Contains((config).Dtor_partitionKeyName()), func(coer53 func() m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func() interface{} {
		return func() interface{} {
			return coer53()
		}
	}((func(_1_config Config) func() m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
		return func() m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
			return Companion_Default___.DDBError(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Partition key "), (_1_config).Dtor_partitionKeyName()), _dafny.SeqOfString(" not found in Item to be encrypted or decrypted")))
		}
	})(config)))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		...
		var _2_valueOrError1 m_Wrappers.Result = Companion_Default___.DDBEncode((config).Dtor_logicalTableName())
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			var _3_logicalTableName _dafny.Sequence = (_2_valueOrError1).Extract().(_dafny.Sequence)
			_ = _3_logicalTableName
			var _4_valueOrError2 m_Wrappers.Result = Companion_Default___.DDBEncode((config).Dtor_partitionKeyName())
			_ = _4_valueOrError2
			if (_4_valueOrError2).IsFailure() {
				return (_4_valueOrError2).PropagateFailure()
			} else {
				var _5_partitionName _dafny.Sequence = (_4_valueOrError2).Extract().(_dafny.Sequence)
				_ = _5_partitionName
				var _6_valueOrError3 m_Wrappers.Result = Companion_Default___.EncodeName((config).Dtor_partitionKeyName())
				_ = _6_valueOrError3
				if (_6_valueOrError3).IsFailure() {
					return (_6_valueOrError3).PropagateFailure()
				} else {
					var _7_partitionKeyName _dafny.Sequence = (_6_valueOrError3).Extract().(_dafny.Sequence)
					_ = _7_partitionKeyName
					var _8_partitionKeyValue _dafny.Sequence = m_StructuredEncryptionUtil.Companion_Default___.EncodeTerminal((item).Get((config).Dtor_partitionKeyName()).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))
					_ = _8_partitionKeyValue
					if ((config).Dtor_sortKeyName()).Is_None() {
						var _9_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.SetOf(m_DynamoDbItemEncryptorUtil.Companion_Default___.TABLE__NAME(), m_DynamoDbItemEncryptorUtil.Companion_Default___.PARTITION__NAME(), m_DynamoDbItemEncryptorUtil.Companion_Default___.SORT__NAME(), _7_partitionKeyName)).Cardinality()).Cmp(_dafny.IntOfInt64(4)) == 0, m_DynamoDbItemEncryptorUtil.Companion_Default___.E(_dafny.SeqOfString("Internal Error")))
						_ = _9_valueOrError4
						if (_9_valueOrError4).IsFailure() {
							return (_9_valueOrError4).PropagateFailure()
						} else {
							var _10_ec _dafny.Map = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(m_DynamoDbItemEncryptorUtil.Companion_Default___.TABLE__NAME(), _3_logicalTableName).UpdateUnsafe(m_DynamoDbItemEncryptorUtil.Companion_Default___.PARTITION__NAME(), _5_partitionName).UpdateUnsafe(_7_partitionKeyName, _8_partitionKeyValue)
							_ = _10_ec
							return m_Wrappers.Companion_Result_.Create_Success_(_10_ec)
						}
					} else {
						...
						if (_11_valueOrError5).IsFailure() {
							...
							var _12_valueOrError6 m_Wrappers.Result = Companion_Default___.DDBEncode(((config).Dtor_sortKeyName()).Dtor_value().(_dafny.Sequence))
							_ = _12_valueOrError6
							if (_12_valueOrError6).IsFailure() {
								return (_12_valueOrError6).PropagateFailure()
							} else {
								var _13_sortName _dafny.Sequence = (_12_valueOrError6).Extract().(_dafny.Sequence)
								_ = _13_sortName
								var _14_valueOrError7 m_Wrappers.Result = Companion_Default___.EncodeName(((config).Dtor_sortKeyName()).Dtor_value().(_dafny.Sequence))
								_ = _14_valueOrError7
								if (_14_valueOrError7).IsFailure() {
									return (_14_valueOrError7).PropagateFailure()
								} else {
									var _15_sortKeyName _dafny.Sequence = (_14_valueOrError7).Extract().(_dafny.Sequence)
									_ = _15_sortKeyName
									var _16_sortKeyValue _dafny.Sequence = m_StructuredEncryptionUtil.Companion_Default___.EncodeTerminal((item).Get(((config).Dtor_sortKeyName()).Dtor_value().(_dafny.Sequence)).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal))
									_ = _16_sortKeyValue
									var _17_valueOrError8 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.SetOf(m_DynamoDbItemEncryptorUtil.Companion_Default___.TABLE__NAME(), m_DynamoDbItemEncryptorUtil.Companion_Default___.PARTITION__NAME(), _7_partitionKeyName, m_DynamoDbItemEncryptorUtil.Companion_Default___.SORT__NAME(), _15_sortKeyName)).Cardinality()).Cmp(_dafny.IntOfInt64(5)) == 0, m_DynamoDbItemEncryptorUtil.Companion_Default___.E(_dafny.SeqOfString("Internal Error")))
									_ = _17_valueOrError8
									if (_17_valueOrError8).IsFailure() {
										return (_17_valueOrError8).PropagateFailure()
									} else {
										var _18_ec _dafny.Map = _dafny.NewMapBuilder().ToMap().UpdateUnsafe(m_DynamoDbItemEncryptorUtil.Companion_Default___.TABLE__NAME(), _3_logicalTableName).UpdateUnsafe(m_DynamoDbItemEncryptorUtil.Companion_Default___.PARTITION__NAME(), _5_partitionName).UpdateUnsafe(_7_partitionKeyName, _8_partitionKeyValue).UpdateUnsafe(m_DynamoDbItemEncryptorUtil.Companion_Default___.SORT__NAME(), _13_sortName).UpdateUnsafe(_15_sortKeyName, _16_sortKeyValue)
										_ = _18_ec
										return m_Wrappers.Companion_Result_.Create_Success_(_18_ec)
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) DDBEncode(s _dafny.Sequence) m_Wrappers.Result {
	return (m_UTF8.Encode(s)).MapFailure(func(coer54 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg77 interface{}) interface{} {
			return coer54(arg77.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) ConfigToCryptoSchema(config Config, item _dafny.Map) m_Wrappers.Result {
	var _0_schema _dafny.Map = func() _dafny.Map {
		...
		_ = _coll0
		for _iter16 := _dafny.Iterate((item).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) ConfigToAuthenticateSchema(config Config, item _dafny.Map) _dafny.Map {
	return func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter17 := _dafny.Iterate((item).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) GetItemNames(item _dafny.Map) _dafny.Sequence {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((item).Keys(), func(coer55 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg78 interface{}, arg79 interface{}) bool {
			return coer55(arg78.(_dafny.Char), arg79.(_dafny.Char))
		}
	}(m_DynamoDbItemEncryptorUtil.Companion_Default___.CharLess))
	_ = _0_keys
	if (uint64((_0_keys).Cardinality())) == (uint64(0)) {
...
func (_static *CompanionStruct_Default___) ContextMissingMsg(actions _dafny.Map, item _dafny.Map) _dafny.Sequence {
	var _0_s _dafny.Set = func() _dafny.Set {
		...
		_ = _coll0
		for _iter18 := _dafny.Iterate((actions).Keys().Elements()); ; {
	...
	_ = _0_s
	var _2_missing _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_s, func(coer56 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg80 interface{}, arg81 interface{}) bool {
			return coer56(arg80.(_dafny.Char), arg81.(_dafny.Char))
		}
	}(m_DynamoDbItemEncryptorUtil.Companion_Default___.CharLess))
	_ = _2_missing
	if (uint64((_2_missing).Cardinality())) == (uint64(0)) {
		return _dafny.SeqOfString("No missing SIGN_AND_INCLUDE_IN_ENCRYPTION_CONTEXT attributes.")
	} else if (uint64((_2_missing).Cardinality())) == (uint64(1)) {
		return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Attribute "), (_2_missing).Select(uint32(uint32(0))).(_dafny.Sequence)), _dafny.SeqOfString(" was configured with SIGN_AND_INCLUDE_IN_ENCRYPTION_CONTEXT but was not present in item to be encrypted."))
	} else {
...
func (_static *CompanionStruct_Default___) EncryptItem(config Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.EncryptItemInput) m_Wrappers.Result {
	...
	_ = _5_valueOrError3
	_5_valueOrError3 = (m_DynamoToStruct.Companion_Default___.ItemToStructured2((input).Dtor_plaintextItem(), (config).Dtor_attributeActionsOnEncrypt())).MapFailure(func(coer57 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg82 interface{}) interface{} {
			return coer57(arg82.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
		}
	...
	_ = _10_valueOrError5
	_10_valueOrError5 = (Companion_Default___.ConfigToCryptoSchema(config, _7_plaintextStructure)).MapFailure(func(coer58 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg83 interface{}) interface{} {
			return coer58(arg83.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
		}
	...
	_ = _13_contextKeysX
	_13_contextKeysX = m_SortedSets.SetToOrderedSequence2((_9_context).Keys(), func(coer59 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg84 interface{}, arg85 interface{}) bool {
			return coer59(arg84.(uint8), arg85.(uint8))
		}
	...
	_ = _16_valueOrError6
	_16_valueOrError6 = (_15_reqCMMR).MapFailure(func(coer60 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg86 interface{}) interface{} {
			return coer60(arg86.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	...
	_ = _20_valueOrError7
	_20_valueOrError7 = (_19_encryptRes).MapFailure(func(coer61 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg87 interface{}) interface{} {
			return coer61(arg87.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	_26_valueOrError9 = (m_DynamoToStruct.Companion_Default___.StructuredToItemEncrypt(_23_encryptedData, (input).Dtor_plaintextItem(), (config).Dtor_attributeActionsOnEncrypt())).MapFailure(func(coer62 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg88 interface{}) interface{} {
			return coer62(arg88.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
		}
	...
	_32_valueOrError11 = (_31_selectorContextR).MapFailure(func(coer63 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg89 interface{}) interface{} {
			return coer63(arg89.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) DecryptItem(config Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DecryptItemInput) m_Wrappers.Result {
	...
	var _5_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptyMap)
	_ = _5_valueOrError3
	_5_valueOrError3 = (m_DynamoToStruct.Companion_Default___.ItemToStructured2((input).Dtor_encryptedItem(), (config).Dtor_attributeActionsOnEncrypt())).MapFailure(func(coer64 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg90 interface{}) interface{} {
			return coer64(arg90.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
		}
	}(func(_6_e m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
		return m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_Error_.Create_AwsCryptographyDbEncryptionSdkDynamoDb_(_6_e)
	}))
	...
	_ = _11_valueOrError6
	_11_valueOrError6 = m_Wrappers.Companion_Default___.Need((uint64(0)) < (uint64(((_9_header).Dtor_B()).Cardinality())), m_DynamoDbItemEncryptorUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected empty header field.")))
	if (_11_valueOrError6).IsFailure() {
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = ((config).Dtor_cmpClient()).CreateRequiredEncryptionContextCMM(m_AwsCryptographyMaterialProvidersTypes.Companion_CreateRequiredEncryptionContextCMMInput_.Create_CreateRequiredEncryptionContextCMMInput_(m_Wrappers.Companion_Option_.Create_Some_((config).Dtor_cmm()), m_Wrappers.Companion_Option_.Create_None_(), m_SortedSets.SetToOrderedSequence2((_13_context).Keys(), func(coer65 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg91 interface{}, arg92 interface{}) bool {
			return coer65(arg91.(uint8), arg92.(uint8))
		}
	}(m_DynamoDbItemEncryptorUtil.Companion_Default___.ByteLess))))
	_15_reqCMMR = _out1
	var _16_valueOrError8 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _16_valueOrError8
	_16_valueOrError8 = (_15_reqCMMR).MapFailure(func(coer66 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg93 interface{}) interface{} {
			return coer66(arg93.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	}(func(_17_e m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
		return m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_Error_.Create_AwsCryptographyMaterialProviders_(_17_e)
	}))
	...
	_ = _20_valueOrError9
	_20_valueOrError9 = (_19_decryptRes).MapFailure(func(coer67 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg94 interface{}) interface{} {
			return coer67(arg94.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	}(func(_21_e m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
		return m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_Error_.Create_AwsCryptographyDbEncryptionSdkDynamoDb_(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Companion_Error_.Create_AwsCryptographyDbEncryptionSdkStructuredEncryption_(_21_e))
	}))
	...
	_26_valueOrError11 = (m_DynamoToStruct.Companion_Default___.StructuredToItemDecrypt(_23_decryptedData, (input).Dtor_encryptedItem(), (_22_decryptVal).Dtor_cryptoSchema())).MapFailure(func(coer68 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg95 interface{}) interface{} {
			return coer68(arg95.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error))
		}
	}(func(_27_e m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error {
		return m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_Error_.Create_AwsCryptographyDbEncryptionSdkDynamoDb_(_27_e)
	}))
	...
	_33_valueOrError13 = (_32_selectorContextR).MapFailure(func(coer69 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg96 interface{}) interface{} {
			return coer69(arg96.(_dafny.Sequence))
		}
