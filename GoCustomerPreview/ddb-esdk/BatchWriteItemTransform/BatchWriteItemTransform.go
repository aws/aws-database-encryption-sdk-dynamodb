		...
		if !(m_DdbMiddlewareConfig.Companion_Default___.IsPlainWrite(config, _4_tableName)) {
			...
			for _8_x := _dafny.Zero; _8_x.Cmp(_hi0) < 0; _8_x = _8_x.Plus(_dafny.One) {
				...
				if ((_9_req).Dtor_PutRequest()).Is_None() {
					...
					_ = _out1
					_out1 = m_DynamoDbMiddlewareSupport.Companion_Default___.IsWriteable(_6_tableConfig, (((_9_req).Dtor_PutRequest()).Dtor_value().(m_ComAmazonawsDynamodbTypes.PutRequest)).Dtor_Item())
					...
					_ = _out2
					_out2 = m_DynamoDbMiddlewareSupport.Companion_Default___.AddSignedBeacons(_6_tableConfig, (((_9_req).Dtor_PutRequest()).Dtor_value().(m_ComAmazonawsDynamodbTypes.PutRequest)).Dtor_Item())
					...
					_ = _out3
					_out3 = ((_6_tableConfig).Dtor_itemEncryptor()).EncryptItem(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_EncryptItemInput_.Create_EncryptItemInput_(_13_item))
					...
					_ = _out4
					_out4 = m_DynamoDbMiddlewareSupport.Companion_Default___.GetEncryptedBeacons(_6_tableConfig, (((_9_req).Dtor_PutRequest()).Dtor_value().(m_ComAmazonawsDynamodbTypes.PutRequest)).Dtor_Item(), m_DynamoDbEncryptionUtil.Companion_Default___.MaybeFromOptionKeyId(_18_keyId))
