...
func (_static *CompanionStruct_Default___) UniPathToString(x _dafny.Sequence) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Success_((((x).Select(uint32(uint32(0))).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.PathSegment)).Dtor_member()).Dtor_key())
}
func (_static *CompanionStruct_Default___) ValidPath(path _dafny.Sequence) bool {
	return _dafny.Quantifier((path).UniqueElements(), true, func(_forall_var_0 m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.PathSegment) bool {
...
func (_static *CompanionStruct_Default___) MakeCanonicalPath(path _dafny.Sequence) _dafny.Sequence {
	...
	_ = _lo0
	for _1_i := uint64((path).Cardinality()); _lo0 < _1_i; {
		_1_i--
		_0_result = _dafny.Companion_Sequence_.Concatenate(Companion_Default___.CanonicalPart((path).Select(uint32(_1_i)).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.PathSegment)), _0_result)
	}
	ret = _0_result
	return ret
	return ret
...
TAIL_CALL_START:
	if (uint64((path).Cardinality())) == (uint64(0)) {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOfString(""))
	} else if (uint64((path).Cardinality())) == (uint64(1)) {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, (((path).Select(uint32(uint32(0))).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.PathSegment)).Dtor_member()).Dtor_key())
	} else {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.Companion_Sequence_.Concatenate((((path).Select(uint32(uint32(0))).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.PathSegment)).Dtor_member()).Dtor_key(), _dafny.SeqOfString(".")))
		var _in0 _dafny.Sequence = (path).Drop(uint32(uint32(1)))
		_ = _in0
		path = _in0
		goto TAIL_CALL_START
	}
...
func (_this *CompanionStruct_TerminalSelector_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _0_x
	return Companion_Default___.ValidTerminalSelector(_0_x)
}
