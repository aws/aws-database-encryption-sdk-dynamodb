...
replace (
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/dynamodb v0.0.0 => ../dynamodb
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/kms v0.0.0 => ../kms
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/primitives v0.0.0 => ../primitives
