...
func (_this *AwsKmsMrkKeyring) OnEncrypt_k(input m_AwsCryptographyMaterialProvidersTypes.OnEncryptInput) m_Wrappers.Result {
	{
		...
		_ = _10_valueOrError2
		_10_valueOrError2 = (m_UTF8.Encode(_8_kmsKeyArn)).MapFailure(func(coer106 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
			return func(arg107 interface{}) interface{} {
				return coer106(arg107.(_dafny.Sequence))
			}
...
func (_this *AwsKmsMrkKeyring) OnDecrypt_k(input m_AwsCryptographyMaterialProvidersTypes.OnDecryptInput) m_Wrappers.Result {
	{
		...
		_ = _11_valueOrError4
		_11_valueOrError4 = (_10_outcome).MapFailure(func(coer107 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
			return func(arg108 interface{}) interface{} {
				return coer107(arg108.(_dafny.Sequence))
			}
