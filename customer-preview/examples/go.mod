...
replace (
	github.com/aws/aws-database-encryption-sdk-dynamodb/releases/go/ddb-esdk => ../ddb-esdk
...
require (
	...
	github.com/aws/aws-database-encryption-sdk-dynamodb/releases/go/ddb-esdk v0.0.0
...
require (
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/dynamodb v0.0.0 // indirect
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/kms v0.0.0 // indirect
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/primitives v0.0.0 // indirect
