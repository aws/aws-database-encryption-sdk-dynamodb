...
func (_static *CompanionStruct_Default___) DynamoDbItemEncryptor(config m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.DynamoDbItemEncryptorConfig) m_Wrappers.Result {
	...
	_ = _7_attributeNames
	_7_attributeNames = m_SortedSets.SetToOrderedSequence2(((config).Dtor_attributeActionsOnEncrypt()).Keys(), func(coer64 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg87 interface{}, arg88 interface{}) bool {
			return coer64(arg87.(_dafny.Char), arg88.(_dafny.Char))
		}
	...
	_ = _12_valueOrError4
	_12_valueOrError4 = (_11_structuredEncryptionRes).MapFailure(func(coer65 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg89 interface{}) interface{} {
			return coer65(arg89.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	if ((config).Dtor_cmm()).Is_Some() {
		...
		_ = _21_valueOrError6
		_21_valueOrError6 = (_20_maybeCmm).MapFailure(func(coer66 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
			return func(arg90 interface{}) interface{} {
				return coer66(arg90.(m_AwsCryptographyMaterialProvidersTypes.Error))
			}
	...
	_ = _26_valueOrError8
	_26_valueOrError8 = (_23_maybeCmpClient).MapFailure(func(coer67 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) func(interface{}) interface{} {
		return func(arg91 interface{}) interface{} {
			return coer67(arg91.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
