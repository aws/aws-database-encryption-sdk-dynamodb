...
// Dafny module QueryTransform compiled into Go
...
func (*Default__) String() string {
	return "QueryTransform.Default__"
}
...
func (_static *CompanionStruct_Default___) Input(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.QueryInputTransformInput) m_Wrappers.Result {
	...
	if !((config).Dtor_tableEncryptionConfigs()).Contains(((input).Dtor_sdkInput()).Dtor_TableName()) {
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_QueryInputTransformOutput_.Create_QueryInputTransformOutput_((input).Dtor_sdkInput()))
		return output
	} else {
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
		_ = _0_valueOrError0
		_0_valueOrError0 = m_Wrappers.Companion_Default___.Need(m_DynamoDbMiddlewareSupport.Companion_Default___.NoList(((input).Dtor_sdkInput()).Dtor_AttributesToGet()), m_DdbMiddlewareConfig.Companion_Default___.E(_dafny.SeqOfString("Legacy parameter 'AttributesToGet' not supported in Query with Encryption")))
		...
		_ = _1_valueOrError1
		_1_valueOrError1 = m_Wrappers.Companion_Default___.Need(m_DynamoDbMiddlewareSupport.Companion_Default___.NoMap(((input).Dtor_sdkInput()).Dtor_KeyConditions()), m_DdbMiddlewareConfig.Companion_Default___.E(_dafny.SeqOfString("Legacy parameter 'KeyConditions' not supported in Query with Encryption")))
		...
		_ = _2_valueOrError2
		_2_valueOrError2 = m_Wrappers.Companion_Default___.Need(m_DynamoDbMiddlewareSupport.Companion_Default___.NoMap(((input).Dtor_sdkInput()).Dtor_QueryFilter()), m_DdbMiddlewareConfig.Companion_Default___.E(_dafny.SeqOfString("Legacy parameter 'QueryFilter' not supported in Query with Encryption")))
		if (_2_valueOrError2).IsFailure() {
			output = (_2_valueOrError2).PropagateFailure()
			return output
		}
		var _3_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
		_ = _3_valueOrError3
		_3_valueOrError3 = m_Wrappers.Companion_Default___.Need((((input).Dtor_sdkInput()).Dtor_ConditionalOperator()).Is_None(), m_DdbMiddlewareConfig.Companion_Default___.E(_dafny.SeqOfString("Legacy parameter 'ConditionalOperator' not supported in Query with Encryption")))
		if (_3_valueOrError3).IsFailure() {
			output = (_3_valueOrError3).PropagateFailure()
			return output
		}
		var _4_tableConfig m_DdbMiddlewareConfig.TableConfig
		_ = _4_tableConfig
		_4_tableConfig = ((config).Dtor_tableEncryptionConfigs()).Get(((input).Dtor_sdkInput()).Dtor_TableName()).(m_DdbMiddlewareConfig.TableConfig)
		var _5_valueOrError4 m_Wrappers.Result = m_Wrappers.Result{}
		_ = _5_valueOrError4
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = m_DynamoDbMiddlewareSupport.Companion_Default___.QueryInputForBeacons(_4_tableConfig, (input).Dtor_sdkInput())
		_5_valueOrError4 = _out0
		if (_5_valueOrError4).IsFailure() {
			output = (_5_valueOrError4).PropagateFailure()
			return output
		}
		var _6_finalResult m_ComAmazonawsDynamodbTypes.QueryInput
		_ = _6_finalResult
		_6_finalResult = (_5_valueOrError4).Extract().(m_ComAmazonawsDynamodbTypes.QueryInput)
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_QueryInputTransformOutput_.Create_QueryInputTransformOutput_(_6_finalResult))
		return output
	}
	return output
}
func (_static *CompanionStruct_Default___) Output(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.QueryOutputTransformInput) m_Wrappers.Result {
	...
	if (!((config).Dtor_tableEncryptionConfigs()).Contains(_0_tableName)) || (m_DynamoDbMiddlewareSupport.Companion_Default___.NoList(((input).Dtor_sdkOutput()).Dtor_Items())) {
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_QueryOutputTransformOutput_.Create_QueryOutputTransformOutput_((input).Dtor_sdkOutput()))
		return output
	}
	...
	_ = _4_valueOrError0
	_4_valueOrError0 = m_DynamoDbMiddlewareSupport.Companion_Default___.GetBeaconKeyId(_1_tableConfig, ((input).Dtor_originalInput()).Dtor_KeyConditionExpression(), ((input).Dtor_originalInput()).Dtor_FilterExpression(), ((input).Dtor_originalInput()).Dtor_ExpressionAttributeValues(), ((input).Dtor_originalInput()).Dtor_ExpressionAttributeNames())
	...
	if (_5_keyId).Is_KeyId() {
		...
		_ = _7_valueOrError1
		_7_valueOrError1 = (m_UTF8.Encode((_5_keyId).Dtor_value())).MapFailure(func(coer156 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
			return func(arg190 interface{}) interface{} {
				return coer156(arg190.(_dafny.Sequence))
			}
	...
	var _15_decryptedOutput m_ComAmazonawsDynamodbTypes.QueryOutput
	_ = _15_decryptedOutput
	var _16_dt__update__tmp_h0 m_ComAmazonawsDynamodbTypes.QueryOutput = (input).Dtor_sdkOutput()
	...
	_15_decryptedOutput = m_ComAmazonawsDynamodbTypes.Companion_QueryOutput_.Create_QueryOutput_(_17_dt__update_hItems_h0, (_16_dt__update__tmp_h0).Dtor_Count(), (_16_dt__update__tmp_h0).Dtor_ScannedCount(), (_16_dt__update__tmp_h0).Dtor_LastEvaluatedKey(), (_16_dt__update__tmp_h0).Dtor_ConsumedCapacity())
	var _18_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_ComAmazonawsDynamodbTypes.Companion_QueryOutput_.Default())
	_ = _18_valueOrError4
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_DynamoDbMiddlewareSupport.Companion_Default___.QueryOutputForBeacons(_1_tableConfig, (input).Dtor_originalInput(), _15_decryptedOutput)
	_18_valueOrError4 = _out1
	if (_18_valueOrError4).IsFailure() {
		output = (_18_valueOrError4).PropagateFailure()
		return output
	}
	var _19_finalResult m_ComAmazonawsDynamodbTypes.QueryOutput
	_ = _19_finalResult
	_19_finalResult = (_18_valueOrError4).Extract().(m_ComAmazonawsDynamodbTypes.QueryOutput)
	output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_QueryOutputTransformOutput_.Create_QueryOutputTransformOutput_(_19_finalResult))
	return output
	return output
}
