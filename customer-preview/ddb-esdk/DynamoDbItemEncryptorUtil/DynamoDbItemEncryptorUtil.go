		...
		if (_3_valueOrError1).IsFailure() {
			...
			if (_4_valueOrError2).IsFailure() {
				...
				if (_6_valueOrError3).IsFailure() {
					...
					var _7_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((context).Keys(), func(coer47 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
						return func(arg65 interface{}, arg66 interface{}) bool {
							return coer47(arg65.(uint8), arg66.(uint8))
						}
					...
					if (context).Contains(m_StructuredEncryptionUtil.Companion_Default___.LEGEND__UTF8()) {
						...
						if (_8_valueOrError4).IsFailure() {
							...
							_ = _9_legend
							var _10_valueOrError5 m_Wrappers.Result = Companion_Default___.GetV2AttrMap(_7_keys, context, _9_legend, _dafny.NewMapBuilder().ToMap())
							_ = _10_valueOrError5
...
func (_static *CompanionStruct_Default___) GetAttrValue(ecValue _dafny.Sequence, legend _dafny.Char) m_Wrappers.Result {
	if (legend) == (m_StructuredEncryptionUtil.Companion_Default___.LEGEND__STRING()) {
		...
		if (_6_valueOrError3).IsFailure() {
			...
			_ = _7_terminal
			var _8_valueOrError4 m_Wrappers.Result = m_DynamoToStruct.Companion_Default___.BytesToAttr((_7_terminal).Dtor_value(), (_7_terminal).Dtor_typeId(), false, _dafny.One)
			_ = _8_valueOrError4
			if (_8_valueOrError4).IsFailure() {
				return (_8_valueOrError4).PropagateFailure()
			} else {
...
func (_static *CompanionStruct_Default___) GetV2AttrMap(keys _dafny.Sequence, context _dafny.Map, legend _dafny.Sequence, attrMap _dafny.Map) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Sign() == 0 {
		if (_dafny.IntOfUint32((legend).Cardinality())).Sign() == 0 {
		...
		if _dafny.Companion_Sequence_.IsProperPrefixOf(m_StructuredEncryptionUtil.Companion_Default___.EC__ATTR__PREFIX(), _0_key) {
			var _1_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((legend).Cardinality())).Sign() == 1, _dafny.SeqOfString("Encryption Context Legend is too short."))
			_ = _1_valueOrError0
			if (_1_valueOrError0).IsFailure() {
				return (_1_valueOrError0).PropagateFailure()
			} else {
				...
				if (_2_valueOrError1).IsFailure() {
					...
					_ = _3_attrName
					var _4_valueOrError2 m_Wrappers.Result = Companion_Default___.GetAttrValue((context).Get(_0_key).(_dafny.Sequence), (legend).Select(0).(_dafny.Char))
					_ = _4_valueOrError2
					if (_4_valueOrError2).IsFailure() {
						return (_4_valueOrError2).PropagateFailure()
					} else {
						...
						_ = _in1
						var _in2 _dafny.Sequence = (legend).Drop(1)
						_ = _in2
						var _in3 _dafny.Map = (attrMap).Update(_3_attrName, _5_attrValue)
						_ = _in3
						keys = _in0
						context = _in1
						legend = _in2
			...
			var _in4 _dafny.Sequence = (keys).Drop(1)
			_ = _in4
			var _in5 _dafny.Map = context
			_ = _in5
			var _in6 _dafny.Sequence = legend
			_ = _in6
			var _in7 _dafny.Map = attrMap
			_ = _in7
			keys = _in4
			context = _in5
			legend = _in6
...
func (_static *CompanionStruct_Default___) AddAttributeToMap(ddbAttrKey _dafny.Sequence, encodedAttrValue _dafny.Sequence, attrMap _dafny.Map) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_2_valueOrError1).IsFailure() {
			...
			_ = _3_terminal
			var _4_valueOrError2 m_Wrappers.Result = m_DynamoToStruct.Companion_Default___.BytesToAttr((_3_terminal).Dtor_value(), (_3_terminal).Dtor_typeId(), false, _dafny.One)
			_ = _4_valueOrError2
			if (_4_valueOrError2).IsFailure() {
				return (_4_valueOrError2).PropagateFailure()
			} else {
...
func (_static *CompanionStruct_Default___) SORT__NAME() _dafny.Sequence {
	return m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-crypto-sort-name"))
}
func (_static *CompanionStruct_Default___) PARTITION__NAME() _dafny.Sequence {
	return m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-crypto-partition-name"))
}
func (_static *CompanionStruct_Default___) TABLE__NAME() _dafny.Sequence {
	return m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-crypto-table-name"))
}
...
func (_static *CompanionStruct_Default___) MAX__ATTRIBUTE__COUNT() _dafny.Int {
