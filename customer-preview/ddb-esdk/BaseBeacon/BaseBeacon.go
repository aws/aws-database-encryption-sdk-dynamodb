...
func (_this BeaconBase) GetHmac(data _dafny.Sequence, key _dafny.Sequence) m_Wrappers.Result {
	{
		...
		_ = _0_input
		var _1_valueOrError0 m_Wrappers.Result = (((_this).Dtor_client()).HMac(_0_input)).MapFailure(func(coer81 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg105 interface{}) interface{} {
				return coer81(arg105.(m_AwsCryptographyPrimitivesTypes.Error))
			}
		...
		if (_dafny.IntOfUint32((value).Cardinality())).Sign() == 0 {
			...
			var _0_valueOrError0 m_Wrappers.Result = (m_DynamoToStruct.Companion_Default___.TopLevelAttributeToBytes(m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_((value).Select(0).(_dafny.Sequence)))).MapFailure(func(coer82 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg106 interface{}) interface{} {
					return coer82(arg106.(_dafny.Sequence))
				}
		...
		if (_dafny.IntOfUint32((value).Cardinality())).Sign() == 0 {
			...
			var _0_valueOrError0 m_Wrappers.Result = (m_DynamoToStruct.Companion_Default___.TopLevelAttributeToBytes(m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_N_((value).Select(0).(_dafny.Sequence)))).MapFailure(func(coer83 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg107 interface{}) interface{} {
					return coer83(arg107.(_dafny.Sequence))
				}
			}((func(_1___this0 StandardBeacon) func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
				return func(_2_e _dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
					return m_DynamoDbEncryptionUtil.Companion_Default___.E(_2_e)
		...
		if (_dafny.IntOfUint32((value).Cardinality())).Sign() == 0 {
			...
			var _0_valueOrError0 m_Wrappers.Result = (m_DynamoToStruct.Companion_Default___.TopLevelAttributeToBytes(m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_B_((value).Select(0).(_dafny.Sequence)))).MapFailure(func(coer84 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg108 interface{}) interface{} {
					return coer84(arg108.(_dafny.Sequence))
				}
			}((func(_1___this0 StandardBeacon) func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
				return func(_2_e _dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
					return m_DynamoDbEncryptionUtil.Companion_Default___.E(_2_e)
...
func (_this StandardBeacon) GetBeaconValue(value m_ComAmazonawsDynamodbTypes.AttributeValue, key _dafny.Sequence, forContains bool) m_Wrappers.Result {
	{
		if ((((_this).Dtor_asSet()) && (!((value).Is_S()))) && (!((value).Is_N()))) && (!((value).Is_B())) {
			...
			var _0_valueOrError0 m_Wrappers.Result = (m_DynamoToStruct.Companion_Default___.TopLevelAttributeToBytes(value)).MapFailure(func(coer85 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg109 interface{}) interface{} {
					return coer85(arg109.(_dafny.Sequence))
				}
