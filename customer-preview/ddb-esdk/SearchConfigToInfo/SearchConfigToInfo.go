...
func (_static *CompanionStruct_Default___) MakeKeySource(outer m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTableEncryptionConfig, keyStore m_AwsCryptographyKeyStoreTypes.IKeyStoreClient, config m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconKeySource, client *m_AtomicPrimitives.AtomicPrimitivesClient) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_mplR).MapFailure(func(coer123 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg153 interface{}) interface{} {
			return coer123(arg153.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	...
	if (_4_cacheType).Is_Shared() {
		...
		_ = _8_valueOrError1
		_8_valueOrError1 = (_7_maybeCache).MapFailure(func(coer124 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg154 interface{}) interface{} {
				return coer124(arg154.(m_AwsCryptographyMaterialProvidersTypes.Error))
			}
	...
	if ((config).Is_multi()) && ((((config).Dtor_multi()).Dtor_partitionId()).Is_Some()) {
		...
		_ = _11_valueOrError2
		_11_valueOrError2 = (m_UTF8.Encode((((config).Dtor_multi()).Dtor_partitionId()).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer125 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg155 interface{}) interface{} {
				return coer125(arg155.(_dafny.Sequence))
			}
		...
		_ = _13_valueOrError3
		_13_valueOrError3 = (m_UTF8.Encode((((config).Dtor_single()).Dtor_partitionId()).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer126 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg156 interface{}) interface{} {
				return coer126(arg156.(_dafny.Sequence))
			}
	...
	_ = _17_valueOrError5
	_17_valueOrError5 = (_16_getKeyStoreInfoOutput_q).MapFailure(func(coer127 func(m_AwsCryptographyKeyStoreTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg157 interface{}) interface{} {
			return coer127(arg157.(m_AwsCryptographyKeyStoreTypes.Error))
		}
	...
	_ = _21_valueOrError6
	_21_valueOrError6 = (m_UTF8.Encode(_20_logicalKeyStoreName)).MapFailure(func(coer128 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg158 interface{}) interface{} {
			return coer128(arg158.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) ConvertVersion(outer m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.DynamoDbTableEncryptionConfig, config m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.BeaconVersion) m_Wrappers.Result {
	...
	var _3_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _3_valueOrError2
	_3_valueOrError2 = (_2_maybePrimitives).MapFailure(func(coer129 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg159 interface{}) interface{} {
			return coer129(arg159.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) FindVirtualFieldWithThisLocation(fields _dafny.Map, locs _dafny.Set) m_Wrappers.Option {
	var _0_badNames _dafny.Set = func() _dafny.Set {
		...
		_ = _coll0
		for _iter31 := _dafny.Iterate((fields).Keys().Elements()); ; {
			_compr_0, _ok31 := _iter31()
			if !_ok31 {
				break
			}
	...
	if ((_0_badNames).Cardinality()).Sign() == 0 {
		...
		var _2_badSeq _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_badNames, func(coer130 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg160 interface{}, arg161 interface{}) bool {
				return coer130(arg160.(_dafny.Char), arg161.(_dafny.Char))
			}
...
func (_static *CompanionStruct_Default___) ExistsConstructorWithTheseRequired(cons _dafny.Sequence, locs _dafny.Set) bool {
	return (Companion_Default___.SeqCount(func(coer131 func(m_CompoundBeacon.Constructor) bool) func(interface{}) bool {
		return func(arg162 interface{}) bool {
			return coer131(arg162.(m_CompoundBeacon.Constructor))
		}
...
func (_static *CompanionStruct_Default___) GetPartsString(c m_CompoundBeacon.Constructor) _dafny.Sequence {
	var _0_req _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer132 func(m_CompoundBeacon.ConstructorPart) bool) func(interface{}) bool {
		return func(arg163 interface{}) bool {
			return coer132(arg163.(m_CompoundBeacon.ConstructorPart))
		}
	}(func(_1_p m_CompoundBeacon.ConstructorPart) bool {
		return (_1_p).Dtor_required()
	}), (c).Dtor_parts())
	_ = _0_req
	var _2_names _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer133 func(m_CompoundBeacon.ConstructorPart) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg164 interface{}) interface{} {
			return coer133(arg164.(m_CompoundBeacon.ConstructorPart))
		}
...
func (_static *CompanionStruct_Default___) FindBeaconWithThisLocation(beacons _dafny.Map, loc _dafny.Sequence) m_Wrappers.Option {
	var _0_badNames _dafny.Set = func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter32 := _dafny.Iterate((beacons).Keys().Elements()); ; {
	...
	if ((_0_badNames).Cardinality()).Sign() == 0 {
		...
		var _2_badSeq _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_0_badNames, func(coer134 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg165 interface{}, arg166 interface{}) bool {
				return coer134(arg165.(_dafny.Char), arg166.(_dafny.Char))
			}
		}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
		_ = _2_badSeq
		return m_Wrappers.Companion_Option_.Create_Some_((_2_badSeq).Select(0).(_dafny.Sequence))
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((c).Cardinality())).Sign() == 0 {
		...
		var _0_thePart _dafny.Sequence = Companion_Default___.MyFilter(func(coer135 func(m_CompoundBeacon.BeaconPart) bool) func(interface{}) bool {
			return func(arg167 interface{}) bool {
				return coer135(arg167.(m_CompoundBeacon.BeaconPart))
			}
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((constructors).Cardinality())).Sign() == 0 {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			var _1_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((Companion_Default___.SeqCount(func(coer136 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.ConstructorPart) bool) func(interface{}) bool {
				return func(arg168 interface{}) bool {
					return coer136(arg168.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.ConstructorPart))
				}
						...
						if (_13_valueOrError5).IsFailure() {
							...
							if (_14_valueOrError6).IsFailure() {
								...
								if (_15_valueOrError7).IsFailure() {
									...
									var _16_numNon _dafny.Int = _dafny.IntOfUint32((_10_signed).Cardinality())
									_ = _16_numNon
										...
										if (_21_valueOrError9).IsFailure() {
											...
											if (_22_valueOrError10).IsFailure() {
												...
												if (_25_valueOrError11).IsFailure() {
													...
													return m_CompoundBeacon.Companion_Default___.MakeCompoundBeacon(m_BaseBeacon.Companion_BeaconBase_.Create_BeaconBase_(client, (beacon).Dtor_name(), _24_beaconName), ((beacon).Dtor_split()).Select(0).(_dafny.Char), _17_allParts, _16_numNon, _23_constructors)
												}
											}
										}
									}
...
func (_static *CompanionStruct_Default___) CheckBeacons(data _dafny.Map) m_Wrappers.Result {
	var _0_beaconNames _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((data).Keys(), func(coer137 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg169 interface{}, arg170 interface{}) bool {
			return coer137(arg169.(_dafny.Char), arg170.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_beaconNames
...
func (_this PartSet) GetSetAsString(strings _dafny.Set) _dafny.Sequence {
	{
		var _0_names _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(strings, func(coer138 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg171 interface{}, arg172 interface{}) bool {
				return coer138(arg171.(_dafny.Char), arg172.(_dafny.Char))
			}
		}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
		_ = _0_names
