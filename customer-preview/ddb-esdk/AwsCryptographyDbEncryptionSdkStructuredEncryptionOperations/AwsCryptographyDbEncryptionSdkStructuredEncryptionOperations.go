...
func (_static *CompanionStruct_Default___) ResolveAuthActions(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.ResolveAuthActionsInput) m_Wrappers.Result {
	...
	output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_ResolveAuthActionsOutput_.Create_ResolveAuthActionsOutput_(m_Canonize.Companion_Default___.UnCanon(_9_canonData)))
	return output
	return output
}
func (_static *CompanionStruct_Default___) GetBinary(data _dafny.Sequence, path _dafny.Sequence) m_Wrappers.Result {
	var _0_data m_Wrappers.Option = Companion_Default___.FindAuth(data, path)
	_ = _0_data
	if (_0_data).Is_None() {
	...
	} else if !_dafny.Companion_Sequence_.Equal((((_0_data).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_data()).Dtor_typeId(), m_StructuredEncryptionUtil.Companion_Default___.BYTES__TYPE__ID()) {
	...
	} else if !(((_0_data).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_AuthenticateAction_.Create_DO__NOT__SIGN_()) {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(((_0_data).Dtor_value().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_data())
	}
}
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((fields).Cardinality())).Sign() == 0 {
		...
		_0___accumulator = (_0___accumulator).Plus(_dafny.IntOfUint32(((((fields).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data()).Dtor_value()).Cardinality()))
		var _in0 _dafny.Sequence = (fields).Drop(1)
		_ = _in0
		fields = _in0
		goto TAIL_CALL_START
	} else {
		var _in1 _dafny.Sequence = (fields).Drop(1)
		_ = _in1
		fields = _in1
		goto TAIL_CALL_START
	}
...
func (_static *CompanionStruct_Default___) GetStructuredEncryptionMaterials(cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager, encryptionContext m_Wrappers.Option, algorithmSuiteId m_Wrappers.Option, encryptedTerminalDataNum _dafny.Int, totalEncryptedTerminalValuesSize _dafny.Int) m_Wrappers.Result {
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_matR).MapFailure(func(coer19 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg24 interface{}) interface{} {
			return coer19(arg24.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContextCanon(schema _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_canonAttrs
	_0_canonAttrs = m_Seq.Companion_Default___.Filter(func(coer20 func(m_StructuredEncryptionUtil.CanonCryptoItem) bool) func(interface{}) bool {
		return func(arg25 interface{}) bool {
			return coer20(arg25.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
	...
	_ = _2_contextAttrs
	_2_contextAttrs = m_Seq.Companion_Default___.Map(func(coer21 func(m_StructuredEncryptionUtil.CanonCryptoItem) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) func(interface{}) interface{} {
		return func(arg26 interface{}) interface{} {
			return coer21(arg26.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContext(schema _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_contextAttrs
	_0_contextAttrs = m_Seq.Companion_Default___.Filter(func(coer22 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) bool) func(interface{}) bool {
		return func(arg27 interface{}) bool {
			return coer22(arg27.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
		}
...
func (_static *CompanionStruct_Default___) Find(haystack _dafny.Sequence, needle _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((haystack).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Failure_(m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Not Found")))
	} else if _dafny.Companion_Sequence_.Equal(((haystack).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key(), needle) {
		return m_Wrappers.Companion_Result_.Create_Success_((haystack).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
	} else {
...
func (_static *CompanionStruct_Default___) FindAuth(haystack _dafny.Sequence, needle _dafny.Sequence) m_Wrappers.Option {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((haystack).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Option_.Create_None_()
	} else if _dafny.Companion_Sequence_.Equal(((haystack).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem)).Dtor_key(), needle) {
		return m_Wrappers.Companion_Option_.Create_Some_((haystack).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem))
	} else {
		var _in0 _dafny.Sequence = (haystack).Drop(1)
		_ = _in0
		var _in1 _dafny.Sequence = needle
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((list).Cardinality())).Sign() == 0 {
		...
		var _in0 _dafny.Sequence = (list).Drop(1)
		_ = _in0
		list = _in0
		goto TAIL_CALL_START
	} else {
...
func (_static *CompanionStruct_Default___) GetV2EncryptionContext2(fields _dafny.Sequence) m_Wrappers.Result {
	...
	for _1_i := _dafny.Zero; _1_i.Cmp(_hi0) < 0; _1_i = _1_i.Plus(_dafny.One) {
		...
		_ = _3_valueOrError0
		_3_valueOrError0 = (m_UTF8.Encode(_2_keyVal)).MapFailure(func(coer23 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
			return func(arg28 interface{}) interface{} {
				return coer23(arg28.(_dafny.Sequence))
			}
	...
	_ = _6_keys
	_6_keys = m_SortedSets.SetToOrderedSequence2((_0_fieldMap).Keys(), func(coer24 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg29 interface{}, arg30 interface{}) bool {
			return coer24(arg29.(uint8), arg30.(uint8))
		}
	...
	for _9_i := _dafny.Zero; _9_i.Cmp(_hi1) < 0; _9_i = _9_i.Plus(_dafny.One) {
		...
		_ = _12_valueOrError1
		_12_valueOrError1 = Companion_Default___.Find(fields, (_0_fieldMap).Get(_10_fieldUtf8).(_dafny.Sequence))
		if (_12_valueOrError1).IsFailure() {
			output = (_12_valueOrError1).PropagateFailure()
			return output
		}
		var _13_item m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem
		_ = _13_item
		_13_item = (_12_valueOrError1).Extract().(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)
		...
		if _dafny.Companion_Sequence_.Equal((_14_attr).Dtor_typeId(), m_StructuredEncryptionUtil.Companion_Default___.NULL()) {
			...
			if !(!((_18_valueOrError3).IsFailure())) {
				panic("dafny/StructuredEncryption/src/AwsCryptographyDbEncryptionSdkStructuredEncryptionOperations.dfy(357,18): " + (_18_valueOrError3).String())
			}
	...
	_ = _22_valueOrError6
	_22_valueOrError6 = (m_UTF8.Encode(_8_legend)).MapFailure(func(coer25 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg31 interface{}) interface{} {
			return coer25(arg31.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) BuildCryptoMap2(keys _dafny.Sequence, plaintextStructure _dafny.Map, cryptoSchema _dafny.Map, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(acc)
	} else {
		var _0_key _dafny.Sequence = (keys).Select(0).(_dafny.Sequence)
		_ = _0_key
		...
		_ = _in2
		var _in3 _dafny.Sequence = _3_newAcc
		_ = _in3
		keys = _in0
...
func (_static *CompanionStruct_Default___) BuildCryptoMap(plaintextStructure _dafny.Map, cryptoSchema _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((plaintextStructure).Keys(), func(coer26 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg32 interface{}, arg33 interface{}) bool {
			return coer26(arg32.(_dafny.Char), arg33.(_dafny.Char))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_keys
	return Companion_Default___.BuildCryptoMap2(_0_keys, plaintextStructure, cryptoSchema, _dafny.SeqOf())
}
func (_static *CompanionStruct_Default___) BuildAuthMap2(keys _dafny.Sequence, plaintextStructure _dafny.Map, authSchema _dafny.Map, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(acc)
...
func (_static *CompanionStruct_Default___) BuildAuthMap(plaintextStructure _dafny.Map, authSchema _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((plaintextStructure).Keys(), func(coer27 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg34 interface{}, arg35 interface{}) bool {
			return coer27(arg34.(_dafny.Char), arg35.(_dafny.Char))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_keys
	return Companion_Default___.BuildAuthMap2(_0_keys, plaintextStructure, authSchema, _dafny.SeqOf())
}
func (_static *CompanionStruct_Default___) UnBuildCryptoMap(list _dafny.Sequence, dataSoFar _dafny.Map, actionsSoFar _dafny.Map) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((list).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(dataSoFar, actionsSoFar))
	} else {
		var _0_valueOrError0 m_Wrappers.Result = m_StructuredEncryptionPaths.Companion_Default___.UniPathToString(((list).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key())
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			...
			if (_2_valueOrError1).IsFailure() {
			...
			} else if m_StructuredEncryptionUtil.Companion_Default___.IsAuthAttr(((list).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_action()) {
				var _in0 _dafny.Sequence = (list).Drop(1)
				_ = _in0
				var _in1 _dafny.Map = (dataSoFar).Update(_1_key, ((list).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_data())
				_ = _in1
				var _in2 _dafny.Map = (actionsSoFar).Update(_1_key, ((list).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_action())
				_ = _in2
				list = _in0
				dataSoFar = _in1
				actionsSoFar = _in2
				...
				var _in3 _dafny.Sequence = (list).Drop(1)
				_ = _in3
				var _in4 _dafny.Map = (dataSoFar).Update(_1_key, ((list).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_data())
				_ = _in4
				var _in5 _dafny.Map = actionsSoFar
				_ = _in5
				list = _in3
				dataSoFar = _in4
				actionsSoFar = _in5
...
func (_static *CompanionStruct_Default___) EncryptStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptStructureInput) m_Wrappers.Result {
	...
	_ = _8_valueOrError4
	_8_valueOrError4 = Companion_Default___.UnBuildCryptoMap((_5_pathOutput).Dtor_encryptedStructure(), _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap())
...
func (_static *CompanionStruct_Default___) EncryptPathStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.EncryptPathStructureInput) m_Wrappers.Result {
	...
	if _dafny.Quantifier(((input).Dtor_plaintextStructure()).UniqueElements(), false, func(_exists_var_3 m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) bool {
		...
		if ((_14_newEncryptionContext).Cardinality()).Sign() != 0 {
			...
			_ = _16_contextKeysX
			_16_contextKeysX = m_SortedSets.SetToOrderedSequence2((_14_newEncryptionContext).Keys(), func(coer28 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
				return func(arg36 interface{}, arg37 interface{}) bool {
					return coer28(arg36.(uint8), arg37.(uint8))
				}
			}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
			...
			_ = _19_valueOrError8
			_19_valueOrError8 = (_18_cmmR).MapFailure(func(coer29 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
				return func(arg38 interface{}) interface{} {
					return coer29(arg38.(m_AwsCryptographyMaterialProvidersTypes.Error))
				}
	...
	_27_valueOrError11 = (_26_randBytes).MapFailure(func(coer30 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg39 interface{}) interface{} {
			return coer30(arg39.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) DetectMismatch(inputContext _dafny.Map, headContext _dafny.Map) m_Wrappers.Outcome {
	var _0_inputFields _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((inputContext).Keys(), func(coer31 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg40 interface{}, arg41 interface{}) bool {
			return coer31(arg40.(uint8), arg41.(uint8))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
	_ = _0_inputFields
...
func (_static *CompanionStruct_Default___) NewCmm(config Config, cmm m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager, context _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_contextKeysX
	_0_contextKeysX = m_SortedSets.SetToOrderedSequence2((context).Keys(), func(coer32 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg42 interface{}, arg43 interface{}) bool {
			return coer32(arg42.(uint8), arg43.(uint8))
		}
	}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
	...
	_ = _3_valueOrError0
	_3_valueOrError0 = (_2_cmmR).MapFailure(func(coer33 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg44 interface{}) interface{} {
			return coer33(arg44.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) DecryptStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptStructureInput) m_Wrappers.Result {
	...
	_ = _6_valueOrError3
	_6_valueOrError3 = Companion_Default___.UnBuildCryptoMap((_5_pathOutput).Dtor_plaintextStructure(), _dafny.NewMapBuilder().ToMap(), _dafny.NewMapBuilder().ToMap())
	if (_6_valueOrError3).IsFailure() {
		output = (_6_valueOrError3).PropagateFailure()
		return output
	}
...
func (_static *CompanionStruct_Default___) DecryptPathStructure(config Config, input m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.DecryptPathStructureInput) m_Wrappers.Result {
	...
	if ((_8_head).Dtor_version()) == (uint8(2)) {
		...
		var _out1 m_Wrappers.Result
		_ = _out1
		_out1 = Companion_Default___.GetV2EncryptionContext(m_Canonize.Companion_Default___.UnCanon(_13_canonData))
		...
		if ((_17_newEncryptionContext).Cardinality()).Sign() != 0 {
			...
			_ = _19_contextKeysX
			_19_contextKeysX = m_SortedSets.SetToOrderedSequence2((_17_newEncryptionContext).Keys(), func(coer34 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
				return func(arg45 interface{}, arg46 interface{}) bool {
					return coer34(arg45.(uint8), arg46.(uint8))
				}
			}(m_StructuredEncryptionUtil.Companion_Default___.ByteLess))
			...
			_22_valueOrError10 = (_21_cmmR).MapFailure(func(coer35 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
				return func(arg47 interface{}) interface{} {
					return coer35(arg47.(m_AwsCryptographyMaterialProvidersTypes.Error))
				}
	...
	_25_valueOrError11 = (_24_matR).MapFailure(func(coer36 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg48 interface{}) interface{} {
			return coer36(arg48.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
