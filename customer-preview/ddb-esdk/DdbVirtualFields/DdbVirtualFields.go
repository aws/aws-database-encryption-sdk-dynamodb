...
func (_static *CompanionStruct_Default___) ParseVirtualFieldConfig(vf m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualField) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer76 func(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualPart) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
		return func(arg100 interface{}) m_Wrappers.Result {
			return coer76(arg100.(m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.VirtualPart))
		}
...
func (_static *CompanionStruct_Default___) UpperCase(s _dafny.Sequence) _dafny.Sequence {
	return m_Seq.Companion_Default___.Map(func(coer77 func(_dafny.Char) _dafny.Char) func(interface{}) interface{} {
		return func(arg101 interface{}) interface{} {
			return coer77(arg101.(_dafny.Char))
		}
...
func (_static *CompanionStruct_Default___) LowerCase(s _dafny.Sequence) _dafny.Sequence {
	return m_Seq.Companion_Default___.Map(func(coer78 func(_dafny.Char) _dafny.Char) func(interface{}) interface{} {
		return func(arg102 interface{}) interface{} {
			return coer78(arg102.(_dafny.Char))
		}
	}(func(_0_c _dafny.Char) _dafny.Char {
	...
	if ((_dafny.IntOfUint32((loc).Cardinality())).Cmp(_dafny.One) == 0) && ((vf).Contains(((loc).Select(0).(m_TermLoc.Selector)).Dtor_key())) {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			if (_1_str).Is_None() {
				...
				var _2_valueOrError1 m_Wrappers.Result = (m_UTF8.Encode((_1_str).Dtor_value().(_dafny.Sequence))).MapFailure(func(coer79 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg103 interface{}) interface{} {
						return coer79(arg103.(_dafny.Sequence))
					}
...
func (_this VirtField) GetFields() _dafny.Sequence {
	{
		return m_Seq.Companion_Default___.Map(func(coer80 func(VirtPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg104 interface{}) interface{} {
				return coer80(arg104.(VirtPart))
			}
...
func (_this VirtField) GetLocs() _dafny.Set {
	{
		return func() _dafny.Set {
			...
			_ = _coll0
			for _iter22 := _dafny.Iterate(((_this).Dtor_parts()).Elements()); ; {
