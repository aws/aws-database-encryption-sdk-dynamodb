// Package DeleteItemTransform
// Dafny module DeleteItemTransform compiled into Go
...
func (*Default__) String() string {
	return "DeleteItemTransform.Default__"
}
...
func (_static *CompanionStruct_Default___) Input(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.DeleteItemInputTransformInput) m_Wrappers.Result {
	...
	if ((config).Dtor_tableEncryptionConfigs()).Contains(((input).Dtor_sdkInput()).Dtor_TableName()) {
		...
		_ = _1_valueOrError1
		_1_valueOrError1 = m_Wrappers.Companion_Default___.Need((((input).Dtor_sdkInput()).Dtor_ConditionalOperator()).Is_None(), m_DdbMiddlewareConfig.Companion_Default___.E(_dafny.SeqOfString("Legacy parameter 'ConditionalOperator' not supported in UpdateItem with Encryption")))
		if (_1_valueOrError1).IsFailure() {
			output = (_1_valueOrError1).PropagateFailure()
			return output
		}
		var _2_tableConfig m_DdbMiddlewareConfig.TableConfig
		_ = _2_tableConfig
		_2_tableConfig = ((config).Dtor_tableEncryptionConfigs()).Get(((input).Dtor_sdkInput()).Dtor_TableName()).(m_DdbMiddlewareConfig.TableConfig)
		var _3_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(false)
		_ = _3_valueOrError2
		_3_valueOrError2 = m_DynamoDbMiddlewareSupport.Companion_Default___.TestConditionExpression(_2_tableConfig, ((input).Dtor_sdkInput()).Dtor_ConditionExpression(), ((input).Dtor_sdkInput()).Dtor_ExpressionAttributeNames(), ((input).Dtor_sdkInput()).Dtor_ExpressionAttributeValues())
	...
	output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_DeleteItemInputTransformOutput_.Create_DeleteItemInputTransformOutput_((input).Dtor_sdkInput()))
	return output
	return output
}
func (_static *CompanionStruct_Default___) Output(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.DeleteItemOutputTransformInput) m_Wrappers.Result {
	...
	if (!((config).Dtor_tableEncryptionConfigs()).Contains(_0_tableName)) || (m_DynamoDbMiddlewareSupport.Companion_Default___.NoMap(((input).Dtor_sdkOutput()).Dtor_Attributes())) {
		output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_DeleteItemOutputTransformOutput_.Create_DeleteItemOutputTransformOutput_((input).Dtor_sdkOutput()))
		return output
	}
	...
	_ = _pat_let_tv0
	output = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Companion_DeleteItemOutputTransformOutput_.Create_DeleteItemOutputTransformOutput_(func(_pat_let43_0 m_ComAmazonawsDynamodbTypes.DeleteItemOutput) m_ComAmazonawsDynamodbTypes.DeleteItemOutput {
		return func(_7_dt__update__tmp_h0 m_ComAmazonawsDynamodbTypes.DeleteItemOutput) m_ComAmazonawsDynamodbTypes.DeleteItemOutput {
			return func(_pat_let44_0 m_Wrappers.Option) m_ComAmazonawsDynamodbTypes.DeleteItemOutput {
				return func(_8_dt__update_hAttributes_h0 m_Wrappers.Option) m_ComAmazonawsDynamodbTypes.DeleteItemOutput {
					return m_ComAmazonawsDynamodbTypes.Companion_DeleteItemOutput_.Create_DeleteItemOutput_(_8_dt__update_hAttributes_h0, (_7_dt__update__tmp_h0).Dtor_ConsumedCapacity(), (_7_dt__update__tmp_h0).Dtor_ItemCollectionMetrics())
				}(_pat_let44_0)
