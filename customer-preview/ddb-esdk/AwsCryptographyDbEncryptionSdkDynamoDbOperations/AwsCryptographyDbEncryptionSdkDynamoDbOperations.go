...
Lmatch0:
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (m_StructuredEncryptionHeader.Companion_Default___.PartialDeserialize(_0_header)).MapFailure(func(coer70 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg94 interface{}) interface{} {
			return coer70(arg94.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error))
		}
	...
	var _hi0 _dafny.Int = _dafny.IntOfUint32((_7_datakeys).Cardinality())
	_ = _hi0
	for _9_i := _dafny.Zero; _9_i.Cmp(_hi0) < 0; _9_i = _9_i.Plus(_dafny.One) {
		var _10_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
		_ = _10_valueOrError2
		_10_valueOrError2 = (m_UTF8.Decode(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_keyProviderId())).MapFailure(func(coer71 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg95 interface{}) interface{} {
				return coer71(arg95.(_dafny.Sequence))
			}
		...
		if _dafny.Companion_Sequence_.IsPrefixOf(_dafny.SeqOfString("aws-kms"), _12_extractedKeyProviderId) {
			...
			_ = _17_valueOrError4
			_17_valueOrError4 = (m_UTF8.Decode(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_keyProviderInfo())).MapFailure(func(coer72 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg96 interface{}) interface{} {
					return coer72(arg96.(_dafny.Sequence))
				}
			...
			if _dafny.Companion_Sequence_.Equal(_12_extractedKeyProviderId, _dafny.SeqOfString("aws-kms-hierarchy")) {
				...
				_ = _20_valueOrError5
				_20_valueOrError5 = (m_EdkWrapping.Companion_Default___.GetProviderWrappedMaterial(((_7_datakeys).Select((_9_i).Uint32()).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)).Dtor_ciphertext(), _16_algorithmSuite)).MapFailure(func(coer73 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg97 interface{}) interface{} {
						return coer73(arg97.(m_AwsCryptographyMaterialProvidersTypes.Error))
					}
				...
				var _23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX _dafny.Int
				_ = _23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX
				_23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX = (Companion_Default___.SALT__LENGTH()).Plus(Companion_Default___.IV__LENGTH())
				var _24_EDK__CIPHERTEXT__VERSION__INDEX _dafny.Int
				_ = _24_EDK__CIPHERTEXT__VERSION__INDEX
				_24_EDK__CIPHERTEXT__VERSION__INDEX = (_23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX).Plus(Companion_Default___.VERSION__LENGTH())
				var _25_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
				_ = _25_valueOrError6
				_25_valueOrError6 = m_Wrappers.Companion_Default___.Need((_23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX).Cmp(_24_EDK__CIPHERTEXT__VERSION__INDEX) < 0, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Wrong branch key version index.")))
				...
				_ = _26_valueOrError7
				_26_valueOrError7 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((_22_providerWrappedMaterial).Cardinality())).Cmp(_24_EDK__CIPHERTEXT__VERSION__INDEX) >= 0, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Incorrect ciphertext structure length.")))
				...
				_27_branchKeyVersionUuid = (_22_providerWrappedMaterial).Subsequence((_23_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX).Uint32(), (_24_EDK__CIPHERTEXT__VERSION__INDEX).Uint32())
				var _28_valueOrError8 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
				_ = _28_valueOrError8
				_28_valueOrError8 = (m_UUID.FromByteArray(_27_branchKeyVersionUuid)).MapFailure(func(coer74 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
					return func(arg98 interface{}) interface{} {
						return coer74(arg98.(_dafny.Sequence))
					}
