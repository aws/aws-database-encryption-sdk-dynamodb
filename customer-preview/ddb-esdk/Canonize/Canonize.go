...
func (_static *CompanionStruct_Default___) ResolveLegend(fields _dafny.Sequence, legend _dafny.Sequence, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((fields).Cardinality())).Sign() == 0 {
		var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((legend).Cardinality())).Sign() == 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Schema changed : something that was signed is now unsigned.")))
		_ = _0_valueOrError0
	...
	} else if (((fields).Select(0).(m_StructuredEncryptionUtil.CanonAuthItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_AuthenticateAction_.Create_DO__NOT__SIGN_()) {
		var _in0 _dafny.Sequence = (fields).Drop(1)
		_ = _in0
		var _in1 _dafny.Sequence = legend
		_ = _in1
		var _in2 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(Companion_Default___.MakeCryptoItem((fields).Select(0).(m_StructuredEncryptionUtil.CanonAuthItem), m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_DO__NOTHING_())))
		_ = _in2
		fields = _in0
		legend = _in1
		acc = _in2
		...
		var _1_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((legend).Cardinality())).Sign() == 1, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Schema changed : something that was unsigned is now signed.")))
		_ = _1_valueOrError1
		if (_1_valueOrError1).IsFailure() {
			return (_1_valueOrError1).PropagateFailure()
		} else {
			var _in3 _dafny.Sequence = (fields).Drop(1)
			_ = _in3
			var _in4 _dafny.Sequence = (legend).Drop(1)
			_ = _in4
			var _in5 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(acc, _dafny.SeqOf(Companion_Default___.MakeCryptoItem((fields).Select(0).(m_StructuredEncryptionUtil.CanonAuthItem), Companion_Default___.LegendToAction((legend).Select(0).(uint8)))))
			_ = _in5
			fields = _in3
			legend = _in4
			acc = _in5
...
func (_static *CompanionStruct_Default___) AuthToCanonAuth(tableName _dafny.Sequence, data _dafny.Sequence) _dafny.Sequence {
	var _0_canonList _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer12 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem) m_StructuredEncryptionUtil.CanonAuthItem) func(interface{}) interface{} {
		return func(arg17 interface{}) interface{} {
			return coer12(arg17.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.AuthItem))
		}
...
func (_static *CompanionStruct_Default___) CryptoToCanonCrypto(tableName _dafny.Sequence, data _dafny.Sequence) _dafny.Sequence {
	var _0_canonList _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer13 func(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem) m_StructuredEncryptionUtil.CanonCryptoItem) func(interface{}) interface{} {
		return func(arg18 interface{}) interface{} {
			return coer13(arg18.(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
		}
...
func (_static *CompanionStruct_Default___) DoResolveLegend(canonSorted _dafny.Sequence, legend _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.ResolveLegend(canonSorted, legend, _dafny.SeqOf())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) UnCanon(input _dafny.Sequence) _dafny.Sequence {
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((input).Cardinality())).Sign() == 0 {
		...
		var _1_newItem m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem = m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoItem_.Create_CryptoItem_(((input).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_origKey(), ((input).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data(), ((input).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action())
		_ = _1_newItem
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf(_1_newItem))
...
func (_static *CompanionStruct_Default___) UnCanonDecrypt(input _dafny.Sequence) _dafny.Sequence {
	var _0_results _dafny.Sequence = Companion_Default___.UnCanon(input)
	_ = _0_results
	return _0_results
}
...
func (_static *CompanionStruct_Default___) RemoveHeaderPaths(xs _dafny.Sequence) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0 {
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, (func() _dafny.Sequence {
			if _dafny.Companion_Sequence_.Contains(_dafny.SeqOf(m_StructuredEncryptionUtil.Companion_Default___.HeaderPath(), m_StructuredEncryptionUtil.Companion_Default___.FooterPath()), ((xs).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem)).Dtor_key()) {
				return _dafny.SeqOf()
			}
			return _dafny.SeqOf((xs).Select(0).(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.CryptoItem))
		})())
...
func (_static *CompanionStruct_Default___) RemoveHeaders(input _dafny.Sequence) _dafny.Sequence {
	var _0_finalData _dafny.Sequence = Companion_Default___.RemoveHeaderPaths(input)
	_ = _0_finalData
	return _0_finalData
}
