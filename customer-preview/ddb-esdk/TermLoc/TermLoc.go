...
func (_static *CompanionStruct_Default___) TermLocToString(t _dafny.Sequence) _dafny.Sequence {
	return _dafny.Companion_Sequence_.Concatenate(((t).Select(0).(Selector)).Dtor_key(), Companion_Default___.SelectorListToString((t).Drop(1)))
}
...
TAIL_CALL_START:
	...
	} else if ((s).Select(0).(Selector)).Is_Map() {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("."), ((s).Select(0).(Selector)).Dtor_key()))
		var _in0 _dafny.Sequence = (s).Drop(1)
		_ = _in0
		s = _in0
		goto TAIL_CALL_START
	} else {
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("["), m_StandardLibrary_String.Companion_Default___.Base10Int2String(_dafny.IntOfUint64(((s).Select(0).(Selector)).Dtor_pos()))), _dafny.SeqOfString("]")))
		var _in1 _dafny.Sequence = (s).Drop(1)
		_ = _in1
		s = _in1
		goto TAIL_CALL_START
	}
...
func (_static *CompanionStruct_Default___) LacksAttribute(t _dafny.Sequence, item _dafny.Map) bool {
	return !(item).Contains(((t).Select(0).(Selector)).Dtor_key())
}
func (_static *CompanionStruct_Default___) TermToAttr(t _dafny.Sequence, item _dafny.Map, names m_Wrappers.Option) m_Wrappers.Option {
	if !(item).Contains(((t).Select(0).(Selector)).Dtor_key()) {
		return m_Wrappers.Companion_Option_.Create_None_()
	} else {
		var _0_res m_Wrappers.Result = Companion_Default___.GetTerminal((item).Get(((t).Select(0).(Selector)).Dtor_key()).(m_ComAmazonawsDynamodbTypes.AttributeValue), (t).Drop(1), names)
		_ = _0_res
...
func (_static *CompanionStruct_Default___) TermToBytes(t _dafny.Sequence, item _dafny.Map) m_Wrappers.Result {
	...
	if (_0_part).Is_None() {
		...
		var _1_valueOrError0 m_Wrappers.Result = (m_DynamoToStruct.Companion_Default___.TopLevelAttributeToBytes((_0_part).Dtor_value().(m_ComAmazonawsDynamodbTypes.AttributeValue))).MapFailure(func(coer75 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg99 interface{}) interface{} {
				return coer75(arg99.(_dafny.Sequence))
			}
	...
	if (_dafny.IntOfUint32((parts).Cardinality())).Sign() == 0 {
		...
		}
		{
			if _source0.Is_L() {
				...
				_ = _8_l
				if !(((parts).Select(0).(Selector)).Is_List()) {
				...
				} else if (_dafny.IntOfUint32((_8_l).Cardinality())).Cmp(_dafny.IntOfUint64(((parts).Select(0).(Selector)).Dtor_pos())) <= 0 {
					...
					var _in0 m_ComAmazonawsDynamodbTypes.AttributeValue = (_8_l).Select(uint32(((parts).Select(0).(Selector)).Dtor_pos())).(m_ComAmazonawsDynamodbTypes.AttributeValue)
					_ = _in0
		...
		}
		{
			...
			_ = _9_m
			if !(((parts).Select(0).(Selector)).Is_Map()) {
			...
			} else if !(_9_m).Contains(((parts).Select(0).(Selector)).Dtor_key()) {
				if (((names).Is_Some()) && (((names).Dtor_value().(_dafny.Map)).Contains(((parts).Select(0).(Selector)).Dtor_key()))) && ((_9_m).Contains(((names).Dtor_value().(_dafny.Map)).Get(((parts).Select(0).(Selector)).Dtor_key()).(_dafny.Sequence))) {
					var _in3 m_ComAmazonawsDynamodbTypes.AttributeValue = (_9_m).Get(((names).Dtor_value().(_dafny.Map)).Get(((parts).Select(0).(Selector)).Dtor_key()).(_dafny.Sequence)).(m_ComAmazonawsDynamodbTypes.AttributeValue)
					_ = _in3
					var _in4 _dafny.Sequence = (parts).Drop(1)
					_ = _in4
					...
					return m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Tried to access "), ((parts).Select(0).(Selector)).Dtor_key()), _dafny.SeqOfString(" which is not in the map."))))
				}
			} else {
				var _in6 m_ComAmazonawsDynamodbTypes.AttributeValue = (_9_m).Get(((parts).Select(0).(Selector)).Dtor_key()).(m_ComAmazonawsDynamodbTypes.AttributeValue)
				_ = _in6
				var _in7 _dafny.Sequence = (parts).Drop(1)
				_ = _in7
...
func (_static *CompanionStruct_Default___) FindStartOfNext(s _dafny.Sequence) m_Wrappers.Option {
	var _0_dot m_Wrappers.Option = m_StandardLibrary.Companion_Default___.FindIndexMatching(s, _dafny.Char('.'), _dafny.Zero)
	_ = _0_dot
	var _1_bracket m_Wrappers.Option = m_StandardLibrary.Companion_Default___.FindIndexMatching(s, _dafny.Char('['), _dafny.Zero)
	_ = _1_bracket
	if ((_0_dot).Is_None()) && ((_1_bracket).Is_None()) {
		return m_Wrappers.Companion_Option_.Create_None_()
	} else if ((_0_dot).Is_Some()) && ((_1_bracket).Is_Some()) {
		if ((_0_dot).Dtor_value().(_dafny.Int)).Cmp((_1_bracket).Dtor_value().(_dafny.Int)) < 0 {
			return _0_dot
		} else {
			return _1_bracket
		}
...
func (_static *CompanionStruct_Default___) GetNumber(s _dafny.Sequence, acc _dafny.Int) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((s).Cardinality())).Sign() == 0 {
		...
		return m_Wrappers.Companion_Result_.Create_Failure_(m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unexpected character in number : "), _dafny.SeqOfChars((s).Select(0).(_dafny.Char)))))
	}
}
func (_static *CompanionStruct_Default___) GetSelector(s _dafny.Sequence) m_Wrappers.Result {
	if ((s).Select(0).(_dafny.Char)) == (_dafny.Char('.')) {
		return m_Wrappers.Companion_Result_.Create_Success_(Companion_Selector_.Create_Map_((s).Drop(1)))
	} else if ((s).Select(((_dafny.IntOfUint32((s).Cardinality())).Minus(_dafny.One)).Uint32()).(_dafny.Char)) != (_dafny.Char(']')) /* dircomp */ {
		...
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.GetNumber((s).Subsequence(1, ((_dafny.IntOfUint32((s).Cardinality())).Minus(_dafny.One)).Uint32()), _dafny.Zero)
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			var _1_num _dafny.Int = (_0_valueOrError0).Extract().(_dafny.Int)
			_ = _1_num
			var _2_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_1_num).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT64__LIMIT()) < 0, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Array selector exceeds maximum.")))
			_ = _2_valueOrError1
			if (_2_valueOrError1).IsFailure() {
				return (_2_valueOrError1).PropagateFailure()
			} else {
				return m_Wrappers.Companion_Result_.Create_Success_(Companion_Selector_.Create_List_((_1_num).Uint64()))
			}
		}
	}
}
func (_static *CompanionStruct_Default___) GetSelectors(s _dafny.Sequence, acc _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	var _0_pos m_Wrappers.Option = Companion_Default___.FindStartOfNext((s).Drop(1))
	_ = _0_pos
	var _1_end _dafny.Int = (func() _dafny.Int {
		if (_0_pos).Is_None() {
			return _dafny.IntOfUint32((s).Cardinality())
		}
		return ((_0_pos).Dtor_value().(_dafny.Int)).Plus(_dafny.One)
	})()
	_ = _1_end
	var _2_valueOrError0 m_Wrappers.Result = Companion_Default___.GetSelector((s).Take((_1_end).Uint32()))
	_ = _2_valueOrError0
	if (_2_valueOrError0).IsFailure() {
		...
		_ = _3_sel
		var _4_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.IntOfUint32((acc).Cardinality())).Plus(_dafny.One)).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT64__LIMIT()) < 0, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Selector Overflow")))
		_ = _4_valueOrError1
		if (_4_valueOrError1).IsFailure() {
			...
			var _in0 _dafny.Sequence = (s).Drop((_1_end).Uint32())
			_ = _in0
...
func (_static *CompanionStruct_Default___) MakeTermLoc(s _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((s).Cardinality())).Sign() == 1, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Path specification must not be empty.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		if (_1_pos).Is_None() {
			...
			var _3_name _dafny.Sequence = (s).Take(((_1_pos).Dtor_value().(_dafny.Int)).Uint32())
			_ = _3_name
			var _4_valueOrError1 m_Wrappers.Result = Companion_Default___.GetSelectors((s).Drop(((_1_pos).Dtor_value().(_dafny.Int)).Uint32()), _dafny.SeqOf())
			_ = _4_valueOrError1
			if (_4_valueOrError1).IsFailure() {
				return (_4_valueOrError1).PropagateFailure()
			} else {
				...
				_ = _5_selectors
				var _6_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.IntOfUint32((_5_selectors).Cardinality())).Plus(_dafny.One)).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT64__LIMIT()) < 0, m_DynamoDbEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Selector Overflow")))
				_ = _6_valueOrError2
...
func (_this *CompanionStruct_TermLoc_) Is_(__source _dafny.Sequence) bool {
	...
	_ = _1_x
	return Companion_Default___.ValidTermLoc(_1_x)
}
