...
func (_static *CompanionStruct_Default___) MakeDefaultConstructor(parts _dafny.Sequence) Constructor {
	var _0_cons _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer86 func(BeaconPart) ConstructorPart) func(interface{}) interface{} {
		return func(arg110 interface{}) interface{} {
			return coer86(arg110.(BeaconPart))
		}
...
func (_this Constructor) GetReqParts() _dafny.Set {
	{
		return func() _dafny.Set {
			...
			_ = _coll0
			for _iter23 := _dafny.Iterate(((_this).Dtor_parts()).Elements()); ; {
...
func (_this CompoundBeacon) PartsToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer87 func(BeaconPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg111 interface{}) interface{} {
				return coer87(arg111.(BeaconPart))
			}
...
func (_this CompoundBeacon) CPartsToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer88 func(ConstructorPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg112 interface{}) interface{} {
				return coer88(arg112.(ConstructorPart))
			}
...
func (_this CompoundBeacon) CListToString(p _dafny.Sequence) _dafny.Sequence {
	{
		var _0_beaconParts _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer89 func(Constructor) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg113 interface{}) interface{} {
				return coer89(arg113.(Constructor))
			}
...
func (_this CompoundBeacon) GetFields(virtualFields _dafny.Map) _dafny.Sequence {
	{
		return m_Seq.Companion_Default___.Flatten(m_Seq.Companion_Default___.Map(func(coer90 func(BeaconPart) _dafny.Sequence) func(interface{}) interface{} {
			return func(arg114 interface{}) interface{} {
				return coer90(arg114.(BeaconPart))
			}
		...
		})(virtualFields)), (_this).Dtor_parts()))
	}
}
...
func (_this CompoundBeacon) GetBeaconValue(value m_ComAmazonawsDynamodbTypes.AttributeValue, keys m_DynamoDbEncryptionUtil.MaybeKeyMap, forEquality bool) m_Wrappers.Result {
	{
		if !((value).Is_S()) {
			...
			_ = _0_parts
			var _1_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer91 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
				return func(arg115 interface{}) m_Wrappers.Result {
					return coer91(arg115.(_dafny.Sequence))
				}
			...
			if (_1_valueOrError0).IsFailure() {
				...
				if (_4_valueOrError1).IsFailure() {
					...
					_ = _5___v1
					var _6_valueOrError2 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer92 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
						return func(arg116 interface{}) m_Wrappers.Result {
							return coer92(arg116.(_dafny.Sequence))
						}
...
func (_this CompoundBeacon) FindPart(val _dafny.Sequence) m_Wrappers.Result {
	{
		var _0_thePart _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer93 func(BeaconPart) bool) func(interface{}) bool {
			return func(arg117 interface{}) bool {
				return coer93(arg117.(BeaconPart))
			}
...
func (_this CompoundBeacon) CheckOnePrefix(pos _dafny.Int) m_Wrappers.Result {
	{
		var _0_partNumbers _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32(((_this).Dtor_parts()).Cardinality())).Uint32(), func(coer94 func(_dafny.Int) _dafny.Int) func(_dafny.Int) interface{} {
			return func(arg118 _dafny.Int) interface{} {
				return coer94(arg118)
			}
		}(func(_1_i _dafny.Int) _dafny.Int {
			return _1_i
		}))
		_ = _0_partNumbers
		var _2_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer95 func(_dafny.Int) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
			return func(arg119 interface{}) m_Wrappers.Result {
				return coer95(arg119.(_dafny.Int))
			}
		...
		})(pos)), _dafny.SeqCreate((_dafny.IntOfUint32(((_this).Dtor_parts()).Cardinality())).Uint32(), func(coer96 func(_dafny.Int) _dafny.Int) func(_dafny.Int) interface{} {
			return func(arg120 _dafny.Int) interface{} {
				return coer96(arg120)
			}
