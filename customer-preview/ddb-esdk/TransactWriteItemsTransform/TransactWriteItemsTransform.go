...
func (_static *CompanionStruct_Default___) Input(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.TransactWriteItemsInputTransformInput) m_Wrappers.Result {
	...
	for _3_x := _dafny.Zero; _3_x.Cmp(_hi0) < 0; _3_x = _3_x.Plus(_dafny.One) {
		...
		if (((_4_item).Dtor_Put()).Is_Some()) && (!(m_DdbMiddlewareConfig.Companion_Default___.IsPlainWrite(config, (((_4_item).Dtor_Put()).Dtor_value().(m_ComAmazonawsDynamodbTypes.Put)).Dtor_TableName()))) {
			...
			_ = _17_valueOrError5
			_17_valueOrError5 = m_DynamoDbMiddlewareSupport.Companion_Default___.IsWriteable(_16_tableConfig, (((_4_item).Dtor_Put()).Dtor_value().(m_ComAmazonawsDynamodbTypes.Put)).Dtor_Item())
			...
			_ = _out0
			_out0 = m_DynamoDbMiddlewareSupport.Companion_Default___.AddSignedBeacons(_16_tableConfig, (((_4_item).Dtor_Put()).Dtor_value().(m_ComAmazonawsDynamodbTypes.Put)).Dtor_Item())
			_21_valueOrError7 = _out0
			...
			_ = _out1
			_out1 = ((_16_tableConfig).Dtor_itemEncryptor()).EncryptItem(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Companion_EncryptItemInput_.Create_EncryptItemInput_(_22_beaconItem))
			_23_encryptRes = _out1
			...
			_ = _out2
			_out2 = m_DynamoDbMiddlewareSupport.Companion_Default___.GetEncryptedBeacons(_16_tableConfig, (((_4_item).Dtor_Put()).Dtor_value().(m_ComAmazonawsDynamodbTypes.Put)).Dtor_Item(), m_DynamoDbEncryptionUtil.Companion_Default___.MaybeFromOptionKeyId(_27_keyId))
			_28_valueOrError10 = _out2
