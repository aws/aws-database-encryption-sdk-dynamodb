...
func (_static *CompanionStruct_Default___) MapError(r m_Wrappers.Result) m_Wrappers.Result {
	return (r).MapFailure(func(coer139 func(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
		return func(arg173 interface{}) interface{} {
			return coer139(arg173.(m_AwsCryptographyDbEncryptionSdkDynamoDbItemEncryptorTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) MapString(r m_Wrappers.Result) m_Wrappers.Result {
	return (r).MapFailure(func(coer140 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
		return func(arg174 interface{}) interface{} {
			return coer140(arg174.(_dafny.Sequence))
		}
