...
func (_static *CompanionStruct_Default___) IsWriteable(item _dafny.Map) m_Wrappers.Result {
	if _dafny.Quantifier((item).Keys().Elements(), true, func(_forall_var_0 _dafny.Sequence) bool {
		...
		_ = _1_bad
		var _3_badSeq _dafny.Sequence = m_SortedSets.SetToOrderedSequence2(_1_bad, func(coer113 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
			return func(arg139 interface{}, arg140 interface{}) bool {
				return coer113(arg139.(_dafny.Char), arg140.(_dafny.Char))
			}
...
func (_static *CompanionStruct_Default___) GetEncryptedAttributes(actions _dafny.Map, expr m_Wrappers.Option, attrNames m_Wrappers.Option) _dafny.Sequence {
	if (expr).Is_None() {
		...
		_ = _0_attrs
		return m_Seq.Companion_Default___.Filter(func(coer114 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg141 interface{}) bool {
				return coer114(arg141.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) TestUpdateExpression(actions _dafny.Map, expr m_Wrappers.Option, attrNames m_Wrappers.Option, attrValues m_Wrappers.Option) m_Wrappers.Result {
	if (expr).Is_Some() {
		...
		_ = _0_attrs
		var _1_encryptedAttrs _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer115 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg142 interface{}) bool {
				return coer115(arg142.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) AddSignedBeacons(search m_Wrappers.Option, item _dafny.Map) m_Wrappers.Result {
	...
	if (search).Is_None() {
		...
		_2_badAttrs = func() _dafny.Set {
			var _coll0 = _dafny.NewBuilder()
			_ = _coll0
			for _iter27 := _dafny.Iterate((_1_newAttrs).Keys().Elements()); ; {
		...
		_7_bad = func() _dafny.Set {
			...
			_ = _coll1
			for _iter28 := _dafny.Iterate((_6_both).Elements()); ; {
				_compr_1, _ok28 := _iter28()
				if !_ok28 {
					break
				}
		...
		if ((_7_bad).Cardinality()).Sign() == 1 {
			...
			_ = _9_badSeq
			_9_badSeq = m_SortedSets.SetToOrderedSequence2(_7_bad, func(coer116 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
				return func(arg143 interface{}, arg144 interface{}) bool {
					return coer116(arg143.(_dafny.Char), arg144.(_dafny.Char))
				}
			}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
...
func (_static *CompanionStruct_Default___) DoRemoveBeacons(item _dafny.Map) _dafny.Map {
	return func() _dafny.Map {
		...
		_ = _coll0
		for _iter30 := _dafny.Iterate((item).Keys().Elements()); ; {
...
func (_static *CompanionStruct_Default___) QueryOutputForBeacons(search m_Wrappers.Option, req m_ComAmazonawsDynamodbTypes.QueryInput, resp m_ComAmazonawsDynamodbTypes.QueryOutput) m_Wrappers.Result {
	...
	if (search).Is_None() {
		...
		_ = _0_trimmedItems
		_0_trimmedItems = m_Seq.Companion_Default___.Map(func(coer117 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg145 interface{}) interface{} {
				return coer117(arg145.(_dafny.Map))
			}
		...
		_ = _7_trimmedItems
		_7_trimmedItems = m_Seq.Companion_Default___.Map(func(coer118 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg146 interface{}) interface{} {
				return coer118(arg146.(_dafny.Map))
			}
...
func (_static *CompanionStruct_Default___) ScanOutputForBeacons(search m_Wrappers.Option, req m_ComAmazonawsDynamodbTypes.ScanInput, resp m_ComAmazonawsDynamodbTypes.ScanOutput) m_Wrappers.Result {
	...
	if (search).Is_None() {
		var _0_trimmedItems _dafny.Sequence
		_ = _0_trimmedItems
		_0_trimmedItems = m_Seq.Companion_Default___.Map(func(coer119 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg147 interface{}) interface{} {
				return coer119(arg147.(_dafny.Map))
			}
		}(func(_1_i _dafny.Map) _dafny.Map {
			return Companion_Default___.DoRemoveBeacons(_1_i)
		}), ((resp).Dtor_Items()).Dtor_value().(_dafny.Sequence))
		...
		var _7_trimmedItems _dafny.Sequence
		_ = _7_trimmedItems
		_7_trimmedItems = m_Seq.Companion_Default___.Map(func(coer120 func(_dafny.Map) _dafny.Map) func(interface{}) interface{} {
			return func(arg148 interface{}) interface{} {
				return coer120(arg148.(_dafny.Map))
			}
		}(func(_8_i _dafny.Map) _dafny.Map {
			return Companion_Default___.DoRemoveBeacons(_8_i)
		}), _5_newItems)
...
func (_static *CompanionStruct_Default___) GetVirtualFields(beaconVersion m_SearchableEncryptionInfo.BeaconVersion, item _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_fieldNames
	_0_fieldNames = m_SortedSets.SetToOrderedSequence2(((beaconVersion).Dtor_virtualFields()).Keys(), func(coer121 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg149 interface{}, arg150 interface{}) bool {
			return coer121(arg149.(_dafny.Char), arg150.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
...
func (_static *CompanionStruct_Default___) GetCompoundBeacons(beaconVersion m_SearchableEncryptionInfo.BeaconVersion, item _dafny.Map) m_Wrappers.Result {
	...
	_ = _0_beaconNames
	_0_beaconNames = m_SortedSets.SetToOrderedSequence2(((beaconVersion).Dtor_beacons()).Keys(), func(coer122 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg151 interface{}, arg152 interface{}) bool {
			return coer122(arg151.(_dafny.Char), arg152.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
