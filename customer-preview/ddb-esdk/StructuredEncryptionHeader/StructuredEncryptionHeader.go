...
func (_static *CompanionStruct_Default___) IsVersion2Schema(data _dafny.Sequence) bool {
	return _dafny.Quantifier((data).UniqueElements(), false, func(_exists_var_0 m_StructuredEncryptionUtil.CanonCryptoItem) bool {
		var _0_x m_StructuredEncryptionUtil.CanonCryptoItem
		_0_x = interface{}(_exists_var_0).(m_StructuredEncryptionUtil.CanonCryptoItem)
		return (_dafny.Companion_Sequence_.Contains(data, _0_x)) && (((_0_x).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_SIGN__AND__INCLUDE__IN__ENCRYPTION__CONTEXT_()))
	})
}
func (_static *CompanionStruct_Default___) VersionFromSchema(data _dafny.Sequence) uint8 {
	if Companion_Default___.IsVersion2Schema(data) {
		return uint8(2)
	} else {
		return uint8(1)
	}
...
func (_static *CompanionStruct_Default___) Create(tableName _dafny.Sequence, schema _dafny.Sequence, msgID _dafny.Sequence, mat m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.ValidEncryptionContext((mat).Dtor_encryptionContext()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid Encryption Context")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32(((mat).Dtor_encryptedDataKeys()).Cardinality())).Sign() == 1, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("There must be at least one data key")))
		_ = _1_valueOrError1
		if (_1_valueOrError1).IsFailure() {
			return (_1_valueOrError1).PropagateFailure()
		} else {
			var _2_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32(((mat).Dtor_encryptedDataKeys()).Cardinality())).Cmp(Companion_Default___.UINT8__LIMIT()) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too many data keys.")))
			_ = _2_valueOrError2
			if (_2_valueOrError2).IsFailure() {
				return (_2_valueOrError2).PropagateFailure()
			} else {
				var _3_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(_dafny.Quantifier(((mat).Dtor_encryptedDataKeys()).UniqueElements(), true, func(_forall_var_0 m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey) bool {
					var _4_x m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey
					_4_x = interface{}(_forall_var_0).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)
					return !(_dafny.Companion_Sequence_.Contains((mat).Dtor_encryptedDataKeys(), _4_x)) || (Companion_Default___.ValidEncryptedDataKey(_4_x))
				...
				if (_3_valueOrError3).IsFailure() {
					...
					var _5_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Cardinality())).Cmp(_dafny.IntOfInt64(2)) == 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid Algorithm Suite Binary ID")))
					_ = _5_valueOrError4
					if (_5_valueOrError4).IsFailure() {
						return (_5_valueOrError4).PropagateFailure()
					} else {
						var _6_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(0).(uint8)) == (m_StructuredEncryptionUtil.Companion_Default___.DbeAlgorithmFamily()), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Algorithm Suite not suitable for structured encryption.")))
						_ = _6_valueOrError5
						if (_6_valueOrError5).IsFailure() {
							return (_6_valueOrError5).PropagateFailure()
						} else {
							var _7_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.ValidFlavor((((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(1).(uint8)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Algorithm Suite has unexpected flavor.")))
							_ = _7_valueOrError6
							if (_7_valueOrError6).IsFailure() {
								return (_7_valueOrError6).PropagateFailure()
							} else {
								var _8_valueOrError7 m_Wrappers.Result = Companion_Default___.MakeLegend(schema)
								_ = _8_valueOrError7
								if (_8_valueOrError7).IsFailure() {
									return (_8_valueOrError7).PropagateFailure()
								} else {
									var _9_legend _dafny.Sequence = (_8_valueOrError7).Extract().(_dafny.Sequence)
									_ = _9_legend
									var _10_storedEC _dafny.Map = func() _dafny.Map {
										...
										for _iter6 := _dafny.Iterate(((mat).Dtor_encryptionContext()).Keys().Elements()); ; {
											...
											_11_k = interface{}(_compr_0).(_dafny.Sequence)
											if m_UTF8.Companion_ValidUTF8Bytes_.Is_(_11_k) {
												if (((mat).Dtor_encryptionContext()).Contains(_11_k)) && (!_dafny.Companion_Sequence_.Contains((mat).Dtor_requiredEncryptionContextKeys(), _11_k)) {
													_coll0.Add(_11_k, ((mat).Dtor_encryptionContext()).Get(_11_k).(_dafny.Sequence))
												}
											}
										}
										return _coll0.ToMap()
									...
									_ = _10_storedEC
									var _12_valueOrError8 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.ValidEncryptionContext(_10_storedEC), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Invalid Encryption Context")))
									_ = _12_valueOrError8
									if (_12_valueOrError8).IsFailure() {
										return (_12_valueOrError8).PropagateFailure()
									} else {
										return m_Wrappers.Companion_Result_.Create_Success_(Companion_PartialHeader_.Create_PartialHeader_(Companion_Default___.VersionFromSchema(schema), (((mat).Dtor_algorithmSuite()).Dtor_binaryId()).Select(1).(uint8), msgID, _9_legend, _10_storedEC, (mat).Dtor_encryptedDataKeys()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) MakeLegend(schema _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.MakeLegend2(schema, Companion_Default___.EmptyLegend())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		_ = _1_legend
		var _2_authCount _dafny.Int = Companion_Default___.CountAuthAttrs(schema)
		_ = _2_authCount
...
func (_static *CompanionStruct_Default___) MakeLegend2(data _dafny.Sequence, serialized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((data).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(serialized)
	} else if m_StructuredEncryptionUtil.Companion_Default___.IsAuthAttr(((data).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()) {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			var _1_legendChar uint8 = Companion_Default___.GetActionLegend(((data).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action())
			_ = _1_legendChar
			var _in0 _dafny.Sequence = (data).Drop(1)
			_ = _in0
			var _in1 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(serialized, _dafny.SeqOf(_1_legendChar))
			_ = _in1
			data = _in0
			serialized = _in1
			goto TAIL_CALL_START
		...
		var _in2 _dafny.Sequence = (data).Drop(1)
		_ = _in2
		var _in3 _dafny.Sequence = serialized
		_ = _in3
		data = _in2
		serialized = _in3
		goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) CountAuthAttrs(data _dafny.Sequence) _dafny.Int {
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((data).Cardinality())).Sign() == 0 {
		...
		var _in1 _dafny.Sequence = (data).Drop(1)
		_ = _in1
		data = _in1
		goto TAIL_CALL_START
	}
...
func (_static *CompanionStruct_Default___) GetLegend(data _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		var _1_len uint16 = m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence(0, 2))
		_ = _1_len
		...
		if (_3_valueOrError1).IsFailure() {
			...
			var _4_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(_dafny.Quantifier(((data).Subsequence(2, (_2_size).Uint32())).UniqueElements(), true, func(_forall_var_0 uint8) bool {
				var _5_x uint8
				_5_x = interface{}(_forall_var_0).(uint8)
				if true {
					return !(_dafny.Companion_Sequence_.Contains((data).Subsequence(2, (_2_size).Uint32()), _5_x)) || (Companion_Default___.ValidLegendByte(_5_x))
				} else {
					return true
				}
			...
			if (_4_valueOrError2).IsFailure() {
				...
				return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf((data).Subsequence(2, (_2_size).Uint32()), _2_size))
			}
		}
	}
}
func (_static *CompanionStruct_Default___) GetContext(data _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		var _1_count _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence(0, 2)))
		_ = _1_count
		var _2_valueOrError1 m_Wrappers.Result = Companion_Default___.GetContext2(_1_count, data, (data).Drop(2), _dafny.TupleOf(_dafny.NewMapBuilder().ToMap(), _dafny.IntOfInt64(2)), _dafny.SeqOf())
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
...
func (_static *CompanionStruct_Default___) GetOneKVPair(data _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfInt64(2)).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_keyLen _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence(0, 2)))
		_ = _1_keyLen
		var _2_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_1_keyLen).Plus(_dafny.IntOfInt64(4))).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			var _3_key _dafny.Sequence = (data).Subsequence(2, ((_1_keyLen).Plus(_dafny.IntOfInt64(2))).Uint32())
			_ = _3_key
			...
			if (_4_valueOrError2).IsFailure() {
				...
				var _5_valueLen _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence(((_1_keyLen).Plus(_dafny.IntOfInt64(2))).Uint32(), ((_1_keyLen).Plus(_dafny.IntOfInt64(4))).Uint32())))
				_ = _5_valueLen
				var _6_kvLen _dafny.Int = (((_dafny.IntOfInt64(2)).Plus(_1_keyLen)).Plus(_dafny.IntOfInt64(2))).Plus(_5_valueLen)
				_ = _6_kvLen
				var _7_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_6_kvLen).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
				_ = _7_valueOrError3
				if (_7_valueOrError3).IsFailure() {
					return (_7_valueOrError3).PropagateFailure()
				} else {
					var _8_value _dafny.Sequence = (data).Subsequence(((_1_keyLen).Plus(_dafny.IntOfInt64(4))).Uint32(), (_6_kvLen).Uint32())
					_ = _8_value
...
func (_static *CompanionStruct_Default___) BytesLess(a _dafny.Sequence, b _dafny.Sequence) bool {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if _dafny.Companion_Sequence_.Equal(a, b) {
		return false
	} else if (_dafny.IntOfUint32((a).Cardinality())).Sign() == 0 {
		return true
	} else if (_dafny.IntOfUint32((b).Cardinality())).Sign() == 0 {
		return false
	} else if ((a).Select(0).(uint8)) != ((b).Select(0).(uint8)) /* dircomp */ {
		return ((a).Select(0).(uint8)) < ((b).Select(0).(uint8))
	} else {
...
func (_static *CompanionStruct_Default___) GetContext2(count _dafny.Int, origData _dafny.Sequence, data _dafny.Sequence, deserialized _dafny.Tuple, prevKey _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (count).Sign() == 0 {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			var _1_valueOrError1 m_Wrappers.Result = Companion_Default___.GetOneKVPair(data)
			_ = _1_valueOrError1
			if (_1_valueOrError1).IsFailure() {
				return (_1_valueOrError1).PropagateFailure()
			} else {
				...
				_ = _2_kv
				var _3_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(Companion_Default___.BytesLess(prevKey, (*(_2_kv).IndexInt(0)).(_dafny.Sequence)), m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Context keys out of order.")))
				_ = _3_valueOrError2
				if (_3_valueOrError2).IsFailure() {
					...
					_ = _in0
					var _in1 _dafny.Sequence = origData
					_ = _in1
					var _in2 _dafny.Sequence = (data).Drop(((((_dafny.IntOfInt64(2)).Plus(_dafny.IntOfUint32(((*(_2_kv).IndexInt(0)).(_dafny.Sequence)).Cardinality()))).Plus(_dafny.IntOfInt64(2))).Plus(_dafny.IntOfUint32(((*(_2_kv).IndexInt(1)).(_dafny.Sequence)).Cardinality()))).Uint32())
					_ = _in2
					var _in3 _dafny.Tuple = _dafny.TupleOf(((*(deserialized).IndexInt(0)).(_dafny.Map)).Update((*(_2_kv).IndexInt(0)).(_dafny.Sequence), (*(_2_kv).IndexInt(1)).(_dafny.Sequence)), ((*(deserialized).IndexInt(1)).(_dafny.Int)).Plus((*(_2_kv).IndexInt(2)).(_dafny.Int)))
					_ = _in3
					var _in4 _dafny.Sequence = (*(_2_kv).IndexInt(0)).(_dafny.Sequence)
					_ = _in4
					count = _in0
					origData = _in1
					data = _in2
...
func (_static *CompanionStruct_Default___) SerializeContext(x _dafny.Map) _dafny.Sequence {
	...
	_ = _0_keys
	return _dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt16ToSeq(uint16((x).CardinalityInt())), Companion_Default___.SerializeContext2(_0_keys, x))
}
...
func (_static *CompanionStruct_Default___) GetOneDataKey(data _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfInt64(2)).Cmp(_dafny.IntOfUint32((data).Cardinality())) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_provIdSize _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence(0, 2)))
		_ = _1_provIdSize
		var _2_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_1_provIdSize).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((data).Cardinality())) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			var _3_provId _dafny.Sequence = (data).Subsequence(2, ((_dafny.IntOfInt64(2)).Plus(_1_provIdSize)).Uint32())
			_ = _3_provId
			...
			if (_4_valueOrError2).IsFailure() {
				...
				_ = _5_part1Size
				var _6_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_5_part1Size).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
				_ = _6_valueOrError3
				if (_6_valueOrError3).IsFailure() {
					return (_6_valueOrError3).PropagateFailure()
				} else {
					var _7_provInfoSize _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence((_5_part1Size).Uint32(), ((_5_part1Size).Plus(_dafny.IntOfInt64(2))).Uint32())))
					_ = _7_provInfoSize
					var _8_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((((_5_part1Size).Plus(_7_provInfoSize)).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((data).Cardinality())) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
					_ = _8_valueOrError4
					if (_8_valueOrError4).IsFailure() {
						return (_8_valueOrError4).PropagateFailure()
					} else {
						var _9_provInfo _dafny.Sequence = (data).Subsequence(((_5_part1Size).Plus(_dafny.IntOfInt64(2))).Uint32(), (((_5_part1Size).Plus(_dafny.IntOfInt64(2))).Plus(_7_provInfoSize)).Uint32())
						_ = _9_provInfo
						var _10_part2Size _dafny.Int = ((_5_part1Size).Plus(_dafny.IntOfInt64(2))).Plus(_7_provInfoSize)
						_ = _10_part2Size
						var _11_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_10_part2Size).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
						_ = _11_valueOrError5
						if (_11_valueOrError5).IsFailure() {
							return (_11_valueOrError5).PropagateFailure()
						} else {
							var _12_cipherSize _dafny.Int = _dafny.IntOfUint16(m_StandardLibrary_UInt.Companion_Default___.SeqToUInt16((data).Subsequence((_10_part2Size).Uint32(), ((_10_part2Size).Plus(_dafny.IntOfInt64(2))).Uint32())))
							_ = _12_cipherSize
							var _13_valueOrError6 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((((_10_part2Size).Plus(_12_cipherSize)).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((data).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Unexpected end of header data.")))
							_ = _13_valueOrError6
							if (_13_valueOrError6).IsFailure() {
								return (_13_valueOrError6).PropagateFailure()
							} else {
								var _14_cipher _dafny.Sequence = (data).Subsequence(((_10_part2Size).Plus(_dafny.IntOfInt64(2))).Uint32(), (((_10_part2Size).Plus(_dafny.IntOfInt64(2))).Plus(_12_cipherSize)).Uint32())
								_ = _14_cipher
...
func (_static *CompanionStruct_Default___) SerializeContext2(keys _dafny.Sequence, x _dafny.Map) _dafny.Sequence {
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((keys).Cardinality())).Sign() == 0 {
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, Companion_Default___.SerializeOneKVPair((keys).Select(0).(_dafny.Sequence), (x).Get((keys).Select(0).(_dafny.Sequence)).(_dafny.Sequence)))
...
func (_static *CompanionStruct_Default___) SerializeDataKeys(x _dafny.Sequence) _dafny.Sequence {
	var _0_body _dafny.Sequence = Companion_Default___.SerializeDataKeys2(x)
	_ = _0_body
	return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(uint8((x).Cardinality())), _0_body)
}
func (_static *CompanionStruct_Default___) SerializeDataKeys2(x _dafny.Sequence) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((x).Cardinality())).Sign() == 0 {
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, Companion_Default___.SerializeOneDataKey((x).Select(0).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey)))
...
func (_static *CompanionStruct_Default___) GetDataKeys(data _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _1_count
		var _2_valueOrError1 m_Wrappers.Result = Companion_Default___.GetDataKeys2(_1_count, _1_count, data, (data).Drop(1), _dafny.TupleOf(_dafny.SeqOf(), _dafny.One))
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
...
func (_static *CompanionStruct_Default___) GetDataKeys2(count _dafny.Int, origCount _dafny.Int, origData _dafny.Sequence, data _dafny.Sequence, deserialized _dafny.Tuple) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (count).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(deserialized)
		...
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.GetOneDataKey(data)
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			...
			_ = _in1
			var _in2 _dafny.Sequence = origData
			_ = _in2
			var _in3 _dafny.Sequence = (data).Drop(((*(_1_edk).IndexInt(1)).(_dafny.Int)).Uint32())
			_ = _in3
			var _in4 _dafny.Tuple = _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate((*(deserialized).IndexInt(0)).(_dafny.Sequence), _dafny.SeqOf((*(_1_edk).IndexInt(0)).(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey))), ((*(deserialized).IndexInt(1)).(_dafny.Int)).Plus((*(_1_edk).IndexInt(1)).(_dafny.Int)))
			_ = _in4
			count = _in0
			origCount = _in1
			origData = _in2
