...
func (_static *CompanionStruct_Default___) Below(x _dafny.Sequence, y _dafny.Sequence) bool {
	return !((_dafny.IntOfUint32((x).Cardinality())).Sign() != 0) || ((((_dafny.IntOfUint32((y).Cardinality())).Sign() != 0) && (((x).Select(0).(uint8)) <= ((y).Select(0).(uint8)))) && (!(((x).Select(0).(uint8)) == ((y).Select(0).(uint8))) || (Companion_Default___.Below((x).Drop(1), (y).Drop(1)))))
}
func (_static *CompanionStruct_Default___) AuthSort(x _dafny.Sequence) _dafny.Sequence {
	var _0_ret _dafny.Sequence = m_Seq_MergeSort.Companion_Default___.MergeSortBy(x, func(coer10 func(m_StructuredEncryptionUtil.CanonAuthItem, m_StructuredEncryptionUtil.CanonAuthItem) bool) func(interface{}, interface{}) bool {
		return func(arg13 interface{}, arg14 interface{}) bool {
			return coer10(arg13.(m_StructuredEncryptionUtil.CanonAuthItem), arg14.(m_StructuredEncryptionUtil.CanonAuthItem))
		}
...
func (_static *CompanionStruct_Default___) CryptoSort(x _dafny.Sequence) _dafny.Sequence {
	var _0_ret _dafny.Sequence = m_Seq_MergeSort.Companion_Default___.MergeSortBy(x, func(coer11 func(m_StructuredEncryptionUtil.CanonCryptoItem, m_StructuredEncryptionUtil.CanonCryptoItem) bool) func(interface{}, interface{}) bool {
		return func(arg15 interface{}, arg16 interface{}) bool {
			return coer11(arg15.(m_StructuredEncryptionUtil.CanonCryptoItem), arg16.(m_StructuredEncryptionUtil.CanonCryptoItem))
		}
