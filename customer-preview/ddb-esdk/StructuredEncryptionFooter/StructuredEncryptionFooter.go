...
func (_static *CompanionStruct_Default___) GetCanonicalType(value m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal, isEncrypted bool) m_Wrappers.Result {
	if isEncrypted {
		...
		if (_0_valueOrError0).IsFailure() {
			...
			return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt64ToSeq(((_dafny.IntOfUint32(((value).Dtor_value()).Cardinality())).Minus(_dafny.IntOfInt64(2))).Uint64()), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("ENCRYPTED"))))
		}
	} else {
...
func (_static *CompanionStruct_Default___) GetCanonicalPlaintextField(fieldName _dafny.Sequence, value m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(fieldName, m_StandardLibrary_UInt.Companion_Default___.UInt64ToSeq(uint64(((value).Dtor_value()).Cardinality()))), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("PLAINTEXT"))), (value).Dtor_typeId()), (value).Dtor_value()))
	}
}
...
func (_static *CompanionStruct_Default___) CanonContent(data _dafny.Sequence, canonized _dafny.Sequence) m_Wrappers.Result {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((data).Cardinality())).Sign() == 0 {
		return m_Wrappers.Companion_Result_.Create_Success_(canonized)
	} else if (((data).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_DO__NOTHING_()) {
		var _in0 _dafny.Sequence = (data).Drop(1)
		_ = _in0
		var _in1 _dafny.Sequence = canonized
		_ = _in1
		data = _in0
		canonized = _in1
		goto TAIL_CALL_START
	} else {
		var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.GetCanonicalItem((data).Select(0).(m_StructuredEncryptionUtil.CanonCryptoItem))
		_ = _0_valueOrError0
		if (_0_valueOrError0).IsFailure() {
			return (_0_valueOrError0).PropagateFailure()
		} else {
			var _1_newPart _dafny.Sequence = (_0_valueOrError0).Extract().(_dafny.Sequence)
			_ = _1_newPart
			var _in2 _dafny.Sequence = (data).Drop(1)
			_ = _in2
			var _in3 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(canonized, _1_newPart)
			_ = _in3
			data = _in2
			canonized = _in3
			goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) CanonRecord(data _dafny.Sequence, header _dafny.Sequence, enc _dafny.Map) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.CanonContent(data, _dafny.SeqOf())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((tags).Cardinality())).Sign() == 0 {
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, (tags).Select(0).(_dafny.Sequence))
