...
func (_static *CompanionStruct_Default___) Output(config m_DdbMiddlewareConfig.Config, input m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.ScanOutputTransformInput) m_Wrappers.Result {
	...
	if (_5_keyId).Is_KeyId() {
		...
		_ = _7_valueOrError1
		_7_valueOrError1 = (m_UTF8.Encode((_5_keyId).Dtor_value())).MapFailure(func(coer155 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTransformsTypes.Error) func(interface{}) interface{} {
			return func(arg189 interface{}) interface{} {
				return coer155(arg189.(_dafny.Sequence))
			}
