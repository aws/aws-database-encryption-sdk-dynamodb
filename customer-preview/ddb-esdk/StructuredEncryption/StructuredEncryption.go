...
func (_static *CompanionStruct_Default___) StructuredEncryption(config m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredEncryptionConfig) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_maybePrimitives).MapFailure(func(coer37 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg49 interface{}) interface{} {
			return coer37(arg49.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	_ = _5_valueOrError1
	_5_valueOrError1 = (_4_maybeMatProv).MapFailure(func(coer38 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg50 interface{}) interface{} {
			return coer38(arg50.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
