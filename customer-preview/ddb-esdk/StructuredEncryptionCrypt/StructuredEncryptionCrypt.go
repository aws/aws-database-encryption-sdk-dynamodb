...
func (_static *CompanionStruct_Default___) FieldKey(HKDFOutput _dafny.Sequence, offset uint32) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.IntOfUint32(offset)).Times(_dafny.IntOfInt64(3))).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT32__LIMIT()) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too many encrypted fields.")))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_keyR m_Wrappers.Result = m_AesKdfCtr.AesKdfCtrStream(Companion_Default___.FieldKeyNonce((offset)*(uint32(3))), HKDFOutput, ((m_StructuredEncryptionUtil.Companion_Default___.KeySize()).Plus(m_StructuredEncryptionUtil.Companion_Default___.NonceSize())).Uint32())
		_ = _1_keyR
		return (_1_keyR).MapFailure(func(coer14 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
			return func(arg19 interface{}) interface{} {
				return coer14(arg19.(m_AwsCryptographyPrimitivesTypes.Error))
			}
...
func (_static *CompanionStruct_Default___) GetCommitKey(client *m_AtomicPrimitives.AtomicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, key _dafny.Sequence, msgID _dafny.Sequence) m_Wrappers.Result {
	...
	_0_commitKey = _out0
	ret = (_0_commitKey).MapFailure(func(coer15 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg20 interface{}) interface{} {
			return coer15(arg20.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) Crypt(mode m_Canonize.EncryptionSelector, client *m_AtomicPrimitives.AtomicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, key _dafny.Sequence, head m_StructuredEncryptionHeader.PartialHeader, data _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_fieldRootKeyR).MapFailure(func(coer16 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg21 interface{}) interface{} {
			return coer16(arg21.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	}(func(_2_e m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error {
		return m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_Error_.Create_AwsCryptographyPrimitives_(_2_e)
	}))
...
func (_static *CompanionStruct_Default___) CryptList(mode m_Canonize.EncryptionSelector, client *m_AtomicPrimitives.AtomicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, fieldRootKey _dafny.Sequence, data _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _2_valueOrError0
	_2_valueOrError0 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((data).Cardinality())).Cmp(m_StandardLibrary_UInt.Companion_Default___.UINT32__LIMIT()) < 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Too many fields.")))
	if (_2_valueOrError0).IsFailure() {
		ret = (_2_valueOrError0).PropagateFailure()
		return ret
	}
	var _hi0 _dafny.Int = _dafny.IntOfUint32((data).Cardinality())
	_ = _hi0
	for _3_i := _dafny.Zero; _3_i.Cmp(_hi0) < 0; _3_i = _3_i.Plus(_dafny.One) {
		if (((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_action()).Equals(m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Companion_CryptoAction_.Create_ENCRYPT__AND__SIGN_()) {
			...
			if (mode).Equals(m_Canonize.Companion_EncryptionSelector_.Create_DoEncrypt_()) {
				...
				var _out0 m_Wrappers.Result
				_ = _out0
				_out0 = Companion_Default___.EncryptTerminal(client, alg, fieldRootKey, _1_pos, ((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_key(), ((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data())
				...
				var _out1 m_Wrappers.Result
				_ = _out1
				_out1 = Companion_Default___.DecryptTerminal(client, alg, fieldRootKey, _1_pos, ((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_key(), ((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)).Dtor_data())
			...
			_ = _7_newItem
			var _8_dt__update__tmp_h0 m_StructuredEncryptionUtil.CanonCryptoItem = (data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)
			...
			_0_result = _dafny.Companion_Sequence_.Concatenate(_0_result, _dafny.SeqOf((data).Select((_3_i).Uint32()).(m_StructuredEncryptionUtil.CanonCryptoItem)))
		}
	}
...
func (_static *CompanionStruct_Default___) EncryptTerminal(client *m_AtomicPrimitives.AtomicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, fieldRootKey _dafny.Sequence, offset uint32, path _dafny.Sequence, data m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal) m_Wrappers.Result {
	...
	_ = _2_cipherkey
	_2_cipherkey = (_1_fieldKey).Subsequence(0, (m_StructuredEncryptionUtil.Companion_Default___.KeySize()).Uint32())
	var _3_nonce _dafny.Sequence
	_ = _3_nonce
	_3_nonce = (_1_fieldKey).Drop((m_StructuredEncryptionUtil.Companion_Default___.KeySize()).Uint32())
	...
	_ = _7_valueOrError1
	_7_valueOrError1 = (_6_encOutR).MapFailure(func(coer17 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg22 interface{}) interface{} {
			return coer17(arg22.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	_ = _10_valueOrError2
	_10_valueOrError2 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32(((_9_encOut).Dtor_authTag()).Cardinality())).Cmp(m_StructuredEncryptionUtil.Companion_Default___.AuthTagSize()) == 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("Auth Tag Wrong Size.")))
...
func (_static *CompanionStruct_Default___) DecryptTerminal(client *m_AtomicPrimitives.AtomicPrimitivesClient, alg m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo, fieldRootKey _dafny.Sequence, offset uint32, path _dafny.Sequence, data m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.StructuredDataTerminal) m_Wrappers.Result {
	...
	_ = _2_encryptionKey
	_2_encryptionKey = (_1_dataKey).Subsequence(0, (m_StructuredEncryptionUtil.Companion_Default___.KeySize()).Uint32())
	var _3_nonce _dafny.Sequence
	_ = _3_nonce
	_3_nonce = (_1_dataKey).Drop((m_StructuredEncryptionUtil.Companion_Default___.KeySize()).Uint32())
	var _4_value _dafny.Sequence
	_ = _4_value
	_4_value = (data).Dtor_value()
	var _5_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _5_valueOrError1
	_5_valueOrError1 = m_Wrappers.Companion_Default___.Need(((m_StructuredEncryptionUtil.Companion_Default___.AuthTagSize()).Plus(_dafny.IntOfInt64(2))).Cmp(_dafny.IntOfUint32((_4_value).Cardinality())) <= 0, m_StructuredEncryptionUtil.Companion_Default___.E(_dafny.SeqOfString("cipherTxt too short.")))
	if (_5_valueOrError1).IsFailure() {
		ret = (_5_valueOrError1).PropagateFailure()
		return ret
	}
	...
	_ = _8_valueOrError2
	_8_valueOrError2 = (_7_decOutR).MapFailure(func(coer18 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkStructuredEncryptionTypes.Error) func(interface{}) interface{} {
		return func(arg23 interface{}) interface{} {
			return coer18(arg23.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	ret = m_Wrappers.Companion_Result_.Create_Success_(m_StructuredEncryptionUtil.Companion_Default___.ValueToData(_10_decOut, (_4_value).Take((m_StructuredEncryptionUtil.Companion_Default___.TYPEID__LEN()).Uint32())))
	return ret
	return ret
}
func (_static *CompanionStruct_Default___) LABEL__COMMITMENT__KEY() _dafny.Sequence {
	return m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("AWS_DBE_COMMIT_KEY"))
}
func (_static *CompanionStruct_Default___) LABEL__ENCRYPTION__KEY() _dafny.Sequence {
	return m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("AWS_DBE_DERIVE_KEY"))
}
