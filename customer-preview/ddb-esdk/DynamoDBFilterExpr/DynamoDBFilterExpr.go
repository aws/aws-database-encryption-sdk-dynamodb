...
func (_static *CompanionStruct_Default___) ParsedExprToString(t _dafny.Sequence) _dafny.Sequence {
	var _0_x _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer107 func(Token) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg132 interface{}) interface{} {
			return coer107(arg132.(Token))
		}
...
func (_static *CompanionStruct_Default___) UnicodeLess(a _dafny.Sequence, b _dafny.Sequence) bool {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if ((_dafny.IntOfUint32((a).Cardinality())).Sign() == 0) && ((_dafny.IntOfUint32((b).Cardinality())).Sign() == 0) {
		return false
	} else if (_dafny.IntOfUint32((a).Cardinality())).Sign() == 0 {
		return true
	} else if (_dafny.IntOfUint32((b).Cardinality())).Sign() == 0 {
		return false
	} else if ((a).Select(0).(_dafny.Char)) == ((b).Select(0).(_dafny.Char)) {
		...
		var _0_aIsHighSurrogate bool = Companion_Default___.IsHighSurrogate((a).Select(0).(_dafny.Char))
		_ = _0_aIsHighSurrogate
		var _1_bIsHighSurrogate bool = Companion_Default___.IsHighSurrogate((b).Select(0).(_dafny.Char))
		_ = _1_bIsHighSurrogate
		if (_0_aIsHighSurrogate) == (_1_bIsHighSurrogate) {
			return ((a).Select(0).(_dafny.Char)) < ((b).Select(0).(_dafny.Char))
		} else {
...
func (_static *CompanionStruct_Default___) UnicodeLessOrEqual(a _dafny.Sequence, b _dafny.Sequence) bool {
	return !(Companion_Default___.UnicodeLess(b, a))
}
func (_static *CompanionStruct_Default___) CompareFloat(x _dafny.Sequence, y _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (m_DynamoDbNormalizeNumber.Companion_Default___.NormalizeNumber(x)).MapFailure(func(coer108 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg133 interface{}) interface{} {
			return coer108(arg133.(_dafny.Sequence))
		}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _2_newX
		var _3_valueOrError1 m_Wrappers.Result = (m_DynamoDbNormalizeNumber.Companion_Default___.NormalizeNumber(y)).MapFailure(func(coer109 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg134 interface{}) interface{} {
				return coer109(arg134.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) AttributeLE(a m_ComAmazonawsDynamodbTypes.AttributeValue, b m_ComAmazonawsDynamodbTypes.AttributeValue) m_Wrappers.Result {
	if ((a).Is_N()) && ((b).Is_N()) {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(m_StandardLibrary.Companion_Default___.LexicographicLessOrEqual((a).Dtor_B(), (b).Dtor_B(), func(coer110 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
			return func(arg135 interface{}, arg136 interface{}) bool {
				return coer110(arg135.(uint8), arg136.(uint8))
			}
...
func (_static *CompanionStruct_Default___) KeyIdFromPart(bv m_SearchableEncryptionInfo.BeaconVersion, keyIdField _dafny.Sequence, attr _dafny.Sequence, value _dafny.Sequence) m_Wrappers.Option {
	if (!((bv).Dtor_beacons()).Contains(attr)) || ((((bv).Dtor_beacons()).Get(attr).(m_SearchableEncryptionInfo.Beacon)).Is_Standard()) {
		...
		_ = _0_parts
		var _1_theParts _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer111 func(m_CompoundBeacon.BeaconPart) bool) func(interface{}) bool {
			return func(arg137 interface{}) bool {
				return coer111(arg137.(m_CompoundBeacon.BeaconPart))
			}
		...
		if (_dafny.IntOfUint32((_1_theParts).Cardinality())).Cmp(_dafny.One) != 0 {
			...
			_ = _4_pieces
			var _5_piece _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer112 func(_dafny.Sequence) bool) func(interface{}) bool {
				return func(arg138 interface{}) bool {
					return coer112(arg138.(_dafny.Sequence))
				}
...
func (_static *CompanionStruct_Default___) TestBeaconize(actions _dafny.Map, keyExpr m_Wrappers.Option, filterExpr m_Wrappers.Option, names m_Wrappers.Option) m_Wrappers.Result {
	...
	_0_encrypted = func() _dafny.Set {
		...
		_ = _coll0
		for _iter25 := _dafny.Iterate((actions).Keys().Elements()); ; {
			_compr_0, _ok25 := _iter25()
			if !_ok25 {
				break
			}
