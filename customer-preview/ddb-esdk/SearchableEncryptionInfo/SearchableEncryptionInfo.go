...
func (_static *CompanionStruct_Default___) GetBeaconKey(client *m_AtomicPrimitives.AtomicPrimitivesClient, key _dafny.Sequence, name _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _0_valueOrError0
	_0_valueOrError0 = (m_UTF8.Encode(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("AWS_DBE_SCAN_BEACON"), name))).MapFailure(func(coer97 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg121 interface{}) interface{} {
			return coer97(arg121.(_dafny.Sequence))
		}
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_keyR).MapFailure(func(coer98 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg122 interface{}) interface{} {
			return coer98(arg122.(m_AwsCryptographyPrimitivesTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) GenerateUuidBytes() m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_uuid_q).MapFailure(func(coer99 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg123 interface{}) interface{} {
			return coer99(arg123.(_dafny.Sequence))
		}
	...
	output = (m_UUID.ToByteArray(_3_uuid)).MapFailure(func(coer100 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
		return func(arg124 interface{}) interface{} {
			return coer100(arg124.(_dafny.Sequence))
		}
...
func (_static *CompanionStruct_Default___) MakeBeaconVersion(version uint8, keySource KeySource, beacons _dafny.Map, virtualFields _dafny.Map, actions _dafny.Map) m_Wrappers.Result {
	var _0_beaconNames _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((beacons).Keys(), func(coer101 func(_dafny.Char, _dafny.Char) bool) func(interface{}, interface{}) bool {
		return func(arg125 interface{}, arg126 interface{}) bool {
			return coer101(arg125.(_dafny.Char), arg126.(_dafny.Char))
		}
	}(m_DynamoDbEncryptionUtil.Companion_Default___.CharLess))
	_ = _0_beaconNames
	var _1_stdKeys _dafny.Sequence = m_Seq.Companion_Default___.Filter(func(coer102 func(_dafny.Sequence) bool) func(interface{}) bool {
		return func(arg127 interface{}) bool {
			return coer102(arg127.(_dafny.Sequence))
		}
...
func (_this KeySource) GetKeysCache(client *m_AtomicPrimitives.AtomicPrimitivesClient, stdNames _dafny.Sequence, keyId _dafny.Sequence, cacheTTL int64, partitionIdBytes _dafny.Sequence, logicalKeyStoreNameBytes _dafny.Sequence, now int64) m_Wrappers.Result {
	{
		...
		_ = _3_valueOrError0
		_3_valueOrError0 = (_2_keyIdBytesR).MapFailure(func(coer103 func(_dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg128 interface{}) interface{} {
				return coer103(arg128.(_dafny.Sequence))
			}
		}(func(_4_e _dafny.Sequence) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error {
		...
		_ = _11_valueOrError1
		_11_valueOrError1 = (_10_maybeCacheDigest).MapFailure(func(coer104 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
			return func(arg129 interface{}) interface{} {
				return coer104(arg129.(m_AwsCryptographyPrimitivesTypes.Error))
			}
		...
		if ((_15_getCacheOutput).Is_Failure()) || (!((_this).CacheEntryWithinLimits(((_15_getCacheOutput).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.GetCacheEntryOutput)).Dtor_creationTime(), now, cacheTTL))) {
			...
			_ = _17_valueOrError2
			_17_valueOrError2 = (_16_maybeRawBeaconKeyMaterials).MapFailure(func(coer105 func(m_AwsCryptographyKeyStoreTypes.Error) m_AwsCryptographyDbEncryptionSdkDynamoDbTypes.Error) func(interface{}) interface{} {
				return func(arg130 interface{}) interface{} {
					return coer105(arg130.(m_AwsCryptographyKeyStoreTypes.Error))
				}
			...
			if !((now) < ((m_BoundedInts.Companion_Default___.INT64__MAX()) - (cacheTTL))) {
				panic("dafny/DynamoDbEncryption/src/SearchInfo.dfy(409,8): " + (_dafny.SeqOfString("expectation violation")).String())
			}
...
func (_this BeaconVersion) ListSignedBeacons() _dafny.Sequence {
	{
		return m_Seq.Companion_Default___.Filter(func(coer106 func(_dafny.Sequence) bool) func(interface{}) bool {
			return func(arg131 interface{}) bool {
				return coer106(arg131.(_dafny.Sequence))
			}
