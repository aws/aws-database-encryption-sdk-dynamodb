...
# Import test classes
from src.v3.aes_key_provider_test import V3AESKeyProvider
from src.v4.raw_aes_keyring_test import V4RawAESKeyring
...
class EncryptionProfiler:
    ...
    def __init__(self, output_dir: str = "profiling_results"):
        ...
        self.v3_provider = V3AESKeyProvider()
        self.v4_provider = V4RawAESKeyring()
        ...
        for version in versions:
            for operation in operations:
                for data_type in data_types:
                    ...
                    # Save profile data
                    profile_name = f"{version}_aes_{operation}_{data_type}"
    ...
    def generate_report(self):
        ...
        report_path = self.output_dir / "profiling_report_aes.txt"
        ...
        # Save JSON results
        json_path = self.output_dir / "profiling_results_aes.json"
